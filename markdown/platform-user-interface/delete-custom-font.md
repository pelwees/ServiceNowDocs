...
3.  From the Theme drop-down list, select the theme that you want to edit.
    ...
    ![Example view of the Editor page with custom font listed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-editor-page-view-custom-font.png "Editor page view with custom font listed")
