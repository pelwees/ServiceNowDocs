 ...
 **Note:** When you add at least one role to a tour, it limits the audience to only those users who have that role.
    ...
    ![Shows Guided Tour Designer in a new tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/create-guided-tour-madrid.png)
...
5.  Follow these steps to add a tour step with a callout and trigger:
    ...
    1.  Drag a callout from the upper right corner of the screen and drop it on top of the UI element.
        ...
        ![Callout positioned correctly](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/guided-tour-drop-callout.png)

    2.  Enter the instructions in the **Text** box.

        ![Create Step Page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/gtd-createstep.png)
    ...
    3.  [Select the trigger](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../reference/guided-tour-triggers.md) from the **Choose action** list. Only triggers applicable to the selected element appears in the list.

        ![Callout trigger](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/guided-tour-delegate-callout-london.png)
    ...
    6.  Select **Save**.
        ...
        ![Tour first step callout label](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/guided-tour-step1-label-london.png)

        When your end users select the label, they see your first step instructions rendered as a message.

        ![Tour first step label is rendered](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/guided-tour-step1-rendered-london.png)
...
8.  Select **Preview** at any time to test your steps and make any final revisions to the tour.
    ...
    Note the steps that aren’t working properly or that need correction. Edit the tour or the steps as described in [Edit Guided Tours](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/edit-guided-tour.md).

9.  To share your draft or published tour with your internal colleagues for review, do the following:

    1.  Select the copy URL icon ![Copy URL icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../../../reuse/icons/product-icons/link-outline-24.svg) to copy the tour URL.
...
[Exploring Guided Tours](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../concept/exploring-guided-tours.md)
