...
![Context menu view options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/context-menu-view-titles.png "Context menu view options")
...
4.  Under Related Links, from the Guided Tour Steps, select the step you want to add a view.
    ...
    ![Guided Tour Steps related list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/guided-tour-steps-related-list.png "Guided Tour Steps related list")

5.  In the Tour Step tab, enter the view name in the **View** field.

    ![In the Tour Step tab enter a view name.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/gtd-tour-step-form.png "Tour Step form")
