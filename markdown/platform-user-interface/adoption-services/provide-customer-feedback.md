...
1.  Open the Help Center by selecting the Help Center icon ![Help Center icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../../../get-started/servicenow-overview/image/pol-nav-help.png).

2.  Scroll to the bottom of the Help Center menu and select **Provide feedback**.

    ![Help Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/ads-help-center.png)

3.  Rate your experience and provide as much or as little detail in the entry boxes as you want.

    ![Provide feedback modal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/../image/provide-feedback-modal.png)
...
4.  When you have completed your feedback, select **Submit**.
    ...
    **Note:** If you do not want the **Provide Feedback** button to appear in the Help Center, you can [disable it](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/adoption-services/disable-feedbak.md).
