...
Click **Enable Edit**.
    ...
    4.  In the Reference Specification section, select the **Reference floats** check box.
        ...
        ![Reference floats check box](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/ReferenceFloatsBox.png)
