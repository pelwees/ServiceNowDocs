...
2.  Create the desired filter using the condition builder \(example, **\[Active\] \[is\] \[true\]**\).
    ...
    ![Filter in a related list with the Set as Default Filter button highlighted](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/DefaultFilter.png)
