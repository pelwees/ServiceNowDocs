...
-   A theme creation workflow enabled in AI Agent Studio. See [Turn on theme creation workflow for use in the Now Assist panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/turn-on-theme-creation-workflow.md).
...
2.  In the chat window, enter `Create a theme`.
    ...
    ![Now Assist panel with Create a theme entered into the chat window.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-nap-chat-window.png "Now Assist panel")

3.  Select **Yes** when prompted to proceed.

4.  Select **Show** to open the theme creation wizard.

    ![Theme Builder Show button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-nap-show-button.png "Launch theme creation wizard")
...
7.  If you chose to upload a brand image or brand guidelines file, generate your theme colors using AI.
    ...
    1.  Upload your brand image or brand guidelines file.
        ...
        Supported formats for image files are JPEG, JPG, PNG, and SVG with a maximum size of 20 MB. Supported formats for brand guidelines are PDF with a maximum size of 20 MB. ![Theme Creation wizard showing a brand image uploaded to generate a color palette using AI.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-nap-wizard-upload-image.png)
