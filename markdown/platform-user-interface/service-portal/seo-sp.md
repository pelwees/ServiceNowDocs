...
![Dynamic page title and URL keywords based on the catalog item sys_id specified by the URL parameter](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../image/dyn-page-ex.png)
...
-   **[Add meta tags to a public page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/seo-tags.md)**  
...
-   **[Add dynamic titles to a page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/add-page-title.md)**  
Create variables to generate descriptive titles depending on the content loaded into a page.
-   **[Configure the main tag on a page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/configure-main-tag-on-page.md)**  
Specify the main content of a page to include in the **&lt;main&gt;** tag to improve search engine optimization and accessibility.
-   **[Enable SEO for localized versions of a portal page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/seo-header-tags.md)**  
Allow users to discover portal pages in their preferred language by adding **hreflang** tags.
-   **[Sitemap Generator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/sitemap-generator.md)**  
