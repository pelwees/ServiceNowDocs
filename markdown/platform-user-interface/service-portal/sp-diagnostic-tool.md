...
![Identifying customization levels](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../image/diagnostic-tool.png "Widget customizations highlighted on a portal page")
...
To view the widget code from the portal page, click the information icon \(![Information icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../image/info-icon.png)\) on a widget.

![Widget diagnostics window](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../image/widget-diagnostics-window.png)

From the widget diagnostics window, you can check the widget code in several ways:

-   [View a widget record from a portal page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/view-widget-record.md)

    View and identify potentially problematic code in the widget record without navigating away from the portal page.

-   [Identify customizations in widget related records](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/view-related-records.md)
...
-   [Compare versions of a widget related record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/compare-related-record-changes.md)
...
-   [Compare versions of a customized widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/compare-widget-versions.md)
...
-   [Compare a cloned or customized widget against a base widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/service-portal/../task/compare-with-base-system.md)
