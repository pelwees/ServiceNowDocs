...
To view the activity stream information, click the list activity stream icon \(![Activity stream icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/Show_live_feed_icon.png)\) in the list title bar. This icon appears in the title bar for all task tables.
