...
A [Response time indicator icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../../common-ui-elements/concept/c_ResponseTimeIndicator.md) \(![Response time indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/Response_time_indicator_UI15.png)\) may appear at the bottom right of some lists to indicate the processing time required to display the list.

![Record list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/800px-UI16_list_view.png "Record list")
...
![Features, menus, and actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/list-features-UI16.png "Features, menus, and actions")

## Hierarchical lists

Hierarchical lists allow users to view records from related lists directly without navigating to a form.

Lists can have sublists in a hierarchy that can also be accessed in list view. To expand or collapse the related lists on a record in a hierarchical list, click the arrow \(![Arrow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/Arrow.png)\) beside the reference icon.

![Hierarchical list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/HierarchicalList.png "Hierarchical list")
...
![Detail rows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/400px-Detail_rows.png "Detail rows")
...
-   **[List fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../reference/r_Fields.md)**  
Fields display data and provide certain functions.
-   **[Configure and use list functions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../task/configure-use-list-functions.md#)**  
...
-   **[Activity streams in list view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/c_DisplayActivityStreams.md)**  
Stream live activity information for all records on the current list.
-   **[Search a list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../task/t_SearchAList.md#)**  
...
-   **[Grouped lists](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/c_GroupedLists.md#)**  
...
-   **[Filters and breadcrumbs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/c_UsingFiltersAndBreadcrumbs.md)**  
A filter is a set of conditions applied to a table to help you find and work with a subset of the data in that table.
-   **[Methods for list edits](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../reference/r_MethodsForListEdits.md)**  
Users can edit data in lists using various methods.
-   **[Personal lists](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/c_PersonalLists.md#)**  
