...
-   [Style Sheets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/c_StyleSheets.md) are records containing CSS declarations.
-   [Themes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/c_DesignThemes.md) are groups of style sheets that can be invoked together.
-   [Frames](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/../task/t_Frame.md) are UI macros that define the outer border of individual content blocks as they appear on a content page. Frames work by calling on particular definitions in the style sheets.

-   **[Style sheets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/c_StyleSheets.md)**  
Styles sheets are standard Cascading Style Sheets \(CSS\) that define the look and feel of all elements within the interface.
-   **[Design themes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/c_DesignThemes.md)**  
...
-   **[Doctypes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/c_SetTheDoctype.md)**  
The view\_content html page template on which all CMS is based defaults to `doctype=html`.
-   **[Format a frame](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/../task/t_Frame.md)**  
...
[Define a frame in a style sheet](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/../task/t_DefineTheFrameInAStyleSheet.md)

[Create a frame UI macro](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/content-management-system/../task/t_CreateANewFrameUIMacro.md)
