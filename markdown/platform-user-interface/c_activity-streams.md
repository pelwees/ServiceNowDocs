...
-   In a list, in the [activity stream](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../../using-lists/concept/c_DisplayActivityStreams.md) for a record.
-   On a Visual Task Board card, in the [card details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../../visual-task-boards/task/t_EditCardDetails.md#).
...
![@mention in an Activity Stream with the user selector menu open.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/activity-stream-mention-form.png "Activity stream mention on a form")
...
You can filter out emails in the activity stream, for example, auto-generated and correspondence emails, by selecting the ![Activity stream filter icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/activity-stream-filter.png). Select **Post types** to check or clear the boxes of the types of emails and posts that display in your activity stream.
...
**Parent Topic:**[Common UI elements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../../common-ui-elements/topic/p_CommonUIElements.md)
