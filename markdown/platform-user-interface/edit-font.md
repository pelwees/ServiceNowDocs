...
4.  From the Global styles Overview panel, navigate to the Typography section and select the current font listed in the **Default font family** field.
    ...
    ![Overview panel with Typography section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-overview-typography.png "Overview panel Typography section")
...
5.  Select a new font from the list of fonts.
    ...
    ![Pick a default font modal with Open Sans selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-pick-default-font-modal.png "Pick a default font modal")
...
Your new font is displayed as the Default font family and applied globally to your theme. If you want to upload a custom font, see [Upload a custom font to your theme](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/upload-custom-font.md).
