...
Theme Builder includes a dark mode option, offering an eye-friendly alternative to the default light mode. You can enable dark mode by selecting the Choose theme icon ![](../image/tb-choose-theme-icon.png) in the application banner.
