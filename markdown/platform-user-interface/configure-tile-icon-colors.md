...
5.  Select any tile icon illustration type from the main stage.
    ...
    **Note:** Customizing the colors of any tile icon illustration type applies the color change to the entire tile icon category, regardless of which type you select.
    ...
    ![Image styles tab selected with tile icon illustrations listed on main stage and property panel opened.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-tile-icon-property-panel.png "Image styles tab with Tile icons expanded and Accessibility illustration selected")
