...
To make the condition builder appear every time you open the list, click the pin/unpin filter icon \(![Pin icon for Core UI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/Icon-Pin_UI15.png)\). This functionality is not supported in List v3.
...
-   **[OR conditions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/c_UsingORConditions.md)**  
