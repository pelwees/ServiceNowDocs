...
-   **[Update an existing image](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../task/t_UpdatingAnExistingImage.md)**  
You can change an existing image to an updated version.
-   **[Upload one or more images](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../task/upload-multiple-images.md)**  
You can upload one image or multiple images at one time.
-   **[Restrict file extensions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../task/restrict-file-extensions.md)**  
