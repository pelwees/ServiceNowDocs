...
2.  From the Home page view, select the Manager page view to see [the themes you have created](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/tb-create-theme.md).
...
3.  Select the theme to which you want to add an alternate color palette to.
    ...
    -   For published or unpublished themes without an alternate color palette already defined, select the More actions icon ![](../image/tb-more-actions.png), and select **Add alternate color palette**.![Add an alternate color palette.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-select-alt-color-pal.png)
    ...
    ![First, name your alternate color palette.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-provide-color-palette.png)
...
6.  On this screen, perform the following actions:
    ...
    -   Select any of the three brand colors defined in this palette and change them from the color picker.
        ...
        **Note:** For dark palettes, only the primary color can be edited. If you want to customize further, see [Edit components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/tb-edit-components.md).


## Result

The alternate color palette is added to your core theme. The theme name now appears as a theme group with the palette recorded under the Color palette drop-down list.![Color palette drop-down list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/../image/tb-color-palette-list.png)
...
**Parent Topic:**[Manage or edit a theme with Theme Builder](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-user-interface/tb-edit-theme.md)
