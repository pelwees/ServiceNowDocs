...
-   [Configured an External Key Management Service \(EKMS\) key definition.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/ekms-configure-external-key-definition.md)
...
[Change the status of an AWS KMS Key](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/ekms-change-status-aws-kms-key.md)
