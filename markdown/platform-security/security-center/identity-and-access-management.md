...
![Identity and Access Management in Security Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/security-center/../images/iam1.png)

IAM consists of three tools you can use to manage access to the data on your instance. You can also select **Go to Console** to view these and other tools within the [Access management console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/security-center/../../contextual-security/concept/access-management-console.md).

-   **[Access findings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/security-center/../../contextual-security/concept/access-findings.md)**
...
-   **[Access Analyzer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/security-center/../../../integrate/identity/concept/access-analyzer.md)**
...
-   **[Scripting Governance for default group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/security-center/../../security/concept/scripting-governance.md)**
