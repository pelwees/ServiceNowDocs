...
-   The external IP address or fully-qualified domain name of the LDAP server. You can also use a [MID server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/ldap-integration/../concept/c_LDAPIntegrationViaMIDServer.md).
