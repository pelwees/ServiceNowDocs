...
-   [Data privacy \(Classic\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../reference/data-privacy-classic.md): First use the data classification app to group your data by type, using pre-defined or user-defined data classifications. Then create data privacy techniques and jobs to anonymize PII.
-   [Data privacy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../../data-privacy-store/concept/dps-data-privacy.md) \(Store App\): Classify and anonymize your data all from within the data privacy app.
