...
[Disable legacy JQuery behavior](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-legacy-jquery-behavior.md)
...
[Enforce Query ACLs for SubLists, List Counts and Widget Data Tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-query-acls-for-sublists-list-counts-and-widget-data-tables.md)
...
[Enable antivirus scan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-antivirus-scan.md)
...
[Timeout Guest Sessions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-timeout-guest-sessions.md)
...
[Enable report view ACLs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-report-view-acls.md)
...
[Disable AJAXEvaluate](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-disable-ajaxevaluate.md)
...
[Maximize reset password verification delay duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-verification-delay.md)
...
[Prevent inactive users from logging in](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-prevent-inactive-users-from-logging-in.md)
...
[Enable High Security Plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-high-security-plugin.md)
...
[Activate Limit Concurrent Sessions Plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-concurrent-sessions-plugin.md)
...
[Enable policy based session access for mobile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-policy-based-session-access-for-mobile.md)
...
[Require obfuscation of mobile app UI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-mobile-app-ui-obfuscation.md)
...
[Enforce read ACLs on report views](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-read-acls-on-report-views.md)
...
[Enable SMS code notification for enrollment and verification](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-sms-code-notification-for-enrollment-and-verification.md)
...
[Enable email OTP for multi-factor authentication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-email-otp-for-multi-factor-authentication.md)
...
[Escape XML markup](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-escape-xml.md)
...
[Remove remember me](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-remove-remember-me.md)
...
[Disable creating users from incoming emails](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-emails-by-domain.md)
...
[Minimize SMTP Recipient Quantity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-max-smtp-recipients.md)
...
[Disable JavaScript tags in embedded HTML](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-allow-javascript-tags-in-embedded-html.md)
...
[Restrict performance monitoring access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-performance-monitoring-acl.md)
...
[Configure Service Portal Widgets Table Allow List](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-configure-service-portal-widgets-table-allow-list.md)
...
[Honor Admin Override ACLs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-honor-admin-override-acls.md)
...
[Enforce oauth state parameter validation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-oauth-state-parameter-validation.md)
...
[Limit max comments per user per day](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-max-comments-per-user-per-day.md)
...
[../reference/sc-disable-chat-server-debugging.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-disable-chat-server-debugging.md)
...
[Configure Service Portal Widgets Allow List](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-configure-service-portal-widgets-allow-list.md)
...
[Prevent verbose HTTP request logging](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-prevent-verbose-http-request-logging.md)
...
[Require authorization for JSONv2 request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-jsonv2-request-authorization.md)
...
[Require authorization for XML output requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-xml-output-authorization.md)
...
[Minimize reset password SMS expiry duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-sms-expiracy.md)
...
[Prevent Unauthenticated Access to Virtual Agent Embedded Web Client](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-publicly-exposed-virtual-agent-embedded-web-client.md)
...
[Maximize reset password SMS pause window duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-sms-pause-window.md)
...
[Maximize reset password request retry window duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-request-retry-window.md)
...
[Double check inbound transactions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-double-check-inbound-transactions.md)
...
[Minimize reset password request expiration duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-request-expiration.md)
...
[Enable CAPTCHA in password reset](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-captcha-in-password-reset.md)
...
[Validate remote host](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-validate-remote-host.md)
...
[Rotate HTTP session identifiers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-rotate-http-session-identifiers.md)
...
[Set Xframe options to prevent embedding third-party websites](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-xframe-options.md)
...
[Enforce production instance behavior](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-production-instance-behavior.md)
...
[Enforce security rules to sharing dashboards](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-security-rules-to-sharing-dashboards.md)
...
[Implement the x-frame-options: SAMEORIGIN security header](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-x-frame-options-sameorigin.md)
...
[Enable HTTP Only Cookie Flag](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-http-only-cookie-flag.md)
...
[Prevent Empty ACL Creation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-prevent-empty-acl-creation.md)
...
[Require authorization for XML requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-xml-request-authorization.md)
...
[Enforce SOAP request strict security](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-soap-request-strict-security.md)
...
[Disable public access to favorites](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-public-access-to-favorites.md)
...
[Disable inbound emails for locked out users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-disable-inbound-emails-locked-out-users.md)
...
[Enable scoped admin application ACLs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-administer-scoped-admin-application-acls.md)
...
[Minimize session activity timeout duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-session-activity-timeout.md)
...
[Enforce HTML Sanitization](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-check-unsanitized-html.md)
...
[Limit integrations' active session life span](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-integrations-active-session-life-span.md)
...
[Limit guest's active session life span](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-guests-active-session-life-span.md)
...
[Enable CAPTCHA for customer registration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-captcha-for-customer-registration.md)
...
[Limit Allowed Number of Failed Login Attempts Before Lockout](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-managing-failed-login-attempts.md)
...
[Require authorization for SCHEMA requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-schema-request-authorization.md)
...
[Set Automatic Token Cleanup for Token Credentials](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-set-automatic-token-cleanup-for-token-credentials.md)
...
[Enable HTTP response headers configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-http-response-headers-configuration.md)
...
[Prevent users from accepting warning to bypass CSRF validation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-prevent-users-from-accepting-warning-to-bypass-csrf-validation.md)
...
[Block access for delegated developers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-block-access-for-delegated-developers.md)
...
[Require Authorization for XSD Requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-xsd-request-authorization.md)
...
[Turn off verbose SQL error messages for import processor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-turn-off-verbose-sql-error-messages-for-import-processor.md)
...
[Escape scripts in scratchpad](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-escape-scratchpad.md)
...
[Require authorization for PDF requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-require-authorization-for-pdf-requests.md)
...
[Enable SNC access control plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-snc-access-control-plugin.md)
...
[Limit concurrent sessions across all nodes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-concurrent-sessions-across-all-nodes.md)
...
[Enable security jump start plugin \(ACL Rules\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-security-jump-start-plugin-acl-rules.md)
...
[Restrict flow context read access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-flow-context-read-access.md)
...
[Restrict Global App Development by Role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-global-app-development-by-role.md)
...
[Enable ACLs to Control Live Profile Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-acls-to-control-live-profile-details.md)
...
[Set safe content security policy for SVG files](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-set-safe-content-security-policy-for-svg-files.md)
...
[Enable Jelly JS Interpolation Protection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-jelly-js-interpolation-protection.md)
...
[Require AJAXGlideRecord ACL checking](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enabling-ajaxgliderecord-acl-checking.md)
...
[Require authorization for excel requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-excel-request-authorization.md)
...
[Use of secure insert multiple operation within import set API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-use-of-secure-insert-multiple-operation-within-import-set-api.md)
...
[Minimize absolute session timeout duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-absolute-session-timeout.md)
...
[Disable locked form elements debugging](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-disable-locked-form-elements-debugging.md)
...
[Deny unauthorized access to request items](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-deny-unauthorized-access-to-request-items.md)
...
[Check UI action conditions before execution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-check-ui-action-conditions-before-execution.md)
...
[Sanitize All Translated HTML Fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-sanitize-all-translated-html-fields.md)
...
[Require write access to access service catalog add item page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-require-write-access-to-access-service-catalog-add-item-page.md)
...
[Restrict knowledge bases access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-knowledge-bases-access.md)
...
[Disable soap fault stack trace display](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-disable-soap-fault-stack-trace-display.md)
...
[Validate SOAP content type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-soap-content-type-checking.md)
...
[Enable ACLs for Encoded Query in Simple List Widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-acls-for-encoded-query-in-simple-list-widget.md)
...
[Restrict Impersonation to Admin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-impersonation-to-admin.md)
...
[Anti-CSRF token validation time](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-anti-csrf-token-validation-time.md)
...
[Hide user comments on articles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-hide-user-comments-on-articles.md)
...
[Enforce Strict User Image Upload](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-strict-user-image-upload.md)
...
[Minimize session window timeout duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-session-window-timeout.md)
...
[Require authorization for API requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-api-request-authorization.md)
...
[Enforce strict elevate privilege](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-strict-elevate-privilege.md)
...
[Enforce strict security of session cookies](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-secure-session-cookies.md)
...
[Enable the hardened java security manager](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-the-hardened-java-security-manager.md)
...
[Restrict access to specific IP ranges plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-access-to-specific-ip-ranges-plugin.md)
...
[Require authorization for unload requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-require-authorization-for-unload-requests.md)
...
[Require authorization for import requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-import-request-authorization.md)
...
[Require authorization for script requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-script-request-authorization.md)
...
[Enable contextual security plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-contextual-security-plugin.md)
...
[Disable logger for low privilege users in script sandbox](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-glide-security-logger-no-loggining-for-sandbox.md)
...
[Require authentication by default for client-callable script includes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-privacy-on-client-callable-script-includes.md)
...
[Enforce field ACLs for inbound query requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-field-acls-for-inbound-query-requests.md)
...
[Limit UI active session life span](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-ui-active-session-life-span.md)
...
[Restrict access to emails with empty target table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-restrict-access-to-emails-with-empty-target-table.md)
...
[Require authorization for RSS requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-rss-request-authorization.md)
...
[Maximize reset password SMS complexity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-sms-complexity.md)
...
[Minimize reset password request success window duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-request-success-window.md)
...
[Disable secure cookie debugging](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-disable-secure-cookie-debugging.md)
...
[Minimize Allowed Attachment Size](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-max-allowed-attachment-size.md)
...
[Enable email spam scoring and filtering](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-email-spam-scoring-and-filtering.md)
...
[Block rooted or jailbroken mobile devices](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-block-rooted-or-jailbroken-mobile-devices.md)
...
[Limit max subscriptions per user per day](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-max-subscriptions-per-user-per-day.md)
...
[Maximize reset password request unlock window duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-reset-password-request-unlock-window.md)
...
[Limit policy based session access mobile refresh token interval](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-limit-policy-based-session-access-mobile-refresh.md)
...
[Enable a deny-list password validation check](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-blacklisted-passwords-validation-check.md)
...
[Verify certificate revocation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-verify-certificate-revocation.md)
...
[Enforce secure referrer policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enforce-secure-referrer-policy.md)
...
[Restrict allowed domains for cross-origin iframe communication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-enable-url-allowlist-for-cross-origin-iframe-communication.md)
...
[Require Minimum and Maximum Password Length](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/../reference/sc-set-minimal-password-length.md)
