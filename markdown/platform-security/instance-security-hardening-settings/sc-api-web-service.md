...
-   **[Validate SOAP content type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-soap-content-type-checking.md)**  
...
-   **[Prevent OAuth Clients from Using Implicit Grant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-prevent-oauth-clients-from-using-implicit-grant.md)**  
Use a system property to avoid the use of the implicit grant type.
-   **[Require authorization for PDF requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-require-authorization-for-pdf-requests.md)**  
...
-   **[Require authorization for SOAP requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-soap-request-authorization.md)**  
Use the **glide.basicauth.required.soap** property to designate if incoming SOAP requests should require basic authorization.
-   **[Require authorization for unload requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-require-authorization-for-unload-requests.md)**  
...
-   **[Require authorization for excel requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-excel-request-authorization.md)**  
...
-   **[Require authorization for import requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-import-request-authorization.md)**  
...
-   **[Require authorization for JSONv2 request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-jsonv2-request-authorization.md)**  
...
-   **[Require authorization for WSDL request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-wsdl-request-authorization.md)**  
...
-   **[Require authorization for XML requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-xml-request-authorization.md)**  
Use the **glide.basicauth.required.xml** property to designate if incoming XML requests should require basic authentication.
-   **[Require authorization for XML output requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-xml-output-authorization.md)**  
Configure this property so that basic authorization is required for all inbound XMLOutputProcessor requests.
-   **[Require Authorization for XSD Requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-xsd-request-authorization.md)**  
...
-   **[Require authorization for script requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-script-request-authorization.md)**  
...
-   **[Require authorization for SCHEMA requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-schema-request-authorization.md)**  
...
-   **[Require authorization for RSS requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-rss-request-authorization.md)**  
Use the **glide.basicauth.required.rss** property to designate if incoming RSS requests should require basic authentication.
-   **[Require authorization for API requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/instance-security-hardening-settings/sc-api-request-authorization.md)**  
