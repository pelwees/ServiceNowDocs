...
5.  On the form, fill in the fields.
    ...
    ![Shows a completed Encrypted Field Configuration.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../../encryption/image/fee-efc.png "Encryption field configuration example")

6.  Click **Save**.

    Establish a Module Access Policy \(MAP\) to assign access to the cryptographic module. See [Create a module access policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../task/create-module-access-policy.md) for additional information.
...
9.  On the form, fill in the fields.
    ...
    ![Shows the completed module access policy form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../../encryption/image/fe-map.png "Module access policy example")
...
2.  Create a cryptographic module.
    ...
    See [Create cryptographic module for Field Encryption](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../task/create-PE-cryptographic-module.md) for more information.
...
The **Single Module** option is used to apply the policies for one module. **Multiple Modules** is used to apply the policies across multiple modules.
    ...
    Establish a Module Access Policy \(MAP\) to assign access to the cryptographic module. Refer to [Create a module access policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../task/create-module-access-policy.md) for additional information.
