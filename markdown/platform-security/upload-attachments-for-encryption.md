...
3.  In the **Attachments** window, select the module to encrypt with from the **Encrypt with Module** drop-down options.
    ...
    ![Encrypt with Module drop-down options for attachments.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../image/encrypt-attachment-module.png)
