...
-   Rekey activity is tracked on the **Modules Key** tab of the cryptographic module. Access the Key life cycle state and Key version for key activity. See [Rotate keys](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/platform-encryption/../../encryption/task/rotate-cust-supplied-keys.md) for additional information.

Configure a Key Exchange and select the **Enable Rekeying After Key Imported** check box for activation. See [Configure Key Exchange](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/platform-encryption/../task/configure-key-exchange.md) for details.

![Select the Enable Rekeying After Key Imported check box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/platform-encryption/../image/rekey-res-exchange.png)

**Parent Topic:**[Key Management Framework Resource Exchange](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/platform-encryption/resource-exchange.md)
