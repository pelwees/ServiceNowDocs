...
For additional information on subcomponents, see [Instance level keys in the Key Management Framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/platform-encryption/../reference/instance-level-keys.md).
