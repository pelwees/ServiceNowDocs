...
The configuration of these parameters is covered in [Create a cryptographic module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/platform-encryption/../task/create-cryptographic-module.md).
