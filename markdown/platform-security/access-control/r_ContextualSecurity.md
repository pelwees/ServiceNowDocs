...
-   [Enable role auditing with Contextual Security: Role Management V2](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../task/enable-audit-roles.md).
-   [Hardening settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../../security-center/reference/security-hardening-settings.md) in Instance Security Hardening Settings.
