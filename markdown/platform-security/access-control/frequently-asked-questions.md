...
At a table level, ACLs are evaluated only for roles and security attributes. Conditions and scripts aren’t evaluated.
 ...
 Roles are evaluated first. If Roles are blocked, conditions and scripts are skipped. For more information, see [Configure an ACL rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../../../administer/contextual-security/task/t_CreateAnACLRule.md).
