...
1.  [Elevated privilege roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../../security/concept/c_ElevatedPrivilege.md) to the security\_admin role.

2.  Navigate to **System Security** &gt; **Access Control \(ACL\)**.

3.  Select **New**.

    **Tip:** When creating an ACL, it’s helpful to review the [Deny-Unless ACL](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../concept/acl-denial-behavior.md).
...
Enforces the ACL on related records. See [Related record access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../concept/related-record-access.md) for more details.
