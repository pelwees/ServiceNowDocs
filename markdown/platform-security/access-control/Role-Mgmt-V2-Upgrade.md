...
You must have the admin role and [Elevate to a privileged role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/access-control/../../security/task/t_ElevateToAPrivilegedRole.md) to obtain the effective security\_admin role.
