...
JDBC credentials are retrieved separately by the activity designer template and support [external credential storage](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/connections-and-credentials/../concept/c_ExternalCredentialStorage.md), such as CyberArk.
...
**Parent Topic:**[Get started with connections](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/connections-and-credentials/../reference/connection-information.md)
