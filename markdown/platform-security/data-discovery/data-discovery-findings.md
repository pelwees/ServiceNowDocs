...
Select the **Available Protections** button to review an entries control service, status, notes, and last check in. As of Xanadu this feature supports only [Field Encryption](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/data-discovery/../../encryption/concept/field-encryption.md).

Protecton services can also be accessed from the Dashboard. For more information on the dashboard see, [Data Discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/data-discovery/data-discovery-landing.md).
