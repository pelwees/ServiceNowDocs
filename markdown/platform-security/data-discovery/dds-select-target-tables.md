...
4.  Check the tables to target, they will show in the right side of the pop-up.
    ...
    **Note:** Target tables will scan all columns, unless specified otherwise [in policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/data-discovery/dds-new-policy.md).
...
Selected tables will now be targeted by [scheduled discovery jobs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/data-discovery/../concept/dds-scheduled-discovery.md).
