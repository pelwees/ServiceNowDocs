...
The **Active Patterns** table lists all of the current active data patterns. See [Select active data patterns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/data-discovery/../task/dds-active-data-patterns.md) to learn how set a pattern to active and used by discovery jobs.
...
The **Target Tables** table lists all tables currently selected for discovery jobs. See [Select target tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/data-discovery/../task/dds-select-target-tables.md) to select tables for use in discovery jobs.
