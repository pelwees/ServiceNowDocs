...
3.  Select **Manage Specifications Settings** from the **Cryptographic Specification**.
    ...
    For Field Encryption Enterprise see [Configure advanced algorithms for Field Encryption Enterprise](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/adv-algorithm-cleent.md).
...
-   Click **Next** to create a cryptographic key. For details on this process, see [Generate a ServiceNow cryptographic key](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/generate_sn_key.md).
