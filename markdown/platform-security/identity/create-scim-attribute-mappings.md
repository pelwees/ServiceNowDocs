...
3.  In the  SCIM Attribute Mappings  related list, click  **New**.
    ...
    ![SCIM Provider Resource Mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../images/new-attribute-mappings.png)
...
[Attribute](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../reference/attribute-mapping-references.md#section_sbw_3jm_htb) for which the mapping must be defined. For example, **userName**.
...
[Sub-Attribute](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../reference/attribute-mapping-references.md#section_o4h_cmm_htb) \(if any\) for which the mapping must be defined.
...
Some multi-valued attributes can have additional information that can be specified by using a [Filter Condition](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../reference/attribute-mapping-references.md#section_gfm_ymm_htb). The choices of filter condition are populated using the schemas defined by the SCIM Provider.
...
The[Database Field Name](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../reference/attribute-mapping-references.md#section_a1t_4sm_htb) field maps the SCIM attribute to the ServiceNow field name to be mapped with the SCIM Attribute. If you choose direct attribute mapping, you must define this field.
...
Details about the [default value](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../reference/attribute-mapping-references.md#section_e2t_zvm_htb) that is passed to the SCIM Provider.
...
[Script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/identity/../reference/attribute-mapping-references.md#section_hpd_1wm_htb)
