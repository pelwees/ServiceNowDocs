...
-   You must have a configured secrets group on your instance. See steps 1 through 3 listed in [Configuring client accessible secrets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../concept/client-access-secret-landing.md).
-   You must have a configured credential encrypted with Secrets Management. See steps 1 through 9 listed in [Create credentials and test credential encryption](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/client-access-example-4.md).
...
2.  Confirm that the credential is encrypted with Secrets Management.
    ...
    2.  Open your credential record.
        ...
        Verify that you have a credential alias listed in the **Credential alias** field. If you have not created one already, see [Create a Connection &amp; Credential alias](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../../../product/credentials/task/connection-alias.md).
    ...
    4.  In the XML view of the record, find the password and confirm that the value starts with `□□□A□□`.
        ...
        ![XML view of a credential alias record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../images/XML-view.png)
...
4.  Configure a record lookup step in Workflow Studio.
    ...
    ![Look up Record step configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../images/test_flow_example.png)
...
</table>    ![PowerShell step configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../images/test_flow_example_2.png)
...
6.  Create a script for your test action.
    ...
    ![Script configuration for the PowerShell step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../images/test_flow_example_3.png)
...
9.  Verify that a test file has been created on the host server in the file path you provided in the script.
    ...
    ![Test file within a host server's file system](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../images/test_flow_example_4.png)
