...
-   [Minimize absolute session timeout duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../security-center/reference/sc-absolute-session-timeout.md)
-   [Minimize session window timeout duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../security-center/reference/sc-session-window-timeout.md)
...
**Note:** To learn more about this property, see [Remove remember me](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../security-center/reference/sc-remove-remember-me.md) in Instance Security Hardening Settings.
