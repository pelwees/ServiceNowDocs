...
Perform these steps only after you have set up ADFS for SAML. For details on that process, see [set up ADFS for SAML](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../concept/c_ADFSIntegrationWithSAML2.0.md).

Role required: sso\_config\_admin, business\_rule\_admin, script\_include\_admin

## Procedure

1.  If not already active, [Activate Multi-Provider SSO plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../single-sign-on/task/t_ActivateMultipleProviderSSO.md).

2.  Configure [SAML](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../concept/c_SAML2.0WebBrowserSSOProfile.md), but when you install the IdP certificate, attach the PEM certificate you created when you [Set up ADFS for SAML](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/t_DefineADFSServiceURL.md).
