...
2.  Create a new record called `SAML 2.0`.
    ...
    **Important:** You MUST use this name. This requirement is only true if you are not using [Multi-Provider single sign-on \(SSO\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../single-sign-on/concept/c_MultipleProviderSingleSignOn.md).
