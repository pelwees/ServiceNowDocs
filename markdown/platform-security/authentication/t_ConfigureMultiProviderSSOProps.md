...
3.  To [update the user table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../saml/task/t_AdministerSAMLUserProvisioning.md) with the users in the IdP, select the **Enable Auto Importing** option.
...
5.  In the property **The field on the user table that identifies a user accessing the User identification login page**, enter the field on the User table that contains the value the IdP uses to identify the user. The default value is **user\_name**.
    ...
    ![Multi-SSO properties.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../image/Multi-SSOProperties.png "Multiple Provider SSO properties")
...
[SAML user provisioning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../../saml/concept/c_SAMLUserProvisioning.md)
