...
2.  Select **Embedded Session Role Configuration**.
    ...
    ![Embedded Session](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../images/embedded-session-role.png)
    ...
    **Note:** The **Embedded Session Role Configuration** record is created by default to remove admin and security admin roles \(high privilege roles\) for the users for the embedded session.
    ...
    ![Configuration record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../images/embedded-session-role-record.png)
...
3.  Use the information icon to open the policy.
    ...
    -   **Policy Inputs**: Embedded Session- the user-specific filter criteria that is used to remove the configured roles.![Policy input record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../images/embedded-session-role-record-input.png)
    -   **Policy Conditions**: Remove high privilege roles in Embedded Session- the condition validates to true to remove the high privilege roles that are added for the configuration.![Condition set to true](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/authentication/../images/embedded-session-role-record-role-true.png)
