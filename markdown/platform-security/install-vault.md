...
4.  Based on organizational needs and functionality of each user, further additional tool-specific roles can be assigned to users.
    ...
    For more role related information, see [ServiceNow Vault roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-security/../concept/vault-roles.md).
