...
3.  On the knowledge base form, fill in the fields.
    ...
    For a description of the field values, see [Knowledge base form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-knowledge-management/../reference/knowledge-base-form-fields.md).
