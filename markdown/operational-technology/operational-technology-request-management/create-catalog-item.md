...
2.  In the **Dashboard** tab under **Start creating your new catalog item**, select **Create a new catalog item**.![Create a new catalog item button in the catalog builder on your instance.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-request-management/../image/create-catalog-item-buttom-otrm.png)
...
6.  On the **Create catalog item** form, fill in the fields.
    ...
    For more information about the Catalog Item form fields, see [Operational Technology Catalog Item form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-request-management/../reference/catalog-item-form-ot-request.md).
...
**Parent Topic:**[Configuring Operational Technology Request Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-request-management/../concept/configuring-operational-technology-request-management.md)
