...
![Auto Query page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/../images/auto-query-full-page.png)
...
![Auto Query Action button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/../images/actions-menu-quick-scan-small.png)
...
-   **Select Multiple**: Opens check boxes by each query in the list. You can check a box and the **Delete Selected** option is activated. This option deletes the selected queries. To turn off this option, select the **Actions** button again and select **Cancel Select Multiple**.
    ...
    ![Cancel multiple deletion](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/../images/cancel-multiples-action-menu.png)
