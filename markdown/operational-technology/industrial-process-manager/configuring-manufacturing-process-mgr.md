...
Optional: [Automate mapping of OT devices](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/../../operational-technology-management/task/automate-mappings-between-ot-assets-and-equipment-model-entity.md)
...
-   [Industrial Process Manager](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/industrial-process-manager-overview.md)

</td></tr></tbody>
</table>-   **[Install the Industrial Process Manager](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/../task/install-manufacturing-process-mgr.md)**  
...
-   **[Industrial Workspace Admin application menu and Guided Setup](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/../task/manufacturing-app-menu-guided-setup.md)**  
...
-   **[Assign Industrial Process Manager user roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/../task/assign-manufacturing-process-manager-roles.md)**  
...
-   **[View and edit OT system properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/../task/view-and-edit-ot-system-properties.md)**  
View and edit all of the Operational Technology \(OT\) related system properties for different applications.
-   **[Defining equipment model templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/defining-equipment-model-templates.md)**  
...
-   **[Importing equipment model data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/importing-isa95-equipment-model-etl.md)**  
...
-   **[Assign or remove equipment model site access for non-administrators](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/../task/create-user-criteria-for-equipment-model-entity-site-users.md)**  
...
-   **[Managing an equipment model entity schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/managing-equipment-entity-schedules.md)**  
...
**Parent Topic:**[Industrial Process Manager](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/industrial-process-manager-overview.md)
