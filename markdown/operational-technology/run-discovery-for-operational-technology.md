...
-   Install the CMDB CI Class Models plugin. To learn more, see [Operational Technology \(OT\) extension classes installation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/install-operation-technology-ot-extension-classes.md).
