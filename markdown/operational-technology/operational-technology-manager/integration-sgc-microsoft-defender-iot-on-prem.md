...
For more information on where data is saved when pulling data from a Microsoft Defender for IoT \(On-premises Management Console\) project, see [CMDB classes targeted](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../reference/sgc-microsoft-d4iot-on-prem-classes.md).

-   **[Configure the Service Graph Connector for Microsoft Defender for IoT \(On-premises Management Console\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../task/configuring-sgc-microsoft-d4iot-on-prem.md)**  
...
-   **[CMDB classes targeted in the Service Graph Connector for Microsoft Defender for IoT \(On-premises Management Console\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../reference/sgc-microsoft-d4iot-on-prem-classes.md)**  
