...
For more information on where data is saved when pulling data from a Microsoft Defender for IoT \(Azure\) project, see [CMDB classes targeted](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../reference/sgc-microsoft-d4iot-azure-classes.md).

-   **[Configure the Service Graph Connector for Microsoft Defender for IoT \(Azure\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../task/configuring-sgc-microsoft-d4iot-azure.md)**  
...
-   **[Validate NIDS sensors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../task/validate-nids-appliances-sgc-msft-d4iot-azure.md)**  
...
-   **[Accessing the connection details of the Service Graph Connector for Microsoft Defender for IoT \(Azure\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/sgc-cmdb-msft-d4iot-azure.md#)**  
...
-   **[Import OT devices using the Standard mode of discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../task/actively-scan-device-data-msft-azure.md)**  
...
-   **[CMDB classes targeted in the Service Graph Connector for Microsoft Defender for IoT \(Azure\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../reference/sgc-microsoft-d4iot-azure-classes.md)**  
...
-   **[Attribute mapping and classification for Service Graph Connector for Microsoft Defender for IoT \(Azure\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/../reference/attribute-mapping-sgc-msft-d4iot-azure.md)**  
The following tables describe the attribute mapping and classification for sensors and devices.

**Parent Topic:**[Operational Technology Manager Integrations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-manager/otm_integrations.md)
