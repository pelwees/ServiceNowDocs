...
For more information about OT change requests, see [Create a change request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-incident-management/create-ot-change-request.md).
...
For more information about OT requests, see [Create an Operational Technology request on the Industrial Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/operational-technology-incident-management/../../operational-technology-request-management/task/create-ot-service-request-industrial-workspace.md).
