...
4.  In Attachment panel of the import task record, download and save the Microsoft Excel spreadsheet template to your local drive.
    ...
    ![Downloading the Microsoft Excel spreadsheet from the OT import task with the Now Assist panel open.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/../image/download-spreadsheet-now-assist-otm.png)

5.  Once you have filled out the spreadsheet with your OT device inventory, upload it in the Attachment panel.

    For more information about how to fill out the spreadsheet, see [Prepare your Pre-import OT Worksheet Entry Review tool for Service Graph Connector import](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/../../mftg-manufacturing-oper-tech-mgr/task/preparing-your-pre-import-ot-worksheet-entry-review-tool-for-sgc-import.md).
...
**Parent Topic:**[Import the OT device spreadsheet into OT CMDB agentic workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/operational-technology/../concept/now-assist-otm-aiagents-import-ot-device-workflow.md)
