...
5.  Click the more actions button \(![More actions button icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-request-management/../image/more-button-icon.png)\) and select **Compose Email**.
...
6.  In the **New Email Draft** tab, compose a new email or respond to the email received.
    ...
    Using response templates, you can insert predefined content into the email body. Select the response template icon \(![Response template icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-request-management/../image/response-template-email-icon.png)\) and find an appropriate response template based on the subject of your email. Copy and paste the template's content into the email body.
...
7.  Send it right away or save it as a draft to send later.
    ...
    -   To save the email as draft, click **Save as draft**.
        ...
        **Note:** You can view the draft emails by clicking the list icon \(![List icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-request-management/../image/lsd-lcc-list-icon.png)\), selecting the **Drafts** list item under the **Email** category, and opening a draft email.
