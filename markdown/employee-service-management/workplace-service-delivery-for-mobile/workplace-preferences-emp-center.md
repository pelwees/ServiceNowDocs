...
3.  Tap and select the **In- office preferences** option from the home page.
    ...
    ![In-office preferences page options to set your workplace preferences.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-new-in-office-preferences-page.png)

    Search for floors. Campus and building have pre-filled values if you have workplace profile data. ![Search and select a floor for your in-office preferences.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-workplace-schedule-search-floors.png)

    Search for preferred workplace services to be added to a reservation if these services are available in a location.![Select and add a workplace services to your in-office preferences.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-workplace-schedule-add-services.jpeg)
