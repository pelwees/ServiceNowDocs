...
For more information, see [Configure map properties for Location directory](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/wsd-mobile-map-config-properties-loc-directory.md)
...
2.  Tap to select **View Location directory**.
    ...
    ![Option to select and open the View Location directory on Now Mobile app.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mob-showing-view-location-directory-button.png)
...
3.  Tap to select the **Select Campus** tab.
    ...
    ![Now Mobile showing the option to select a campus on the Location Directory home page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-location-directory-homepage.png)
    ...
    2.  Use the zoom in \(![Zoom in control icon to focus on the map artifacts.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-zoom-in-icon-new-loc-directory.jpeg)\) controls on the map to bring into focus the location pin marker icon \(![Location pin marker on map.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-location-pin-icon.png)\) to select a campus.
...
4.  When you select a campus, the **Select Building** tab is enabled and the buildings in a campus are displayed.
    ...
    ![Location Directory campus showing buildings in a campus on Now Mobile.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-new-loc-directory-home-page.png)
...
5.  Tap on the **Select Building** tab and select a building.
    ...
    **Note:** The **Last updated &lt;time interval&gt;** label is shown on the map after selecting a building. For example, **Last updated 1 min ago**. The map is automatically refreshed if your administrator has enabled the map property \(**Auto Refresh time interval \(in mins\) for showing Reservation and/or Occupancy information on the Location directory**\). This property fetches the latest reservation and occupancy data on the map.
    ...
    ![Last updated time interval label to show the time when the latest occupancy and reservation data is fetched.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-last-updated-time-new-loc-directory.jpeg)

6.  Tap **Select Floor** to select a floor.

    You can also search and select floor from the list.

    ![Search for a floor from the Floor list option.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-new-search-floors-loc-dir.png)
...
7.  Select **Filters**.
    ...
    ![Filter space availability by reservation status and occupancy status.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-filters-new-rsv-occ-status-loc-dir.png)
    ...
    **Note:** The option to show **Filters** option is configured by your administrator using a map property \[sn\_wsd\_space\_map.show\_rsv\_occ\_data\_loc\_dir\]. Filters can be applied at a floor or space level for both Card view and Map view.
    ...
    1.  Tap to select the **Occupancy status** check box.
        ...
        ![Filter space availability by occupancy status or spaces.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-filters-occupancy-spaces-new-loc-dir.png)
...
8.  Tap to select a space on the map to view the space card details panel.
    ...
    ![Select space on the map showing space card details panel on Now Mobile Location directory .](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-new-reservation-states-loc-dir.png)
    ...
    1.  Select **Reserve** to reserve an available space.
        ...
        ![Space card details panel on the Location Directory showing both reservation and occupancy status tag.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-space-card-details-use-new-loc-directory.png)

        ![Space card details panel showing reservation status as Available.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-space-card-details-available-use-new-loc-directory.png)
    ...
    2.  Select **Get Directions** for wayfinding.
        ...
        ![Get directions panel showing Default and accessible routes for navigation.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mob-get-directions-default-path-loc-directory.png)
    ...
    3.  Select **Default**or **Accessible**.
        ...
        ![Get directions from one building to another.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-get-directions-new-loc-dir-wayfinding-buildings.png)

        ![Get directions to a workplace user or collaborator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-get-directions-collaborator-new-loc-dir.jpeg)
        ...
        ![Location directory Get directions pathways showing error for locations that are not configured.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-get-directions-error-use-new-loc-directory.png)

        ![Location for get directions not configured error message.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-get-directions-error-use-new-loc-directory.png)

9.  From the Space details card panel, tap and select the More actions icon \(![More options icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../workplace-service-delivery/images/wsd-more-options-icon-loc-directory.png)\) and select any of the following options as required:
...
10. Select the Map display settings icon \(![Map display settings to show layers, private users, and permanent seating on the map.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../workplace-service-delivery/images/wsd-gear-settings-icon-loc-directorr.png)\) to enable or disable the following on the map:.
...
11. Tap and select the swipeable drawer on the navigation bar.
    ...
    ![Mobile navigation bar displaying swipeable drawer to open and view map legends and neighborhoods.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-nav-scalable-drawer-new-loc-dir.jpeg)
    ...
    -   Amenities: Option to view the available space types for a selected location.
        ...
        ![Mobile navigation bar displaying workplace amenities.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-nav-drawer-amenities-new-loc-directory.png)

    -   Space Availability: Option to view the map legends for space occupancy and reservation status.

        ![Map Legend for Space availability based on reservation and Occupancy status.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-nav-drawer-space-availability-new-loc-dir.png)
    ...
    ![Navigation bar showing option to enable neighborhood on Now Mobile.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-nav-drawer-mobile-neighborhood-enabled-new-loc-dir.jpeg)
...
12. Tap to select the Map controls or symbols that are available on the map.
    ...
    -   Reset north: Option to select the Reset north icon \(![Reset north icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../workplace-service-delivery/images/wsd-reset-north-icon-loc-directory.png)\).
    -   Refresh view: To refresh the map manually, select the Refreshed view icon ![Refresh view icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../workplace-service-delivery/images/wsd-refresh-icon-loc-directory.png).
    -   Map display settings: Select the Map setting icon \(![Map display settings icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../workplace-service-delivery/images/wsd-gear-settings-icon-loc-directorr.png)\) to open the display options:
    -   Zoom controls: Option to zoom in and zoom out on the map. The Zoom in control icon \(![Zoom in control icon to focus on the map artifacts.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-zoom-in-icon-new-loc-directory.jpeg)\) and zoom out control icon \(![Zoom out map control icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-zoom-out-icon-new-loc-directory.png)\) can be used to change the zoom level of the map.
13. To switch to Card view, select the **Card view** tab.

    ![Card view tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-card-view-tab-mob-loc-directory.png)

14. Select a campus from the All campuses screen.

    ![All campuses screen showing the Select Campus tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-card-view-all-campuses-new-loc-dir.png)

    The **Select building** tab is enabled when you select a campus.

15. Tap to select a building.

    ![All buildings screen with the Select Building tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mobile-card-view-all-buildings-page-loc-dir.png)
...
17. Tap to select a space from the All Spaces page.
    ...
    -   Option to mark a space as favorite \(![Favorite icon to mark a space as favorite.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../wsd-reservation-management/image/favorite-icon.png)\)
    -   Space name
    -   Occupancy status
    -   Reservation status
    -   Space image
    ...
    -   Neighborhood
    ![Card view location directory.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../images/wsd-mob-card-view-loc-directory.png)
...
22. Select a space and select the More actions icon \(![More actions icon to select on a space.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../../workplace-service-delivery/images/wsd-more-options-icon-loc-directory.png)\).
...
**Previous topic:**[Scan the QR code to reserve a space](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/scan-qr-code.md)

**Next topic:**[Workplace Service Delivery for Mobile references](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery-for-mobile/../concept/wsd-mobile-references.md)
