...
-   **[Configure Lifecycle Events employee requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-employee-request.md)**  
...
-   **[Verify Lifecycle Events Employee requests configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/test-verify-employee-request.md)**  
Use the Preview and Test capabilities to verify that the employee request activity has been configured correctly.
-   **[Create a Lifecycle Events Employee Request from the Employee Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/create-employee-request.md)**  
