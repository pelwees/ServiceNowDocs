...
|------------|-----------|
|[Configure mobile content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../../employee-center/task/ecpro-content-delivery-mobile.md)|Mobile content is delivered as a mobile banner in the Now Mobile and Mobile Onboarding apps.|
|[Content Publishing](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../../employee-center/concept/ec-publish-content.md)|Portal content is delivered as content \(such as a banner, calendar, or video\) in a portal such as the Employee Service Center.|
|[Notification content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../../employee-center/concept/ec-notification-content.md)|Notification content is delivered as a notification.|
|[Creating to-do content that appears in a banner or styled content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../../employee-center/concept/ecpro-content-to-dos.md)|To-do content is delivered as a to-do in both portal and mobile.|
...
6.  Add additional fields with corresponding values, as needed.
    ...
    -   To-do content
    For a list of the available fields for each content type, see [Schedule content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../../employee-center/concept/ec-content-publishing-schedule.md).
...
**Parent Topic:**[Configure the supporting components for a lifecycle event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../concept/configure-supporting-components-for-lifecycle-event.md)
