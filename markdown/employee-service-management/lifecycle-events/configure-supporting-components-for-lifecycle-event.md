...
[Configure an HR task template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-hr-task-template.md) To learn more about HR templates, see [HR templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/hr-template-configuration.md).
...
[Configure an HR service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-hr-service.md) To learn more about HR services, see [HR services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/hr-service-administration.md).
...
[Create a subflow](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/create-subflow.md) **Important:** The only subflow available for use by default is the **Switch primary job** subflow. This subflow is used to [support multiple jobs in a lifecycle event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/adopt-jobs-table.md).
...
[Configure a schedule content template for a lifecycle event activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-schedule-content-template-for-lifecycle-event.md) To learn more about Content Experiences and Content Publishing, see [Content Publishing](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../../employee-center/concept/ec-publish-content.md).
...
-   **[Configure an owning group for a lifecycle event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-lifecycle-event-owning-group.md)**  
...
-   **[Configure an activity configuration for a lifecycle event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-lifecycle-event-fulfiller-activity-configuration.md)**  
...
-   **[Configure a schedule content template for a lifecycle event activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-schedule-content-template-for-lifecycle-event.md)**  
...
**Previous topic:**[Document the lifecycle event process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/define-lifecycle-event-process.md)

**Next topic:**[Configure an owning group for a lifecycle event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../task/configure-lifecycle-event-owning-group.md)
