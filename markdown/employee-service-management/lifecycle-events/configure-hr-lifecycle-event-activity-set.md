...
-   Select **Show case to subject person** for the HR service that the lifecycle event is associated with. See [Configure an HR service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/configure-hr-service.md) for more information.
...
-   hrTriggerUtil: Allows checking of other activity sets or dates from other types of triggers.
 The Activity Set Launcher workflow runs every four hours to verify these conditions. See [Lifecycle Events workflows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/lifecycle-events/../concept/LEWorkflow.md).
