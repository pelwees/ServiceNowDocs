...
-   **[Configure mappings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-transfer-map-config.md)**  
...
-   **[Create a service set](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-create-service-set.md)**  
...
-   **[Create your service-specific assignment groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-create-grp-service.md)**  
...
-   **[Assign assignment group to service sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-assign-groups-service-set.md)**  
...
-   **[Create your service for Universal Request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-register-service.md)**  
...
-   **[Assign assignment group to your service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/assign-group-to-service.md)**  
...
-   **[Create service specific UI actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-create-service-UIactions.md)**  
...
-   **[Register application administration enabled scoped application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-service-scoped-administration.md)**  
...
-   **[Remove UR administrator role from system administrator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/remove-admin-role-ur.md)**  
...
-   **[Create a business rule for your service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-create-busrule-service.md)**  
Create a business rule on the service table to attach the newly created department ticket with a universal request.
-   **[Create a business rule to automatically create universal request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-create-brule-omnichannel.md)**  
...
-   **[Create extension points for departments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/create-extn-points-ur-service.md)**  
...
-   **[Create an extension point for post-processing of transfers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/create-extension-points-ur-transfers.md)**  
...
-   **[Unified ticket experience setting](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/unified-ticket-experience.md)**  
...
-   **[Universal Request state mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/universal-request-for-hr-service-delivery/../task/ur-state-mapping.md)**  
