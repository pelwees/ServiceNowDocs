...
3.  On the Request a permit to work form, fill in the fields.
    ...
    For a description of the field values, see [Permit-to-work request form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../reference/hs-permit-to-work-form.md).
