...
-   **[Set up a safety inspection schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-schedule-recurring-safety-inspection.md)**  
...
-   **[Create and manage a safety inspection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-create-manage-safety-inspection.md)**  
...
-   **[Set up a safety audit schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-setup-safety-audit-schedule.md)**  
Create an audit schedule and define the top-level audit details and the recurrence, for example, monthly or bi-monthly.
-   **[Create and manage a safety audit](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-create-manage-safety-audit-workspace.md)**  
...
-   **[Complete a safety inspection or audit survey through Employee Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-complete-safety-insp-survey.md)**  
Complete a safety inspection or audit survey assigned to you through the Employee Center.
-   **[Add a finding and root cause analysis for a safety inspection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-add-finding-rca-safety-inspection.md)**  
Record a finding based on the survey results for a safety inspection and perform a root cause analysis \(RCA\) for it.
-   **[Add an action for a safety inspection or audit](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-add-action-safety-inspection.md)**  
...
-   **[Add an action from survey response in safety inspection through Employee center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/add-action-from-survey-response-in-safety-inspection.md)**  
...
-   **[Assign safety inspection to agents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../task/hs-assign-safety-inspection-to-agents.md)**  
