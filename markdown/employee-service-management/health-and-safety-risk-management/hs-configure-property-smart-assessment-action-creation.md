...
-   The **More actions** icon \(![More icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/health-and-safety-risk-management/../../human-resources/image/agent-workspace-more-ui-actions-icon.jpg)\) appears for configured questions in a smart assessment questionnaire and when selected, shows the **Actions list** button.
