...
4.  Select a date and time for the reservation.
    ...
    **Note:** If the **Max days in future** value is not enabled, users can select a date as per the **Max number of occurrences** on the Reservable module. For more information, see [Configure a reservable module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery/../../wsd-reservation-management/task/config-reservable-module.md).

    -   If an employee clicks open the calendar icon ![date picker icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery/../../workplace-visitor-mgmt/image/date-time-icon.png) and tries to select a date greater than the **Max days in future** value, the dates are disabled in the calendar date picker.
...
5.  In the Reserve a space sidebar, fill in the following fields:
    ...
    3.  Select the required **Capacity**capacity of the space.
        ...
        ![Workplace reservations in the Microsoft Outlook Add-in](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery/../images/reservation-outlook-building.png "Workspace Reservations for Microsoft Outlook Add-in")
...
18. Click **Save reservation**.
    ...
    ![Save reservation in the Microsoft Outlook Add-in](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-service-delivery/../images/reservation-outlook.png "Reservation window in Microsoft Outlook")
