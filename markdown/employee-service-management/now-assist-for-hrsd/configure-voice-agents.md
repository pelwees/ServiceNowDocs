...
2.  Activate the HR AI voice agents.
    ...
    For more information on the HR-specific agents, see [HR AI voice agents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../concept/now-assist-hrsd-voice-ai-agents.md).
...
Assign roles to admins and users to grant them access to Voice features. See [Components installed with voice](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../reference/components-installed-voice-agents.md).
...
[HR AI voice agents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../concept/now-assist-hrsd-voice-ai-agents.md)
