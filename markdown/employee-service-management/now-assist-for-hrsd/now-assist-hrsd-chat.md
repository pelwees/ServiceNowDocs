...
7.  Review the text in the **Short description** or **Chat Summary** fields and make the necessary changes.![Review the text in theShort description orChat Summary fields and make the necessary changes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../image/chat-summary.png)
