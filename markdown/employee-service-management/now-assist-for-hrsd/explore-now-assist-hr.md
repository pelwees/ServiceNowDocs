...
-   **Resolution notes generation**
    ...
    For information on activating the resolution notes skill, see [Configure Now Assist for HR Service Delivery \(HRSD\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../task/configure-now-assist-hr.md). For information on how to use the skill on Agent Workspace for HR Case Management, see [Generate resolution notes using Now Assist for HRSD](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../task/now-assist-hrsd-res-note.md).

    The following example shows the AI-generated resolution notes.

    ![Add resolution notes dialog box with generated resolution notes that read "Provided link to Career Level Guide for Solution Consulting."](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../image/gen-resolution-note2.png "AI-generated resolution notes")
...
![Options for detected sensitive topics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../image/sensitivity-detection.png)

For more information on the out-of-the-box filters and how they are mapped to chat queues and HR case services, see [Sensitivity detection filters mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../reference/reference-sd-info-values.md).

For information on setting up sensitivity detection, see [Configure sensitivity detection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../task/config-na-sd-filters.md).
...
For more information on using sentiment analysis in HR Service Delivery, see [Analyze sentiments in Now Assist for HR Service Delivery \(HRSD\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../task/analyze-sentiments-now-assist.md).
...
For more information about the Now Assist panel, see [Use the Now Assist panel in HR Agent Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../task/now-assist-panel-hr.md). ![Now Assist panel menu in Workspace.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../image/now-assist-icon.png)
...
![Galileo Inside responses contain in-text citations and source URLs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-hrsd/../image/galileo-now-assist.png)
