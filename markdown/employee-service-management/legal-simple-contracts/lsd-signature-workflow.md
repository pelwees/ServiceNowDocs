...
-   The document status updates to Sent for Signature and electronic signature flow is triggered as in [legal integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-simple-contracts/../task/integrate-legal-contracts-esign.md).
...
</table>-   **[Sign or decline a legal contract electronically in Legal Simple Contracts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-simple-contracts/../task/sign-a-legal-contract-document.md)**  
As a signatory, you can review and sign or decline to sign a contract document.
-   **[Wet Signature workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-simple-contracts/lsd-wet-signature-workflows.md)**  
...
**Parent Topic:**[Non-disclosure agreement requests in Legal Simple Contracts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-simple-contracts/legal-request-nda.md)
