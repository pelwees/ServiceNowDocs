...
3.  Import the spreadsheet into the application.
    ...
    For more information on importing, see [Configuring spreadsheets to import workplace data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-core/../concept/importing-workspace-data-wsd.md#).
...
Type of the office space. To configure a new space type, see [Add a space type configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-core/add-space-type-configuration-wsd.md).
...
-   If you are using a spreadsheet to enter and import bulk data for workspaces, see [Configuring spreadsheets to import workplace data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-core/../concept/importing-workspace-data-wsd.md#).
-   If you have added all of your workplace data, you can define employee shifts. For more information, see [Define shifts for your workplace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-core/create-shifts-wsd.md).
