...
3.  Open the related reservation record, which is the parent reservation:
    ...
    1.  Select the information \(![Info icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-core/../../wsd-reservation-management/image/info-icon.png)\) icon next to the **Reservation** field.
