...
Make sure you have already created a flexible service. See [Create a flexible service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-reservation-management/add-flexible-service.md).
...
5.  On the Edit Members form, select the service.
    ...
    2.  To move the service to the **Flexible Services List** column on the right, use the add-remove icon.
        ...
        ![Add-remove icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-reservation-management/../image/add-remove-icon.png)
...
**Parent Topic:**[Create a flexible service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-reservation-management/add-flexible-service.md)
