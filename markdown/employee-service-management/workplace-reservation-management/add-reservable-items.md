...
For more information about adding the workspaces, see [Create records for your workplace data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-reservation-management/../../workplace-service-delivery/task/create-records-of-workplace-data-wsd.md).
...
3.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Space form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-reservation-management/../reference/space-new-record-form.md).
