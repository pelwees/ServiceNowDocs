...
5.  On the Diagnostic Request form, run the diagnostic request on the affected employee to identify other potentially exposed employees, and add them to the case.
    ...
    For more information on running a diagnostic request, see [Run a diagnostic request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contact-tracing/../../business-continuity/task/use-emergency-exposure-mgnt.md).
...
[Send notification to potentially exposed contacts in a case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contact-tracing/send-notification-to-exposed-contact.md).

If the automatic case task creation is disabled, [create a case task for each exposed contact](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contact-tracing/create-task-exposed-contact.md).
