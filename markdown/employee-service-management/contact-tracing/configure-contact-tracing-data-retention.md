...
-   The **Data Retention Job For Contact Tracing** scheduled job checks for records that have an updated date that is past the defined retention period, and deletes them.
    ...
    -   **Closed and canceled cases and associated records**
        ...
        The Diagnostic Request and Diagnostics Events tables are installed with the [Emergency Exposure Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contact-tracing/../../business-continuity/concept/emergency-exposure-management.md) application.
