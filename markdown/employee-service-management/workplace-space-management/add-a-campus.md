...
Region where the campus is situated. Click![search icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/../../workplace-case-mgmt/image/search-icon.png) to search for a region.
...
Campus site name. Click the search icon \(![search icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/../../workplace-case-mgmt/image/search-icon.png)\) to search for a site.
...
For more information, see [Synchronize Indoor Mapping with Workplace Service Delivery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/../../wsd-indoor-mapping/task/synchronize-ind-mapping-wsd.md).
...
7.  To add an Indoor map campus, select the Additional Actions icon \(![Additional Actions to switch to the Workplace view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/../images/additionalactions-icon.png)\) to select **View** &gt; **Workplace Indoor Mapping Campus**.
