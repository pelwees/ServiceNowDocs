...
9.  To add an image to a space, select the Additional Actions icon \(![Additional Actions to switch to the Workplace view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/../images/additionalactions-icon.png)\) to select **View** &gt; **Workplace**.
...
-   **[Configure a space type as usable with Workplace Space Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/assign-a-space-as-usable.md)**  
