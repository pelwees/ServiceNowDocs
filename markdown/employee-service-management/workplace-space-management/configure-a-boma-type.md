...
The BOMA type is configured. To map the BOMA type with a Space type, refer to [Map a space type with BOMA type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/map-a-space-type-with-boma-type.md).
