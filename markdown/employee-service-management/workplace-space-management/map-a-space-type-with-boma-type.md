...
-   Space type is configured. To configure a space type, refer to [Add a space type configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/../../workplace-service-delivery/task/add-space-type-configuration-wsd.md).
-   BOMA type is configured. To configure a BOMA type, refer to [Configure a BOMA type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/configure-a-boma-type.md).
