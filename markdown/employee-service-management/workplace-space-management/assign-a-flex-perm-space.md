...
-   The space is added in the application. Otherwise, refer to [Add a space using Workplace Space Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-space-management/add-a-space.md).
