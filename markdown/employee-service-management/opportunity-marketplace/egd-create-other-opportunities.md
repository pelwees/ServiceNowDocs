...
2.  Select **Create an opportunity**.
    ...
    **Note:**
    ...
    -   Gig: For details on gigs, see [Gig opportunities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/opportunity-marketplace/../concept/egd-oppt-mrktplc-gig.md).
    -   Project: For details about what a project is, see [Project opportunity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/opportunity-marketplace/../concept/egd-oppt-mrktplc-project.md)
    -   Volunteer: For details about what a volunteer opportunity is, see [Volunteer opportunities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/opportunity-marketplace/../concept/egd-oppt-mrktplc-volunteer.md)
    **Tip:** If you need a different opportunity type, you can create custom opportunity types. For more details, read [Creating custom opportunity types in Opportunity Marketplace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/opportunity-marketplace/../concept/egd-oppt-mrktplc-custom-oppt-type.md).
...
4.  Fill in the form with the details for the opportunity that you selected.
    ...
    To read details about the opportunity forms and fields, see [Form fields for creating opportunities in Opportunity Marketplace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/opportunity-marketplace/../reference/egd-oppt-mrktplc-oppty-form-fields.md).
...
7.  Fill in the form with the role details.
    ...
    To read more details about the role form and fields, see [Form fields for creating opportunities in Opportunity Marketplace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/opportunity-marketplace/../reference/egd-oppt-mrktplc-oppty-form-fields.md).
