...
Users can select the ![Plus icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-mobile-employee-experience/../image/more-items.png) icon on the applet launcher page to open the quick action.
