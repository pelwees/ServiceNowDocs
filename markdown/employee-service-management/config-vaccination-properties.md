...
-   Vaccine code, such as a CVX code, to verify the vaccine's manufacturer
 This property is inactive by default. For more information on enabling automated vaccine response reviews, see [Automating vaccine response reviews](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../concept/vaccination-status-vaccine-validation.md).
...
If your organization is using the Azure Form Recognizer service to automatically validate CDC Vaccination Cards, this property sets the default confidence threshold that a submitted vaccination card must meet for the vaccine response to be approved. The default value is 0.90, indicating a 90% confidence threshold.
 ...
 For more information, see [Automating vaccine response reviews with the Azure Form Recognizer service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../concept/automate-vaccine-validation-with-azure-form-recognizer.md).
