...
-   The data access permissions must be set for the Now Assist skills, contract metadata extraction, and contract obligation extraction.
    ...
    For more information, see [Configure data permissions for Now Assist skills](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cmpro-conf-roles-skills.md).
...
1.  As a Contract Admin with the AI role, activate the contract metadata extraction skill in the Now Assist Admin console.
    ...
    For more information, see [Configure Now Assist in Contract Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/confg-na-in-cmpro.md).
...
For more information, see [Review AI-extracted metadata and contract reminder date](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cmpro-na-review-ai-metadata.md).
...
For more information, see [Review AI-extracted obligations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cmpro-na-review-obligations.md).
