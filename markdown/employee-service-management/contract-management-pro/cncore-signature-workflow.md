...
-   The contract document is added to the repository after it is uploaded.
 ...
 For more information, see [Upload a manually signed contract document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-upload-doc-wsignature.md).
...
For more information, see [Modify signatories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-pause-signature.md) and [Resend signature request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-resend-sign-req.md).
...
-   **[Upload a manually signed contract document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-upload-doc-wsignature.md)**  
...
-   **[Modify signatories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-pause-signature.md)**  
Modify signatories while a signature workflow is in progress.
-   **[Resend signature request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-resend-sign-req.md)**  
Resend signature request functionality enables contract fulfillers to manually trigger signature request when needed.
-   **[Cancel the signature process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cncore-cancel-a-manual-signature.md)**  
