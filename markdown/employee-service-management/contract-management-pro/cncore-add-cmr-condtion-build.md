...
3.  Add the contract request as a reference field to the table.
    ...
    2.  In the **Type** field, select the Lookup using list icon \(![Lookup using list icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../../workplace-lease-administration/images/look-up-icon.png)\) and search for `Reference` and select it.
    ...
    8.  Select **Submit**.
        ...
        ![Enable contract request fields to be available in condition builder](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-bu-add-contractreq-fields.png "Enable contract requests to be available in condition builder")
...
![Condition builder with contract request fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-enable-cr-fields-cond-builder.png "Condition builder with contract request fields")
