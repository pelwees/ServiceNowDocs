...
4.  In the **Type of paper** drop-down list, select **Own paper**.
    ...
    ![Initiate contract window to populate the contract request details.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-initiate-own-paper.png "Initiate own-paper contract")
