...
2.  Select the table configured as a contract repository.
    ...
    For more information, see [Create a contract configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cncore-contract-config.md).
...
5.  Add the Contract documents tab in contract repository records by moving **Contract documents** from the Available list to the Selected list.
    ...
    ![Moving contract documents from Available list to Selected list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-enable-contract-doc.png "Add contract documents related list")
...
![The contract document related list is available in your record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-bu-add-doc-rl-result.png "Contract document related list")
