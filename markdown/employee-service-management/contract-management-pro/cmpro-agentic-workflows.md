...
If you have customized the manage contract repository agentic workflow, [update the script include to run it autonomously.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/cmpro-script-includ-agenticAI.md)
