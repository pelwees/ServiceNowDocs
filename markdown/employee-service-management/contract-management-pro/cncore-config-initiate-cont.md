...
1.  Add initiate contract request functionality to your workspace.
    ...
    3.  Set the action to the type UXF client action and map the action to the initiate contract request functionality and by entering the following field values.
        ...
        ![Add initiate contract declarative action to your workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-bu-form-actn-initiate-cntr.png)

    4.  On the form, fill in the other fields.

        For details, see [Action assignment form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../reference/cmpro-actn-assignment-form.md)
...
2.  Create an event mapping for the initiate contract declarative action.
    ...
    9.  On the form, fill in the other fields.
        ...
        ![Create event mapping for initiate contract action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-uptake-ux-add-event.png)

        For a description of the field values, see [UFX Add on Event mapping form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../reference/cmpro-ufx-event-map-form.md).
...
![Initiate action button added to your workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-bu-initiate-contract-button.png "Initiate contract action configured")
