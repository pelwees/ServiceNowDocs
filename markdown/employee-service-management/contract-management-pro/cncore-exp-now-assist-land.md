...
-   **Contract obligation extraction**
    ...
    **Note:** Obligation extraction is available only with the manage contract repository agentic workflow.
    ...
    For more information on activating the skill, see [Configure Now Assist in Contract Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/confg-na-in-cmpro.md).
...
-   [Configure Now Assist in Contract Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../task/confg-na-in-cmpro.md)
-   [Using Now Assist in Contract Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cncore-use-now-assist-land.md)
