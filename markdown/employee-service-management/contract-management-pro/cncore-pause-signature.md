...
2.  For the signatory you want to reorder, select and hold the Reorder icon \(![Reorder icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-reorder-icon.png)\).
...
Resume the signature process after you have modified the signatories. For more information, see [Resume signature process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cncore-resume-signature.md).

-   **[Resume signature process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cncore-resume-signature.md)**  
