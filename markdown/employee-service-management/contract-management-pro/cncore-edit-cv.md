...
4.  On the form Clause Variation form, edit the fields that you want to modify.
    ...
    For a description of the field values, see [Clause Variation form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../reference/cncore-cv-form.md).
