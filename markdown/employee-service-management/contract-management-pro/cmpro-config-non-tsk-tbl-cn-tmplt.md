...
5.  On the Script Include form, fill in the fields.
    ...
    ![Scripted extension point for non-task table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-non-task-table.png "Scripted extension point")
...
For more information, see [Create a contract template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cncore-create-contract-template.md).
