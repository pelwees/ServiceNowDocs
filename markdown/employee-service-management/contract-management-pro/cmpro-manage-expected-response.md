...
5.  Select the actions icon ![Actions icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-na-three-dot-icon.png) on the expected response mapping that you want to update, delete, or deactivate.

    ![Actions available for fields mapped to expected responses for contract analysis use cases.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-na-edit-response-map.png "Expected responses for contract analysis fields")

    -   **Edit**

        Update the expected response for the fields of a use case.

        For more information on clause mapping, see [Map a field to an expected response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cmpro-na-exp-res-mapping.md).
...
[Manage clause mappings for contract analysis](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cmpro-manage-clause-mappings.md)
