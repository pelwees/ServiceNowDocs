...
3.  Select **Send for signature**.
    ...
    ![Send for signature button in a contract request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/../image/cmpro-send-sign.png "Send for signature")
    ...
    -   If a message appears stating that the signatories aren't synchronized:
        1.  Update and sync the signatures.
            ...
            -   For earlier versions of Contract Management Pro, see [Resolve an error during send for signature](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cncore-sync-signatories-user.md).
    ...
    -   If a message appears stating that the parent contract request is not signed, ensure the parent contract is either signed or unlinked before selecting **Send for Signature**.
        ...
        For more information, see [Remove a linked contract](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/contract-management-pro/cmpro-remove-linked-cntr.md).
