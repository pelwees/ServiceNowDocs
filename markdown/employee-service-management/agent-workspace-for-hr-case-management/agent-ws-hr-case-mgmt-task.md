...
</table>    **Note:** For information on all the fields, see [Adding an HR task to an HR case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/t_ViewAnHRTask.md).

5.  Select **Save**.

    You can also add a task by selecting **Add Task** from the ![More icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../reference/images/more-icon.png) from **Details**.
