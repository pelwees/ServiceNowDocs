...
-   Set up these components:
    ...
    -   Forms in workspace. See [Customize fields in a form in Agent Workspace for HR Case Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../task/form-builder-aws.md).
