...
-   **HR groups**
    ...
    For more information about HR groups, see [Manage HR Groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../task/t_ManageHRGroups.md).
...
-   **Virtual agent**
    ...
    For more information on virtual agent, see [Virtual Agent for HR Service Delivery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/hr-virtual-agent-conversations.md#).
