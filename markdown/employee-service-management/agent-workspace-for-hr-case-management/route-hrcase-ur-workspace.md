...
**Note:** The state changes mentioned can be configured. See [Transfer configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../../universal-request/task/configure-route-state.md) for more information.
