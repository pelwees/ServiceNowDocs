...
-   **HR cards**
    ...
    -   For more information, see [Configure HR Service Delivery playbook card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../task/playbook-hr-card-configuration.md).
