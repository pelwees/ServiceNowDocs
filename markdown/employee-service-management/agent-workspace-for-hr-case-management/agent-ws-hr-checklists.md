...
-   **Creating a checklist directly into an HR case**
    ...
    -   Scroll down and select the down arrow and select **Create New**.![Checklist](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../reference/images/checklist-create-new.png)
    -   Enter instructions.
