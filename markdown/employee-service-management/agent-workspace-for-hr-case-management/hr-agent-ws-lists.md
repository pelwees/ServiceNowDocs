...
HR cases fulfilled by lifecycle events. For more information, see [Lifecycle event cases in Agent Workspace for HR Case Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/hr-agent-ws-lifecycle.md).
...
Reminders created by the HR agents. For more information, see [Create a reminder in Agent Workspace for HR Case Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../task/hr-agent-ws-reminder.md).
