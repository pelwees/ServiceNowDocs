...
At any point in time, the HR agent can [route the HR case back](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/agent-workspace-for-hr-case-management/../task/route-hrcase-ur-workspace.md) to the universal request queue with or without resolution.
