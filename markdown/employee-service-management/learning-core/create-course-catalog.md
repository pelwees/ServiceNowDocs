...
3.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Course catalog form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/learning-core/../reference/course-catalog-table.md).

4.  Click **Submit**.


-   **[Create courses to add to a course catalog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/learning-core/add-course-to-catalog.md)**  
After creating a course catalog, create new course items to add to the course catalog and categorize them accordingly.
-   **[Define user access to course catalog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/learning-core/define-user-access-to-cc.md)**  
