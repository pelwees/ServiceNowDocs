...
1.  Navigate to **All** &gt; **Content Experiences** &gt; **Configurations** &gt; **Campaign Content**.
    ...
    -   Select **Create new** from the content library column after selecting the ![Choice list icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/choice-list-icon.png). For more information, see [Add content to a campaign using Content Experience Builder](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/ecpro-campaigns-manage-content-builder.md).
...
**Note:** For more information, see [Creating employee communications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../concept/ec-publish-content.md).
...
**Note:** Other users that have access to the content can view the restricted content assigned to a topic, but cannot edit or delete the topic.
 ...
 For more information, see [Content Ownership](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../concept/ecpro-content-restriction.md) and [Create and associate topics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/create-topics-for-taxonomy.md).
...
</table>    ![Campaign content - New](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/campaign-content-new.png)

2.  Click **New**.

    ![Campaign Content - New](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/campaign-content-2.png)

3.  Select the **Lookup using list** ![Lookup using list icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../../human-resources/image/magnify-glass-outline-icon.png) icon next to Content.

    ![Campaign Content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/campaign-content-type.png)

4.  Select existing content or **New**.

    ![Campaign Content Type select](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/campaign-content-type-select.png)
...
Content that appears on your Employee Center or Service Portal.**Note:** For information on creating portal content, see [Portal content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../concept/ec-streamline-content.md).
