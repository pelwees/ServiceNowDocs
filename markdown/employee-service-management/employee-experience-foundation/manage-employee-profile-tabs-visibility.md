...
6.  On the Tab widget mapping form, fill in the fields.
    ...
    For a description of the field values, see [Tab widget mapping form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../reference/tab-widget-mapping-form.md). The Tab widget mapping **sys\_id** is available in the **tabWidgetMappingId** variable of the widget options object.
