...
For more information, see [Configure the Recommended for you](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../task/config-rfy.md)

## How Recommended for you works

Administrators, developers, and advanced users can configure the widget options​. **Recommended for you** highlights the most viewed knowledge article and most requested catalog items across all employees for a time period defined in the [Modify the Recommended for you widget display](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../task/config-recommended-for-you.md) by the portal administrator.
