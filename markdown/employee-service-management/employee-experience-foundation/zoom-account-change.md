...
6.  Enter `CHANGE` in the **Type CHANGE to continue** field, and then select **Override connection**.
    ...
    ![Override Zoom connection on ServiceNow instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/zoom-change-zoom-account.png)
