...
3.  Select the **Portal preview** tab.
    ...
    **Note:** You can also show a portal preview by selecting the show preview icon \(![Show Preview icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/campaign-prev-icon.png)\) from the top of a stage.
...
5.  Exit **Preview filters** to view the portal.
    ...
    **Note:** Select the **View content details** \(![View content details icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../../human-resources/image/view-content-details-icon.png)\) icon to see additional details about the content.
