...
3.  Double-click within the list to open the text formatting bar, where you can format the text, change the bullet list to a numbered list, or increase indentation.
    ...
    ![Text formatting bar enables users to bold, italicize, underline, or strike through text, change the bullet list to a numbered list, or modify the indentation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/ec-rich-content-list.png)
