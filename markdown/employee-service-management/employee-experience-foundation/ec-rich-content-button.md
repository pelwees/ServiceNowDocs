...
1.  Navigate to the canvas by selecting the **Open editor** button from the **Design** tab of the **New content** form.
    ...
    ![Open the Rich Content Editor from the Design tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/ecpro-open-editor.jpg)

2.  From the **Rich Content Editor** canvas, you can use a drag-and-drop method to add a button.

3.  Navigate to **Settings** tab.

    ![Settings tab on the side of the canvas has styling configurations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/ecpro-settings-tab.jpg)

4.  See full configration settings options.

    ![Configuration options under the settings tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/ecpro-settings-tab-details.png)
