...
![Get support on the homepage as a widget and modal window for reference purpose](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/get-support-ec.png "Get support")
...
4.  Select **Content** from the available options.
    ...
    -   For **Quick Link**, select the **Table name** \(sn\_ex\_sp\_quick\_link\) and **Document**. For more information on quick links, see [Quick links](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../concept/emp-center-quick-link-config.md).
...
![Alignment for get support](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/get-support-alignment-ec.png "Alignment for Get support")
