...
2.  Point to ![Microsoft Teams](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/teams-decorator.png) next to the **Caller** field.
...
-   Web Client – Opens the chat interaction in Microsoft Teams web client.
 The system remembers the selected option and will open the chats in the preferred chat client for all the further chat interactions.
    ...
    ![Continue chat modal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-experience-foundation/../images/continue-chat.png)
