...
3.  On the form, edit the fields that you want change.
    ...
    For more information about each field on the form, see [Configure a Record producer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../../workplace-case-mgmt/task/wsd-create-record-producer.md).
