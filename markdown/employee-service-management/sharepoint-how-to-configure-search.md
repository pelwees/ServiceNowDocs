...
2.  Click **New**.
    ...
    ![Options of site permission display for REST connection setup.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../image/site-permission-spoc.png "Connector details")
...
Subsites are automatically indexed. See [SharePoint Online Search Connector search results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../reference/using-search.md).
...
6.  Proceed to see the **Indexed Sites** related list.
    ...
    To know more about how to exclude sites, see [Exclude sites from indexing](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../task/how-to-exclude-sites-indexing.md).
