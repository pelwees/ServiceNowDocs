...
![Users can self-report and select their health status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../image/employee-self-report-employee-view.png "User view")
...
![Managers can see status for all direct reports, and see what tasks they need to reassign](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../image/employee-self-report-dashboard-manager-view-fullscreen.png "Manager view")
...
![Response team overview dashboard with customization options for at-a-glance status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../image/esr-overview-dashboard.png "Response team view")
...
![HR task list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../image/esr-hr-tasks-list-import-tasks.png "HR tasks")
...
-   **[Set up Emergency Self Report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../task/set-up-emergency-self-report.md#)**  
...
-   **[Report and track health statuses during an emergency](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../task/use-emergency-self-report.md)**  
...
-   **[View self-reported user HR tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../task/view-hr-tasks-response-team.md)**  
...
-   **[Import Crisis Task data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../task/import-crisis-task-data.md)**  
As a crisis task administrator, upload a spreadsheet of self-reported health statuses to create crisis tasks in bulk.
-   **[Domain separation for Emergency Self Report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/../reference/emergency-self-report-domain-separation.md)**  
The following table lists the domain separation use cases for service providers \(SPs\) using this application.

**Parent Topic:**[Emergency Response Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-self-report/emergency-response-management.md)
