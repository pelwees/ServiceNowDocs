...
-   The contract document is added to the repository after it is uploaded.
 ...
 For more information, see [Upload a manually signed contract document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-upload-doc-wet-sign.md).
...
For more information, see [Modify signatories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-pause-signature.md) and [Resend signature request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-resend-sign-req.md).
...
-   **[Upload a manually signed contract document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-upload-doc-wet-sign.md)**  
...
-   **[Modify signatories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-pause-signature.md)**  
Modify signatories while a signature workflow is in progress.
-   **[Resend signature request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-resend-sign-req.md)**  
Resend signature request functionality enables contract fulfillers to manually trigger signature request when needed.
-   **[Cancel a wet signature process for non-disclosure agreement legal requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-cancel-a-wet-signature.md)**  
...
**Parent Topic:**[Work on NDA legal requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/snlc-work-on-contract-request.md)
