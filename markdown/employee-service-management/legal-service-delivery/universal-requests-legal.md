...
For more information about submitting and tracking a universal request, see [Using Universal Request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../../universal-request/concept/using-ur.md).

For more information on submitting and managing ethics complaints, see [Better together solution: Legal Investigations and HR Service Delivery Employee Relations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../../legal-investigations/concept/lsd-investigations-hr-emp-relations.md).
...
Also, you've to configure various settings in Universal Request. For more information, see [Configure Universal Request for legal services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/configure-universal-request-legal.md).

-   **[Configure Universal Request for legal services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/configure-universal-request-legal.md)**  
...
-   **[Create a legal request from a universal request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/create-legal-request-universal-request.md)**  
Create a legal request from a universal request to get the Legal department's assistance in resolving the request.
-   **[Transfer a legal ticket to another department](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-service-delivery/../task/transfer-legal-request-universal-request.md)**  
