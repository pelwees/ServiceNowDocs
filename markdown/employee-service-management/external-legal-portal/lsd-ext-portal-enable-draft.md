...
2.  In the **Name** column, search for the `glide.sc.enable.save_as_draft.portal.elp` property.
    ...
    For more information on the system property, see [Property installed with External Legal Service Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/external-legal-portal/../reference/lsd-ext-portal-properties.md).
