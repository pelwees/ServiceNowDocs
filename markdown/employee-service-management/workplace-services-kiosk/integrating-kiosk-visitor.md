...
3.  Create a kiosk module and module configuration. For more information, see [Create a kiosk module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-services-kiosk/../task/create-kiosk-module.md).

    The kiosk module is linked to the check-in or check-out table to decide the flow and pages for the kiosk.

4.  Create a homepage configuration. For more information, see [Create a kiosk homepage](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-services-kiosk/../task/create-kiosk-homepage.md).
...
6.  Assign the kiosk configuration to a kiosk device. For more information, see [Setting up a kiosk device](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-services-kiosk/setting-up-kiosk-device.md#).
