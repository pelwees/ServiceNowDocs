...
2.  New direction modes require icons.
    ...
    For more information, see [Create Indoor Mapping icons and place types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/place-icons-place-type.md)
...
10. To draw directions from one point to another, select **Draw** and begin drawing routes along all the hallways for each floor.
    ...
    **Note:** Lines must be straight as they are used by the wayfinding application to display routes within a building.
    ...
    ![Draw directions for wayfinding](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/../images/manage-directions.png)
...
18. Once the direction graph is complete, make sure you clearly identify the connectors to link your floors together.
    ...
    For more information, see [Create a connector type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/create-connectors.md).

19. Select the **Display settings** icon ![Manage directions toggle option](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/../images/manage-directions-new-toggle-icon.png)adjacent to the **Save** button.
...
31. Click the other options icon \(![Other options icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/../../wsd-for-mobile/images/more-options-icon.png)\).
...
-   **[Create a connector type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/create-connectors.md)**  
...
-   **[Copy direction graphs to multiple floors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/copy-directions-multiple-floors.md)**  
...
**Previous topic:**[Create Indoor Mapping icons and place types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/place-icons-place-type.md)

**Next topic:**[Create a connector type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/indoor-mapping/create-connectors.md)
