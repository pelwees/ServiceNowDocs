...
1.  [Set up Connector Configuration for Environmental sensor data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/wsd-connectorconfiguration-environment.md)  
...
2.  [Provider Connector Configuration for Environmental sensors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/wsd-env-provider-connectorconfig.md)  
Configure the provider connector configuration for setting up environmental sensors in workplace locations.
3.  [Set up the Units of measure data table for environmental sensors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/wsd-enviromental-unit-measure.md)  
...
4.  [Configure environmental sensor data for a workplace location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/config-connectors-env-sensor.md)  
...
5.  [Archive and purge Environmental data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/archive-purge-environmental-data.md)  
...
**Previous topic:**[Archive and Purge space occupancy data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/archive-purge-occupancy-data.md)

**Next topic:**[Set up Connector Configuration for Environmental sensor data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../task/wsd-connectorconfiguration-environment.md)
