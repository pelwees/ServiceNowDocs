...
Option to search for and select the lookup list icon \(![Lookup list icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../../workplace-lease-administration/images/look-up-icon.png)\) to select **Badging**. For more information, see [Configure connectors for badging data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/workplace-connector-configuration.md).
...
Option to select the callback URL icon \(![Callback URL icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../images/wsd-callback-url-icon.png)\) to lock or edit the callback URL.
...
7.  On the Workplace Connector Webhook event page, provide the following values:
    ...
    -   ni.nolog.id: Copy the System ID of the webhook created in step 2 and paste it. Select the additional actions menu icon \(![Additional actions menu icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../../human-resources/image/additional-actions-icon.png)\) from the pane.
...
**Parent Topic:**[Provider connector configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../concept/provider-configuration-ovw.md)

**Previous topic:**[Configure badging table data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/provider-configuration-wsd-connectors.md)

**Next topic:**[Employee attendance data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/employee-attendance.md)
