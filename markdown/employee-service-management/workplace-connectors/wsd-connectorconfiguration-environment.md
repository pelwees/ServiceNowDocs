...
Make sure that vendor or provider is selected for fetching environmental sensor data. For more information, see [Configure sensor data providers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/providers-occupancy.md).
...
Search for extension point definition for the environmental data. Search using the lookup list icon \(![Look up list icon to search for required extension point definition.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../images/wsd-lookup-list-icon.png)\) to locate the extension point definition **EnvironmentDataHandler**.
...
**Previous topic:**[Setup Workplace Connectors for environmental data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/../concept/setup-environmental-data-connectors.md)

**Next topic:**[Provider Connector Configuration for Environmental sensors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-connectors/wsd-env-provider-connectorconfig.md)
