...
3.  Create a schedule plan.
    ...
    2.  In the contextual side panel, click the show schedules icon ![Show Schedules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workforce-optimization-for-hr/../image/show-schedule-new.png) to display the schedules.
    3.  In the Schedules panel, click ![Create New Schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workforce-optimization-for-hr/../../workforce-optimization-for-customer-service-configurable/image/create-schedule-new.png) icon.
