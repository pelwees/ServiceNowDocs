...
-   **[Maintain type mappings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../task/wsm-mappedin-type-mappings.md)**  
...
-   **[Import a new building - Mappedin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../task/wsm-mappedin-import-building.md)**  
Use **Import a new building** to import the Mappedin map and define the building details.
-   **[Import an existing building - Mappedin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../task/wsm-mappedin-import-existing-bldg.md)**  
Follow these steps to import an existing building for a Mappedin map.

**Parent Topic:**[Configure Mappedin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/mappedin-integration-topics.md)
