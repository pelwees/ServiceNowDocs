...
-   Date and time information when the employee is requesting to book a space for reservation.
    ...
    If no time is provided, it reserves a space for All day. For more information, see [Configure a reservable module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-wsd/../../wsd-reservation-management/task/config-reservable-module.md).
...
-   **[Reserve a space using the reservation agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-wsd/../task/create-rsv-agent.md)**  
The Create a reservation agent enables employees to reserve a space with a single prompt query or utterance.

**Parent Topic:**[Using Now Assist in Virtual Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/now-assist-for-wsd/create-rsv-agent-ovw.md)
