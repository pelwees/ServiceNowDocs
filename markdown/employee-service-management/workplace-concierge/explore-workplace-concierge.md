...
-   Apply the filter on collaborators using the **sn\_wsd\_concierge.collaborators\_filter** system property. Based on the filter, the collaborators are displayed to employees while adding a collaborator. For more information about setting the property, see [Properties installed with Workplace Concierge](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-concierge/../reference/properties-installed-with-workplace-concierge.md).
-   Create insights for employees, which are personalized and displayed on the Presence dashboard and the calendar section. For more information, see [Create custom insights using Proactive Prompts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-concierge/../task/create-insights-proactive-prompts.md).
