...
4.  Choose which of the emergency procedures to view:
    ...
    For more information on the types of emergency procedures, see [Employee portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/critical-event-management/../concept/employee-center-portal-overview.md).
