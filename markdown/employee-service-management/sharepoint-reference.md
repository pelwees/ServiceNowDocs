...
For more information on crawl types, see [Microsoft SharePoint crawl types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../concept/sp-crawl-types.md).

-   The time of crawling may vary, based on the content size.
-   The documents are available for search after a successful crawl. For more information on crawl types, see [Microsoft SharePoint crawl types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../concept/sp-crawl-types.md).
...
The default-scheduled job frequency is set to maximize the performance. For more information, see [SharePoint Online Search Connector scheduled jobs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../concept/sharepoint-scheduled-jobs-full-crawl.md).
