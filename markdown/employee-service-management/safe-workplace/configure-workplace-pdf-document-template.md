...
5.  At the desired location in the **Body** field, enter the following variables:
    ...
    ![Signature and checklist variables in signing template body](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/safe-workplace/../../../reuse/workplace-safety-mgmt/images/signing-template-body.png)
