...
The workplace manager of the group that manages the space reservation for the floor plan.Select the Lookup using list icon ![Lookup using list icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/safe-workplace/../../workplace-case-mgmt/image/search-icon.png) to view a list of group managers you can select.

</td></tr></tbody>
</table>3.  Select the attachment icon ![Attach icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/safe-workplace/../../human-resources/image/attach-icon.png) and upload your Drawing eXchange Format \(.dxf\) file.
