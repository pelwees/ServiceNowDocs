...
-   The field is set to **None** by default.
 For more information about each field, refer to [Location privacy settings and impact](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/safe-workplace/../../wsd-reservation-management/reference/location-privacy-settings-and-impact.md)
...
**Parent Topic:**[Mapping employees to their designated workspaces](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/safe-workplace/../concept/mapping-employees-to-existing-work-locations.md)
