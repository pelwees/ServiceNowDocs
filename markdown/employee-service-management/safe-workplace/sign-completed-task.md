...
3.  In the **Sign template** field, review the signing template selected for the task.
    ...
    For more information, see [Configure a workplace task signing template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/safe-workplace/../../workplace-service-delivery/task/configure-workplace-pdf-document-template-wsd.md).
