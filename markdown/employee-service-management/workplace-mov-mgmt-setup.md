...
To create a move-related workplace service, refer to [Create a Workplace service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../../workplace-case-mgmt/task/create-workplace-service.md). To configure and link the workplace service to a record producer, refer to [Configure a Record producer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../../workplace-case-mgmt/task/wsd-create-record-producer.md).
