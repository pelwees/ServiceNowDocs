...
-   Navigate to **All** &gt; **Indoor Mapping** &gt; **View types**
    ...
    -   If the **Kiosk** view type is not available, ensure that you have installed [Workplace Services Kiosk](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../../workplace-services-kiosk/concept/workplace-services-kiosk.md).
...
**Previous topic:**[Configure map features for kiosk](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/config-map-features.md)

**Next topic:**[Configure a module for kiosk indoor mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/config-kiosk-ind-map-module.md)
