...
![Scenario planning on Workplace Central with the Stack plan tab selected. The space details tab displays the view options and KPIs for spaces and profile assignments.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../images/stack-plan-view.png)

When you select spaces on the floor map, the Space details panel displays information based on your selection.

![Scenario planning on Workplace Central with the Floor map tab selected. The space details tab displays the view options and KPIs for the selected spaces and profile assignments.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../images/floor-map-view.png)
...
-   The legend card displays the allocations on the selected area of the stack plan or floor map.
    ...
    If the view by option is Workplace Entity, you can view the hierarchy by selecting the tree icon \(![Tree icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../images/wsd-central-tree-icon.png)\) on the legend card.
...
-   **[Edit a scenario using the stack plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/edit-scenario-stack-plan.md)**  
Edit a scenario using the stack plan to allocate spaces to departments, cost centers, workplace entities, or neighborhoods.
-   **[Edit a scenario using the floor map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/edit-scenario-floor-map.md)**  
Edit a scenario using the floor map to add or remove allocations, or to assign users to spaces in your organization.
-   **[Edit user assignments of a neighborhood](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/add-or-edit-user-assignments-of-a-neighbourhood.md)**  
Add a user to a neighborhood or edit the existing user assignments of a neighborhood in a building.

**Parent Topic:**[Working with Space Optimization](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/working-with-space-optimization.md)

**Related topics**  


[Create a scenario](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/create-a-scenario.md)

[Review a scenario](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/review-a-scenario.md)

[Publish a scenario](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/publish-a-scenario.md)

[Send a scenario for approval](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/send-a-scenario-for-approval.md)

[Change owner of a scenario](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/change-owner-of-a-scenario.md)

[Deploy a scenario](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/deploy-a-scenoria.md)

[View scenario change details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/view-scenario-change-details.md)

[Create a copy of an existing scenario](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/create-copy-of-scenario.md)

[View or edit space allocations of a building](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/view-or-edit-space-alloctions-of-a-building.md)

[Work on a space assist request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../task/work-on-space-assist-request.md)

[Map based space administration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/map-based-space-administration.md)
