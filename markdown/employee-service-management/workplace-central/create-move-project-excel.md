...
7.  On the `Fix data issues` page, review the information and resolve the conflicts.
    ...
    1.  Perform any of the following actions based on your requirement.
        ...
        -   You can edit a record by selecting the edit icon \(![Edit icon in the shape of a pencil.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/../../../reuse/icons/product-icons/pencil-outline-24.svg)\) for the record.
...
For more information about working on a move project, see [Work on a move project](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-central/work-on-a-move-project.md).
