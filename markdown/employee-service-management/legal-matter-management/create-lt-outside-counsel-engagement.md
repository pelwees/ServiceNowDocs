...
</table>2.  Select **Add outside counsel for Legal Tracker** from the down arrow ![Down Arrow icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-matter-management/../../legal-invention-disclosure/image/arrow.png) on **Add outside counsel**.

3.  On the form, fill in the fields.

    For more information on the form fields, see [Legal Tracker Outside Counsel Engagement request form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-matter-management/../reference/create-lt-outside-counsel-engagement-form.md).
