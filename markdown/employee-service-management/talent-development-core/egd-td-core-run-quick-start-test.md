...
2.  Search and select the quick start tests you want to run.
    ...
    For information on available quick start tests, see [Quick start tests for Talent Development Core](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/talent-development-core/../reference/egd-quick-start-tests-td-core.md).
...
**Parent Topic:**[Quick start tests for Talent Development Core](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/talent-development-core/../reference/egd-quick-start-tests-td-core.md)
