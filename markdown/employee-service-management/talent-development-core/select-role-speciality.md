...
5.  To change the role specialty, select the pencil the \(![Pencil icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/talent-development-core/../../customer-service-management/image/icon-pencil-ac.png)\) icon.
