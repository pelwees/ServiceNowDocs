...
To learn more about Growth plans, see [Growth plans overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/talent-development-core/../concept/egd-growth-plans-ovrvw.md).
...
To learn more about Aspirations, see [Aspirations overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/talent-development-core/../concept/egd-aspirations-overview.md).

-   **[Run quick start tests for Talent Development Core](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/talent-development-core/../task/egd-td-core-run-quick-start-test.md)**  
