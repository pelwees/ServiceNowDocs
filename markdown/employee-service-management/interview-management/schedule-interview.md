...
4.  On the application record page, select **Schedule interview**.
    ...
    **Note:** If upgrading from an earlier version, make sure to edit and populate the **Hiring role**, **Visibility to applicant**, and **Type** fields of the hiring team members in the job requisition. For details, see [Edit hiring team members](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/interview-management/../concept/manage-hiring-team.md#).

5.  On the Schedule interview form, fill in the fields.

    For a description of the field values, see [Schedule interview form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/interview-management/../reference/schedule-interview-form.md).
...
You can also track your interviews from the List view. For more information, see [List view in Recruitment workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/interview-management/../concept/list-view-recruit-workspace.md).
