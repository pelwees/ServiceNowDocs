...
5.  On the Request scheduling preferences form, fill in the fields.
    ...
    For a description of the field values, see [Request scheduling preferences form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/interview-management/../reference/request-availability-form.md).
