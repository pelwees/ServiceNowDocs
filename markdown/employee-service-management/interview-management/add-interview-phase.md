...
4.  On the Create New Interview phase form, fill in the fields.
    ...
    For a description of the field values, see [Create new interview phase form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/interview-management/../reference/add-interview-phase-form.md).
