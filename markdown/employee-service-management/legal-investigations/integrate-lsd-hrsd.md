...
4.  Configure the Universal Request property to determine how the primary ticket should be handled while transferring between the departments.
    ...
    For more information, see [Universal Request properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/legal-investigations/../../universal-request/reference/ur-properties.md).
