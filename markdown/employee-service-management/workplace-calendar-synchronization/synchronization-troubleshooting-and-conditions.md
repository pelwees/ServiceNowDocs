...
-   **Virtual meeting link**
    ...
    To set up Microsoft Teams, refer to [Connect Workplace Reservation Management with Microsoft Teams](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-calendar-synchronization/../../wsd-reservation-management/task/connect-rsv-mgmt-with-teams.md).

    To set up Zoom, refer to [Connect Workplace Reservation Management with Zoom](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-calendar-synchronization/../../wsd-reservation-management/task/connect-rsv-mtm-with-zoom.md).
