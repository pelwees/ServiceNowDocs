...
3.  Add all usersfrom the User \[sys\_user\] table who will be reporting their vaccination status to a Safe Workplace audience.
    ...
    2.  Add users to the audience.
        ...
        For detailed instructions about adding users to an audience, see [Add a Safe Workplace audience](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../../employee-readiness-core/task/add-safe-workplace-audience.md).
...
4.  Configure an outreach to send the privacy consent to users.
    ...
    2.  Make any modifications to the outreach if needed, such as scheduling a time to send.
        ...
        For detailed instructions about configuring an outreach, see [Send notifications for an emergency](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../../business-continuity/task/send-eo-notification-outreach.md).
    ...
    3.  Enable the outreach to provide location-specific privacy consents by selecting the **Use Country** option on the **Content configuration** tab.
        ...
        For more information on updating a location's privacy statement, see [Generate location-based privacy configurations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/../../employee-readiness-core/task/generate-location-common-privacy-configuration.md).
