...
-   **[Rules to archive data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../concept/archive-data-ta.md)**  
Create rules to archive and delete data according to your organizational policy.
-   **[Cascade rules for cleaning data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../reference/cascade-rule-ta.md)**  
Cascade rules determine a thorough cleanup of the outdated data and its related counterparts at source from the system.

**Parent Topic:**[Configuring Hiring Experiences](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../concept/config-frmwrk-ta.md)
