...
1.  The Contract requester initiates a contract request. For more information, see [Initiating a contract or amendment request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-initiate-contract.md).
...
-   **[Work on self-served contract requests as a contract fulfiller](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-work-ss-cntr-request-fulfiller.md)**  
Review and finalize a contract document according to the contract request.
-   **[Work on self-served contract requests as a contract user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-work-ss-cntr-request-user.md)**  
As a contract user, edit request, regenerate contract document, and send for signature.
-   **[Add signatories in self-served contract request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-update-sign-ss-cmr.md)**  
...
-   **[Create an updated contract document revision after modifying a self-served contract request \(starting Contract Management Pro 1.2.1\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-sync-document.md)**  
...
-   **[Regenerate contract document after modifying request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-regen-contract-doc.md)**  
...
-   **[Updating and synchronizing signatories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-update-sync-signatories.md)**  
...
-   **[Reviewing and finalizing a self-serve contract document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../task/cncore-review-finalize-contract.md)**  
...
**Parent Topic:**[Using Contract Management Pro](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/cncore-use-cmpro.md)
