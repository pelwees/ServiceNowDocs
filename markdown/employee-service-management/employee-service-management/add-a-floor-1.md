...
9.  To add an indoor map, select the Additional Actions icon \(![Additional Actions to switch to the Workplace view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/../images/additionalactions-icon.png)\) to select **View** &gt; **Workplace Indoor Mapping Floor**.
...
[Add a building using Workplace Space Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/employee-service-management/add-new-building-1.md)
