...
-   [activated the Adobe Sign spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/activate-adobe.md)
...
3.  [Configure an HR PDF document template for an adhoc document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-pdf-document-adobesign.md).
...
2.  [Configure an HR service for the Adobe Sign integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-adobe-sign-template-for-hr-document-template.md).
3.  [Configure an HR PDF document template for an Adobe Sign template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-service-for-adobe-sign-integration.md).
...
For more information, see [Request an electronic signature through the Adobe Acrobat Sign service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/request-e-signature-through-adobe-sign-service.md).

-   **[Activate the Adobe Sign spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/activate-adobe.md)**  
...
-   **[Configure an HR PDF document template for an adhoc document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-pdf-document-adobesign.md)**  
...
-   **[Configure an HR PDF document template for an Adobe Sign template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-service-for-adobe-sign-integration.md)**  
...
-   **[Configure an HR service for the Adobe Sign integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-adobe-sign-template-for-hr-document-template.md)**  
