...
**Tip:** For more information about the configuration process, see [Configure time range data in tenure widgets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/td-lh-configure-tenure-widgets.md).
