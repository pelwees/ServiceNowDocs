...
2.  [Create a service table configuration in Service Portfolio Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/config-service-table.md).

    **Note:** Default HR service table configuration is available for use.

3.  [Configure CSDM service mappings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/config-csdm-ser-map.md).
