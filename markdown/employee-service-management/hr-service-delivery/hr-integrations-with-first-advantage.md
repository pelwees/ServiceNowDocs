...
1.  [Provide source credentials for the First Advantage service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-integrations-sources-first-advantage.md)  
Provide the source and SOAP credentials for the First Advantage service so that it can be accessed for integration.
2.  [Verify integration for the First Advantage service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/verify-base-inbound-integration-for-first-advantage.md)  
...
3.  [Add background check packages for the First Advantage](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/background-check-package-for-first-advantage.md)  
