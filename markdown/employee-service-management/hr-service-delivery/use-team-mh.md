...
5.  Click the quick links that navigate you through ServiceNow applications that are integrated with Manager Hub.
    ...
    For more information, refer to [Integrate Manager Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../reference/integrate-mh-jc.md).
