...
11. Select **Edit** to associate groups to the COE security policy.
    ...
    For more information on Groups, see [Manage HR Groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/t_ManageHRGroups.md).
