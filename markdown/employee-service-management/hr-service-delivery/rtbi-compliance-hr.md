...
-   Approving hierarchy for the report generation. For more information, see [Generate Personally Identifiable Information \(PII\) report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/generate-pii-report-rtbi.md).
-   Requesting personal information report by an employee or alumni. For more information, see [Request personal information report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/request-personal-information-report-rtbi.md).
...
-   Creating erasure request. For more information, see [Request erasure of personal data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/request-erasure-personal-data-rtbi.md).
