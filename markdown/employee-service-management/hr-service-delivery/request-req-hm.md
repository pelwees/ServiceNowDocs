...
3.  On the new job opening request form, fill in the fields.
    ...
    For a description of the field values, see [Job requisition form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../reference/new-job-form.md).
...
-   **[Use Now Assist to open a job requisition](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/request-req-hm-now-assist.md)**  
