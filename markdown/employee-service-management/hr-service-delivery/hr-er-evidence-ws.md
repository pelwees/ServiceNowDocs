...
Any person involved with the evidence provided in the ER case.Click into the field and a list of involved parties appears.
 ...
 If no names appear, you have to create an involved party record. For more information, see [Create an involved parties record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/hr-er-involved-parties.md).
