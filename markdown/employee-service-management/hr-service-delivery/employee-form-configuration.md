...
For more information, see [Create an employee form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-employee-form.md).
...
-   [Adding an HR task to an HR case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/t_ViewAnHRTask.md)
...
For more information, see [Create an HR criteria record for an employee form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-criteria-record-for-employee-form.md).
...
-   **[Create an employee form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-employee-form.md)**  
...
-   **[Create an HR criteria record for an employee form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/configure-hr-criteria-record-for-employee-form.md)**  
