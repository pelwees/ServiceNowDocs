...
-   **[HR PIWB template: Auto-categorize email cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-email-categorization.md)**  
...
-   **[HR PIWB template: Predict the HR service for incoming cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-predict-hrservice.md)**  
...
-   **[HR PIWB template: Predict the assignment group for incoming cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-predict-ag.md)**  
...
-   **[HR PIWB template: Predict knowledge case clusters and demand insights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-kb-case-clusters.md)**  
...
-   **[HR PIWB template: Predict knowledge gaps and insights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-kb-gaps-insights.md)**  
...
-   **[HR PIWB template: Predict knowledge for HR case resolution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-similar-hrcases-agent.md)**  
...
-   **[HR PIWB template: Recommend similar cases by employee profile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-similar-profile.md)**  
...
-   **[HR PIWB template: Predict knowledge for HR task completion](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-similar-hrtasks-employee.md)**  
...
-   **[HR PIWB template: Recommend similar cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-similar-cases.md)**  
...
-   **[HR PIWB template: Recommend estimated time to resolve](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-piwb-ettr.md)**  
...
**Parent Topic:**[HR Predictive Intelligence Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/hr-predictive-intelligence-wb.md)
