...
Stores source job details, such as start time, run end time, and state. For more information, see [View job tracker details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-integration-job-tracker.md).
...
Stores service job details such as start time, end time, and state. For more information, see [View job tracker details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-integration-job-tracker.md).
...
</table>**Parent Topic:**[Enterprise Service Management Integrations Framework reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/ent-service-mgmt-int-framework-reference.md)
