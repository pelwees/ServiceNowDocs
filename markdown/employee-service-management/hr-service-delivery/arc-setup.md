...
1.  Install and activate the Anonymous Report Center \(com.sn\_anonymous\_report\_center\) plugin: [Activate the Anonymous Report Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/arc-activate.md).
...
</table>3.  Give employees access to the Anonymous Report Center by adding the catalog items to the Employee Center: [Add ARC catalog items to the Employee Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/add-arc-menu.md)
