...
3.  For better performance, index the employee number field in HR Profile table and index coalesce fields in [transform maps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../reference/oracle-hcm-transform-maps.md).
...
5.  Configure integration source properties for HR Service Delivery integration with Oracle Cloud HCM
    ...
    For more information, see [Configure properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../reference/oracle-hcm-properties.md).
...
6.  Activate and run the scheduled flow that synchronizes Worker profile information between Oracle HCM and ServiceNow HR Service Delivery periodically.
    ...
    For more information, see [Activate schedule flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/setup-the-job.md).
