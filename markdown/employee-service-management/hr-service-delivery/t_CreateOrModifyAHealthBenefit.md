...
Alternatively, a manager can submit an enrollment request by opening an HR case: [Create an HR case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/search-hr-case.md).
