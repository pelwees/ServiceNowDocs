...
-   Use Microsoft Outlook Calendar to schedule an interview.
    ...
    **Note:** You can use the manual method of scheduling in HR Service Delivery Agent Workspace. For more information, see [Schedule an interview in Employee Relations using the legacy UI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-er-interview.md) or [Schedule an interview in Employee Relations using Agent Workspace for HR Case Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/hr-er-interview-ws.md).
