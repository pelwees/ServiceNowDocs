...
1.  Open the HR case that has a rejected approval.
    ...
    A message appears at the top of the form.![HR case form - reject message](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../image/hr-case-reject.png)

2.  Select the **here** link.

    The **Enter the reason for resubmitting approval requests** pop-up appears. You can enter work notes \(not visible to employee\) or comments \(visible to employee\). Work notes or comments are required.![HR case form - reject comments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../image/hr-case-reject-comments.png)
