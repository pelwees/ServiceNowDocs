...
4.  Create the following properties for the Magnit source. These are one-time configurations:​
    ...
    ​ For more information, see [Source for HR Service Delivery Integration with Magnit](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../reference/source-magnit.md#).

5.  Pull contingent workers from Magnit application into ServiceNow AI Platform instance via a scheduled job that can be configured. See [Activate a schedule flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../task/activate-sch-flow-magnit.md).
...
![End-to-end work flow of HR Service Delivery Integration with Magnit.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/hr-service-delivery/../image/magnit-flow.png "Flow diagram")
