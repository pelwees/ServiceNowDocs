...
Type of page that you want to create for the kiosk flow. For more information, see [Kiosk Check-in Flow Configuration form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-visitor-management/kiosk-check-in-config-form.md).
