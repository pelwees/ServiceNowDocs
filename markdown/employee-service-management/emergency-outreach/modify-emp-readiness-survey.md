...
![Survey definition with owners who are check-in admins](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/../image/survey-definition-owners.png "Survey definition owners")

## Procedure

1.  Navigate to **All** &gt; **Surveys** &gt; **View Surveys** and open the **Employee workplace readiness survey**.

    ![Survey definition Introduction and end notes form section and related lists](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/../image/survey-definition-fields-lists.png)
...
Select the lock icon \(![Lock icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/../../../common/image/icon-lock.png)\) beside **Owners** to unlock the list of survey owners. Add the user to collaborate with on this survey.
...
[Send a readiness survey in Emergency Outreach](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/../../contact-tracing/task/send-notification-to-exposed-contact.md)
