...
**Note:** The [Employee Readiness Surveys](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/employee-readiness-surveys.md) app must be installed to use response scripts.

**Parent Topic:**[Emergency Outreach](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/emergency-outreach.md)

## Included response scripts

Emergency Outreach provides the pre-built Request PPE response script.

The Request PPE response script requires the [Workplace PPE Inventory Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/emergency-outreach/../../ppe-inventory-management/concept/ppe-inventory-management.md) app. This response script creates a PPE request for employees who complete the Employee workplace readiness survey and meet the response criteria for the health status, travel, and ready to return to the workplace questions.
