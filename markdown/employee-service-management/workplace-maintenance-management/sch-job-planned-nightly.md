...
-   For a six-hour schedule, eight maintenance cases are created for two maintenance assets or locations in a day \(four cases for each\).
    ...
    ![Published Workplace Maintenance Plan showing eight maintenance cases for two maintenance items.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../images/wsd-case-generation-with-schedule-less.png "Workplace Maintenance cases")
...
-   Filters out plan records where the Next run time is 48 hours or less than a day.
    ...
    ![Published plan showing the Next run time duration.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../images/wsd-plan-record-showing-next-run-time.png "Schedule job Next run time")
...
-   For each plan record, the **Next run value** depends on the **Field** name value. The **Field** value is available when you’re creating a meter-based schedule.
    ...
    For more information, see in [Create or copy a maintenance schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../task/create-maint-schedule.md).
...
**Parent Topic:**[Manage Workplace Maintenance Management plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/manage-maintenance-plans.md)

**Previous topic:**[Create or copy a maintenance schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../task/create-maint-schedule.md)

**Next topic:**[Create workplace services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../task/create-workplace-services.md)
