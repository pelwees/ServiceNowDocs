...
3.  On the Workplace Maintenance Configuration form, fill in the fields:
    ...
    1.  Workplace service: Name of the Workplace service.
        ...
        Select the lookup list icon \(![Lookup list icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../../contact-tracing/image/icon-lookup.png)\) and workplace service for a plan record. For example: Cleaning desk.

        For more information, see [Create workplace services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/create-workplace-services.md).
    ...
    3.  Select the **Set conditions** filter and apply filter conditions for a selected item.
        ...
        ![Create plan service configuration.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../images/wsd-schedule-conditions-plan-service-config.png)

        For more information about Workplace services, see [Create workplace services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/create-workplace-services.md).
    ...
    1.  Select and open the **View matching results** to see the schedule job **Name****Next run time** or **Next run value** duration.
        ...
        ![View matching results showing the Next run value for a meter-based schedule.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../images/wsd-meter-based-next-run-value.png)
        ...
        ![Workplace template configuration form showing workplace service for a plan record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../images/workplace-template-configuration-new.png)

        For more information, see [Workplace planned maintenance scheduled job](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../concept/sch-job-planned-nightly.md) and [Workplace maintenance cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/create-maint-cases.md).
...
8.  The Workplace Services column shows the plan service configuration associated with a plan record.
    ...
    ![Published maintenance plan showing mapped workplace services to a maintenance case.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/../images/wsd-published-maint-case-wiht-service.png)
...
**Previous topic:**[Create workplace services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/create-workplace-services.md)

**Next topic:**[Workplace maintenance cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/employee-service-management/workplace-maintenance-management/create-maint-cases.md)
