...
3.  Select the Gauge \(![dial gauge icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/icon-dial-gauge-ac.png)\) visualization type.
...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for gauge data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-gauge-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for gauge data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-gauge-ind-data.md).
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for gauge visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-gauge-uxa-data.md).
...
-   **[Table data options for gauge data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-gauge-table-data.md)**  
When you select a table data source for a gauge visualization, the following Data configuration options are available.
-   **[Indicator data options for gauge data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-gauge-ind-data.md)**  
...
-   **[Usage Insights data options for gauge visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-gauge-uxa-data.md)**  
...
-   **[Gauge visualization example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/task/dv-example-gauge.md)**  
