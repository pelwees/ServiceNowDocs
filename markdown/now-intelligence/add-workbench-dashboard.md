...
6.  Choose one or more workbenches from the library and select **Add to Dashboard**.![Select a workbench from the library modal showing four elements with name, description, creator, and last updated timestamp](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/inline-db-select-wb.png)

    Users with the admin or pa\_admin roles see the option to create new workbench widgets in Core UI. For more information, see [Monitor a workflow with a workbench process widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/concept/c_MonitorWorkflowWorkbenchWidget.md#).
