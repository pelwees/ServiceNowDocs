...
3.  Select the Dial \(![Data visualization dial type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/inline-data-vis-dial.png)\) visualization type.
...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for dial visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-dial-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for dial data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-dial-ind-data.md).
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for dial data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-dial-uxa-data.md).
...
-   **[Table data options for dial visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-dial-table-data.md)**  
When you select a table data source for a dial visualization, the following Data configuration options are available.
-   **[Indicator data options for dial data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-dial-ind-data.md)**  
When you select an indicator data source for a dial visualization, the following Data configuration options are available.
-   **[Usage Insights data options for dial data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-dial-uxa-data.md)**  
...
-   **[Dial visualization example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/task/dv-example-dial.md)**  
