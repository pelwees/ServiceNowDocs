...
Only table data sources listed in the Semantic Table Configuration table are supported. See [Add a table to the semantic data layer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/add-table-semantic-layer.md#).
...
**Parent Topic:**[Generate visualizations in the Now Assist panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/use-dv-generation.md)
