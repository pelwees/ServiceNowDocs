...
6.  Select the type of task scope you want to create.
    ...
    ![Screenshot showing task scope options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/tm-add-task-scope.png)
...
|End|State that triggers the end point of the task.|
    ...
    ![Screenshot showing automated task scope fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/tm-task-scope-project.png)
    ...
    ![Screenshot showing user-initiated task fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/tm-user-initiated-task.png)
...
![Screenshot showing the example task.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/tm-task-example.png)
