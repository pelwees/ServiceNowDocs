...
![Screenshot showing a Project details page in Task Mining.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/task-mining-projects-page.png)

## Data page

You access the Data page by selecting the Data icon ![](../image/task-mining-data-icon.png).

Access data requests to confirm approvals are completed, manage categorization groups to organize activities, and review workstation user information from the Data page. For more information about managing data requests, see [Follow data request progress](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../task/manage-data-log-requests.md).

![Screenshot showing the Data page in Task Mining.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/task-mining-data-page.png)
...
Create rules from the Application categorization page to organize your data by grouping similar workstation activities with user-friendly names. For more information, see [Categorize workstation activities to simplify analysis](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../task/define-default-categorization-rules.md).

![Screenshot showing the Application categorization page in Task Mining.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/task-mining-categorization-page.png)
...
![Screenshot showing the Configuration page in Task Mining.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../image/task-mining-system-page.png)
