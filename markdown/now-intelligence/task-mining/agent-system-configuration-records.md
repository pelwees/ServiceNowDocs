...
For information about configuration, see [Adjust Task Mining agent parameters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/task-mining/../task/set-system-parameters.md).
