...
3.  Select the horizontal bar \(![horizontal bar icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/inline-data-vis-bar-horizontal.png)\) or vertical bar \(![vertical bar icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/inline-data-vis-bar-vertical.png)\) visualization type.
...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for horizontal and vertical bar visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-bar-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for horizontal and vertical bar visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-bar-ind-data.md).
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for bar visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-bar-uxa-data.md).
...
-   **[Table data options for horizontal and vertical bar visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-bar-table-data.md)**  
...
-   **[Indicator data options for horizontal and vertical bar visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-bar-ind-data.md)**  
...
-   **[Usage Insights data options for bar visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-bar-uxa-data.md)**  
...
-   **[Following filters per metric](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../concept/chart-options-bars-multi-metrics.md)**  
...
-   **[Bar visualization examples](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/task/dv-example-bar.md)**  
