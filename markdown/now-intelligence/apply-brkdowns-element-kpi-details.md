...
For classic indicators, you can select up to two levels of breakdown, and you can select multiple elements on the first breakdown. [Breakdown matrix collection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/task/create-breakdown-mapping.md#) must be enabled on the indicator to have more than one breakdown. For classic formula indicators, breakdown matrix collection must be enabled on the contributing automated indicators.
...
1.  In the sidebar of KPI Details, select the Filter icon. ![Filter icon highlighted on sidebar.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-filter-icon.png)
...
3.  If an elements filter exists for the breakdown, you can use it to refine the list of elements.
    ...
    1.  Expand the **Refine by** list to see the available element filters.
        ...
        ![Refine by menu on KPI Details filter pane showing available element filters.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-elements-filters.png)
    ...
    2.  Select an elements filter.
        ...
        ![One of my groups element filter applied to the Assignment Group breakdown, so only the groups with the user as a member are shown.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-elements-filters2.png)
...
![Breakdown and element filter sidebar for KPI Details, highlighting Apply button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-filter-sidebar.png)
...
![Indicator with 4 elements selected, showing the aggregate view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-multi-element-aggregate.png "Aggregate view of multiple elements")

![Number of open incidents indicator with multiple elements selected and separate time series view selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-multi-element-separate.png "Separate view of multiple elements")
...
![The filter sidebar for a formula indicator that does not allow aggregate view of multiple elements, with multiple elements selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-multi-element-sep-only.png "Filter sidebar of indicator that does not support aggregate view")

**Related topics**  


[Indicator breakdowns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/concept/c_CreatingBreakdowns.md)
