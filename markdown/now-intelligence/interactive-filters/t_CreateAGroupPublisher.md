...
4.  In the **Filter based on** list, select **Group**.
    ...
    ![Filter based on list with Group selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/interactive-filters/../../reporting/image/if-filter-based-on-group.png)
