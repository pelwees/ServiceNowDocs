...
![Boolean filter example with the true option selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/interactive-filters/../image/if-ex-bool.png)
...
4.  In the **Filter based on** list, select **Boolean**.
    ...
    ![Filter based on list with Boolean selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/interactive-filters/../../reporting/image/if-filter-based-on-bool.png)
