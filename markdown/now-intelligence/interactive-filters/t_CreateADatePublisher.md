...
![Reference list filter example with the Last 90 days option selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/interactive-filters/../image/if-ex-date.png)
...
4.  In the **Filter based on** list, select **Date**.
    ...
    ![Filter based on list with Date selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/interactive-filters/../../reporting/image/if-filter-based-on-date.png)
