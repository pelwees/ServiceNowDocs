...
You have selected an Indicator data source in [Create time series data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/create-dv-time-series-ac.md).
