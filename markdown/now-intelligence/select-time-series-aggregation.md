...
For more information about the use, behavior, and limitations of time aggregations, see [Applying time series aggregations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/concept/applying-time-series-aggregations.md#). For examples and a deeper exploration of using time series aggregations with indicators, see this Performance Analytics Academy video, [Leveraging Time Series with Performance Analytics](https://youtu.be/aM6JtUndRYk).
...
2.  Expand the time aggregation menu, which has a label matching the currently selected aggregation period, usually Daily.
    ...
    ![The control for expanding the time aggregation menu](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-open-time-aggregate.png)
...
![Time aggregation menu for a daily indicator, showing a Period aggregation to a weekly sum](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-time-aggregation.png)
