...
A log of every call to Query Generation. For more information, see [Query Generation logs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/query-generation-logs.md).
