...
![Metrics tile when there are 2 metrics, showing visualization selection menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/ts-chart-choice-multi-metrics.png)
...
![Adding Y-axis visualizations for each metric.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/ts-metric-multi-addaxis.png)

## Group by per metric

You can also set separate group-by values for each metric.

![Dialog setting different breakdowns for two different indicators as group-bys.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/dv-group-by-per-metric.png)
...
![Selecting alternative group-bys for two metrics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/dv-alt-groupby-multi-metric.png)
...
**Parent Topic:**[Create time series data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/create-dv-time-series-ac.md)
