...
4.  Select the arrow next to the **Save** button or next to the Share icon \(![Share icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../../dashboards/image/icon-share-db.png)\).
...
5.  Select **Insert and Stay**.
    ...
    |--------------------|-----------------------|
    |![Save menu with Insert and Stay selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/copy-report-with-save-button.png)|![Arrow menu with Insert and Stay selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/copy-report-without-save-button.png)|
...
[Share a Core UI report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/t_ShareASetting.md)
