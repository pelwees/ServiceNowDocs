...
2.  Select the info button \(![info button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../../performance-analytics/image/InfoIcon.png)\) next to the report that you want to address and select **Open record** to see the options associated with the report.
    ...
    ![Report view ACL report options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/rep-acl-report-options-2.png)

3.  Select **Ignore Report** to remove this report from future assessments.

    To review these reports later, see [Reassess ignored reports](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/recover-ignored-reports.md).
...
4.  Select **Show Affected Users** and then **View Result**.
    ...
    ![Report view ACL affected users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/rep-acl-report-options-2-pol.png)
...
6.  Add users to a group.
    ...
    2.  Select `Assign to group` from the list **Actions on selected rows**.
        ...
        ![Report view ACL affected users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/rep-acl-report-options-3-pol.png)
    ...
    3.  Choose a group and a role \(if available\) to add the selected users to and select **Submit**.
        ...
        ![Report view ACL affected users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/rep-acl-add-users-to-group.png)
...
2.  [Perform the Report View assessment scan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/perform-report-view-acl-assessment-scan.md).
...
[Report on extended tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/t_AccessFieldExtendedTable.md#)
...
![Affected reports list with one blocking ACL link highlighted](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/../image/affected-reports-blocking-acl.png)

### Edit the report sharing options

-   For reports created in the Classic environment, open the report in the Report Designer and change who the report is shared with. For more information, see [Share a Core UI report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/reporting/t_ShareASetting.md).
