...
Role required: You must be a [responsible user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../concept/kpi-signals-responsible-users.md#), unless you have the admin, pa\_admin, or pa\_kpi\_signal\_admin role.
...
1.  Open KPI Signals from KPI Details.
    ...
    In the KPI Details page for an indicator, you see a notification dot on the KPI Signals tab. This dot tells you that you have a signal for the indicator. ![Open KPI Signals icon with notification dot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/image/kpi-signals-notification-dot.png)
...
5.  Click either **Dismiss signal** or **Confirm**, to dismiss the signal, or reset the baseline, respectively.
    ...
    ![Explanation of a baseline reset including what, why, and when.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/image/kpi-signals-understand-reset.png)
