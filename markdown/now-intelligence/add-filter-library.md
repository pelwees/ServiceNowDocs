...
5.  Choose the filter source.
    ...
    -   **Usage Insights**
        ...
        Select the Usage Insights property to filter on. For more information, see [Filter data in Usage Insights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../../administer/user-exp-analytics/task/filter-user-list.md).
