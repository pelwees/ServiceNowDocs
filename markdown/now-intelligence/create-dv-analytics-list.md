...
-   **[Create a list visualization with variable columns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/create-list-dv-with-var-col.md)**  
