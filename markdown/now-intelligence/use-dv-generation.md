...
5.  To pop out a larger view of the visualization that shows the table name and conditions, select **View details**.
    ...
    ![Details of a vertical bar visualization of incident data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/analgen-viz-details.png)
...
7.  To add the visualization to a collaborative workspace in AI Data Explorer, select **Add to exploration**.
    ...
    For more information, see [Use AI to explore data with AI Data Explorer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/now-assist-explorer.md).
...
-   **[Guidelines and example questions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../concept/example-questions-generating-dv.md)**  
...
-   **[Limitations to generating data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/limitations-generating-dv.md)**  
