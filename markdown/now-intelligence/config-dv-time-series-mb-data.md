...
You have selected a MetricBase data source in [Create time series data visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/create-dv-time-series-ac.md).
