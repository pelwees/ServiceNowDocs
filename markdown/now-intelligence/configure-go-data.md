...
4.  Under Action, select from the available chart interactions.
    ...
    The interactions are described in [Chart interactions in a data visualization](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/concept/dv-chart-interactions.md).

    ![Chart interaction section of data visualization configuration panel with available actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/chart-int-go-data-view.png)
...
![Incident by Priority visualization in the Visualization Designer.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/dv-c2c-incident-by-priority.png)
...
1.  You navigate to the Chart interaction section of the configuration panel. Here you select **Drill down to chart** as the action. You can add a drilldown chart to any of the metrics in the visualization. As the Incident metric is the only one on the visualization, this metric is your only choice.
    ...
    ![Chart interaction configuration options with Drill down to chart selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/dv-c2c-select-c2c.png)
...
3.  You configure the visualization to show a single score representing the number of incident records on the Incident table and save the visualization.
    ...
    ![The first level of visualization that you can drill down to on the Incident by Priority visualization.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/dv-c2c-configure-drilldown.png)
...
5.  Now, when a viewer interacts with this visualization on a dashboard, they can drill down from the bar visualization to the single score and navigate back up. Similarly, you or another editor of the visualization can move between the parent and child visualizations to edit the configuration of either one.
    ...
    ![Drilling down from parent visualization to child and navigating back up to parent.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/dv-c2c-incident-by-priority-gif.gif)


**Parent Topic:**[Chart interactions in a data visualization](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/concept/dv-chart-interactions.md)
