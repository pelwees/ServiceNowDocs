...
-   **Go to data view**
    ...
    Opens a view of the data appropriate to the data type. For information about the views for each data source, see [Data views for different data sources](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../dashboards/reference/visualization-drilldown-in-config-ws.md).
...
</table>-   **[Configure visualization interactions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../reporting/task/configure-go-data.md)**  
Select what happens when a viewer interacts with a section of a data visualization that you are editing.
-   **[Data views for different data sources](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../dashboards/reference/visualization-drilldown-in-config-ws.md)**  
