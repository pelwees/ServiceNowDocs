...
6.  If your only option is to add an event mapping, do so.
    ...
    ![Making a data visualization component interactive.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/add-event-mapping.png)

    1.  Select **Add event mapping**.

    2.  In the list of events, select **Visualization Clicked**.

        ![Selecting the Visualization Clicked event.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/visualization-clicked.png)

    3.  Select **Continue**.

7.  If the **Visualization Clicked** event is already listed on the Events tab, select **Add handler** for it.

    ![Adding a handler to the Visualization Clicked event.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/techdash-add-handler.png)

8.  Search for and select the **Advanced dashboards - Redirect** event handler and **Continue**.

    ![Selecting the Advanced dashboards - Redirect event handler.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-adv-db-redirect.png)
...
2.  In the Context field, you select **Edit**.
    ...
    ![The Edit control in the Context field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-adv-db-ex-edit-context.png)

3.  In the editing dialog, you select the object JSON type.

    ![Selecting the object JSON type for the Context.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-adv-db-ex-json-object.png)
...
4.  You select **Add property** and enter `path` as the property name and `now/platform-analytics-workspace` as the property value. These values specify that the viewer drills down to the Platform Analytics experience.
    ...
    ![Setting the value of the Context.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-adv-db-ex-context-value-table.png)
...
7.  For the Route fields, you first choose to bind data. ![Selecting to bind data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/bind-data.png)
8.  Then you add the property `{table: @payload.params.table}` to the field. This property passes the name of the table in your visualization to the simplelist page of the Platform Analytics experience.
    1.  You select the Event payload property `params` and then `table`.
        ...
        ![Selecting the payload.params.table property in the data binding editor.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-tech-adv-redirect-table-param.png)
    ...
    3.  Double-click on the property in the upper area of the editor to open it for editing.
        ...
        ![Double-clicking the property pill to open it for editing.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-adv-event-edit-prop.gif)

    4.  You surround the `@payload.params.table` property with curly brackets and add the `table:` property.

        ![Completing the table property.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/image/db-tech-event-complete-parm.gif)
