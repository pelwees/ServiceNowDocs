...
-   [Change dashboard name or description](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/config-db-in-ac.md)

    Provide an informative description of your dashboard for other users.

-   [Specify dashboard requester](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/config-db-in-ac.md)
...
-   [Transfer ownership of a dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/config-db-in-ac.md)
...
-   [Set background colors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/configure-ac-db-settings.md)

    Select the background colors for one or more tabs on the dashboard.

-   [See who created a dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/config-db-in-ac.md)
-   [See who the dashboard is shared with](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/config-db-in-ac.md)

## Admin configuration tasks

The following tasks require at least the dashboard\_admin if not the admin role.

-   [Set data refresh options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/configure-ac-db-settings.md)

    Set whether the dashboard is refreshed on a schedule and whether data caching is used. Requires the dashboard\_admin or admin role. For more information, see [Data caching in Platform Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/concept/data-caching-pa.md).

-   [Certify a dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/certify-db-ac.md)

    Certify that a dashboard has been officially approved for use by your organization. Requires the admin role.

-   [Configure Platform Analytics dashboard tab cache timeout](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/configure-ac-db-timeout.md)
...
-   [Manage which workspaces are allowed to contain the dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/config-db-in-ac.md)
...
-   [Move a Platform Analytics dashboard with an update set](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/move-pae-db-with-update-set.md)
...
-   [Configure a Process Mining map on a dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/task/configure-po-map.md)
...
-   [Creating Process Mining projects from Proactive Analytics suggestions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/concept/pm-projects-insights-suggestions.md#)
