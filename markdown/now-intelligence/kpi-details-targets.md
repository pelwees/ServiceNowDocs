...
To view targets, select the target icon ![Target icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/target-icon.png) in the side panel. You have two choices to make:

-   View the targets that are for everyone \(global\) or just for you \(personal\).
-   Select the Configure icon ![Configure icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../../common/image/Form_PersonalizeFormIcon.png) and choose what combination of past, current, or future targets to view.

    ![Selecting which targets to view on the Targets panel.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpid-select-targets-view.png)
...
![KPI Details for Number of open incidents > Category: Network, showing target and that indicator is on track to be less than the target](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-showing-target.png)
...
![KPI Details with Forecast on and the review date chosen in the chart, showing that the score is expected to beat the target by 2.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-review-date-gap.png)
...
![KPI Details showing target that has been met.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-met-target.png)

## Past and current targets

When a target reaches its review date, it is no longer active. Usually you want a new target to take effect. When you add a new target, the expired targets are still visible, both in the chart and on cards. Here, a new target is added to the indicator after the target from the previous example has expired. This target is based on a 10% improvement to the previous target, as described in [Create a target in KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/create-kpi-details-targets.md). The chart shows information about whichever target is in effect on the selected date.

![KPI Details showing both an active and an expired target.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/kpi-details-old-new-targets.png)

-   **[Create a target in KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/create-kpi-details-targets.md)**  
...
-   **[Edit multiple targets in KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/edit-multiple-targets.md)**  
...
-   **[Subscribe users to Data snapshots indicator target](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/subscribe-users-to-ds-target.md)**  
...
-   **[Create, modify, or delete a threshold in KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/add-mod-pers-tar-thresh-kpi-details.md)**  
...
-   **[Add a target to multiple breakdown elements in KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../task/add-multiple-targets.md)**  
...
-   **[Responsibility for indicator targets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/responsibiity-targets-kpi-details.md#)**  
...
**Parent Topic:**[KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/kpi-details.md)

**Related topics**  


[Exploring KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/exploring-kpi-details.md)

[Examining indicators with KPI Details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/kpi-details-components.md)

[KPI Details reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/kpi-details-reference.md)
...
[Performance Analytics targets and thresholds](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../performance-analytics/concept/pa-targets-thresholds.md)
