...
2.  Click the Add widgets icon\(![Add widgets icon - a plus inside of a circle](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/icon-add-user-db.png)\) to put the dashboard in edit mode.

3.  Point to the widget, then click the gear icon \(![Gear icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../performance-analytics/image/Cogwheel.png)\).

4.  Select **Show real-time updates** then click **Done**.

5.  Click the plus sign \(![Plus sign button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/AddWidgetButton.png)\) to exit edit mode for the dashboard.

    The real-time icon \(![Real time icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/real-time-update-icon.png)\) is added to the widget. This icon is permanently visible, even when the score isn’t changing.
