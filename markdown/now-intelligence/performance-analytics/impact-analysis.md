...
-   **Bottom-up tree view**
    ...
    The bottom-up tree view shows where a performance analytics entity is used in your instance. If you select **Show Used By** from the context menu of a tree view component, the tree view shows all the places where that entity is used. Click the reset icon \(![Tree view reset icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/tree-view-reset-icon.png)\) to return to the top-down tree view.

-   **Component summaries**

    Click the info icon \(![Admin console tree view info button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/admin-console-treeview-info.png)\) to see a summary of the component.

-   **Other actions**

    Click the context menu icon \(![Admin console tree view context menu button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/admin-console-treeview-menu.png)\) in any component to view the actions available for that component. These include editing the component, viewing the schema map of the component, and previewing a widget.
...
-   **[Launch Dependency Assessment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../dashboards/task/launch-dependency-assessment.md)**  
...
-   **[Dependency Assessment tree view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/dependency-assessment-treeview.md)**  
...
-   **[Bottom-up tree view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/dependency-assessment-show-used-by.md)**  
...
-   **[Tree view navigation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../reference/admin-console-tree-view-nav.md)**  
