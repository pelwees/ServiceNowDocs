...
2.  [Populate the homepage migration status table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/hpm-populate-hp-status-table.md).
...
![Animated gif of homepage deprecation dashboard that scrolls through all four tabs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/hp-dep-db-overview.gif "Homepage deprecation dashboard")
...
|------|----|-----------|
|Homepages not deprecated|![](../../reporting/image/icon-single-score-report-p.png) Single score|Number of homepages that you have not converted or retired. Select this report to see the associated homepages on the [Homepage migration status table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../concept/homepage-migration-status-table.md).|
|Converted homepages|![](../../reporting/image/icon-single-score-report-p.png) Single score|Number of homepages that you’ve converted to responsive dashboards. Select this report to see the associated homepages on the [Homepage migration status table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../concept/homepage-migration-status-table.md).|
|Retired homepages|![](../../reporting/image/icon-single-score-report-p.png) Single score|Number of homepages that you’ve retired. Select this report to see the associated homepages on the [Homepage migration status table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../concept/homepage-migration-status-table.md).|
|Restored homepages|![](../../reporting/image/icon-single-score-report-p.png) Single score|Number of retired dashboards that you’ve restored as responsive dashboards. Select this report to see the associated homepages on the [Homepage migration status table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../concept/homepage-migration-status-table.md).|
