...
![The age breakdown with Incident.Age.Days source and mapping highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/age-breakdown.png)

![The Incident.Age.Days breakdown source showing the Incident Age Ranges bucket group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/incident-age-days-bkdown-source.png)
...
![Incident Age Ranges bucket group buckets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/incident-age-ranges-bucket-group.png)

Here is the result of running this script on the Number of open incidents indicator.

![Analytics Hub for the Number of open incidents indicator showing the Age breakdown.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-age-breakdown.png)
