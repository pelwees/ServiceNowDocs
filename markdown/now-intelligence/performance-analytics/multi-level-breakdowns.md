...
-   Formula indicators with only non-scripted, automated [contributing indicators](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/performance-analytics-glossary.md#)
...
![Dashboard with visualizations of an indicator that supports multiple breakdowns and one that does not.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../par-for-workspace/image/mlb-dashboard.png)
...
![An indicator that supports multiple breakdown with three breakdowns applied.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../par-for-workspace/image/mlb-supported.png)
...
![An indicator that does not support multiple breakdowns, showing that only the first two of three breakdowns applied to the dashboard are applied to the indicator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../par-for-workspace/image/mlb-not-supported.png)
...
![KPI Details for an indicator that supports multiple breakdowns, with two breakdowns selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/mlb-kpi-details-2-filters.png)
...
![KPI Details for an indicator that supports multiple breakdowns, with three breakdowns selected but no data from before the implementation of multiple breakdowns.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/mlb-kpi-details-3-filters.png)

-   **[Activate Data snapshots](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/activate-unlimited-breakdowns.md#)**  
...
-   **[Limitations and requirements for Data snapshots](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../reference/limitations-mlb.md)**  
Several features of indicators and breakdowns are not supported with Data snapshots and multiple breakdowns.
-   **[Data snapshots sources and collection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../reference/tables-unlimited-breakdowns.md)**  
Data snapshots include data sources for indicator score collection and the mapping between indicators and these sources.
-   **[Create a Data snapshots automated indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/create-ds-automated-indicator.md)**  
...
-   **[Create a Data snapshots formula indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/create-ds-formula-ind.md)**  
Create a formula indicator to calculate a score from two or more Data snapshots indicators.
-   **[Deactivate Data snapshots for an indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/deactivate-mlb-for-indicator.md)**  
