...
2.  Press **Check instance eligibility** to see if your instance is eligible for Data snapshots and, if not, why.
    ...
    ![Indicator library with Data snapshots eligible on the instance.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../par-for-workspace/image/kpis-ds-enabled.png)

3.  Expand **Edit list columns** ![Edit list columns button and tooltip.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/edit-list-columns.png) and add the Data snapshots status and Fact table row count columns.

    If the number of table rows exceeds the license limit, the column Fact table row count has the value `true`.

    ![Adding the Data snapshots status column to the Indicator library.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/edit-columns.png)
...
5.  Select one or more indicators in the list and press **Enable Data Snapshots \(quantity of indicators selected\)**.
    ...
    ![Modal that your facts table has exceeded size limitations for activating Data snapshots.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ds-table-size-modal.png)
...
To see why a specific indicator does not support Data snapshots \(Data snapshots status = unsupported\), you can examine its indicator record. Select the Edit icon ![Edit icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../../administer/process-mining/image/edit-icon.png) for that indicator to open its record. Decide whether to alter the indicator and try to activate Data snapshots for it.
...
[Create a Data snapshots automated indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/create-ds-automated-indicator.md)

[Create a Data snapshots formula indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/create-ds-formula-ind.md)
...
2.  Select Edit ![Edit icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../../administer/process-mining/image/edit-icon.png) to open the indicator record.
    ...
    ![Example message of reasons an indicator does not support Data snapshots.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ds-indicator-unsupported-reasons.png)
...
5.  Select **Enable Data Snapshots**.
    ...
    ![The enable Data snapshots button on an indicator record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/indicator-top-right-buttons.png)

    A modal opens explaining the process of enabling Data snapshots:

    -   That the indicator will be linked to an appropriate [Data snapshots source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../reference/tables-unlimited-breakdowns.md) if one exists
...
![Classic and Data snapshots sources in Source tab of indicator record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/classic-and-ds-sources.png)
