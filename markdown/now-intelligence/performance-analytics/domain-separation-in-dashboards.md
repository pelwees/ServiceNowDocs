...
-   Only dashboards that have been shared are visible to other users. See [Share a responsive dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/t_ControlAccessToADashboard.md).
...
![List of company departments in separate domains including IT, CS, and HR](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../reporting/image/domains-list-example.png "Domains list example")
