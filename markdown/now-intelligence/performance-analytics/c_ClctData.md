...
-   **[Collect historical data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/t_RunHistoricalDataCollection.md)**  
...
-   **[Create or schedule a data collection job](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/t_CreatASchedDataCollJob.md)**  
Schedule a data collection job to regularly collect Performance Analytics indicator scores and snapshots.
-   **[Configure a job indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/configure-job-indicator.md)**  
Increase the efficiency of data collection by configuring job indicators to collect only necessary and sensible data.
-   **[Cancel a data collection job](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../task/cancel-pa-dc-job.md)**  
