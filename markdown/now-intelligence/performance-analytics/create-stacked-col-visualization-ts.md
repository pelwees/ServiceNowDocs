...
![Four indicators for regional sales centers stacked in each column to show both the relative contribution and the sum of all regions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/stacked-column-time-series.png "Stacked column visualization - time series")
