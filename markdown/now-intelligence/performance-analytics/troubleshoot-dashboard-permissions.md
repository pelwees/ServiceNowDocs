...
-   RTR = Restrict to Roles
    ...
    For more information, see [Restrict responsive dashboard access to specific roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../../dashboards/task/restrict-dashboard-access-to-certain-roles.md).
