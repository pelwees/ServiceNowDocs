...
![The overview tab of the Analytics Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-overview.png "Overview tab")
...
![Score section of Analytics Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-score.png "Score section showing compliance with a target")
...
![Score time period navigation buttons showing real-time option](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ds-overview-period-nav.png "Selecting to show real-time score") ![The Score section of the Analytics Hub with the calendar expanded to show that real-time scores are selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-overview-real-time.png "Selecting to show real-time score")

**Note:** You can show real-time scores to dashboard users in some widgets. For more information, see [Real-time scores](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/real-time-scores.md).
...
![Possible time series aggregations for a daily indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-monthly-agg.png "Menus of daily time series aggregations")
...
-   ![Calendar for setting time period](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-calendar.png "Date range calendar")

-   The sliders with the navigation bar: ![Navigation bar consisting of sliders and graph for setting the time period](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-slider.png)
...
![Breakdown and element search field and icon for opening breakdown and element selector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-breakdown.png "Breakdown menu and search field")

If you select a breakdown but not an element, the chart shows each element of the breakdown.

![With the Priority breakdown selected but no elements selected, the chart shows a line for each element of Priority.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-breakdown-elements.png "Chart with all elements of a breakdown")
...
![With Priority of Low selected, the score, the statistics, and the chart show only the incidents that match Priority=Low.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-one-element.png "Analytics Hub filtered to show only low-priority incidents")

If the breakdown has an elements filter defined for its breakdown source, you can choose one of those elements filters. For more information, see [Element filters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/c_BreakdownElementFilters.md#).

![Breakdown and element selector on Analytics Hub showing elements filters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ah-elements-filter.png "Element filter")
...
![Analytics Hub showing breakdown relations between parent and child elements in the same breakdown](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/child-locations.png "Breakdown relations")
...
![With Category: Software the first breakdown and element selected, the user is selecting from the elements of the Priority breakdown.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-bkdown-element-filtr.png "Selecting breakdowns and elements")

The following animation shows the selection and clearing of a first- and second-level breakdown and element:

![Setting and clearing breakdown and element](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-bkdown.gif)
...
![Clicking on a score that is the aggregate of all the selected elements in a widget on a breakdown dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ah-from-multi-element-aggregate.png "Analytics hub with aggregate score of three elements")
...
![Analytics Hub showing the Software, Hardware, and Database elements of the Category breakdown selected from a breakdown dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ah-multi-element.png "Analytics Hub with multiple elements")
...
![Icons that change the chart display.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-timeseries-icons.png "Chart option icons")
...
![Chart showing score, trend, confidence band, forecast, target, and threshold](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/ah-busy-chart.png "Chart showing multiple options selected")
...
![Expanded drop-down list showing the available chart visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/performance-analytics/../image/detailed-scorecard-visualizations.png "Available chart visualizations")
