...
From the Improvement Opportunities icon \(![Improvement opportunities icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../image/icon-imp-opp.png)\) on the side panel, you can choose which improvement opportunity you want to view in detail.

![List of improvement opportunities for the project](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../image/opp-det-listofimp.png)

After selecting an improvement opportunity, all details for that improvement opportunity are provided.

![Opportunity details page after generating highlights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../image/opp-det-page.png)
...
![Breakdowns tab in the highlights section of the Opportunities page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../image/highlights-breakdowns.png)
...
![Variants tab in the highlights section of the Opportunities page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../image/highlights-variants.png)

## Task Mining

Create a Task Mining project from opportunity details page. For more information on creating Task Mining project, see [Create Task Mining project](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/create-task-mining-project.md).
