...
2.  Select a table from the list if you want to configure work notes analysis for a table available in the list.
    ...
    If you don’t have the table listed, select **New**. For more information, see [Create process configuration using Classic view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/create-process-config.md).

    **Note:** For information on configuring work notes analysis using the Process Configuration Builder, see [Configure investigative features](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/investigative-features.md).

    ![Configure Work notes Analysis](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../image/worknotes-configure.png)
