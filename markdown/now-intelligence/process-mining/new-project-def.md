...
The PAR dashboard \[par\_dashboard\] associated with this project. Select an existing dashboard or use the Plus \(+\) icon to create a dashboard.
 ...
 For details on creating these dashboards, see [Create and use dashboards](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../../../use/dashboards/concept/create-and-edit-dashboards.md)
