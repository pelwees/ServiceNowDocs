...
For the detailed procedure of configuring intent and activity analysis for a process table, see [Configure investigative features](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../task/investigative-features.md).

There are system properties that determine how process inefficiency work. For information about the system properties, see [Intent and agent activity analysis properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/process-mining/../concept/data-cleanup.md#).
