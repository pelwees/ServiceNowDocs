...
3.  Select the Boxplot \(![vertical box icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/inline-data-vis-box.png)\) visualization type.
...
6.  Configure the data settings as described in [Table data options for boxplot visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-box-table-data.md).
...
-   **[Table data options for boxplot visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-box-table-data.md)**  
