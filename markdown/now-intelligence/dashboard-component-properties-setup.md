...
Hides the Create Dashboard option in the 3-dot menu of the Dashboard page. Users can still create dashboards from the Analytics Center or the dashboards library \(Dashboard Overview component\).When false:
 ...
 ![3-dot menu of dashboards when Disable dashboard creation is off.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/hide-create-dashboard-false.png)

 When true:

 ![3-dot menu of dashboard page when Disable dashboard creation is on.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/hide-create-dashboard-true.png)
