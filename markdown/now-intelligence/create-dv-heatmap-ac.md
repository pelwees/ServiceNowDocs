...
3.  Select the Heatmap \(![Heatmap icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../image/inline-data-vis-heatmap.png)\) visualization type.
...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for heatmap visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-heatmap-table.md).
    -   If your visualization represents indicator data, go to [Indicator data options for heatmap visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-heatmap-ind.md).
...
-   **[Table data options for heatmap visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-heatmap-table.md)**  
When you select a table data source for a heatmap visualization, the following Data configuration options are available.
-   **[Indicator data options for heatmap visualizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../reference/config-dv-heatmap-ind.md)**  
...
-   **[Heatmap visualization example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/now-intelligence/../../par-for-workspace/task/dv-example-heatmap.md)**  
