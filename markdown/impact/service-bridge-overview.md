...
For information on configuring the data transfer between the Impact Store Application and the Impact Delivery Instance see [Configure the Impact Store Application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/configuring-impact-platform.md).
