...
2.  From the **Performance** menu, select **Transactions/Response Times**.
    ...
    ![Anomaly reporting options configuration section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../image/io-anomaly-config.png)
...
4.  Select **Get Snapshot**.
    ...
    **Note:** Options available on Report and Charts:
    ...
    ![Configure anomaly alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../image/io-anomaly-alert-tab.png)
...
**Parent Topic:**[Anomalies detection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/anomalies-detection.md)
