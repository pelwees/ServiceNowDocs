...
1.  [Use Guided Setup to onboard users to the Impact Store Application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/onboard_users_impact_store_application.md).
...
4.  Create Development Teams.
    ...
    3.  Create the relevant development teams assigned to the appropriate team lead.
        ...
        See [Configure scanning properties per persona](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../concept/teamdev-scanning-properties.md#) for additional information on assigning team leads to development teams.
...
[Activate Scan Engine and review settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/configure-initial-scan-engine-settings.md)
...
**Previous topic:**[Use Guided Setup to onboard users to the Impact Store Application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/onboard_users_impact_store_application.md)

**Next topic:**[Activate Scan Engine and review settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/configure-initial-scan-engine-settings.md)
