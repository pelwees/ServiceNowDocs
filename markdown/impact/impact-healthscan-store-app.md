...
For more information, see [Scan Engine definitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/scan-engine-definitions.md).
...
See [Run your first scan with the Scan Engine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../task/run-scan-engine.md) for first time setup.
...
**Note:** See [Configure Scan Engine properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../task/configure-scan-engine-properties.md) for on-demand scan configuration options.
...
**Note:** See [Configure update set scanning properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../task/update-set-scanning-properties.md) for details.
...
Scan applications to identify definition findings before publishing to the application repository. **Note:** See [Initiate application scans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../task/initiating-on-demand-scans-scan-engine.md)for details.

</td></tr></tbody>
</table>## Configuration overview

For more information on configuring and running the Scan Engine, see [Running on-demand scans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/../task/using-impact-scan-engine.md), and [Analytics Dashboards](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/impact/scan-engine-diagnostic-dashboards.md).
