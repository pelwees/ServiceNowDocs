...
![Threat Lookup - VirusTotal workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../image/hreat-lookup-virustotal-wf.png "Threat Lookup - VirusTotal workflow")

For information on the activities used by this workflow, see [Common Security Operations integration flows and orchestration activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../../security-operations-common/concept/common-wf-activities.md).
