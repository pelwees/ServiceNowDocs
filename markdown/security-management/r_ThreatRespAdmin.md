...
|-----------|-----------|
|Properties|Threat Intelligence [properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../concept/c_GetStartedWithThreatIntel.md#) allow you to control how different aspects of the system function, including the setting of API keys.|
