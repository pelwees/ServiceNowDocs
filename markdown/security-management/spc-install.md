...
1.  Download the required applications from the ServiceNow Store into your ServiceNow instance.
    ...
    See [Creating your own API connectors in Security Posture Control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../concept/spc-creating-sgc-template.md) for more information.

    For more information about downloading and activating applications, see the following topics:

    -   [Download an application from the ServiceNow Store for the first time](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-incident-response/reference/download-app-first-time.md).
    -   [Activate a ServiceNow Store application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-incident-response/task/activate-entitled-store-app.md).
