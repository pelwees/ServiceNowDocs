...
-   Your search criteria and results remain displayed in the Now Assist panel until you reset the conversation. To reset your conversation, select the Now Assist more options icon \(![More options menu icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../image/now-assist-reset-icon.png)\) in the panel and select **Reset Conversation**.
