...
-   [Configuring Now Assist for Security Incident Response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/configuring-now-assist-for-security-operations.md)
-   [Summarize a security incident with Now Assist for Security Incident Response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../task/summarize-security-incident-now-assist-sec-incident.md)
-   [Generate closure notes for a security incident with Now Assist for Security Incident Response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../task/generate-closure-notes-si-now-assist-sec-incident.md)
-   [Generate correlation insights with Now Assist for Security Incident Response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../task/generating-insights-for-now-assist-for-security.md)
-   [Generate recommended actions for a security incident with Now Assist for Security Incident Response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../task/generate-recommended-actions-now-assist-for-security.md)
...
-   [Analyze security operations metrics agentic workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../task/assess-metrics-sir-aiagent.md)
-   [Inputs and triggers for Now Assist for Security Incident Response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/now-assist-for-security-incident-response-sir/../reference/input-triggers-now-assist-security-incident.md)
