...
3.  Click **Submit**.
    ...
    For more information about state transitions, see [Test result and remediation task state transitions in the Configuration Compliance application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/configuration-compliance/../concept/cc-state-transition.md).
