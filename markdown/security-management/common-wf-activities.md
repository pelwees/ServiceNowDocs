...
-   **[Execution Tracking - Begin Flow Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/execution-tracking-begin.md)**  
...
-   **[Capability Execution Tracking - Complete Flow Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/capability-execution-tracking-complete.md)**  
The Capability Execution Tracking - Complete flow action updates the audit record when the flow is complete.
-   **[Capability Execution Tracking- Failure Flow Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/capability-execution-tracking-failure.md)**  
The Capability Execution Tracking - Failure flow action records a failure to the audit record.
-   **[Capability - Determine CIs activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-integrations/reference/determine-cis-activity.md)**  
The Capability - Determine CIs workflow activity determines which configuration items \(CIs\) to include in the workflow.
-   **[Create Enrichment Data records Flow Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/create-enrich-data-records.md)**  
The **Create enrichment data records** flow action creates or updates enrichment records to use in the flow.
-   **[Get Configuration Item FQDN Flow Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-orchestration/reference/get-config-FQDN-activity.md)**  
...
-   **[Determine Observables activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-integrations/reference/determine-observables-activity.md)**  
The **Determine Observables** workflow activity determines which observable to include in the workflow
-   **[Get Supported Security Capabilities action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-integrations/reference/get-supported-security-capabilities-activity.md)**  
...
-   **[Capability Execution Tracking- No Impls action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-integrations/reference/execution-tracking-noimpls-activity.md)**  
...
-   **[Create Compliance Search Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../secops-integration-sir/secops-integration-ms-exchange-on-prem/reference/get-email-details-from-exch-server.md)**  
...
-   **[Get IP from CI activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-orchestration/reference/get-IP-from-CI-activity.md)**  
This workflow activity determines the IPV4 address associated with a configuration item \(CI\).
-   **[Get Network Statistics via netstat Flow Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-orchestration/reference/get-network-stats-netstat-activity.md)**  
...
-   **[Get running processes via WMI activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-orchestration/reference/get-running-process-WMI-activity.md)**  
...
-   **[Check Compliance Search Status Action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../secops-integration-sir/secops-integration-ms-exchange-on-prem/reference/search-delete-email-threat-exchange.md)**  
...
-   **[Roll up lookup info to security incident activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../threat-intelligence-orchestration/reference/r_RollUpScanInfoSI.md)**  
...
-   **[Filter Allowlisted Observables activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-integrations/reference/filter-whitelisted-observables-activity.md)**  
...
-   **[Write content to record as attachment activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-orchestration/reference/write-content-record-attachment-activity.md)**  
This activity writes the content passed in from an input and creates a designated attachment to a given record.
-   **[Get IP from CI activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../../security-operations-integrations/reference/get-ip-from-ci-activity.md)**  
