...
5.  Click **Reload** to confirm the changes.
    ...
    The following illustration shows how to select an observable and roll up the Threat Lookup results to the security incident.![Manually rollup threat lookup results.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../image/mitre-rollup-threat-lookup.gif)
