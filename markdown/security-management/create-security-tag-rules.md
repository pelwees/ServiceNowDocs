...
5.  Choose or [create a security tag](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/create-class-group-and-tags.md).
