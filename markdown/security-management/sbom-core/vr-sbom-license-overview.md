...
-   Alternatively, navigate to **Workspaces** &gt; **SBOM Workspace** &gt; **License administration** &gt; **License classification**.
    ...
    For information on how to classify licenses, see [Classify imported licenses in the Software Bill of Materials Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/sbom-core/../task/vr-sbom-classify-license.md).
