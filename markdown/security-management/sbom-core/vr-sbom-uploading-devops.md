...
See [Uploading Software Bill of Materials files using a REST API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/sbom-core/vr-sbom-preparing-upload.md) for more information about \(POST\) and \(GET\) parameters and URLs for the Upload and Status APIs.
