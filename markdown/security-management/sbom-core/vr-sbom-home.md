...
5.  Select the tabs on the entity record to review the data.
    ...
    3.  Select the **Vulnerabilities** tab to see the vulnerabilities associated with a dependency of this entity.
        ...
        For more information about the vulnerabilities displayed for an entity, see [View upload status for Software Bill of Materials files](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/sbom-core/../task/vr-sbom-bom-queue.md).
