...
For example, you can use the email address field to identify the end user.
    ...
    ![Create the assignment rules for your Data Loss Prevention Incident Response incidents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/data-loss-prevention/../image/dlp-assignment-rule.png "DLP Assignment rule")
