...
2.  Select **Risk and compliance** label from the list on the left of the dashboard.
    ...
    ![Unified Cybersecurity Executive Dashboard for risk, and compliance metrics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/../image/cybersecurity-executive-dashboard.png "Unified Cybersecurity Executive Dashboard for risk and compliance metrics")
