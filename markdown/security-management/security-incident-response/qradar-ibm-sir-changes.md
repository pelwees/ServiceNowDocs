...
![IBM QRadar: SIR: Worknote](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-sir-worknote.png)
...
![IBM QRadar: Internal Offense Record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-offense-record.png)
...
![IBM QRadar Aggregated Offenses](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-offense-aggregate.png)
...
![IBM QRadar Aggregated Offenses: Create and Delete](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-offense-aggregate-create.png)
...
![IBM QRadar Offense Updates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-offense-updates.png)
...
![IBM QRadar: Recent Events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-recent-events.png)

By default, a maximum number of 100 events are displayed. You can modify this default setting in the [Configuration settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/qradar-ibm-intg-settings.md).
...
![IBM QRadar: Recent IBM QRadar Events: List View](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-recent-events-custom.png)
...
![IBM QRadar: Recent Flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-recent-flows.png)

By default, a maximum number of 100 flows are displayed. You can modify this default setting in the [Configuration settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/qradar-ibm-intg-settings.md).
