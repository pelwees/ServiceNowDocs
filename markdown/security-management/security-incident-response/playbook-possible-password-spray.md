...
-   **[Set up the Possible Password Spray playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-possible-password-spray.md)**  
Use the following steps to set up the Possible Password Spray playbook.
-   **[Use the Possible Password Spray playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-possible-password-spray.md)**  
