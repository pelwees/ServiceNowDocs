...
![Executive Status Report Email](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/msim-executive-report-email.png "Executive Status Report Email")
...
![Executive Status Report PDF](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/executive-reports-01.png "Executive Status Report PDF")
...
![Technical Status Report PDF](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/msim-technical-status-report.png "Technical Status Report - PDF")
...
1.  Branding: [Add Branding to your Report Templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/add-branding-to-your-report-templates.md)
2.  Template Scripts: [Use Template Scripts in your Report Templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/using-template-scripts-in-your-report-templates.md)
3.  [Use Visualizations in Report Templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/using-widgets-in-your-report-templates.md)
4.  [Use Reports Lists in Report Templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/using-reports-lists-in-your-report-templates.md)

-   **[Create a Report Template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/create-report-template.md)**  
...
-   **[Create a Report Section Template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/create-report-section-template.md)**  
...
-   **[Create a Report Subsection Template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/create-report-subsection-template.md)**  
...
-   **[Create Report Subsection Element template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/create-report-subsection-element-template.md)**  
...
-   **[Add system properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/adding-system-properties-to-your-status-reports.md)**  
...
**Parent Topic:**[Managing MSIM status reports](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/reports-and-metrics.md)
