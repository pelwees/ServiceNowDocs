...
4.  In the Carbon Black - Incident Enrichment card, click **Configure**.
    ...
    ![Configure Carbon Black - Incident Enrichment integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/carbonblack-config-inc.png)
