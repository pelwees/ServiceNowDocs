...
![Work notes in SIR.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/sentinel-worknotes.png "Viewing work notes in SIR")
...
![View the incident raw data in SIR.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/sentinel-incident-raw.png "Viewing the incident raw data in SIR")
...
![Incident record in Azure Sentinel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/sentinel-record.png "Viewing the incident record in Azure Sentinel")
...
![Incidents that are aggregated to the security incident.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/Sentinel-aggregated-related-lists.png)
...
![Security incident and de-aggregate from the parent security incident.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/sentinel-create-incident.png)
...
![Alerts that are associated with the Sentinel incident that triggered the security incident.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/azure-sentinel-alerts.png "Azure Sentinel Alerts")
