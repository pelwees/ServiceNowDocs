...
2.  Drag the field name, for example, `description`, and drop it on a field in the Input Expression column next to a field name in the Security Incident column.
    ...
    ![IBM QRadar: Create Profile: Mapping: SIR1](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-profile-mapping-sir1.png)
...
To use the script editor, select the ![IBM QRadar: Create Profile: script icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-mapping-script-icon.png). The script editor is displayed.

![IBM QRadar: Create Profile: Script Editor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-mapping-script-editor.png)
...
4.  \(Optional\) In the second row, set a second filter condition.
    ...
    ![IBM QRadar: Create Profile: Mapping: SIR5](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-mapping-sir5.png)
...
2.  From the Available list, select the field values that you want to match on existing security incidents in your ServiceNow AI Platform and move them to the Selected list.
    ...
    ![IBM QRadar: Create Profile: Mapping: Aggregation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/ibm-qradar-profile-mapping-agg.png)
