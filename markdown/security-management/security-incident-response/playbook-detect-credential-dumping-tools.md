...
-   **[Set up the T1003 - Detect Credential Dumping Tools playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-detect-credential-dumping.md)**  
Use the following steps to set up the T1003 - Detect Credential Dumping Tools playbook.
-   **[Use the T1003 - Detect Credential Dumping Tools playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-detect-credential-dumping.md)**  
