...
1.  [Install and configure Shodan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/install-and-configure-shodan.md)  
...
2.  [Verify expected results for Shodan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/shodan-verify-expected-results.md)  
...
3.  [\(Optional\) Manually attach an observable for Shodan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/manually-attach-an-observable-shodan.md)  
