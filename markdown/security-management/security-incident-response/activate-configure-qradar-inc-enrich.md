...
4.  In the IBM QRadar - Incident Enrichment card, click **New**.
    ...
    ![IBM QRadar - Incident Enrichment Configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/QRadar-config.png)
...
**Parent Topic:**[IBM QRadar - Incident Enrichment Integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/qradar-landing-page.md)
