...
1.  [Supported observables for RISKIQ and RISKIQ WHOISIQ](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/riskiq_supported_obsv.md)  
...
2.  [Install and configure RISKIQ and WHOISIQ](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/install-and-config-riskiq.md)  
...
3.  [Verify expected results for RISKIQ SSL certificate lookups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/verify-expected-rslts-for-riskiq.md)  
...
4.  [Verify expected results for WHOISIQ URL lookups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/verify-expctd-rslts-url-lookups-riskiq.md)  
...
5.  [Create an observable for manual WHOISIQ lookups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/manually-attch-obsv-whoisiq.md)  
...
6.  [Verify expected results for manual WHOISIQ lookups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/verify-expected-rslts-whoisiq.md)  
