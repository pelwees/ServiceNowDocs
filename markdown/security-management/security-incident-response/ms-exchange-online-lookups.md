...
1.  [Set up your Microsoft Azure account](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/ms-azure-account.md)  
...
2.  [Install Microsoft Exchange Online application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/install-and-configure-ms-exchange-online.md)  
...
3.  [Configure the Microsoft Exchange Online integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/msx_configure.md)  
...
4.  [Define email search criteria and request a search on the Microsoft Exchange Online service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/verify-expected-results-ms-exchange-online.md)  
...
5.  [Request delete approval for emails on Microsoft Exchange online service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/ms-delete-email.md)  
...
6.  [Approve delete email requests for the Microsoft Exchange Online integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/ms-approve-delete.md)  
...
7.  [Recover deleted emails on the Microsoft Exchange Online service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/ms-recover-deleted-emails.md)  
...
8.  [Edit security tags for the Microsoft Exchange Online integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/ms-edit-tags.md)  
