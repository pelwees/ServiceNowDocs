...
-   **[Set up the Credential Sniffing playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-credential-sniffing.md)**  
Use the following steps to set up the Credential Sniffing playbook.
-   **[Use the Credential Sniffing playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-credential-sniffing.md)**  
