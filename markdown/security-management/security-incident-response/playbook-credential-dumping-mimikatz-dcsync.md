...
-   **[Set up the T1003 - Credential Dumping - Mimikatz DCsync playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-credential-dumping-mimikatz-dcsync.md)**  
Use the following steps to set up the T1003 - Credential Dumping - Mimikatz DCsync playbook.
-   **[Use the T1003 - Credential Dumping - Mimikatz DCsync playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-credential-dumping-mimikatz-dcsync.md)**  
