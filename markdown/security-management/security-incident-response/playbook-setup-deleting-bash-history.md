...
3.  Create a copy of the User Deleting .bash\_history - Cloud playbook flow and make the necessary modifications.
    ...
    ![Overview of the User Deleting Bash History - Cloud playbook.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/playbook-bash-history-overview.png "User Deleting Bash History - Cloud playbook")
...
5.  Set a **Trigger Condition** for the playbook.
    ...
    ![Trigger condition for User Deleting Bash History playbook.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/playbook-bash-history-trigger.png "User Deleting Bash History - Cloud playbook trigger condition")
