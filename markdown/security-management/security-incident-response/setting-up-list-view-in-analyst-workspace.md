...
To get to the list view, select the list icon \(![list view icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/listview-icon.png)\). When you select a record in a list view, the record opens in a new tab.

## List types

The following gives you an example view of the lists.

![Landing page list view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/landing-page-list-view.png)
...
-   Report Phishing Email. For more information, see [Report Phish Email](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/report-phish-email.md) on how to report a phishing email.
...
</table>-   **[Personalize a list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/personalize-a-list.md)**  
...
**Parent Topic:**[Exploring SIR Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/exploring-security-incident-response-workspace.md)

**Related topics**  


[SIR Workspace plugins](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/components-installed-with-analyst-workspace.md)

[SIR Workspace features](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/key-features.md)

[SIR Workspace interface overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/overview.md)
...
[Quick links section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/quick-links.md)

[Shift Handover Records section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/shift-handover-records-section.md)
