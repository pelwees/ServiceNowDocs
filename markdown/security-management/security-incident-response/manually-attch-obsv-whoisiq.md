...
1.  Navigate to **All** &gt; **IoC Repository** &gt; **Observables**.
    ...
    ![Enter Observables in the navigation panel.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-obs-enter.png "Enter Observables in navigation filter")

    Under the navigation panel, the Observables module is displayed.

    ![Observables module.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-obsv-navfilter.png "Observables module")

2.  Click the **Observables** module to display the Observables list.

    ![Observables list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-o-list.png "Observables list")
...
4.  On Observable form, fill in the fields.
    ...
    ![Enter a value in the field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-testmail-new.png "Create a new observable")
...
6.  Edit the **Observable type** field to change the type from **Unknown** to **Email address** to match your observable.
    ...
    1.  In the **Observable type** column, single-click to the right of the **Unknown** text to select it.
        ...
        ![Click off of the text and in the column to select the field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-test1email-unknown.png "Select the Observable type field")
    ...
    3.  In the field that is displayed, enter the observable type \(`Email address`\) and click the green check mark to save the value.
        ...
        ![Enter the observable type in the editor and click the green check to save it.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-test1email-edit.png "Edit the Observable type field")

        In the **Observable type** column on the list, `Email Address` is displayed for your new observable.

        ![Observable type field updated with new observable.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/riskiq-test1email-edited.png "Updated Observable type field")
...
**Previous topic:**[Verify expected results for WHOISIQ URL lookups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/verify-expctd-rslts-url-lookups-riskiq.md)

**Next topic:**[Verify expected results for manual WHOISIQ lookups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/verify-expected-rslts-whoisiq.md)
