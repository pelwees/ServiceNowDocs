...
1.  Navigate to **All** &gt; **Palo Alto Networks NGFW Integration** &gt; **Firewall EDL Configuration**.
    ...
    ![Select Firewall EDL Configuration module.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-fedl-nav.png)

2.  Select the EDL module and click an EDL in the **Name** column.

    ![Select an EDL from the Name column.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edl-arrow.png)

3.  In the open EDL record, click the change request number in the Change Requests related list.

    ![Task: Select the change request.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edl-app-notactive.png)
    ...
    ![Work notes with text requesting the addition of a new EDL.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-1-shrtdescr.png)
...
4.  In the upper-right corner of the record, click **Request Approval**.
    ...
    ![Change request in Assess state.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-2.png)
...
5.  To complete the change request and activate the EDL, follow the steps to assign the tasks and close the change request.
    ...
    1.  If not displayed, open the change request and select the **Change Tasks** tab.
        ...
        ![Change Tasks tab on the change request.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-task-1.png)

    2.  Click the task associated with creating the EDL object to open it.

        ![Task to create the EDL Object highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-task-1-first.png)
    ...
    3.  On the record that is displayed, assign the task to the Palo Alto Networks firewall administrator, and click **Update**.
        ...
        ![Task: Copy Retrieval URL to create the EDL object.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-pa-1-dialog-5-7.png)
    ...
    5.  Navigate to the Change Tasks tab and click the task for assigning a firewall policy to the EDL Object.
        ...
        ![Task: Assign EDL to a firewall policy highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-task-2-a.png)
    ...
    6.  Open the record and assign the next task.
        ...
        ![Task to navigate to Policies in Palo Alto Networks.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-pa-2-box.png)
    ...
    7.  In the **Name** column, locate and click the security policy rule you want to add the EDL to, for example, **ServiceNow ip edl list**.
        ...
        ![Task to select an EDL.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-pa-2-arrow.png)
    ...
    9.  To view all the available EDLs, click the **Add** icon.
        ...
        ![Task to select Destination Address.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-obj-to-policy-pa.png)
    ...
    12. On the change request record, click the **Approvers** related list, and select an item in the **State** column to open the request used for creating the EDL.
        ...
        ![Approval requests for security incident admin listed on change request.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-paloalto-my-approvals-4-2-cropped.png)

    13. On the open approval request form, click **Approve**.

        The change request state moves to Scheduled.

        ![Change request in Scheduled state.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-3.png)
    ...
    15. Click the **Closure Information** related tab and enter notes to close the request.
        ...
        ![Close notes entered and change request completed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/edl-apprv-closenotes.png)
        ...
        ![Activated EDL in Firewall EDL Configuration list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edl-list-active-callout.png)

        In the Name column, click the EDL name, and in the open record, note that the **Active** check box is also selected.

        ![EDL activated with check box selected on EDL record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-apprv-4.png)
...
**Parent Topic:**[Activate an EDL for Palo Alto Networks Next-Generation Firewall](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/paloalto-activate-edl.md)
