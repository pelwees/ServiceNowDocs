...
5.  In the Additional Configuration section, select the **Define Alternative Field** option to define an alternative input field.
    ...
    **Note:** For more information, see [Trigger conditions in a configuration item](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/trigger-conditions-configuration-item.md).
