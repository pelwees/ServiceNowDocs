...
![System tree in ePO console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee_newtab.png "PODClient")
...
-   **[Configure profiles and security incidents for system enrichment queries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/mcafee-epo-configure-profile.md)**  
Configure your profile settings so that the profile triggers only under the conditions that you set.
-   **[Configure a profile to initiate malware scan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/mcafee-epo-config-scan-malwr.md)**  
