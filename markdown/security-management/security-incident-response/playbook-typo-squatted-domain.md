...
-   **[Set up the Typo Squatted Domain playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-typo-squatted-domain.md)**  
Use the following steps to set up the Typo Squatted Domain playbook.
-   **[Use the Typo Squatted Domain playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-typo-squatted-domain.md)**  
