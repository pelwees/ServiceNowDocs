...
-   **[Set up the T1070 - Windows Events Logs Cleared playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-windows-events-logs.md)**  
Use the following steps to set up the T1070 - Windows Events Logs Cleared playbook.
-   **[Use the T1070 - Windows Events Logs Cleared playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-windows-events-logs.md)**  
