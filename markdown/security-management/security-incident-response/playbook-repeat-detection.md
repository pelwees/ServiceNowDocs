...
-   **[Set up the Repeat Detection playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-repeat-detection.md)**  
Use the following steps to set up the Repeat Detection playbook.
-   **[Use the Repeat Detection playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-repeat-detection-playbook.md)**  
