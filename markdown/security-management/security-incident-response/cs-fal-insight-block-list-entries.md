...
2.  Select **Entry Value**.
    ...
    For a description of the field values, see [Allow and Block Request List Entries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/allow-and-block-list-properties.md).
