...
3.  In the Scheduled Script Execution record that is displayed, click **Execute Now**.
    ...
    ![Execute Now button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/scheduledjob02__job_detail_with_execute_now_button.png)
