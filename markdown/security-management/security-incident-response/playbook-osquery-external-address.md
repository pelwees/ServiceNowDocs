...
-   **[Set up the OSquery of External Address in the /etc/hosts file playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-osquery-external-address.md)**  
Use the following steps to set up the OSquery of External Address in the /etc/hosts file playbook.
-   **[Use the OSquery of External Address in the /etc/hosts file playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-osquery-external-address.md)**  
