...
4.  Tap the Back arrow \(![Back icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/back.jpg)\) or **DONE** to save your changes to a field.
...
6.  Tap the intersection icon ![Intersection filter icon for AND.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../../vulnerability-response/image/mobile-filter-1.jpg) to create AND conditions.

    Alternatively, tap the intersection icon ![Union filter icon for OR.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../../vulnerability-response/image/mobile-filter-2.jpg) to create OR conditions.
