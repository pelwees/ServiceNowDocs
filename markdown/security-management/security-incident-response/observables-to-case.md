...
8.  Select the case\(s\) from the **Add to Case** dialog box.
    ...
    ![Add to TISC Case.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/tisc-add2-case-modal.png)
