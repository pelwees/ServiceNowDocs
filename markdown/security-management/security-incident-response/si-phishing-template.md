...
![Spear phishing workflow template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/spear-phishing-wf-template.png "Spear Phishing")

## Procedure

1.  Open the security incident for this potential spear phishing attack, or [create a new security incident](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../../security-incident-response/task/t_ManuallyCreateSecurityIncident.md).
