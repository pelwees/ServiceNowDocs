...
4.  Browse and select a profile with **Remove Isolation capability** selected from the list of available profiles, and click **Submit**.
    ...
    ![Remove Isolation capability in Microsoft Defender for Endpoint](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/remove_isolation.png "Remove Isolation")
