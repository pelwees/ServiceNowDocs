...
If an error occurs during authentication, you may see the following screen:![Invalid certificate error](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/new-images/authentication-errors.png)
...
An error condition similar to the following will likely appear: ![Certificate error](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/splunk_es_auth_error1.png)
