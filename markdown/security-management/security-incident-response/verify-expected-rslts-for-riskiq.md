...
2.  Verify that the lookup ran successfully.
    ...
    ![Lookup status in work notes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/flows-riskiq-whois-worknotes-start.png)

    ![Lookup status execution in work notes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/flows-riskiq-whois-worknotes-end.png)
...
-   **[RISKIQ SSL certificate lookups that return an exact match](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/riskiq_ssl_exact_match.md)**  
...
-   **[RISKIQ SSL certificate lookups that return multiple certificates or no certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/riskiq_ssl_no_match.md)**  
...
**Previous topic:**[Install and configure RISKIQ and WHOISIQ](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/install-and-config-riskiq.md)

**Next topic:**[RISKIQ SSL certificate lookups that return an exact match](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/riskiq_ssl_exact_match.md)
