...
</table>        ![ServiceNow Event Ingestion Integration set up on Splunk](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../../secops-integration-sir/secops-integration-splunk-addon/image/splunk-event-ingest-config.gif)
...
[Using ServiceNow Event Ingestion Integration add-on](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/use-v2-addon.md)
