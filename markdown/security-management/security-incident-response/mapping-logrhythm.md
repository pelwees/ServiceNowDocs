...
The next step is to [Map LogRhythm alarm fields to security incident fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/logrhythm-map-alarms.md).

-   **[Map LogRhythm alarm fields to security incident fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/logrhythm-map-alarms.md)**  
...
[Use the script editor to format LogRhythm values](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/add-scripted-values-logrhythm.md)

[Filter alarms for LogRhythm](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/filter-alarms-logrhythm.md)
