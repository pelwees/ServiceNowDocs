...
![Wildfire data enrichment flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/get-wildfire-flow.png "Security Operations Palo Alto Networks - Get WildFire Data Enrichment flow")
...
4.  Click **Update**.
    ...
    **Note:** If the enriched data includes packet capture information, PCAP information is also downloaded. PCAP data captures what actions the file was performing. For example, it can report on what servers the file was contacting. To view PCAP files, you need a packet analyzer, such as [Wireshark](https://www.wireshark.org/).
    ...
    ![Sample PDF report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/wf-pdf-report.png "Sample PDF generated by Wildfire")
