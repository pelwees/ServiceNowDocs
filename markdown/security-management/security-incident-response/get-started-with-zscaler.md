...
Verify that you have the required Zscaler permissions and have configured [access to the Zscaler Internet Access APIs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/configure-zscaler-api-access.md).
