...
-   **[Set up the Office Malicous File Detected playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-setup-office-malicous-file-detected.md)**  
Use the following steps to set up the Office Malicous File Detected playbook.
-   **[Use the Office 365 Malicious File Detected playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/playbook-using-office-malicous-file-detected.md)**  
