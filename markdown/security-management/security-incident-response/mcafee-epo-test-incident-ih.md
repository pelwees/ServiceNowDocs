...
1.  If the Test Incident page is not displayed, click **Test Incident** in the progress bar.
    ...
    ![Test Incident page of a McAfee Capability Profile.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-test-incident1.png)
...
2.  To the right of the top field, click the search icon to select a security incident to preview.
    ...
    ![Search symbol highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-test-incident1-callout.png)
...
3.  In the Number column of the list that is displayed, select an item that you want to display in the preview.
    ...
    ![List of security incidents.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-test-incident2a.png)
...
5.  Click **McAfee ePO Preview** to view the security incidents.
    ...
    ![McAfee ePO Preview button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-test-incident-clk-preview.png)
    ...
    **Note:** If you leave the Test Incident page at this point, your security incidents are cleared from these fields.
    ...
    ![Security incidents displayed on tabs.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-test-incident-4.png)

6.  Select a tab, and, on the security incident, scroll to view the work notes.

    ![Work notes logging when capability tasks are initiated and successfully completed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-notes-pending.png)
    ...
    ![Security incident with Isolate Host Queued tag displayed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-que-tag.png)
...
7.  If you are a user in an approval group, follow these steps to process a request.
    ...
    1.  Navigate to **My Approvals** in your instance.
        ...
        ![My Approvals module highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-maryapprv.png)

        The approvals list is displayed.

    2.  In the State column, click an item to open the approval record.

        ![In My approvals, Requested in State column highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-maryapprv1.png)

    3.  In the Approval record that is displayed, click **Approve** or **Reject**.

        ![On Approval record, Approve and Reject buttons highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-maryapprv2.png)
        ...
        ![Transaction processing message.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-transaction-msg-ih.png)
        ...
        ![In My Approvals, Approved displayed in State column.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-maryapprv3.png)
    ...
    4.  Navigate to **Security Incident** &gt; **Incidents** &gt; **Show All Incidents** and, in the Number column, click an entry to open the security incident that you are working with.
        ...
        ![Show All Incidents highlighted in navigation panel.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-maryapprv-si.png)
        ...
        ![On security incident, Host successfully Isolated security tag.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-iso-tag.png)
        ...
        ![Work notes logging when capability tasks are initiated and successfully completed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-ih-notes-isolated.png)
...
8.  To remove the host from quarantine and return it to the network, follow these steps.
    ...
    1.  If the McAfee ePO Isolate Host Entries table is not displayed, navigate to **McAfee epO Integration** &gt; **Mcafee epO integration Isolate Host Entries**.
        ...
        ![On McAfee ePO Isolate Host Entries table, Status column with Isolated highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-uih-isolated-status.png)
    ...
    2.  In the Added date column, click the item to open the record.
        ...
        ![Isolate Host Entries record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-uih-2.png)
    ...
    3.  Click **Remove Isolation** to launch the workflow to restore the machine to the network.
        ...
        ![Isolate Host Entry record with messages.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-uih-3.png)
    ...
    5.  Click **Approve** to approve the request and return the asset to the network.
        ...
        ![Work notes logging when capability tasks are initiated and successfully completed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/mcafee-remove-notes-cmplt.png)
...
**Previous topic:**[Test security incidents to initiate malware scan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/mcafee-epo-test-incident-malscan.md)

**Next topic:**[Edit the start and completion tag names and colors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/mcafee-epo-edit-security-tag.md)
