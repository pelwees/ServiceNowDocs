...
3.  You can create a copy of the Repeat Detection playbook flow and make the necessary modifications.
    ...
    ![Overview of the Repeat Detection playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/playbook-repeat-detection.png "Repeat Detection playbook")
...
5.  Set a **Trigger Condition** for the playbook.
    ...
    ![Trigger condition for Repeat Detection playbook.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/playbook-repeat-detection-trigger.png)


**Parent Topic:**[Playbook for Repeat Detection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../concept/playbook-repeat-detection.md)
