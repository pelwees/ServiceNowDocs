...
1.  [Install and configure Reverse Whois](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/install-and-config-reversewhois.md)  
...
2.  [\(Optional\) Install and configure Whois](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/whois-install-and-config.md)  
...
3.  [Initiate the lookup for Reverse Whois](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/manually-attch-an-obsvrble-reversewhois.md)  
Initiate domain lookups using search terms in observables that you manually attach to a security incident record.
4.  [Verify expected results for Reverse Whois](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/verify-expected-rslts-rvrsewhois.md)  
...
5.  [\(Optional\) Run enrichment lookup and verify expected results for Whois](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../task/verify-expected-results-for-whois.md)  
