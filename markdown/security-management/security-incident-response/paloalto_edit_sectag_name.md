...
1.  Navigate to **All** &gt; **Palo Alto Networks NGFW Integration** &gt; **Firewall EDL Configuration**.
    ...
    ![Select Firewall EDL Configuration.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-fedl-nav.png)
...
2.  Click an item in the **Name** column to open it
    ...
    ![Security tag name in the EDL tag for observables field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edl-tag-edit-b4-box.png)

3.  Click the information icon \(![Information icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../../vulnerability-response/image/i-icon.png)\) next to **EDL tag for observables** then **Open record**.

    ![Open the EDL tag for observables record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edl-tag-edit-icon.png)

    The Security Tag Form is displayed.

    ![Security tag form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edit-tag-rcd.png)
...
4.  In the **Name** field, modify the security tag name and click **Update**.
    ...
    ![New security tag name in EDL tag for observables field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-edl-tag-edit-after.png)
    ...
    ![Security Incident record with security tag.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/4-30-si-tagged.png)
...
**Previous topic:**[EDL entry exceptions for Palo Alto Networks Next-Generation Firewall](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../reference/paloalto-edl-execptions.md)

**Next topic:**[Uninstall](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/paloalto-unistall.md)
