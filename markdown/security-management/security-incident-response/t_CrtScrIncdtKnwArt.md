...
2.  Select the Create an Article icon \(![Article icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/cj-sir-add-article-icon.png)\).
...
3.  Fill in the fields on the form, as appropriate.
    ...
    **Note:** If you're creating a [knowledge article to be associated with a playbook task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/use-the-playbook.md#), set the **Knowledge base** field to **Security Incident Response Runbook**.
