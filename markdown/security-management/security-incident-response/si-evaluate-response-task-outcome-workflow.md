...
1.  Review the workflow process activities and the workflow diagram.
    ...
    ![Security Incident Evaluate Response Outcome workflow diagram](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/security-management/security-incident-response/../image/EvaluateResponseOutcomeWorkflow.png "Evaluate response task outcome")
