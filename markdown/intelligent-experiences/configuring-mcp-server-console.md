...
1.  [Create a Model Context Protocol server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/create-mcp-server.md)

    An AI administrator creates a server and adds tools to the server.

2.  [Create a tool for a Model Context Protocol server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/create-tool-mcp-server.md)
