...
To see some examples of the Natural Language query responses, refer [Natural language queries use cases and examples](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/knowledge-graph/../concept/natural-language-queries-example-usecases.md).
