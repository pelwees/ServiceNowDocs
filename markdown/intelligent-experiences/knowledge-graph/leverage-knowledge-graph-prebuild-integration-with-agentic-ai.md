...
See [Add a Knowledge Graph to an AI agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/knowledge-graph/../../now-assist-ai-agents/task/add-knowledge-graph.md) to add Knowledge Graph to an AI agents in AI Agent Studio.
