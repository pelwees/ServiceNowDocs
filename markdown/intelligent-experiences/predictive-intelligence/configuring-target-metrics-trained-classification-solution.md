...
![This sample image shows the estimated values set for solution precision, recall and coverage metrics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-default-solution.png)
...
![This image shows you how to set the Precision metric to 80%.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-precision-example.png)
...
![This image shows you the estimated precision, recall, and coverage values the system assigned to the solution based on your Precision input value of 80%.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-precision-example-result.png)
...
![How to set the Coverage metric to 70%.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-coverage-example.png)
...
![This image shows you how to set the Recall metric to 95%.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-recall-example.png)
...
![The estimated precision, recall, and coverage values that the system assigned to the solution based on your Recall input value of 95%.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-recall-example-result.png)
...
![The class-level results the system applied to a solution's precision, coverage, and recall statistics for 37 classes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../images/metric-all-example-result-classes.png)
