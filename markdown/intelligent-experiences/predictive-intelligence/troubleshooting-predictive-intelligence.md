...
4.  Adjust the class precision and coverage values to increase coverage or precision. See [Tune a trained classification solution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/predictive-intelligence/../task/configure-class-precision-coverage.md).
