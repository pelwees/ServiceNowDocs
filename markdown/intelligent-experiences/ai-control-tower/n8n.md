...
Create a n8n API key using your n8n instance. For creating a n8n API Key, see [Create an API Key in n8n environment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/ai-control-tower/../task/create-a-api-key-for-n8n.md)
