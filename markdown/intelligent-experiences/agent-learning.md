...
To configure agent learning at the AI agent level, see [Define the specialty of an AI agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/define-specialty.md).

To configure agent learning at the AI Agent Studio level, see [Set up long-term memory](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/long-term-memory-aia.md).
