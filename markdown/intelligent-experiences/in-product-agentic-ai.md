...
![Service Operations Workspace with the AI Workflows open](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/inproduct-ai.png)
...
![Filter dropdown for agentic workflow executions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/inproduct-ai-filter.png)
...
You can change the processing messages for an AI agent or tool in AI Agent Studio. For an AI agent, open the AI agent and go to the [Select channels and access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/channels-access-aia.md) step. For a tool, open the AI agent, go to the [Add tools and information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/add-tool-aia.md) step, and select the tool to open the form modal.

![Processing messages in the AI Workflows panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/inproduct-ai-processing.png)
...
![Output of an agentic workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/inproduct-ai-output.png)
...
When an agentic workflow is in progress on the record, an icon ![AI workflow indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/inproduct-ai-indicator.png) is displayed at the top of the record form along with other UI actions. If selected, you can see how many agentic workflows are running on the record and the general status of each one.
