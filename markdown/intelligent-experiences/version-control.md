...
![Version control modal from the guided setup of an AI agent with multiple versions showing](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/version-modal.png "Version control modal")
...
For more information about writing effective descriptions and instructions, see [General guidelines for creating AI agents and agentic workflows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/gg-creating-aia.md).
...
![Create a new version modal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/version-create.png "Create a new version modal")
...
If you’re updating an agentic workflow, you can [execute an agentic evaluation run](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/execute-aia-eval.md) to measure performance.
...
![Testing page in AI Agent Studio with a workflow and a version selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/version-test.png "Version selector in the AI Agent Studio Testing page")
...
![Activity page of AI Agent Studio with the versions column highlighted](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/ais-activity-versions.png "Example execution logs")
