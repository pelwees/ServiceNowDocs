...
1.  [Create a use case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../task/create-a-document-classification-use-case.md).

    Define the name and properties for the use case.

2.  [Create document classes using fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../task/create-document-classes.md).

    Define the classes or categories that the AI will learn to detect and apply to documents.

3.  [Train the use case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../task/train-a-use-case.md).
