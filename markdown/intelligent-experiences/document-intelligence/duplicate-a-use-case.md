...
2.  In the list, select the display name of the use case that you want to copy.
    ...
    ![List of data extraction use cases.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../image/docintel-duplicate-use-case-1.png)

3.  On the use case screen, select the Duplicate this use case icon \(![Duplicate this use case icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../image/icon-docintel-duplicate.png)\).

4.  In the Duplicate use case box, type a name for the new use case.

    ![Duplicate use case modal.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../image/docintel-duplicate-use-case-2.png)
...
[Import a document extraction use case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/import-a-use-case.md)
