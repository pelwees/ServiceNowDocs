...
Option to add a field to the group.
 ...
 Use the reorder icon \(![Reorder icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/document-intelligence/../image/icon-docintel-drag.png)\) to reorder a field in the group.
