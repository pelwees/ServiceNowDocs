...
3.  In the **Choose a test type** drop-down menu, select **Test access**.
    ...
    If you want to test the basics of how an agentic workflow works, select **AI agent or worfklow**. The full instructions for that test type can be found in [Test performance manually](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/test-ai-agent.md).
...
6.  Select **Test access**.
    ...
    ![Completed test form for a test access test type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/aw-test-access-form.png)
...
If the results are different than what you expect or want, you can [redefine the security controls](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/define-sec-controls-aw.md) of the agentic workflow.
