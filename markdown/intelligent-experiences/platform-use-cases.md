...
To run the AI agents autonomously, you must either [activate the agentic workflow template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/activate-aia-use-case.md) or [duplicate the agentic workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../task/clone-aia-usecase.md), and then proceed with the following steps:
