...
4.  In the row of the use case you want to delete, select **Delete** in the options menu \(![Field options menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/now-assist-in-document-intelligence/../image/icon-docintel-field-options-menu.png)\).
