...
4.  In the row of the use case you want to edit, select **Edit** in the options menu \( ![Field options menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/now-assist-in-document-intelligence/../image/icon-docintel-field-options-menu.png)\).

5.  Make changes as needed.

    For more information on use case setup, see [Set up a use case for Now Assist in Document Intelligence](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/now-assist-in-document-intelligence/set-up-use-case-for-now-assist-document-intelligence.md)
