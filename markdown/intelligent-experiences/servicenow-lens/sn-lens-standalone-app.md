...
4.  \(Optional step\). To provide instructions to analyze the data in the screenshot in a specific way, select the Edit icon \(![Edit icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-instructions-icon.png)\), and enter the instructions.

![Field to enter instructions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-incident-email.png)
...
![Preview of the analysis of single image.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-single-scrnsht-analysis.png "Preview of the analysis of the single image")
...
3.  Select the Multi-capture icon \(![Multi-capture icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-multi-capture-icon.png)\), and then place the scanner window over the document that you want to scan.

You can resize the scanner window by dragging its borders.

4.  \(Optional step\). To provide instructions to analyze the data in the screenshots in a specific way, select the Instructions icon \(![Instructions icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-instructions-icon.png)\), and enter the instructions.

![Field to enter custom instructions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-incident-email.png)

The default character limit is 500. Users with the admin role can increase this limit to up to 5000 characters by navigating to the `sn_lens_user_prompt_max_length` system property.

5.  Select the Capture icon \(![Capture icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/capture-icon.png)\)

The first screenshot is captured.

6.  Place the ServiceNow AI Lensscannerwindow over the page of another or the same document and then select the Capture icon \(![Capture icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/capture-icon.png)\).

The second screenshot is captured.

Repeat the step to capture more screenshots, if required.

![number of screenshots you've captured.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-number0f-scrnshts-captured.png "View the number of screenshots you've captured")
...
![Captured screenshot delete button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-scrnsht-delete-button.png)
...
8.  To complete the capture, select the Done icon \(![Capture complete icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-capture-done-icon.png)\).
 The ServiceNow AI Lens preview window displays the screenshots that you've captured.

 ![Multiple screenshots captured.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-multiple-images-captured.png "Multiple screenshots captured")
...
-   To remove a captured screenshot, select the ![Remove file](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-file-attch-remove.png) icon.
...
**Note:** You must have the admin role to set the system properties.
    ...
    -   To remove a file that you attached, select the Remove file icon \(![Remove file](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-file-attch-remove.png)\).
3.  Select **Next**.
**Drag and drop files**1.  On your computer, navigate to the location and select one or more files that you want to upload.
2.  Drag the selected files to the Drag and drop section \(![Drag and drop section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-drag-and-drop.png)\).
...
![Multiple files attached.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-multiple-images-attached.png "Multiple files attached") ![Multiple files attached.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/ "Multiple files attached")
...
**Tip:**
    ...
    -   To remove an uploaded file, select the ![Remove file](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-file-attch-remove.png) icon.
...
**Note:** You can upload a total of 10 unprotected files with the combined size of all files not exceeding 10 MB.
    ...
    ![Analysis response displayed under Preview window.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-single-scrnsht-analyze-response.png)
...
9.  Copy the previewed data by selecting the Copy icon ![Copy icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../../../administer/document-intelligence/image/icon-docintel-na-copy.png).
...
[Create a record in an instance by using ServiceNow AI Lens](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/create-record-sn-lens.md)
