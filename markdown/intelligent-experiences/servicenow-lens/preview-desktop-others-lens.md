...
Verify that you've defined the Lens action for this purpose. For more information, see [Define a Lens action.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../concept/servicenow-lens-actions.md#)
...
7.  Select **Proceed with Lens**.
    ...
    ![Proceed with Lens button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-actions-home-screen.png)
...
10. Extract data from a single screen.
    ...
    1.  Enter additional instructions to extract, analyze, and organize data by selecting the Edit icon \(![Edit icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-instructions-icon.png)\) and then enter the instructions.
        ...
        ![Capture data from a single screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-action-submit-form.png "Capture data from a single screen")

        **Note:** This is an optional step.

        **Tip:** Use the Upload file icon \(![File Upload icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-file-upload-icon.png)\) to upload a file from which data is extracted. For more information, see [sn-lens-standalone-app.md\#upload-files-steps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/sn-lens-standalone-app.md#upload-files-steps)

    2.  Select **Analyze**.

        The ServiceNow AI Lens preview window displays the extracted output in an editable form.

        ![Preview of extracted output displayed](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-action-form-preview-window.png "Preview of extracted output displayed in an editable form")
...
11. Extract data from multiple screenshots.
    ...
    2.  Select the **Multi-capture** button ![Multi-capture icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/multi-capture-icon.png).
        ...
        **Tip:** Use the Upload file icon \(![File Upload icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-file-upload-icon.png)\) to upload one or more files. For more information, see [sn-lens-standalone-app.md\#upload-files-steps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/sn-lens-standalone-app.md#upload-files-steps)
    ...
    4.  Place the ServiceNow AI Lensscannerwindow over another document or page and then select the Capture icon ![Capture icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/capture-icon.png)\).
        ...
        ![Display of the number of screenshots captured.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-action-multi-capture-scrnshts.png "Display of the number of screenshots captured")
    ...
    6.  Select **Analyze**.
        ...
        ![Data extracted from multiple screenshots and editable form shown.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-multi-scrnsht-submit-form.png "Data extracted from multiple screenshots and editable form shown")

        ![Lens action data preview.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/servicenow-lens/../image/lens-action-data-preview.png "Lens action data preview")
