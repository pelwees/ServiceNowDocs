...
5.  In the first step of the skill configuration, determine which inputs or triggers that you want to associate with the skill.
    ...
    ![First step of the Now Assist incident summarization skill, which shows the input fields that the summary is based on.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../../now-assist-platform/images/activate-skill-step-1.png)
...
7.  For some skills, the next step is to define the availability.
    ...
    ![Case summarization Define Availability step with customize skill availability selected and the Location field value set to 111w 18th Street, Plano,TX as a required condition.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/now-assist-define-availability.png)
...
-   **[Configure chat summarization and chat reply recommendation skills in the Now Assist Admin console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/configure-chat-summarization-in-the-now-assist-admin-console.md)**  
...
-   **[Configure email reply recommendation in the Now Assist Admin console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/configure-email-recommendation.md)**  
