...
![Prompt injection dashboard page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-offensive-content.png "Now Assist Guardian dashboard page")
...
-   **Guardrail-added latency**
    ...
    ![Guardrail latency for prompt injection.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-guardrail-latency-offensive-content.png "Guardrail-added latency indicator")
...
-   **Percentage flagged as offensive**
    ...
    ![Percentage of offensive content occurrences.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-percentage-offensive-content.png "Percentage flagged as offensive indicator")
...
-   **Total offensive content occurrences**
    ...
    ![Total offensive content occurrences.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-total-offensive-content.png "Total offensive content occurrences indicator")
...
-   **Categories of offensive content**
    ...
    ![Categories of offensive content indicator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-categories-offensive-content.png "Categories of offensive content indicator")
...
-   **Offensive content occurrences by skill**
    ...
    ![Offensive content occurrences by skill.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-offensive-content-occurrences-by-skill.png "Offensive content occurrences by skill indicator")
...
-   **Guardrail-added latency**
    ...
    ![Guardrail-added latency indicator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-guardrail-latency-prompt-injection.png "Guardrail-added latency indicator")

-   **Percentage flagged as prompt injection**

    This area of the dashboard shows the percentage of requests and responses to and from the LLM service that are flagged for offensive content.

    ![Percentage flagged as prompt injection indicator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-percentage-prompt-injection.png "Percentage flagged as prompt injection indicator")

-   **Total prompt injection occurrences**

    This area of the dashboard shows the total number of offensive content occurrences for the selected skills and date range.

    ![Total prompt injection occurrences](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-total-prompt-injection.png "Total prompt injection occurrences indicator")
...
-   **Prompt injection occurrences by skill**
    ...
    ![Prompt injection occurrences by skill indicator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/naa-nag-prompt-injection-by-skill.png "Prompt injection occurrences by skill indicator")
