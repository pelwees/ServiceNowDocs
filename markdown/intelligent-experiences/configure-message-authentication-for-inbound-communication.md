...
3.  Set the channel identity.
    ...
    3.  In the Provider Channel Identity form, locate the **Message auth** field and select the message auth that you set up previously.
        ...
        ![Provider Channel Identity form for the AI Voice Agent Provider Application record, with the Message auth field highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/intelligent-experiences/../image/voice-agents-provider-application-config.png)
