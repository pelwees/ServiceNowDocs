...
9.  On the Set actions form, fill in the fields.
    ...
    For a description of the field values, see [Standard automation task form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/industrial-connected-workforce/digital-factory-workspace/../reference/standard-task-automation-form.md).
