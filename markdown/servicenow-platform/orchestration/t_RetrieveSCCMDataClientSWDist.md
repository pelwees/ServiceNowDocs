...
-   [Configure a user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/t-config-SCCM-deployment-manager.md) with the Application Deployment Manager role on the SCCM server.
...
5.  Open the new SCCM record and click **Discover now** under **Related links**.
    ...
    ![SCCM server instance record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/SCCMServerInstance.png "Retrieving SCCM data with Discovery")
...
Users run the **Discover SCCM** workflow from an [SCCM Server Instance record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/t_RetrieveSCCMDataClientSWDist.md#) to populate the following ServiceNow tables:
