...
3.  Under **Related Links** click **Extend Lease**.
    ...
    ![Requested Software form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ExtendLease.png "Requested Software form")
...
4.  In the dialog box that appears, select a new lease end date in the calendar and click **OK**.
    ...
    ![New Lease End Date Time dialog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/NewLeaseEndDate.png)
