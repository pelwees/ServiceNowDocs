...
6.  Choose from the following options.
    ...
    ![Reusing an output variable](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/OutputsReuseVariable.png "Reuse of data structures")

7.  To delete a variable, click the delete icon \(![delete icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/DeleteVar.png)\) in the row.
...
1.  To map a variable, drag it from the **Outputs** variable builder and drop it into an empty **Variable name** field in the Parsing rules section.
    ...
    See [create a parsing rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/t_CreateAParsingRule.md#) for instructions on configuring parsing for output variables.

    ![Mapping an output field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/OutputsMappingVariable.png)
