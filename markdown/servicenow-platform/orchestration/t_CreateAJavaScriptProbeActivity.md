...
For descriptions of the JavaScript Probe command fields, see the table in [Configure the JavaScript Probe execution command](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/t_CreateAJavaScriptProbeActivity.md#).
...
1.  Drag variables from the list of inputs and drop them into command fields.
    ...
    ![JavaScript Probe execution command](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/JavaScriptExecutionCommand.png "JavaScript Probe execution command")
