...
4.  Drag an output variable from the data structure builder into the **Variable name** field in the **Parsing rules** builder.
    ...
    ![Mapping variables to parsing rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/OutputsMappingVariable.png "Mapping variables to parsing rules")
...
5.  Complete the form using the fields in the table.
    ...
    ![Parsing rules form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ActivityParsingRule.png)
...
2.  Click the **Inputs** tab, and note the **Command**.
    ...
    ![Parsing rule PowerShell inputs command](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesPowershellCommand.png "Parsing rule PowerShell inputs command")
...
6.  Select the parsing type for the source.
    ...
    ![Parsing rule raw payload data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesSampleDataRaw.png)
...
7.  Click **Parse sample data**.
    ...
    ![Parsing rule parsed payload data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesSampleData.png)
...
8.  To create the expression, click the elements in the data sample you want to map to the variable.
    ...
    ![Creating parsing rule expressions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesCreateExpression.png)
...
9.  Select an expression from the list.
    ...
    ![Selecting a parsing rule expression](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesSelectExpression.png)
...
10. Click **Test expression**.
    ...
    ![Testing a parsing rule expression](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesTestExpression.png)
...
11. Click **Submit**.
    ...
    ![List of completed parsing rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/../image/ParsingRulesList.png)
