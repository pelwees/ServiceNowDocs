...
For descriptions of the Powershell command fields, see the table in [Configure the PowerShell execution command](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/orchestration/CreateInputVariables.md#).
