...
1.  Delete the records associated with the type to delete:
    ...
    -   [Assessment results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/../reference/r_AssessmentResults.md) \(metric and category results\)
    -   [Assessment instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/../concept/c_AssessmentInstances.md) \(questions and assessment instances, in that order\)
