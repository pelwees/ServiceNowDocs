...
-   A detailed reference to all synchronization options appears in [How life-cycle values for Asset, CI, and IBI are synchronized](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/reference/cmdb-asset-CI-IBI-sync-options.md).

**Tip:** Terms used in this document are defined in [CSDM life-cycle terms](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../reference/csdm-life-cyle-terms.md).
...
See [How life-cycle values for Asset, CI, and IBI are synchronized](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/reference/cmdb-asset-CI-IBI-sync-options.md).
...
-   **The system runs the discrepancy check**
    ...
    ![Discrepancy report that lists mapping errors.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/image/csdm-lcss-discrepancy.png)
...
![Overall flow of the one-time bulk alignment of legacy status data to CSDM life-cycle value pairs.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/image/csdm-legacy-to-lcss-migration.png)
...
![Updates to sync operations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/image/csdm-lcss-new-sync.png)
...
![Ongoing synchronization of all CSDM life-cycle values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/image/csdm-lcss-ongoing-sync.png)
...
Instructions [Migrate legacy asset and CI settings to CSDM life-cycle values](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/csdm-life-cycle-standard-values.md#)

**Parent Topic:**[Implementing the CSDM framework in stages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/concept/csdm-implementation-stages.md)
...
![Map existing legacy values to CSDM life-cycle values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../../csdm-implementation/image/csdm-lifecycle-mapping-form.png)

### Procedure

1.  Navigate to **All** &gt; **CSDM** &gt; **Life Cycle Mapping**.

2.  On the Life cycle mappings list view, select **New** and then fill in the Life cycle mapping form as described in [Life cycle mapping form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/../reference/csdm-life-cycle-mapping-form.md).

3.  Select **Submit**.

4.  Repeat the process and, when you have mapped all legacy status values, migrate them to the CMDB.

    For instructions, see [Migrate legacy asset and CI settings to CSDM life-cycle values](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/csdm-life-cycle-standard-values.md#).
...
Business rules now perform ongoing alignment of life-cycle data as described in [Enabling life-cycle synchronization from legacy to asset](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/csdm-life-cycle-standard-values.md#).
...
2.  Use the [CMDB Data Manager](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/common-service-data-model-csdm/cmdb-data-management.md) to centrally govern the life cycle of CIs in bulk and in a standard and consistent way.
