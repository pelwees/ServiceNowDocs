...
This state indicates that the agent has completed a conversation with a customer and is wrapping up the interaction.
 ...
 For more information, see [Interaction wrap up](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/interaction-management/../concept/interaction-wrap-up-state.md).
...
</table>**Parent Topic:**[Configuring Interaction Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/interaction-management/../concept/configuring-interaction-management.md)
