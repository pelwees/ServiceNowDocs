...
6.  After installation and depending on the setting for the `/NORESTART` argument, you might need to restart the computer.
    ...
    See [Install Password Reset Windows Application using a wizard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/password-reset/win-install-pwr-wizard.md).
