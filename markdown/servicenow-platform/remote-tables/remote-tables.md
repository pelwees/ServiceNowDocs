...
-   **Remote tables**
    ...
    To learn more about creating remote tables, see [Create a remote table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../task/create-remote-table.md).
...
-   **Script definitions**
    ...
    To learn more about script definitions and how to associate them with a remote table, see [Create script definitions for a remote table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../task/create-remote-table-script.md).
...
-   **[Activate the remote tables plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../task/activate-remote-tables-plugin.md)**  
...
-   **[Create a remote table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../task/create-remote-table.md)**  
...
-   **[Create a flow definition for a remote table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../task/create-remote-table-flow.md)**  
Build and create a flow for a remote table so that you can retrieve data from an external source with it.
-   **[Debugging remote table script definitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../reference/debugging-remote-table-scripts.md)**  
...
-   **[Domain separation and remote tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/domain-separation-remote-tables.md)**  
...
**Parent Topic:**[Manage instance data sources](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/../../general/concept/manage-data-sources.md)
