...
-   **[Create a document approval revision rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/create-doc-approval-rev-rule.md)**  
Create a document approval revision rule for the document review and approval process.
-   **[Add a reviewer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/add-a-reviewer.md)**  
Add a single or multiple reviewers to the document approval and review rule for document review.
-   **[Add an approver](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/add-an-approver.md)**  
Add a single or multiple approvers to the document approval and review rule for document approval.
-   **[Send a document version for review and approval](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/send-document-for-review.md)**  
Send a document version for review and approval before publishing the document.
-   **[Approve or reject a document version](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/approve-document.md)**  
Approve or reject a document version after the review process is complete.
-   **[Approve or reject a document version through email](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/approve-reject-document-email.md)**  
Approve or reject a document version request directly from your email.
-   **[Publish a document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/document-management-services/../task/publish-a-document.md)**  
