...
-   **Capabilities**: The [network capability](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../reference/r_MIDServerCapabilities.md) an application needs to use, such as the [PowerShell Orchestration activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../../orchestration/reference/mid-server-powershell-files.md) or the Workflow Studio [PowerShell step](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/powershell-step-action-designer.md). Some applications, like Cloud Management, require a specific capability.
...
The **Discovery** or **ALL** application must be [specified on the MID Server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../task/t_SpecifyMIDServerApplications.md#).
...
Choose the MID Server on the Discovery schedule.**Note:** You can also specify [a cluster of MID Servers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../task/t_ConfigureAMIDServerCluster.md#).
...
-   **[Configure a default MID Server for each application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../task/t_SpecifyMIDServerApplications.md#)**  
...
-   **[Configure an IP address range for the MID Server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../task/t_ConfigureMIDIPRange.md)**  
You can manually configure an IP address range for the MID Server to explore.
-   **[Override the MID Server selection filter](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../task/override_mid_server_selector.md)**  
