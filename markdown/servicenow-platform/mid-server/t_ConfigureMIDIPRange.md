...
3.  Complete the form, using the fields in the table.
    ...
    ![IP address ranges](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/mid-server/../image/IPRangeForm.png "IP address ranges")
