...
4.  Select the **Cancel** related link.
    ...
    ![Cancel Confirmation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/../image/CancelConfirmation.png)

5.  Click **OK**.

    The workflow engine attempts to cancel the workflow gracefully.

    ![Wait for Cancel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/../image/WaitForCancel.png)

    If the workflow does not respond to the cancel command, the Force Cancel option appears.

    ![Force Cancel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/../image/ForceCancel.png)
...
**Parent Topic:**[Administering workflow contexts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/../reference/r_AdministeringWorkflowContexts.md)
