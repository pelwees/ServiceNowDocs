...
2.  Find and add more widgets by selecting the add content icon \(![Add Content icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/../../../use/homepages/image/AddContent.png)\) in the corner of the dashboard.
