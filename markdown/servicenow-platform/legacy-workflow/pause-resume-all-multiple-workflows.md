...
3.  To pause all active workflows, select **Pause All**, then click **Update**. To pause a filtered group of active workflow contexts, skip this step.
    ...
    All currently active workflow contexts in the instance are paused until you resume them. Use [Workflow pause request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/monitor-workflow-pause-requests.md) to monitor their status.
...
7.  For the paused workflow group request, use the **Resume At** field to specify the date and time of day at which the paused workflow contexts should resume.
    ...
    2.  Click ![Green check mark icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/legacy-workflow/../image/Check.png) when finished.
