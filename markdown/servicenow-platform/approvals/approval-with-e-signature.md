...
![Dialog to enter user credentials](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../image/approval-authentication-dialog-cropped.png)
...
![Example approval showing Bow Ruggeri approving a change request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../image/activity-stream-approval.png "Example activity stream")
...
-   **[Activate Approval with e-Signature plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../../../integrate/single-sign-on/task/activate-approval-esignature.md)**  
...
-   **[De-activate e-signatures](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../reference/r_DeactivateESignatures.md)**  
Use this procedure to de-activate e-signatures.
-   **[Select an approval table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../task/t_SelectAnApprovalTable.md)**  
...
-   **[Set up an approval from a local database](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../task/t_SetUpAnApprovalFromALocalDb.md)**  
Enable users to authorize e-signature approvals using local database credentials.
-   **[Use Multi-Provider SSO to set up an SSO approval for a SAML 2.0 authentication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../../../integrate/single-sign-on/task/sso-esignature-approval-SAML.md)**  
An SSO approval with e-signature requires configuration on the SAML IdP and the ServiceNow instance.
-   **[Installed with approval with e-signature](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../reference/r_InstalledWApprWithEsignature.md)**  
Installing approval with e-signature installs certain properties.

**Parent Topic:**[Classic approvals](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/approvals/../reference/r_Approvals.md)
