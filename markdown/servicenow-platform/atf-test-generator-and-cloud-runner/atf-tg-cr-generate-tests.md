...
1.  Navigate to **All** &gt; **Automated Test Framework \(ATF\)** &gt; **Administration** &gt; **Test Generator**.
    ...
    **Note:** The **Generate Tests** module is visible only to the admins. Even an ATF test admin can't access the **Select Cloud User** module.
    ...
    ![Image showing in progress test generation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-app-inprogress-test-generation.png)
...
3.  Select one of the two ways to generate tests.
    ...
    ![Generate Tests screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-tg-cr-advanced.png)
...
4.  Select **Save preset** to implement the preset filter conditions.
    ...
    **Note:** You can't delete the default **None** preset. Some example presets have been provided which can be edited.
    ...
    ![Generate Tests screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-app-preset-tabs.png)
    ...
    **Note:** You can create new condition sets to filter the required information in tabs.
    ...
    ![Users screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-app-filter.png)

5.  Select **Start Test Generation**.

    The Test Generation Started page shows up.

    ![Image showing the test generation started dialog box](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-app-test-generation-progress.png)

    If you run a test or a suite when the test generation is in progress, one of the following messages shows up.

    -   For test run

        ![Image showing test run queue when test generation is in progress](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-app-queue-test-run.png)

    -   For suite run

        ![Image showing suite run queue when test generation is in progress](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../image/atf-app-queue-suite-run.png)
...
**Parent Topic:**[Operating ATF Test Generator and Cloud Runner](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../concept/atf-tg-cr-operate.md)

**Related topics**  


[Tests generation for flow and flow logic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../concept/atf-tg-cr-sc-flow.md)
