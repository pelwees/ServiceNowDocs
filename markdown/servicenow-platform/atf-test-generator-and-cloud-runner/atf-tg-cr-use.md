...
-   **[Executing the tests using Cloud Runner](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../task/atf-tg-cr-execute-tests.md)**  
Execute the generated tests suite using the Cloud Runner browser option.
-   **[Scheduling test execution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/atf-test-generator-and-cloud-runner/../task/atf-tg-cr-schedule-test-run.md)**  
