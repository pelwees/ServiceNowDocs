...
Enable the wish list feature for catalog. For information about enabling the wish list, see [Saving catalog items to a wish list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../concept/catalog-items-wishlist.md).
...
4.  Open the **Main menu** by clicking the preview this record icon \(![Preview this record icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../image/preview_record.png)\).
