...
**Note:** To pass a variable between tasks, select the **Global** check box when you [create a Service Catalog variable](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/t_CreateAVariableForACatalogItem.md).
