...
A [script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/t_ContrlAccessByCDGUOrLoc.md#) to define any additional criteria, and return **true** or **false**. This field is available only if **Advanced** is selected. **Note:**
