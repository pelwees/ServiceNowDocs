...
Check box to support the catalog client script on a record created for task-extended tables via record producers. See [Default variable editor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../concept/service-catalog-variable-editor.md#cat-default-variable-editor).
