...
-   **[Browse catalog items using the catalog hierarchy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../task/now-mob-browse-cat-item-catalog.md)**  
...
-   **[Enable notifications in Now Mobile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../task/enable-notification-mobile.md)**  
Allow push notifications on your mobile device when there is an update for a request.
-   **[Enable the cart in Now Mobile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../task/enable-cart-mobile.md)**  
Allow a requester to add or edit items in the cart. By default, the cart is disabled in Now Mobile.
-   **[Edit the label of Submit button for a record producer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../task/edit-recprdcr-submit-label.md)**  
For a record producer submission experience that you can relate to, edit the label of the **Submit** button.
-   **[Configure Now Mobile properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../task/config-now-mob-properties.md)**  
Define the behavior of various catalog entities in Now Mobile.

**Parent Topic:**[Service Catalog in mobile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/catalog-experience-mobile.md)

**Related topics**  


[Fulfiller experience in Mobile Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-catalog/../../../administer/service-administration/concept/itsm-mobile-request-approval.md)
