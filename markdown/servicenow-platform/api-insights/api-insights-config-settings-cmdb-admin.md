...
Assigns the API to a support group responsible for resolving incidents, maintaining stability, and troubleshooting issues.
    ...
    **Note:** Workflows are created by your administrator using the Workflow Studio. See [Configuring flows for API actions in API Insights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/api-insights/../concept/api-insights-workflow.md).
