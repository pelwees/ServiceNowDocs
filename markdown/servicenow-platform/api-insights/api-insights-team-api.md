...
3.  From the **Name** column, select an API to view more details of the API.
    ...
    See [Viewing API details in API Insights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/api-insights/../concept/api-insights-api-details-page.md).
