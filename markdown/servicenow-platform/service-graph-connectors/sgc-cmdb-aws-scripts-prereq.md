...
**Important:** Ensure that you have downloaded the scripts available within the Service Graph Connector for AWS. See [Download the AWS scripts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-graph-connectors/../task/sgc-cmdb-aws-scripts-dwld.md).

Decide the following details to be used later during the execution of the AWS scripts:

-   [ServiceNow IAM role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.md#section_mxv_3l3_pzb)
-   [ServiceNow IAM username](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.md#section_sf3_rl3_pzb)
-   [S3 bucket for the ServiceNow IAM role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-scripts-prereq.md#)

    **Note:** Define an S3 bucket only when you are using [deep discovery scripts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/service-graph-connectors/sgc-cmdb-aws-script-op.md#section_ahc_jwf_4zb).
