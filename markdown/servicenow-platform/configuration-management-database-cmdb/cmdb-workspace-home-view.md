...
For more information, see [Now Assist for Configuration Management Database \(CMDB\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/now-assist-landing-cmdb.md).
...
For more details about using NLQ with Intelligent Search, see [Intelligent Search for CMDB](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/intelligent-search-cmdb.md).
...
-   **CI Summary**
    ...
    -   Drill down a class to access the Create CI experience to create a new CI in the selected class. For more information about the Create CI experience which applies Identification and Reconciliation Engine \(IRE\) processes, see [Create a CI manually in CMDB Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../task/create-ci-manual-cmdb-workspace.md).
    -   Add custom class groups by creating [CMDB groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/cmdb-groups.md#) with the following settings:
...
-   **My CIs**
    ...
    Use the [sn\_cmdb\_ws.ci\_overview.managed\_by\_me.enabled​](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/installed-with-cmdb-workspace.md) property to show or hide this chart.
...
-   **Cloud vs Non-cloud resources**
    ...
    -   [Resume a disabled scheduled job](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../task/cmdb-workspace-resume-cloud-job.md).
...
Supports targeted business outcomes by improving CMDB data quality across Data Foundations and individual applications including Hardware Asset Management \(HAM\). For more information, see [CMDB success advisor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../../cmdb-success-advisor/reference/cmdb-sa.md).

## Quick links

A list of links to key CMDB dashboards and tools. You can [add a link](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../task/cmdb-workspace-add-quick-link.md) to the list of quick links that are available to you.
...
-   [Relationship Health Dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../task/t_ViewRelationshipsHealth.md): View the Relationship Health Dashboard with CMDB Health scores for CI relationship.
...
</table>-   **[Cloud vs Non-cloud resources chart](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/cmdb-workspace-ci-overview-cloud.md)**  
