...
[Managed API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/api-sgc-boomi-cloud-tables.md#section_e2t_zvz_whc)[Boomi API Gateway](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/api-sgc-boomi-cloud-tables.md#section_ivl_zvz_whc)

[API Frontend](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/api-sgc-boomi-cloud-tables.md#section_t2z_zvz_whc)

[API Backend](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/api-sgc-boomi-cloud-tables.md#section_qsk_1wz_whc)
...
[API Consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/api-sgc-boomi-cloud-tables.md#section_thq_1wz_whc)

</td></tr></tbody>
</table>For more information on where data is saved when pulling data from a Boomi Cloud API Management application, see [Target tables for storing API Service Graph Connector for Boomi Cloud API Management data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/../reference/api-sgc-boomi-cloud-tables.md).
