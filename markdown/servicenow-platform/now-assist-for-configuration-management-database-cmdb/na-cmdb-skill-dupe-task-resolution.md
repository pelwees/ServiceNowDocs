...
3.  In the Remediate pop-up, select **Use the Duplicate CI Remediator \(Now Assist\)** and then select **Next**.
    ...
    ![Proposed remediation actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../image/na-cmdb-skill-dupe-task-res-assist.png)
...
4.  In the Summary section, review each recommendation in turn and assess whether to accept the recommended actions or modify them.
    ...
    **Important:** **Unique to main CI:** Each subsequent step depends on the selected main CI. If you change the main CI, then the Now Assist skill cannot proceed and you must perform remediation manually. None of the remaining steps \(merge attribute values, merge relationships, merge related items, and determine duplicate Cl actions\) have dependencies like main CI selection. You can therefore make changes and still proceed with the Now Assist process.
    ...
    ![Warning that changing the Main CI cancels the Now Assist process.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../image/na-cmdb-skill-dupe-change-main-ci.png)
...
5.  After you determine that all recommended actions are correct, select **Submit** and then select **Proceed** in the confirmation pop-up.
    ...
    ![Proceed with remediation.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../image/na-cmdb-skill-dupe-task-confirm.png)
...
1.  Expand the **Merge Attribute Values** step to view the reasoning that led to the recommendations.
    ...
    ![Start the process of reviewing the attribute merge recommendations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../image/na-cmdb-mng-dupe-attr-select.png)

2.  To view the merge recommendations, select the **Merge Attribute Values** tab.

    ![View the merge recommendations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../image/na-cmdb-select-merge-attr-tab.png)
...
4.  Review, assess, and update each step in turn.
    ...
    ![Be sure to verify or update the Now Assist recommendations in the remaining steps.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../image/na-cmdb-skill-dupe-task-summary.png)
...
[Duplicate CIs remediation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../../configuration-management/concept/de-duplication-tasks.md)

[Detecting duplicate CIs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../../configuration-management/concept/id-detect-dup-ci.md)

[View CMDB Health Dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/now-assist-for-configuration-management-database-cmdb/../../configuration-management/concept/c_MonitorCMDBHealth.md)
