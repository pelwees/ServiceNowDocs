...
-   **[Modify the data retention policy for knowledge usage metrics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/Modify-data-retention-policy-knowledge-usage-metrics.md)**  
