...
-   **[Create field mapping from an incident to a knowledge article](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../task/table-mapping-knowledge-incident.md)**  
...
-   **[Add a property to enable creating knowledge article from incidents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../task/property-article-incident.md)**  
Add a property, which is required to allow users to create a knowledge article from an incident.
-   **[Create a UI action to enable creating knowledge articles from incidents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../task/ui-action-article-incident.md)**  
