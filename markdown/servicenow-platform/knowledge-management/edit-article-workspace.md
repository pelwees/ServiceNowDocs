...
9.  Work with attachments.
    ...
    -   Attach a file with supporting information by clicking the attachments icon \(![Attachments icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../image/attachments.png)\) in the contextual side panel and selecting the file.
    -   Download, remove, or rename an existing attachment by clicking the menu icon \(![Menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../image/attachment-menu.png)\) displayed for the attachment.
10. Click **Save**.
