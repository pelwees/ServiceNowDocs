...
-   **[Search Log fields and description](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../reference/km-search-logs.md)**  
The knowledge search log stores the history of all knowledge searches performed by the users.
-   **[View Log fields and description](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../reference/km-view-logs.md)**  
The knowledge View log stores the history of knowledge articles views and their usage.
-   **[View the source of a knowledge article search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/find-knowledge-search-source.md)**  
Analyze knowledge searches by finding the source used for searching a knowledge article.
-   **[Modify the data retention policy for View logs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/auto-flush-kb-use.md)**  
