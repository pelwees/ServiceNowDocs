 ...
 **Note:** This access doesn't apply to scoped knowledge bases. For more information, see [Scoped knowledge bases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/scoped-knowledge-base-administration.md).
...
Read, modify, approve, and retire that knowledge article \(see [Ownership groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/enable-ownership-group.md)\).
...
![Flowchart showing how contribute access to a knowledge base and its article using user criteria is evaluated](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../image/contribute_access.png "Contribute access to a knowledge base and its article flowchart")
...
No user has contribute access to the knowledge base except [users with special knowledge privileges](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/user-access-knowledge.md#section_uvc_rqf_sjb).
...
![Flowchart showing how read access to a knowledge article using user criteria is evaluated.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../image/read_access.png "Read access to a knowledge article flowchart")
...
No user has read access except [users with special knowledge privileges](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/user-access-knowledge.md#section_uvc_rqf_sjb) and users who have contribute access to the knowledge base.
...
-   **[Create user criteria for controlling access to knowledge bases and articles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../task/create-user-criteria-record-in-knowledge-management.md)**  
...
-   **[Control access at the knowledge article level through user criteria](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../task/t_SelectUCArticle.md)**  
