...
**Note:** For better comparison experience of the knowledge article versions, see [Compare knowledge article versions in Agent Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/compare-article-versions-agent.md).
...
3.  In the Article Versions related list, select the check boxes for the two versions of the article to compare.
    ...
    ![Article Versions related list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../image/article-version-related-list.png "Article Versions")
...
4.  In the Actions on selected rows list, select **Compare** from the list.
    ...
    ![The Compare versions page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/servicenow-platform/knowledge-management/../image/compare-version.png "Compare versions page")
