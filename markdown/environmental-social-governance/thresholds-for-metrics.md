...
Threshold fields and metric status are not evaluated for ad hoc metric data tasks. For more information, see [Ad hoc metric data task limitations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../reference/ad-hoc-metric-data-task-limitations.md).
