...
Threshold evaluation does not apply to ad hoc metric data tasks. For more information, see [Ad hoc metric data task limitations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../reference/ad-hoc-metric-data-task-limitations.md).
...
5.  On the form, fill in the fields.
    ...
    For a description of the field values, see [Metric Threshold form fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../../esg-management-reporting/reference/metric-threshold-form-fields.md).
