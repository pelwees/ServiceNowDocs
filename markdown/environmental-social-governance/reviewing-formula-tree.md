...
![Accessing the formula tree. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../image/metric-formula-tree.png "Example of accessing a formula tree")

![Viewing the formula tree. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../image/metric-formula-tree-view.png "Example of a formula tree")
...
![Viewing an empty page. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../image/formula-tree-empty.png "Example of an empty page")

![Viewing an empty page. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../image/formula-tree-error.png "Example of an error page")

To learn more about formula trees, see:

-   **[View the calculation breakdown in a formula tree](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/../task/view-formula-tree.md)**  
View a structured and visual representation of the entire calculation chain.

**Parent Topic:**[Using GRC: Metrics to provide data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/environmental-social-governance/using-grc-metrics.md)
