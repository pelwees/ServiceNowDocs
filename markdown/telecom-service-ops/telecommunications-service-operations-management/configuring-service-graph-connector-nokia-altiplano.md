...
**Note:** Fore more information, see [Mapping Nokia Altiplano CIs and Relationships in CMDB](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/data-mapping.md).
...
2.  Follow the task sequence to configure MID Server settings, Nokia Altiplano connections, filters, and import schedules. For more information, see [Set up Nokia Altiplano](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/../task/initial-setup-procedure.md).

**Related topics**  


[Set up Nokia Altiplano](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/../task/initial-setup-procedure.md)

[Set up multiple Nokia Altiplano instances](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/../task/multi-instance-setup.md)

[Configure concurrent import and parallel loading for Nokia Altiplano](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/../task/configure-concurrent-import-and-parallel-loading.md)

[Mapping Nokia Altiplano CIs and Relationships in CMDB](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/data-mapping.md)

[Run and verify import for Nokia Altiplano Service Graph Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-service-ops/telecommunications-service-operations-management/../task/run-and-verify-import-for-nokia-altiplano-service-graph-connector.md)
