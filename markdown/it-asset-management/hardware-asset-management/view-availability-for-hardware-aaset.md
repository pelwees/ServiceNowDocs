...
4.  On the contextual sidebar, select the Asset availability and related KPIs icon ![](../../enterprise-asset-management/image/asset-kpi-icon.png).
    ...
    ![Hardware Asset Workspace showing detailed asset form with Asset KPIs report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../image/asset-kpis-report-sidebar-ham.png)
