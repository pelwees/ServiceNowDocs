...
Update the associated Decision table entries to trigger the new flow. For more information, see [Update associated Decision tables for HAM flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/trigger-flow-ham.md).

For the list of readily available decision tables and the associated Hardware Asset Management features that you can update, see [Decision tables for Hardware Asset Management flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../reference/ham-decision-table.md).
