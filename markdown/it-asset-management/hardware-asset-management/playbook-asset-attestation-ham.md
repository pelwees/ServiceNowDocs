...
-   **[Return to the playbook to continue pending asset attestation activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/continue-with-attestation-playbook.md)**  
Resume work on the incomplete asset attestation activities in the playbook by using the attestation schedule details.

**Parent Topic:**[Audit your hardware assets by using Asset Attestation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/audit-hardware-assets-attestation.md)
