...
The **Open** tab displays a list of existing open asset audits
    ...
    The Asset audit results are displayed. For more information about audit result fields, see [Audit results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../reference/audit-results.md).

    ![Audit Results shows a pie chart of assets grouped by state](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../image/ham-asset-audit.png)
