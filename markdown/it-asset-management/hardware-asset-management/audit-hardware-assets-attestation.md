...
-   [Create an asset attestation or a schedule using the playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/create-attestation-using-playbook.md)
-   [Create an asset attestation in the Inventory view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/create-attestation-req-ham.md).
-   [Create an asset attestation schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/create-attest-schedule-ham.md).
-   [Create an attestation for a hardware asset](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/attest-single-asset-ham.md)
...
For more details, see [Asset Attestation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/asset-attestation-ham.md).

-   **[Playbook for asset attestation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/playbook-asset-attestation-ham.md)**  
...
-   **[Confirming the assigned serialized hardware assets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/confirming-assets-emp-portal-mobile.md)**  
...
-   **[Cancel an asset attestation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/cancel-asset-attestation-ham.md)**  
Cancel an asset attestation when you no longer have to validate the ownership of the serialized assets.
-   **[Cancel an attestation schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/cancel-attestation-schedule-ham.md)**  
...
-   **[Complete the remediation task for asset attestation in the Hardware Asset Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/complete-attestation-remediation-ham.md)**  
