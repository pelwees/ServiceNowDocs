...
-   **[Create Calculated lifecycle templates in the Hardware Asset Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/create-calc-model-lc-temp-ham.md)**  
Create Calculated lifecycle templates to manage the complete lifecycle of hardware models efficiently.
-   **[Associate a hardware model with a Calculated lifecycle template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/associate-hardware-model-cal-temp.md)**  
