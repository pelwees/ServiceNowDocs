...
3.  [Trigger the assignment of a remote task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/create-rtd-for-providers.md).
...
2.  [Activate the remote task definitions published by the provider](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/activate-rtd-for-customers.md).
