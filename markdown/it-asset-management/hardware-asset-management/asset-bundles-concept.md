...
Asset bundles are based on bundled models. A bundled model is a grouping of models. For more information on bundled models, see [Bundled models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../../product-catalog/concept/c_CreatingBundledModels.md).
...
For more information on creating asset bundles, see [Manage asset bundles from your inventory](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../task/create-bundled-assets.md).
