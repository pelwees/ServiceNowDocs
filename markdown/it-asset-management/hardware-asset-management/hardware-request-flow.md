...
![Hardware asset disposal flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../image/Hardware-asset-req-flow.png "Standard Hardware Asset Request flow")
...
16. Complete the Asset pick task using the Mobile Agent application.
    ...
    For details on completing this step, see [Manage hardware asset pick tasks using the Mobile Agent application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/hardware-asset-management/../concept/manage-asset-pick-task-ham-mobile-app.md).
