...
**Note:** For details on configuring values for likelihood, impact, and score, see [Create configuration values for risk likelihood](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/risk-likelihood-config.md), [Create configuration values for risk impact](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/risk-impact-config.md), or [Create configuration values for risk scores](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/risk-score-config.md).
...
-   **[Create configuration values for risk likelihood](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/risk-likelihood-config.md)**  
Use the Risk Likelihood module to create configuration values for the likelihood vector.
-   **[Create configuration values for risk impact](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/risk-impact-config.md)**  
Use the Risk Impact module to create configuration values for the impact vector.
-   **[Create configuration values for risk scores](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/risk-score-config.md)**  
