...
3.  In the table, locate all entries for the Enterprise Asset Management for DCNAM application.
    ...
    ![ITAM Licensing Resource Counts table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../image/itam-licensing-resource-counts-table.png)
