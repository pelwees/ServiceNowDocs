...
4.  Configure the option to display the **Asset indoor map** tab in the Enterprise asset estate view of the Enterprise Asset Workspace.
    ...
    For detailed instructions, see [Configure tabs in the Enterprise Asset Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/configure-model-asset-class-tabs.md).
...
For more details on using indoor maps, see [Track assets using indoor maps in the Enterprise Asset Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/track-enterprise-assets-indoor-maps.md).
