...
4.  Complete and close the Extension confirmation task for the lease contract.
    ...
    3.  In the same section, select the Open Record icon \(![Open record icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../image/open-record-icon.png)\) in the **Purchase order** field.
