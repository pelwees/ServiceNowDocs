...
17. Complete the Asset pick task using the Mobile Agent application.
    ...
    For details on completing this step, see [Manage enterprise asset pick tasks using the Mobile Agent application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../concept/manage-asset-pick-task-eam-mobile-app.md).
...
**Parent Topic:**[Fulfilling enterprise asset requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../concept/fulfilling-enterprise-asset-requests.md)
