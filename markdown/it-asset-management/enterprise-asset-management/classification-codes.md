...
Create classification codes to increase the visibility and efficiency of your enterprise models. For details, see [Create sources for classification codes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/create-class-source-eam.md).

You can also import multiple classification codes at one go to your ServiceNow instance. For details, see [Import classification codes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/enterprise-asset-management/../task/import-class-codes-eam.md).
