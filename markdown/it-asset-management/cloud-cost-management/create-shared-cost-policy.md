...
4.  On the Shared Cost Allocation Policy Creation form, fill in the fields.
    ...
    For a description of the field values, see [List of Shared cost allocation policy fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/cloud-cost-management/../reference/shared-cost-allocation-policy-fields.md).
