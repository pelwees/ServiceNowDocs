...
-   You must set up required roles to perform billing download. For more information, see [Setup roles for Google Cloud billing download](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/cloud-cost-management/gcp-user-policy-create-cloudin.md).
