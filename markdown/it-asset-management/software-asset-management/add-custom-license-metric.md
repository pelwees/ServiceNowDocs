...
Custom metrics can be disabled using the custom license metric [property](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/sam-properties.md). This feature is enabled by default.
...
-   **[Custom license metric example script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/custom-license-example-script.md)**  
The following is an example of a custom license metric script.
-   **[Specify resource values for your custom license metrics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/specify-resource-values-custom-license-metrics.md)**  
