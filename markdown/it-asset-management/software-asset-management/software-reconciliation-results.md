...
-   **Product Results**
    ...
    ![Product Results and related lists for SQL Server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../image/product-results.png)
...
-   **Software Model Results**
    ...
    ![Software Model Results and related lists for SQL Server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../image/software-model-results-workspace.png)
    ...
    For more details on software model results related lists and descriptions, see [View software model results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/t_ViewSWModelResults.md).

-   **License Metric Results**

    ![License Metric Results and related lists for SQL Server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../image/license-metric-results.png)
    ...
    For more details on license metric results related lists and descriptions, see [Software model results license metric results fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/license-metric-results-fields.md).
