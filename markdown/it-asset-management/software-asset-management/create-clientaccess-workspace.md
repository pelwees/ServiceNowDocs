...
If you select this option, you can assign the associated User CALs to specific users. See [step 7](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/create-clientaccess-workspace.md#cal-type) for more details.
...
If you select this option, you can assign the associated Device CALs to specific devices. See [step 7](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/create-clientaccess-workspace.md#cal-type) for more details.
...
If you select this option, you can assign the associated User and Device CALs to specific users and devices. See [step 7](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/create-clientaccess-workspace.md#cal-type) for more details.
