...
-   **Prerequisites**
    ...
    1.  [Install Software Asset Management Professional for Microsoft](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/microsoft-publisher-pack.md)
    ...
    2.  [Install ITAM Health Check application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/health-check-dboard.md)
    ...
    3.  [Install Software Asset Management - SaaS License Management plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/request-saas-license-management.md)
    ...
    5.  [Receive latest updates from Software Asset Management Content Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/c_SAMContentService.md)
    ...
    6.  [Create a success goal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/create-success-goals.md)
...
-   **Software Asset Management configurations**
    ...
    1.  [Register application on Microsoft Entra ID](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/register-microsoft-app.md)
    ...
    2.  [Configure Power BI usage to get usage information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/enable-service-principal-authentication-microsoft.md)
    ...
    3.  [Prevent anonymous user information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/conf-update-micro-admin.md)
    ...
    4.  [Set up a Microsoft 365 integration profile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/set-up-microsoft-office-365.md)
    ...
    5.  [Configure the integration profile to get data for government customers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/update-o365-gov-plans.md)
    ...
    6.  [Configure the integration profile to get usage for Microsoft 365 Copilot, Visio Online, and Project Online](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/upload-usage-reports-copilot-visio-project.md)
    ...
    7.  [Configure reclamation rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/add-reclamation-rule-sub.md)

        The Software Asset Management application automatically provides base system reclamation rules when you create an integration profile for Microsoft 365. For more information, see [Reclamation rules for Microsoft 365 integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/m365-reclamation-rules.md).

    8.  [Configure user resolution rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/map-user-data.md)
    ...
    9.  [Run scheduled jobs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/m365-scheduled-jobs.md)
    ...
    10. [Set up software models and entitlements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/view-user-subscription-workspace.md)
    ...
    11. [Set up Add on, From SA, and Step Up entitlements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/creating-m365-from-sa-add-on-entitlements.md)
    ...
    12. [Set up license reservations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/creating-0365-reserve-entitlements.md)
...
-   **Software Asset Management configurations verification**
    ...
    1.  [Verify the complete pull of all subscriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/ver-o365-info.md)

        Verify with the Microsoft 365 administrator that all subscription records have been successfully pulled.

    2.  [Run health check](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/run-healthcheck.md)
    ...
    3.  [Verify the pull of all required software usage](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/o365-usage-activity.md)
    ...
    4.  [Create a success goal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/create-success-goals.md)

        Create a success goal to manage your Microsoft 365 licenses.

    5.  [Add Microsoft 365 and associated products to the published product list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/add-published-products.md)
    ...
    6.  [Run reconciliation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/run-recon-workspace.md)
    ...
    7.  [Check license position report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/sam-license-position-report.md)

        Check your overall compliance positions for Microsoft 365 and associated products in the License Position Report.

    8.  [Act on unlicensed subscriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/publisher-overview-microsoft.md)

        Identify and address the unlicensed Microsoft 365 subscriptions.

    9.  [Act on optimization recommendations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/pub-opt-microsoft.md)
...
[Microsoft 365 integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/microsoft-o365.md)

[Automated license removal for Microsoft 365](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/m365-license-auto-removal.md)
