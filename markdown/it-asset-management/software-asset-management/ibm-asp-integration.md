...
-   Request and install Anglepoint's IBM Licensing for Software Asset Management application from the ServiceNow® Store. See [Request Anglepoint's IBM Licensing for Software Asset Management application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/request-anglepoint-application.md) for detailed instructions.
-   Set up the Anglepoint Elevate platform.

-   **[Virtualization technologies and public cloud platforms supported by IBM Authorized SAM Provider \(ASP\) integrations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/supported-virtualization-technologies-iasp-integrations.md)**  
...
-   **[Licensing for IBM Cloud Paks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/licensing-ibm-cloud-paks.md)**  
...
-   **[IBM reconciliation for IBM Authorized SAM Provider \(ASP\) integrations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/ibm-reconciliation-iasp-integrations.md)**  
...
-   **[Setting up an IBM Authorized SAM Provider \(ASP\) integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/setting-up-anglepoint-integration.md)**  
...
-   **[Creating a connection for the Anglepoint integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/creating-connection-anglepoint-elevate-platform.md)**  
...
-   **[View the daily aggregated peak usage of your IBM software products](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/view-daily-aggregated-peak-usage-ibm-products.md)**  
...
-   **[View devices with the highest daily usage of your IBM software products](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/view-daily-high-water-mark-usage-ibm-products.md)**  
...
-   **[View product classifications for your IBM components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/view-product-classifications-ibm-components.md)**  
...
-   **[Specify the virtual machine managers \(VMMs\) for which you are tracking IBM licenses](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/specify-vm-managers-anglepoint-integration.md)**  
...
-   **[Deduplicating IBM software installations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/deduplicating-ibm-software-installations.md)**  
...
-   **[Enable IBM reconciliation for specific domains](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/enable-domain-recon-anglepoint-integration.md)**  
...
-   **[Verify the meta data for your IBM hosts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../task/verify-ibm-device-meta-data.md)**  
