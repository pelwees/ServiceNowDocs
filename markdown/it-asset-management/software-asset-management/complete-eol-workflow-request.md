...
6.  Complete the first task, which is the Assess IT architecture impact task.
    ...
    ![Software EOL tasks in the list view on the Software EOL Tasks tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../image/eol-tasks.png)
    ...
    2.  On the **Details** tab of the Assess IT architecture impact task, fill in the fields.
        ...
        For details on the form fields and their description, see [Software EOL tasks tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/software-eol-request.md#section_l11_yb1_4bc).
