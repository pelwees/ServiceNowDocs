...
3.  Select a normalization suggestion record to view its details.
    ...
    For a detailed description of the normalization suggestion fields, see [Normalization suggestions for discovery models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../concept/normalization-suggestions.md).
