...
10. Correct the errors and then select **Import**.
    ...
    The entitlement is successfully created. For more information on resolving errors, see [Entitlement import error actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/import-software-rights-form.md).
