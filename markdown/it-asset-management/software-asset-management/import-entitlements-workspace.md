...
2.  Select **Create entitlement**.
    ...
    ![Bulk import of entitlements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../image/create-bulkimport.png)
...
11. Select the import error record to view the errors.
    ...
    For a detailed description of the entitlement import error fields, see [Entitlement import error fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/software-asset-management/../reference/entitlement-import-error-fields.md)
