...
Type of integration profile. This field is automatically set to **Roadmunk Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-roadmunk.md#) table.
...
5.  To avoid your integration profile from including inactive users in your list of Roadmunk subscriptions, enable the Roadmunk Download Subscriptions subflow to download only the active users in your Roadmunk account.
    ...
    7.  On the form header, select the **Manage Attachments** icon ![Manage attachments icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/../image/manage-attachments-icon.png).

    8.  In the Attachments dialog box, select **Choose file** to locate and select the Roadmunk User Report that you downloaded in [step e](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-roadmunk.md#download-user-report).
