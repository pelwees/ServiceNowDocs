...
-   PagerDuty Role required: Refer to the [Minimal user permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md#) table.
...
1.  On the Add New App page of your PagerDuty account, select **Scoped OAuth** or **Classic User OAuth** in the Authorization section.
    ...
    For more information about the permission scopes, refer to the [Minimal user permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md#) table.
...
Type of integration profile. This field is automatically set to `PagerDuty Subscription`.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md#) table.
...
8.  Select **Create and Get OAuth Token**.
    ...
    **Note:** For the role required to perform this step, refer to the [Minimal user permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-pagerduty.md#) table.
