...
3.  On the side navigation bar, select the account icon \(![Account icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/../image/account-menu-icon.png)\) and then select **Apps &amp; Integrations**.
...
Type of integration profile. This field is automatically set to **Smartsheet Subscription**.
    ...
    **Note:** For more information, see [Minimal user permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/integrate-with-smartsheet.md#) table.
