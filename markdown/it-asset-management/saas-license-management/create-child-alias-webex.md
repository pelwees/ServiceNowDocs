...
1.  Create a Cisco Webex integration profile.
    ...
    For more information about creating an integration profile, see [Integrating with Cisco Webex](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-asset-management/saas-license-management/../concept/integrate-with-webex-apps.md#).
