...
Scroll along the lines to display the number of records contained in your selection. A list of the data contained in the displayed lines is listed in the header. Tap each segment in the header to see a list of records contained within that segment. To magnify or contract the chart view, spread or pinch your fingers on the screen. Tap the zoom-out button \( ![Zoom-out button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/button-zoom-out.png)\) to return the screen to its original magnification. For time series charts that support multiple lines, select lines from the legend that you want to include or omit from the chart.

 **Note:** The ability to magnify charts is available for the Android operating system.

 To list the records corresponding to the point highlighted in the chart line, tap the navigation arrow \(![Arrow button to list records specific to a point in the chart.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/button-specifc-records.png)\) in the chart header. Tap the list icon \(![Button to display all records related to the chart.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/button-all-records.png)\) in the screen header to display a list of all the records contained within the time series chart.

</td><td>

![Report chart drill-down.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/Report-chart-drilldown.png)
