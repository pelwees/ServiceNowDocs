...
-   You must create an input form screen before you create variables and attributes. For information about creating an input form screen, see [Configure an input form screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/parameter-screen-config.md).
...
</table>**Parent Topic:**[Configure reference inputs for input form screens in offline mode](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/reference-fields-offline-mode.md)
