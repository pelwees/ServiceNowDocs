...
-   [Legacy parameter screen \(UI parameters\), Quebec and earlier](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/parameter-input-screen.md)
-   [Input form screen \(sys\_sg\_parameter\_screen table\), Rome and later](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/parameter-input-screen.md)
-   [Details screen using the Attachment list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/sg-mobile-attachments.md)
-   [Offline mode](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/mobile-offline-mode.md)
