...
3.  In the screen shortcut record, update the **Screen** field by clicking the reference icon \(![Reference lookup icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/reference-lookup-icon.png)\) and selecting a screen. This screen displays to your users when they access the associated Siri shortcut.


**Parent Topic:**[Siri shortcuts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/siri-shortcuts.md)
