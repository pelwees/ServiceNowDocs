...
You can disable attachments for mobile apps by using access control rules. For more details on this process see [Disable attachments in mobile apps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/sg-disable-mobile-attach.md).
