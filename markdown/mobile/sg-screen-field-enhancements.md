...
![Text screen field with value only option selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/screen-field-value-only.png)
...
![Percentage screen field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/screen-field-percent.png)
...
![Screen field on form and image preview screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/screen-field-image.png)
...
![Attachment screen field on the incident table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/screen-enhance-attachment.png)
...
![Video screen field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/screen-field-video.png)

</td></tr><tr><td>

**File** Use a file screen field to display a PDF file within your form. The PDF displays as a preview on your form. Users can tap the preview \(![PDF preview icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/pdf-preview-icon.png)\) icon to open it in a preview screen where they can scroll and zoom on the PDF document. The file screen field gets its value from a field on the current record. The value must be the sys\_ID of an attachment \[sys\_attachment\] record on your instance that contains a PDF file.

</td><td>

![File screen field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/screen-field-file.png)
...
![HTML screen field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/field-screen-html.png)
...
![Mobile stage field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mobile-stage-field.png)
...
![Script screen option in a record screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/record-script-screen-platform.png)

</td></tr></tbody>
</table>-   **[Add screen fields to a record screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/sg-mobile-add-screen-field.md)**  
...
-   **[Add a video screen field to a record screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/sg-mobile-add-video-field.md)**  
