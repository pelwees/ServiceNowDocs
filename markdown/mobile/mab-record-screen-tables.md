...
![Mobile App Builder record screen table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-record-screen-table-large.png)

## Usage of Choose and New buttons in record screen tables

Each table within a record screen table displays either a **Choose** button \(![Choose button in record screen table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-button-choose.png)\), a **New** button \(![New button in record screen table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-button-new.png)\), or both buttons \(![Choose and New button in record screen table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-button-choose-and-new.png)\).
...
To change a single-reference record, first remove the existing reference by selecting the delete row icon \(![Delete row icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-button-delete-row.png)\), then either choose or create a new reference.

For more information about working with these options, see [Create reference record entries in record screen tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/mab-record-screen-table-add-edit.md) and [Edit record reference entries in record screen tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/mab-record-screen-table-edit.md).
...
|UI element|Function|
|----------|--------|
|![Actionable item in table reference record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-table-entry-blue.png)|Actionable items in a table reference record are blue. These items can be record names that open the record, remove buttons, and editable fields.|
|![Column sort button in table reference record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-column-sort.png)|The column sort icon is available within the header row of all tables in the Mobile App Builder. Select the column sort icon \(![Column sort icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-column-sort-triangle.png)\) to list the column contents in either ascending or descending order. The black triangle indicates the sorting order for the entire table.|
...
|![Delete row button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-button-delete-row.png)|Use the remove icon to remove an entry from the record. It does not delete the entry from the database.|

**Related topics**  


[Create reference record entries in record screen tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/mab-record-screen-table-add-edit.md)

[Edit record reference entries in record screen tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/mab-record-screen-table-edit.md)
