...
-   **Standard data items**
    ...
    For information on standard data items, see [Configure a standard data item](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/sg-studio-create-data-item.md).
