...
For examples of configuring smart buttons, see [Configure a smart button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/sg-studio-config-smart-button.md).
