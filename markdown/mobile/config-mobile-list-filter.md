...
For information about configuring map screens, see [Configure a map screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/sg-configure-map-screen.md).
