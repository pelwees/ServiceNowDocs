...
4.  Select the **List** option in the Create a screen page, and then select **Continue**.
    ...
    ![blank list screen creation record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-list-screen-creation.png "New list screen creation screen")
...
6.  Select **Create**.
    ...
    **Note:** Selecting **Cancel** takes you back to the **Screens** selection page.
    ...
    ![three generated records with a blue spark next to them](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-generated-records-icon.png "Generated record icons")
...
![List screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mobile-list.png "Created list screen")
