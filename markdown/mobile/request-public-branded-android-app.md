 ...
 **Note:** Deep links can only be edited when you submit a new branded app request or when you update a branded app.
 ...
 To learn more about mobile deep links, see [Deep linking for mobile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/deep-link-mobile.md).
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded Android app for public distribution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/testpubnu-andapp-pubdist.md).
