...
After activating the plugins and performing the various configurations, you must enable location tracking for users. For more information, see [Enabling location tracking for users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/location-tracking-add-user.md).
...
-   **[Enabling and selecting location tracking options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/location-tracking-enable.md)**  
...
-   **[Enabling location tracking for users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/location-tracking-add-user.md)**  
