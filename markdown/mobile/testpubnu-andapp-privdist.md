...
3.  Select the **Android testing file** link and the APK file is downloaded to your local system for testing:
    ...
    ![Mobile Publishing UI showing the Android .apk file download link](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mob-pub-apk-download-link.png)
