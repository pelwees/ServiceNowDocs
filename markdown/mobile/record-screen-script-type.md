...
For full configuration instructions, see [Configure the script field for records screens](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/record-screen-script-type-config.md).
...
**Parent Topic:**[Add screen fields to a record screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/sg-mobile-add-screen-field.md)
