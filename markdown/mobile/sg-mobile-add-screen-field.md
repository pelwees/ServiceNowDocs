...
Type of screen field. For a list of types and a description of how they're used, see [Screen fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/sg-screen-field-enhancements.md).**Note:**
...
**Note:** For more information about using the script screen option, see [Dynamic variable support in record screens](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../reference/record-screen-script-type.md).
...
-   **[Dynamic variable support in record screens](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../reference/record-screen-script-type.md)**  
...
-   **[Configure the script field for records screens](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/record-screen-script-type-config.md)**  
