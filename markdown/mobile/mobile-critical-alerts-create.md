...
This task describes how to create a critical alert from an existing push notification. To create a push notification from scratch, see [Mobile push notifications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/sg-mobile-push-notifications.md).
...
4.  From the **Record type** field, select Notification \[sysevent\_email\_action\] and then select an existing push notification event.
    ...
    **Note:** If you want to create a push notification from scratch, refer to [Mobile push notifications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/sg-mobile-push-notifications.md). You then must follow these subsequent steps to define the push notification as critical.

5.  Select the Push notification message content record within the Push notification event.

    ![Location of the push notification message content in the MAB hierarchy tree.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/push-notif-mess-content.png)

6.  Within the **Push message content** area, define and configure your critical alert.

    For information on how to configure a critical alert, see [Configure code for critical alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../reference/mobile-citical-alert-code.md).
...
8.  Complete these steps if you need the same push notification to be pushed to different mobile applications.
    ...
    2.  Select the more button \(![More button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/mab-button-more.png)\) and select **Duplicate**.
