...
![Ensure logos are 550 pixels from the edge of the image to avoid a cut off appearance.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/logo-padding.png)

Images that don't follow this guideline may appear cut off, as shown in this example.

![Example with cut off logo and text.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../image/cut-off-icon.png)
 ...
 **Note:** Deep links can only be edited when you submit a new branded app request or when you update a branded app.
 ...
 To learn more about deep links, see [Deep linking for mobile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/deep-link-mobile.md).
...
-   Don't select this option if you're using AppConfig to pre-configure a default instance URL through an EMM suite or an embedded MAM SDK app. For more information, see [AppConfig for Mobile Apps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../reference/appconfig.md).
...
After the build successfully completes and your app is ready for testing, see [Test and publish a new branded Android app for private distribution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/testpubnu-andapp-privdist.md).
