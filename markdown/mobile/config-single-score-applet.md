...
In addition, you also need a mobile analytics preview contained within a mobile dashboard preview. For more information, see [Create a mobile analytics preview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/sg-mobile-dashboard-preview.md).
...
Configure a navigation function to direct your users from an analytics preview to your chart screen. For details on this process, see [Create a navigation function to a chart screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/config-chart-nav.md).
