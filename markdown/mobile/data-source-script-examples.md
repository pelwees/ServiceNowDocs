...
**Note:** All the scripts listed in this topic are configured within the data source record. For more information, see [Configure data sources](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../task/data-sources-config.md).
