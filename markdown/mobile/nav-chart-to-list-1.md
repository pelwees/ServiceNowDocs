...
Configure the List item config for your list screen to choose the cards and fields that will appear on this list. For more information, see [List screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/../concept/list-screen.md).

If you're adding an analytics preview to the launcher screen UI section. See, [Configure an analytics UI section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/mobile/sg-ui-section-config-reports.md).
