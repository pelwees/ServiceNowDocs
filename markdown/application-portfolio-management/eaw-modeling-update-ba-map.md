...
4.  Select the newly added shape and select the Open the side panel icon \(![Open side panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/modeling/icon-open-side-panel.png)\) to open the details panel for the selected shape in the canvas.

5.  Select a shape in the diagram to see the following options:

    -   Side panel icon \(![Open side panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/modeling/icon-open-side-panel.png)\) to update the details of a record.
    -   Add related records icon \( ![Add related records](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/modeling/icon-add-related-records.png)\) to add entities and relationship.
    -   More Actions context menu \(![More actions menu](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/eaw-icon-menu.png)\) to see options for adding relationship or deleting a shape from the canvas.
...
8.  Select the More Actions menu \(![More actions menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/icon-three-dot-menu-eaw.png)\) to perform the following actions:
...
[Update a business capability map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-modeling-update-bc-map.md)
