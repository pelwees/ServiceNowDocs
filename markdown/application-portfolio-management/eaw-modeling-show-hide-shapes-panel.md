...
4.  Select the **Toggle shape library** icon on the diagram page to show or hide the panel.
    ...
    ![Show or hide the shapes panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/modeling/modeling-show-hide-shapes-panel.gif)
