...
3.  Use one of the following options to deactivate a policy.
    ...
    ![Deactivate a policy using the context menu](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/eaw-data-cert-deactivate-policy.png)

    A confirmation message appears.

    -   Open the policy by selecting the policy name link and select the **Deactivate Policy** button.
    ![Deactivate a policy from the record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/eaw-data-cert-deactivate-from-recordpage.png)
