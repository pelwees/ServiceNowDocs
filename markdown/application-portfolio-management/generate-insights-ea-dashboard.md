...
2.  Select the Explore with AI icon \(![Explore with AI icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai.png)\) on any widget on the dashboard.

    The AI pop-up window appears.

    ![Enterprise Architecture Workspace Dashboard page displaying the Explore with AI pop-up window.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-popup.png)
...
Use this option to enable Now Assist to generate its own insights into the widget data.
    ...
    ![Screenshot of the explore with AI pop-up window with the analysis type options highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-zoom.png)
...
4.  Enter your query or select any of the available options.
    ...
    ![Screenshot of the AI Data Explorer window displaying the insights generated for the selected widget.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-output.png)
...
5.  View the AI Data Explorer insights and take further actions.
    ...
    -   Define a goal in the **Goal** box for Now Assist to improve the quality of insights and suggestions.
        ...
        ![Screenshot of the AI Data Explorer window displaying the Goal box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-goal.png)

    -   Ask follow-up questions based on suggestions provided by Now Assist

        ![Screenshot of the AI Data Explorer window displaying list of follow-up questions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-flw-up-qst.png)

    -   Select **Summarize** to summarize the insights generated.

        ![Screenshot of the AI Data Explorer window with the Summarize button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-summarize.png)

    -   Share, duplicate, or delete the insights generated by AI Data Explorer by selecting the more actions icon \(![More actions icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../application-portfolio-management/image/eaw-image/eaw-icon-menu.png)\).

        ![Screenshot of the AI Data Explorer window displaying the more actions drop-down menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../image/explore-ai-share.png)
...
[Configure AI Data Explorer and Query Generation skills](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/configure-ai-data-explr-qry-genr-skills.md)
