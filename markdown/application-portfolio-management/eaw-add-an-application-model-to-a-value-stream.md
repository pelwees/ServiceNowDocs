...
8.  On the form, fill in the field.
    ...
    For a description of the field values, see [Create new application model form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../reference/eaw-reference/eaw-create-new-application-model-from.md).
