...
6.  In the body of the ADR docs, enter **/**.![Context menu displaying the available options to tag.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/adr-tag-user-or-records.png)
...
7.  Tag a record or a user.
    ...
    -   To tag a record:
        1.  Select **Mention a record**.
            ...
            ![List of available records for tagging.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/adr-available-records-to-tag.png)

        2.  Select a record type.

            A context menu is displayed listing the available records for that record type.

            ![List of available records for the selected record type.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/adr-available-users-to-tag.png)
    ...
    -   To tag a user:
        1.  Select **Mention a user**.
            ...
            ![List of available users for tagging.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/adr-tag-users-list.png)
