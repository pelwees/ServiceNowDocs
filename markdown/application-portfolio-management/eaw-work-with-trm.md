...
-   **[View all TRM phases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-all-trm-phases.md)**  
...
-   **[View all TRM products grouped by product category](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-all-trm-products-grouped-by-product-category.md)**  
...
-   **[View all TRM products](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-all-trm-products.md)**  
You can view all available Technology Reference Model \(TRM\) products in the Enterprise Architecture Workspace.
-   **[Request a TRM product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-request-a-trm-products.md)**  
You can request a TRM product using the TRM catalog to add a new software or hardware to the TRM library.
-   **[Request a TRM product lifecycle](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-request-a-trm-product-lifecycle.md)**  
...
-   **[View product capabilities associated with a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-capabilities-associated-with-trm-product.md)**  
...
-   **[Create product capabilities and associate it with a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-create-a-new-product-capability-and-assoc-trm-product.md)**  
...
-   **[Add an existing product capability to a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-add-existing-product-capability-to-trm-product.md)**  
...
-   **[Remove product capabilities associated with a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-remove-product-capabilities-assoc-with-trm-product.md)**  
...
-   **[View business applications associated with a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-ba-assoc-with-trm-product.md)**  
...
-   **[Add an existing business application to a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-add-existing-ba-to-trm-product.md)**  
...
-   **[Remove business applications associated with a Technology Reference Model product](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/remove-ba-assoc-with-trm-product.md)**  
...
-   **[Export Technology Reference Model product category data to Excel or CSV](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-export-trm-prod-cat-data.md)**  
