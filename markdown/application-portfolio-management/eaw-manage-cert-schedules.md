...
3.  Select the expand row icon \(![expand row icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/ExpandIcon.png)\) next to **Certification Policies**.
...
6.  On the CMDB Data Management Certification Policy form, fill in the fields.
    ...
    For field information, see [Certification policy form in Enterprise Architecture Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../reference/eaw-reference/eaw-certification-policy-form.md).
