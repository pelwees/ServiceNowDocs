...
-   **[Create a diagram for a business application in the EA Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-create-diagram-ba.md)**  
...
-   **[Add an existing AI system to a business application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-add-ai-system-to-ba.md)**  
...
-   **[View product capabilities associated with a business application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-product-capabilities-associated-with-ba.md)**  
...
-   **[Add an existing product capability to a business application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/add-existing-product-capability-to-ba.md)**  
You can add existing product capabilities to business applications in the Enterprise Architecture Workspace.
-   **[Remove product capabilities associated with a business application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-remove-product-capabilities-associated-with-ba.md)**  
...
-   **[View Technology Reference Model products associated with business applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-view-trm-products-assoc-with-ba.md)**  
...
-   **[Create Technology Reference Model products and associate it with business applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-create-trm-products-and-assoc-ba.md)**  
...
-   **[Add existing Technology Reference Model products to business applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-add-existing-trm-products-to-ba.md)**  
...
-   **[Remove Technology Reference Model products associated with a business application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-remove-trm-products-assoc-with-ba.md)**  
...
-   **[Working with product capabilities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-working-with-product-capabilities.md)**  
...
-   **[Run a scheduled job to generate an application model for business applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-run-job-gen-model-id-ba.md)**  
...
[Working with application Total Cost of Ownership \(TCO\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-work-with-tco.md)

[Working with digital integration management in Enterprise Architecture Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-work-with-digital-integ-mngmnt.md)
