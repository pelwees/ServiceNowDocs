...
![List view in the Application Rationalization page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/eaw-list-view.png "List view")
...
![Scores for fiscal period list highlighted on the Application rationalization list view page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/fiscal-period-dropdown.png)
...
You can select the name of a business application to open it and view its associated details. Also, you can select the expand row icon \(![Expand row icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/ExpandIcon.png)\) to see the demands and projects associated with that business application. On selecting a demand or a project, its details are displayed. You can modify business application details and its associated demand and project details, as required.
...
To view the actual scores of indicators, select the data visibility icon \(![Data visibility icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/list-view-display-visibility-icon.png)\) and then enable the **Show actual score data** toggle.

![List view page with the data visibility icon and Show actual score data toggle highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/list-view-actual-score-toggle.png)
...
![List view page with the actual and normalized score columns highlighted for the Number of Incidents indicator.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/list-view-scores-highlighted.png)
...
-   Edit business application details. For more information, see [Edit business application details in list view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-edit-business-application-details.md).
-   Create a demand for a business application. For more information, see [Create a demand using the list view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-create-a-demand-using-the-list-view.md).
-   Set the planned disposition of a business application. For more information, see [Set the planned disposition of a business application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-set-planned-disposition-of-a-business-application-listview.md).
-   Add the business application lifecycle data. For more information, see [Add business application lifecycle data using the list view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-add-business-application-lifecycle-data-listview.md).
-   You can add or hide the displayed columns according to your requirement by selecting the Personalize icon \(![Personalize icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/icon-bubblechart-settings.png)\). Your display preferences are saved and applied the next time you visit the page.
-   Export the list view data to Microsoft Excel or CSV. For more information, see [Export application rationalization data to Excel or CSV](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-export-app-rat-list-data.md).
...
**Parent Topic:**[Rationalization of business applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-rationalize-business-applications.md)
...
[Export application rationalization data to Excel or CSV](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-export-app-rat-list-data.md)

[Apply filters on the Application Rationalization page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../task/eaw-task/eaw-apply-filters-app-rat.md)
