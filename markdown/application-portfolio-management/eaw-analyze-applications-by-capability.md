...
4.  Modify the bubble chart parameters as required by selecting the settings icon \(![Settings icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/icon-bubblechart-settings.png)\).
    ...
    -   X and Y axis: Dimension of the indicators that fall into the X and Y-axis. The available options are derived from the Application Bubble Charts table \[apm\_bubble\_chart\]. The indicator scores are gathered from the Indicator Scores table \(apm\_app\_indicator\_score\).
        ...
        **Note:**
        ...
        -   For details on how to add the X and Y-axis indicators of the bubble chart, see [Add or edit an application indicator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/eaw-create-indicator.md).
