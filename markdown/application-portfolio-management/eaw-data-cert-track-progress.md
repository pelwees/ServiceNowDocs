...
3.  Select the **Track Progress** tab.
    ...
    A list of certification instances are displayed with details such as due date, percent complete, and associated tasks.![Track progress of certification policies](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/eaw-data-cert-track-prog.png)
