...
3.  Select the TRM more actions icon ![TRM more actions icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../image/eaw-image/trm-more-actions-icon.png) next to **Request TRM product**.

4.  Select **Request TRM product lifecycle**.

5.  On the form, fill in the fields.

    For field information, see [Request TRM product lifecycle form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-portfolio-management/../../reference/eaw-reference/eaw-create-trm-prod-lifecycle-req-form.md).
