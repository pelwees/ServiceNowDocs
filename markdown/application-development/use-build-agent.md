...
-   **[Accessing Build Agent in ServiceNow Studio and the ServiceNow IDE](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../concept/access-build-agent.md)**  
...
-   **[Create an application using Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/create-a-new-application-using-build-agent.md)**  
...
-   **[Edit an existing application using Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/edit-an-existing-application-using-build-agent.md)**  
Modify existing ServiceNow applications using natural language prompts with Build Agent.
-   **[Creating or updating an app file with Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../concept/creating-or-updating-an-app-file.md)**  
...
-   **[Create agentic workflows, agents, and skills](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/create-custom-ai-agent.md)**  
...
-   **[Revert app changes with Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/revert-app-changes-using-build-agent.md)**  
...
-   **[Testing what you built](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../concept/build-agent-testing.md)**  
...
-   **[Build Agent conversation change log](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../concept/ba-conversational-change-log.md)**  
...
-   **[Troubleshooting in Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../reference/build-agent-troubleshooting.md)**  
