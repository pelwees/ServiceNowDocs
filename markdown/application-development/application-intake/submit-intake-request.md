...
If you have not already [activated the Apply for Citizen Development standard catalog item](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/application-intake/activate-catalog-item-for-app-intake.md), you must do so before you can perform this procedure.
...
1.  Navigate to **All** &gt; **Self-Service** &gt; **Service Catalog**.
    ...
    ![Service Catalog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/application-intake/../image/can-we-help-you.png "Service Catalog")

2.  In the Service Catalog, select the **Can We Help You?** category.

    ![Apply for Citizen Development catalog item](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/application-intake/../image/apply-for-cit-dev.png "Apply for Citizen Development catalog item")
...
If you are an admin who approves requests, learn more about [managing AEMC requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/application-intake/../concept/manage-aemc-requests.md).
