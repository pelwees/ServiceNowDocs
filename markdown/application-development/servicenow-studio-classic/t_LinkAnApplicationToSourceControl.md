...
-   Role required: admin
-   Learn more about [Managing application-customizations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/manage-customizations-store-apps.md).
...
-   Learn more: [Legacy - Migrate completed update set history to Source Control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../concept/migrate-update-set-history.md)
...
2.  Navigate to **Source Control** &gt; **Link to Source Control**.
    ...
    Studio displays the Link to Source Control dialog box.![Link to Source Control dialog box](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/mid-server-ssh-box.png)
...
-   **[Legacy - Using MID Server with source control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../concept/tips-source-control-midserver.md)**  
