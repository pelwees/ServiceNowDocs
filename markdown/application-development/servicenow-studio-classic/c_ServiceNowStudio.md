...
![Studio User interface displaying the header, application explorer, content frame, and status bar.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/studio-ui-istanbul.png "Studio")
...
For more information, see [Exploring ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../../servicenow-studio/concept/exploring-servicenow-studio.md)and [Build Agent in ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../../servicenow-studio/concept/build-agent-in-servicenow-studio.md).
...
Allows developers to [add an application file to an application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_AddAnAppFileToAnApp.md).
...
The status bar displays the name of the [current application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_UpdateAnApplicationRecord.md).
...
The status bar displays the current [application version](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_ApplicationVersioning.md).
...
The status bar displays the total number of [application files](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_ApplicationFiles.md).
...
The status bar displays the current number of application files with [unsaved changes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_CommitChanges.md).
...
The status bar displays an icon indicating the current status of the [source control integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_SourceControlIntegration.md).

</td></tr></tbody>
</table>-   **[Legacy - Access ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_AccessStudio.md)**  
Application developers access ServiceNow Studio to create, import, or open applications.
-   **[Legacy - ServiceNow Studio keyboard shortcuts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../reference/r_ServiceNowStudioKeyboardShortcuts.md)**  
ServiceNow Studio supports various keyboard shortcuts to manage and edit application files.
-   **[Legacy - Add an application file to an application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_AddAnAppFileToAnApp.md)**  
Studio allows application developers to add new application files by type.
-   **[Legacy - Publish an application from ServiceNow Studio when linked to Source Control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/publish-app-from-studio.md)**  
You can publish a custom application from ServiceNow Studio when linked to Source Control.
-   **[Legacy - Search for an application file by name or type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_SearchForAppFilesByNameOrType.md)**  
Application developers can use Studio to search for application files.
-   **[Legacy - Search within application files](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_SearchWithinApplicationFiles.md)**  
Studio allows application developers to search within application files for matching record values.
-   **[Legacy - Update a custom application record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_UpdateAnApplicationRecord.md)**  
You can update a custom application record to add new features or change application functionality.
-   **[Legacy - Switch between applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_SwitchBetweenApplications.md)**  
Application developers can switch between applications without leaving the Studio environment.
-   **[Legacy - Global application file management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/manage_global_application_files.md)**  
...
-   **[Legacy - Automatic recovery of draft records](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_AutomaticRecoveryOfDraftRecords.md)**  
...
-   **[Legacy - Source Control integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_SourceControlIntegration.md)**  
...
**Parent Topic:**[Building pro-code applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../../custom-application/reference/building-pro-code-applications.md)

**Related topics**  


[Contextual development environment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_ContextualDevelopmentEnvironment.md)
