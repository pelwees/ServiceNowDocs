...
![The automatic recovery message reads, Previous unsaved edits to this record have been recovered. Continue to edit or clear the changes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/AutorecoveryUnsavedChanges.png "Automatic recovery message")
...
-   **[Legacy - Auto recovery properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../reference/r_AutoRecoveryProperties.md)**  
Administrators can configure how Studio handles the recovery of draft records by navigating to **Auto Recovery** &gt; **Properties**.
-   **[Legacy - Auto recovery dictionary attribute](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../reference/r_AutoRecoveryDictionaryAttributes.md)**  
