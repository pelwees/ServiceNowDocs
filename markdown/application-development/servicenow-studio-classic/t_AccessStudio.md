...
1.  Select the path available to your role.
    ...
    ![The Select Application modal dialog with options to create application, import from source control or open an existing application.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/select-app.png)
