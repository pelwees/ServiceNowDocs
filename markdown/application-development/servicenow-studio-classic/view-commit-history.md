...
1.  Navigate to **All** &gt; **Source Control** &gt; **View History**.
    ...
    ![History window displaying two commit changes: one from the user david.loo and one from the user admin.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/source-control-view-history.png)
