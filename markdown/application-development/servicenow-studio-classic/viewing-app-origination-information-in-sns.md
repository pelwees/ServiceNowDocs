...
![The app details page shows badges for AI, Creator Studio, and Fluent to let you know where the app was created and may need to be deployed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/sn-studio-crs-badge.png)
...
You can open your app in Creator Studio by selecting the more options icon ![more options icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/sn-studio-more-options-icon.png) on the Navigator panel or the App details page and selecting **Open with Creator Studio**. For more information, see [Building apps with Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../../creator-studio/concept/building-apps-with-creator-studio.md).

![Option to open the current app in Creator Studio from the Navigator panel.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/sn-studio-open-in-crs.png)

![Option to open the current app in Creator Studio from the App details page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/sn-studio-open-w-creator-studio.png)
...
![Filter the list showing All, Custom, Store, Creator Studio, and Fluent options to see the apps you need.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/sn-studio-app-filter-ys2.png)
...
![In the IDE Created column, find information about which environment your app was created in. This image shows two apps created in Creator Studio and two in ServiceNow Studio.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../image/sn-studio-ide-created.png)

**Parent Topic:**[Change your development experience in ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/change-your-development-experience.md)
