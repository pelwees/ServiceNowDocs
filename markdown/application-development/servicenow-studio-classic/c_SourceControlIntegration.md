...
Use an existing MID Server to connect to a Source Control repository. [Linking](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_LinkAnApplicationToSourceControl.md) or [importing](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_ImportAppFromSourceControl.md) an application through a MID Server enables access to repositories behind a firewall.
...
-   **[Legacy - Production deployment tips](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/tips-production-deployment.md)**  
...
-   **[Legacy - Available source control operations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../reference/r_AvailableSourceControlOperations.md)**  
...
-   **[Legacy - Import application or application-customization from source control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_ImportAppFromSourceControl.md)**  
...
-   **[Legacy - Link an application or application-customization to source control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_LinkAnApplicationToSourceControl.md)**  
...
-   **[Legacy - Migrate completed update set history to Source Control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/migrate-update-set-history.md)**  
...
-   **[Legacy - Edit a Git repository configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/edit-git-repo.md)**  
You can edit a Git repository to change the network protocol selection, credentials or other field entries.
-   **[Legacy - Apply remote changes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_ApplyRemoteChanges.md)**  
Application developers can pull changes from a linked GIT repository to apply remote changes to the local instance.
-   **[Legacy - Commit changes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_CommitChanges.md)**  
...
-   **[Legacy - Stash local changes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_StashLocalChanges.md)**  
Application developers can remove and save changes locally to apply them later.
-   **[Legacy - Switch branch](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_SwitchBranch.md)**  
Application developers can switch to a different repository branch to work on another version of the application.
-   **[Legacy - Create branch](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_CreateBranch.md)**  
Application developers can create a branch to work on a new version of an existing application.
-   **[Legacy - Set default branch](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/set-default-branch.md)**  
...
-   **[Legacy - Manage stashes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_ManageStashes.md)**  
Application developers can apply or delete stashed changes from Studio.
-   **[Legacy - Resolve conflicts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/t_ResolveConflicts.md)**  
Application developers can choose which application file version to use when applying remote or stashed changes.
-   **[Legacy - View commit history](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/view-commit-history.md)**  
Application developers can view the commit history of applications linked to a source control repository.
-   **[Legacy - Move application files in a GIT repository](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/move-application-files-git.md)**  
...
-   **[Legacy - Collision avoidance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/../task/collision-avoidance.md)**  
Avoid modifying an application file across different update sets to ensure seamless experience during the commit process.
-   **[Legacy - Delta loading](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/delta-loading.md)**  
"Delta loading" is an optimized way to load an application from a Git repository.
-   **[Legacy - De-noise your source control commits](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/denoise-source-control-commits.md)**  
...
**Parent Topic:**[Legacy - ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-studio-classic/c_ServiceNowStudio.md)
