...
![Select the delete icon to delete a question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../image/crs-delete-question.png "Deleting a form question")

-   **[Delete a form in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/crs-delete-form.md)**  
Delete an unpublished form from a Creator Studio app to remove it completely from the ServiceNow AI Platform.
-   **[Hide a form from use in the ServiceNow AI Platform in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-deactivate-form.md)**  
