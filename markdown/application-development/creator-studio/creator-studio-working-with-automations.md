...
**Summary:** After reading this section, you'll understand how to use [automation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/creator-studio-glossary.md#) to do the following things:
...
**Note:** Because playbooks are based on forms, you must publish a form \(mark it as ready\) before you use it to create a playbook. For more information, see [Publish a form for your app in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-publish-form.md).

[Playbooks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/creator-studio-glossary.md#) are a series of steps triggered by an event. You can add multiple playbooks to an app if needed
...
Learn how to add activities in [Add activities to an app's playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-add-activities-automation.md).
...
![A playbook in Creator Studio in Diagram view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../image/crs-playbook-diagram.png "Diagram view of the playbook")
...
![A playbook in Creator Studio in Board view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../image/crs-playbook-board.png "Board view of the playbook")
...
-   **[Workflow for creating automations in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-automations-workflow.md)**  
...
-   **[Add an automated playbook to an app in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-add-automation.md)**  
...
-   **[Copy an automated playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-duplicate-automation.md)**  
...
-   **[Add activities to an app's playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-add-activities-automation.md)**  
...
-   **[Add a decision to an app's playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-add-decision-automation.md)**  
...
-   **[Add a parallel process to an app's playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-decision-parallel-process-add.md)**  
Create parallel processes in Creator Studio to make things happen in your app at the same time.
-   **[Edit the trigger for a playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-add-trigger-automation.md)**  
Define the trigger for a playbook in Creator Studio to specify what makes the playbook start running.
-   **[Edit a playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-edit-automation.md)**  
Update a playbook to change its settings, or rearrange or remove tasks, to make it work for your app.
-   **[Activate a playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-activate-automation.md)**  
...
-   **[Delete a playbook in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-delete-automation.md)**  
