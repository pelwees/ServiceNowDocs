...
-   **[Steps to create a custom activity in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/creator-studio-custom-activity-workflow.md)**  
There are multiple steps to add custom activities for use in Creator Studio automations.
-   **[Make a custom activity available for playbooks in Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-add-custom-activity.md)**  
...
-   **[Reorder how activities appear in a playbook's activity picker](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-reorder-activities.md)**  
Change the order that activities appear in the activity picker in Creator Studio to present them in the order you want.
-   **[Make an activity unavailable in playbooks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../task/creator-studio-hide-activity.md)**  
