...
For complete details on which roles each role contains, see [Components installed with Creator Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/creator-studio-components-installed.md).
...
-   The user is automatically delegated as the app owner. For more information, see [Delegated development and deployment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/creator-studio/../../applications/concept/c_DelegatedDevelopment.md).
