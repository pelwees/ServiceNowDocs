...
-   **[Install Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/install-build-agent.md)**  
Install the Now Assist for Creator application from the ServiceNow Store to get the Build Agent.
-   **[Build Agent plugins](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../reference/build-agent-plugins.md)**  
The plugins for Build Agent depend on whether you're using the free/trial version or premium version.
-   **[Connect Build Agent to a supported MCP server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ba-connct-mcp-server.md)**  
...
-   **[Connect Build Agent to a Figma MCP server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/connect-figma-mcp-server-to-build-agent.md#)**  
