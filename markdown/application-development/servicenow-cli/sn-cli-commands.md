...
-   **--help**
    ...
    Provides help information for the specified command, which includes the description, supported arguments, and examples. For more information, see [Get help with ServiceNow CLI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-cli/../task/get-help.md).
...
-   **--debug**
    ...
    provides debug logging output when executing a command. For more information, see [Get help with ServiceNow CLI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-cli/../task/get-help.md).
...
-   **--profile**
    ...
    Specifies the named profile to use for a command. For more information, see [Configuring and managing your ServiceNow CLI connection profiles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-cli/../task/configure-profile.md).
