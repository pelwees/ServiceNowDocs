...
Setting deployment permissions in Manage Developers. See [Delegate development and deployment permissions to personnel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/delegated-development-and-deployment/../task/t_AddADeveloper.md)
...
Assignment of deployment user roles to specific persons. See [Instance-specific deployment user roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/delegated-development-and-deployment/delegated_deployment_user_roles.md).
...
As a system administrator, you want to assign Abel Tuter certain developer and deployment permissions for a specific application in your development instance. For more details on developer and deployment permissions, see [Delegate development and deployment permissions to personnel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/delegated-development-and-deployment/../task/t_AddADeveloper.md).

![manage developers permissions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/delegated-development-and-deployment/../image/ManageDevelopers2.png).

**Related topics**  


[Application files](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/delegated-development-and-deployment/c_ApplicationFiles.md)
...
[Application sharing](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/delegated-development-and-deployment/c_SharingApplications.md)
