...
For procedures, see [Restrict access to an application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../task/enable-application-administration.md).
...
For procedures to enable application administration and restrict the assignment of application-specific roles, see [Restrict access to an application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../task/enable-application-administration.md).
...
[Delegated development and deployment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/c_DelegatedDevelopment.md)
