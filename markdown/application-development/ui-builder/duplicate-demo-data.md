...
3.  In the **Search UI interactions** field, enter `demo`.
    ...
    ![UI interactions list with demo interactions listed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/uib-uii-demo-list.png)
...
**Parent Topic:**[Working with UI interaction demo data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../concept/working-with-demo-interactions.md)
