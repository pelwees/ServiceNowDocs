...
3.  Select the page that you want to upgrade.
    ...
    ![Page variants that can be upgraded to the new layout system.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/uib-update-layout-icon.png)
...
4.  Select the **Update layout** button.
    ...
    ![UI Builder updating a page layout to the new layout system.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/uib-update-layout.gif)
...
5.  You can compare your old layout to the upgraded layout by selecting **compare the two layout versions** in the **Layout needs review before you can edit** notification.
    ...
    ![Compare layouts before rejecting or accepting the changes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/uib-layout-review.png)
...
7.  Select **Keep new** to complete the upgrade to the new layout system, or select **Use old** to reverse the upgrade process and return the page to the old layout system.
    ...
    ![Confirm that you want to keep the updated layout for your experience.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/uib-layout-keep-new.png)

8.  The page reloads with the changes applied.

9.  View and test your page by selecting the **Preview** button \(![Preview button that opens the page variant.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/preview-button.png)\).
