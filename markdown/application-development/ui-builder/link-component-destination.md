...
9.  In the Inherited event handlers section, select **Link to destination**.
    ...
    ![Arrow pointing to the link to destination inherited event handler.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/link-destination-select-handler.png)

10. Click **Select destination**.

    ![Arrow pointing to the select destination button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-select-dest.png)
...
12. Complete each required parameter field and the applicable parameter fields with an appropriate `@payload.*` value.
    ...
    ![Using autocomplete to select the @payload.indicator_sysId property for the uuid parameter field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-destination-props.png)
...
![List of UX Applications.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handlers-ux-app-list.png)
...
![Destination Relay event handler.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-link-destination-relay.png)
...
![Last page of the create a page wizard.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-page-parameters.png)
...
![Configure tab of the list component.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-list-config.png)
...
![Configuring the navigation for a link to the destination event handler.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-destination.png)
...
**Parent Topic:**[Bind an event to a data resource](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/bind-event-data-resource.md)
