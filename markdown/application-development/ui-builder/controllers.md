...
![List controller added with the List Page Template.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-data-shelf-example.png "Controller in the Data resource drawer")
...
![Highlighted components with preset label.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/presets-highlighted-components.png "Components with presets")
...
5.  Select **Data resource**.
    ...
    ![Add a Data resource option.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/data-resource-open.png)
...
8.  Select **Add**.
    ...
    ![Select the form controller to add it to the page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-add-button.png)

9.  Fill in the fields to configure the controller.

    ![Controller configuration modal.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-apply-button.png)
...
![Form controller displays in the data resource section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-add-result.png)
...
4.  Select the controller that you want to edit in the **Data and scripts** drawer.
    ...
    ![Arrow pointing to the form controller located in the data resources drawer.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-add-result.png)
...
4.  Select the **Menu** icon \(![Menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-menu-icon.png)\) next to the controller you want to delete.

    ![Arrow pointing to the data resource menu icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-open-menu.png)

5.  Select **Delete**.

    ![Arrow pointing to the delete option in the controller menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/controller-delete-option.png)
...
This procedure assumes that you have placed a component with a preset on the page and have configured a controller. For instructions, see [Add a controller](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/controllers.md#).
...
![Shows the preset properties expressed as a path to the controller data in the configure panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-config-panel.png)

1.  To view the data resources for a component, select the data icon in the lower left sidebar.

    ![Arrow pointing to the data resource icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/data-shelf-icon.png)
...
2.  In the first column where the data resources are listed, select the controller whose output you want to view.
    ...
    **Note:** Configuring **-1** for the value in the **Sys ID** field configures the controller for a new record. The controller then generates a full GUID that you can use to store data against the record before it's saved. This allows you to perform actions in a newly created record such as saving attachments.
    ...
    ![Shows the user configuration for the Record controller in the data resources panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-user-config.png)
...
3.  Select **top level outputs** in the third column.
    ...
    ![Shows the top level parent category for controller data and how it is used to create the first part of the path to specific data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-parent-level.png)
    ...
    ![Shows how the path to a controller output value is derived for a preset property value at the top level](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-top-level-path.png)
...
4.  To view data below the top level, select the child category indicated by the path in the preset property value.
    ...
    ![Shows how the path to the second level of controller data is appended to the base path for the controller in the data inspector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-second-level-data.png)

    In this example, multiple controller output properties are used in a formula expression to build an object.

    ![Shows how to use multiple controller output properties to build a formula for a property in UI Builder](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-formula-example.png)
...
5.  To view a scripted property value, select the lock icon next to the property.
    ...
    ![Shows the edit scripted property value modal with the mapping to the controller data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-edit-scripted-value.png)
...
2.  To view the mapping for a preset event, select the event tile.
    ...
    ![Selected event showing the modal containing preset values for the event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-view-preset-event.png)

3.  To add an event handler to the event, select **+ Add event handler** under the event tile.

    ![Shows the control for adding event handlers to a preset event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-add-event-handler.png)
...
4.  Select an event handler from the list and select **Add**.
    ...
    ![Shows the event handler that was selected from the list of available handlers added to the event tile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../../../build/component-uib-setup/image/controller-api-new-event-handler.png)
