...
![Edit audiences modal with options to set the audience or audiences and order.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/add-audience-form.png "Add audiences modal")
...
-   Choosing an audience from the list in the **Audience** field.
    ...
    ![UI Builder variant audience drop down list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/UIB-varant-audience-drop-down.png "Audience list")
