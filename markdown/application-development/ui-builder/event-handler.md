...
10. Select the handler you want to trigger from the event selected in the earlier step.
    ...
    ![Link to destination selected from the handler list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-select-list-link-dest.png)

11. Select **Continue**.

12. Configure the payload for the event.

    ![Event handler configured to open the list page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/event-handler-configured.png)
