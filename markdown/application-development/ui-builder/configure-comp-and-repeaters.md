...
-   **[Add repeaters to components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../task/repeaters.md)**  
In UI Builder, use repeaters to repeat one or more components with results from a data resource.
-   **[Optimize page loading performance \(Advanced Feature\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../task/performance-settings.md)**  
