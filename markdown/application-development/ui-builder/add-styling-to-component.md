...
For information about adding styling to your entire experience, see [Manage the visual style of UI Builder experiences](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../concept/manage-the-visual-style-of-ui-builder-experiences.md).
...
5.  For Body or a component, select the **Styles** tab in the configuration panel.
    ...
    ![Configuration panel Styles tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/styles-tab.png)
...
6.  Use the visual representations on the **Styles** tab to decide what is best for the look and feel of your page.
    ...
    -   **Background \(Body, Column layout, Column, and Component\)**
        ...
        ![Background color options on the List tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/styles-tab-background.png)
    ...
    -   **Border \(Column layout, Column, and Component\)**
        ...
        ![Border option expanded showing Thickness, Type, Color, and Corner shape options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/styles-tab-border.png)
    ...
    -   **Layout \(Body, Column layout, Column, and Component\)**
        ...
        ![Edit CSS styles modal with style options for containers and layout styles for components inside container.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/css-styles-edit.png)
    ...
    -   **Sizing \(Component\)**
        ...
        ![Sizing option expanded showing width and height options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/styles-tab-sizing.png)
    ...
    -   **Spacing \(Body, Column layout, and Component\)**
        ...
        ![Margin and padding spacing options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/styles-tab-spacing.png)

        You can set the size for each margin or padding side by selecting the current setting and then selecting an option.

        ![Spacing option with margin and padding settings for all four sides of body, column layout, or component.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/spacing-margin-padding-video.gif)
...
7.  For Body and components, you can edit the CSS code by selecting the **View and edit CSS** link at the bottom of the **Styles** tab.
    ...
    -   `max-width`
    -   `z-index`
    ![CSS styles code editor.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/uib-css-code-editor.png)
...
6.  In the main header, select **Save** to save your changes.
    ...
    ![Styles tab CSS styles option that can be used to add styling to the body or a component using standards-based CSS.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/add-styling-to-component-demo.gif "Add styling to a component in the Styles configuration panel")
