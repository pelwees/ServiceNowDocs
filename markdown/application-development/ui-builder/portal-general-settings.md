...
3.  Select **Experience settings** in the UI Builder header.
    ...
    ![Arrow pointing to the Experience settings link on the experience view page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/portal-settings-toggle.png)
...
4.  Change the title, description, and path of your portal experience.
    ...
    ![UI Builder experience general settings where you have fields for the title, URL path, and landing path.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/ui-builder/../image/experience-portal-settings.png "UI Builder experience settings")
