...
Before you can use Application Intake to submit application ideas, you must ensure that the [App Engine Studio application is installed](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/install-aes.md).

Role required: admin

## About this task

Application Intake guided setup provides a sequence of tasks that help you configure the Application Intake app on the ServiceNow AI Platform. For more information on each task, see [Application Intake configuration tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../reference/app-intake-config-tasks.md).
...
1.  Navigate to **All** &gt; **App Engine** &gt; **Application Intake** &gt; **Guided Setup**.
    ...
    ![App Intake guided setup landing page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../image/app-intake-gs-landing-pg.png "Application Intake guided setup landing page")
...
2.  To initiate guided setup, select **Get Started**.
    ...
    ![App Intake guided setup tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../image/app-intake-gs-tasks.png "Application Intake guided setup category page")
