...
If they aren't enabled, only the instance scan runs. For more information, see [Enable Automated Test Framework \(ATF\) properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../../pipelines-and-deployments/task/enable-atf-properties.md).
