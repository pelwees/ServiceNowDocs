...
2.  When you begin the tasks to configure your pipeline environments, select one of your non-production instances and designate it as a production instance in the pipeline environment record.
    ...
    For more information on the usual process, see [Configure your pipeline environments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../../pipelines-and-deployments/task/config-pipeline-environments.md).
