...
1.  Navigate to **All** &gt; **App Engine** &gt; **Application Intake** &gt; **Guided Setup**.
    ...
    For more information, see [Configure App Engine Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../concept/configure-aes.md).
