...
For more information about deploying with ReleaseOps, see [Exploring ReleaseOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../../release-ops/concept/exploring-release-ops.md).
...
2.  An App Engine deployment request is created and sent to an App Engine admin for approval. At the same time, a corresponding ReleaseOps deployment request is created.
    ...
    ![With migration enabled, App Engine deployment requests have corresponding ReleaseOps deployment request records.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/../image/aemc-dr-with-releaseops-dr.png)
