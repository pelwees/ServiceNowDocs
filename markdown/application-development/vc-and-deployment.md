...
-   Git-based source control integration with ServiceNow IDE: ServiceNow supports Git-based workflows for version control and CI/CD.
    ...
    -   For more information, see [Integrating source control with the ServiceNow IDE](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../servicenow-ide/concept/integrating-source-control-servicenow-ide.md).
-   Update sets and application packaging: Standard ServiceNow deployment uses System Update Sets to track changes.
    ...
    -   For more information on System Update Sets, see [System update sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../system-update-sets/concept/system-update-sets.md).
...
2.  Publish the app to AppRepo:
    ...
    -   For more information on Application Repository, see [ServiceNow application repository](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../applications/concept/app-repo.md).
...
-   App Engine Management Center \(AEMC\):
    ...
    -   For more information on AEMC, see [Using the App Engine Management Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../app-engine-studio/concept/monitor-requests-using-aemc.md).
-   ReleaseOps:
    ...
    -   For more information on ReleaseOps, see [ReleaseOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../release-ops/concept/releaseops-landing.md).
-   ServiceNow SDK:
...
-   Automated Test Framework \(ATF\)
    ...
    -   For more information on ATF, see [Automated Test Framework \(ATF\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../../administer/auto-test-framework/concept/atf-landing-page.md).
