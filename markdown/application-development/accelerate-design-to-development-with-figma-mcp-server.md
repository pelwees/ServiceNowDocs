...
For details on configuring MCP connections in Build Agent, see [Connect Build Agent to a supported MCP server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../tasks/ba-connct-mcp-server.md).
...
For configuration information, see [Connect Build Agent to a Figma MCP server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../tasks/connect-figma-mcp-server-to-build-agent.md#)
