...
For more information, see [Create agentic workflows, agents, and skills](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../tasks/create-custom-ai-agent.md).
...
-   [Install Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../tasks/install-build-agent.md)
-   [Use Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../tasks/use-build-agent.md)
...
-   **[Example Build Agent use cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/additional-build-agent-use-cases.md)**  
...
-   **[Build Agent workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent-workflow.md)**  
...
-   **[Tutorial for Build Agent in ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent-tutorial.md)**  
...
-   **[General guidelines for Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent-general-guidelines.md)**  
Follow some general guidelines for implementing and managing Build Agent effectively in your development workflow.
-   **[Build Agent tools](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent-tools.md)**  
...
-   **[MCP connections and Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/accelerate-design-to-development-with-figma-mcp-server.md)**  
...
-   **[Build Agent governance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent-governance.md)**  
...
-   **[Build Agent limitations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent-limitations.md)**  
...
**Parent Topic:**[Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-agent.md)
