...
-   Create: If creating an application directly, use [ServiceNow Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../servicenow-studio/concept/servicenow-studio-landing.md) to create the application.
...
-   **[Build the data model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/build-data-model.md)**  
Create tables and fields on the tables to support the application’s data model.
-   **[Secure data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/secure-data.md)**  
...
-   **[Manage data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/manage-data.md)**  
