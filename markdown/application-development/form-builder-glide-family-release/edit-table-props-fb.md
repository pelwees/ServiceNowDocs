...
3.  In the dialog box that appears, update the table properties as shown in the following example.
    ...
    For more information on these properties, see [Table properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/form-builder-glide-family-release/../reference/table-parameters.md#section_ezz_pft_ssb).

    ![Editing table properties.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/form-builder-glide-family-release/../image/tb-edit-table-props.png "Editing table properties")
