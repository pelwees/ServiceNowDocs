...
-   **[Create a basic auth profile using the Automated Test Framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../task/atf-create-basic-auth-profile.md)**  
Create basic auth profiles to specify basic authentication credentials for Send Request - Inbound test steps.
-   **[Filter REST request and response headers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/atf-filter-rest-headers.md)**  
...
-   **[Automated Test Framework REST properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-rest-properties.md)**  
