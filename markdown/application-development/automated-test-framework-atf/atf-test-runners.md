...
To work with the client test runner module, the [test execution property](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-admin-properties.md) must be enabled.
...
-   The browser must meet the criteria you specified on the [Scheduled suite run record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-suite-sched-run-record.md).
-   A client test runner meeting the criteria you specified on the [Scheduled suite run record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-suite-sched-run-record.md) must be available to run the test suite at the scheduled time. The system cannot automatically open a client test-runner session.
...
When you start a client test runner, the system registers that runner in the Active Test Runners table. You can view this table in the [Active Manual Test Runners](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-active-manual-runners-module.md) module and the [Active Scheduled Test Runners](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-active-sched-runners-module.md) module. These two modules provide views of the same table, filtered to show only manual or only scheduled test runners.
...
[Client test runner](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-client-test-runner-module.md)

[Scheduled client test runner](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-sched-test-runner-module.md)
