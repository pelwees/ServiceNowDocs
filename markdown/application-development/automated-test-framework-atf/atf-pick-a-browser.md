...
2.  Click **Manage your test runners here** as needed to view all client test runners registered for the current user.
    ...
    See [Active manual test runners](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../reference/atf-active-manual-runners-module.md).
...
-   **[Cloud Runner browser](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../concept/atf-cloud-runner-browser.md)**  
If you are running a test or a test suite, select the Cloud Runner browser option to run your tests in a cloud browser.

**Parent Topic:**[UI test steps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../concept/ui-test-steps.md)
