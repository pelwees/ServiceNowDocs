...
-   If necessary, enable test execution. For instructions, see [Enable or disable executing Automated Test Framework tests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/atf-enable-tests.md).
...
**Parent Topic:**[Getting started with the Automated Test Framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../concept/atf-intro.md)
...
3.  On the Test new record form, enter a name for your test in the **Name** field.
    ...
    ![Form for creating a new test](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../image/atf-test-create-new.png)
...
4.  In the middle column, click the row for the step type **Open a new form**, then select **Next**.
    ...
    ![Add Test Step dialog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../image/atf-test-step-dlg.png)
...
5.  From the **Table** field, select the **User \[sys\_user\]** table and click **Submit**.
    ...
    ![Add Test Step: Open a New Form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../image/atf-test-step-add-open-new.png)
...
For some ideas on how to continue learning about the Automated Test Framework, see [Next steps with the Automated Test Framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../concept/atf-next-step-concepts.md).
...
4.  In the field values section, set **Last name** to `Test` and **First name** to `Otto` \(or other names of your choice\).
    ...
    ![Test step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../image/atf-first-test-01.png)
...
4.  Leave all values as set by default and click **Submit**.
    ...
    ![Submit a form test step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../image/atf-first-test-02.png)
    ...
    ![Updated test record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../image/atf-first-test-03.png)
...
The system returns to the list of tests. For more information about adding steps to automated tests, see [Add steps to an automated test](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/atf-create-step.md).
...
The system displays the Run Test progress dialog. For more information about running automated tests, see [Run an automated test](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/atf-run-test.md).
...
If needed, you can cancel a test even while it's running. For more information, see [Cancelling automated tests and test suites](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/automated-test-framework-atf/../concept/atf-cancelling.md#).
