...
-   **[Install the ServiceNow SDK in an application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-sdk/../task/install-servicenow-sdk.md)**  
Install the ServiceNow software development kit \(SDK\) in a local application using Node Package Manager \(npm\).
-   **[Upgrade the ServiceNow SDK](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-sdk/../task/upgrade-servicenow-sdk.md)**  
Upgrade to the latest version of the ServiceNow SDK for use with instances beginning with the Washington DC release.
-   **[Install the ServiceNow Fluent Language server in Visual Studio Code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-sdk/../task/install-fluent-language-extension-vs-code.md)**  
