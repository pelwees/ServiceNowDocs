...
-   **[Authenticate to a ServiceNow instance using basic authentication with the ServiceNow SDK](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-sdk/../task/authenticate-instance-basic-auth.md)**  
Use basic authentication to connect to a ServiceNow instance with the ServiceNow SDK.
-   **[Authenticate to a ServiceNow instance using OAuth 2.0 with the ServiceNow SDK](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/servicenow-sdk/../task/authenticate-instance-oauth.md)**  
