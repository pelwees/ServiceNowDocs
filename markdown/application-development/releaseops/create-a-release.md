...
7.  Set a freeze date for the release.
    ...
    3.  Select your freeze date by selecting the date.
        ...
        ![Select the Select freeze date and time icon and choose your freeze date from the calendar pop-up to set your freeze date.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/releaseops/../image/releaseops-select-freeze-date.png)
