...
Administers the use, sharing, and activation or deactivation of templates.
 ...
 This role is assigned by an admin to individual users. For more information, see [Manage template access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../task/manage-template-access.md).
...
Builds applications in App Engine Studio.
 ...
 This role is assigned automatically to users in the App Engine Studio Users group. For more information, see [Grant user access to AES](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../task/grant-aes-access.md).
