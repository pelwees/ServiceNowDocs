...
4.  On the app selection screen, select an existing application for the custom template creation, and then select **Continue**.
    ...
    **Note:** For more information, see [Supported features and metadata in custom templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../reference/supported-features-metadata-custom-templates.md).
