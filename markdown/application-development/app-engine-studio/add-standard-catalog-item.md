...
For the standard catalog item you want to edit, select the menu icon \(![Menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/menu-icon-purple.png)\) and select **Edit**.

-   **[Sample standard catalog item](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../concept/standard-catalog-item-examples.md)**  
