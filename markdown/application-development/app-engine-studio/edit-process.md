...
3.  Next to a process, select the menu icon \(![Menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/menu-icon-purple.png)\) and then select **Edit**.'

    ![Process Definition with menu actions 'Edit' and 'Delete' displayed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/modify-process.png)
