...
Collapse / expand icons\(![Collapse or expand pane icons.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-collapse-pdf-pane.png)\)
...
Page controls\(![PDF page controls icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-page-controls-icon.png)\)
...
Zoom controls\(![PDF zoom controls.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-zoom-controls.png)\)
...
Add new field icon\(![Add new field icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-add-new-field.png)\)
...
Add reference table icon\(![Add reference table icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-add-reference-table.png)\)
...
Open data table and form icon\(![Open data table and form icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-open-table-and-form.png)\)
...
Table additional actions list \(![Additional actions menu](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-ellipsis-menu.png)\)
...
Trash icon\(![Trash icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-trash-icon.png)\)

</td><td>

Select the **Trash icon** \( ![Trash icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-trash-icon.png)\) to delete fields from a table.
...
6.  Select and upload the PDF.
    ...
    **Note:** It may take a moment for the PDF to load. Select the trash icon \(![Trash icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-trash-icon.png)\) to clear the PDF selection.

    ![Choose the PDF you want to upload.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-to-table-upload.png "Choose the PDF you want to upload")
...
Option to allow other tables to share data from this table. For more information on table extension, see [Table extension](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/add-data.md#section_ebj_sdb_d5b).
...
Next, you will add fields from the uploaded PDF. Follow the steps in [Add new fields from a PDF form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/pdf-extractor.md#) to populate your new data table with field columns.
...
1.  Choose one of the following options:
    ...
    -   Follow the steps outlined in the previous procedure to upload a PDF \(see [Create a table from a PDF form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/pdf-extractor.md#)\).
...
2.  Review the PDF.
    ...
    Use any of the navigational controls in the PDF pane to navigate to where you'd like to begin adding fields. See [General navigation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/pdf-extractor.md#section_wkf_twk_gvb).
...
4.  In the PDF, click on a field or text phrase to highlight it to use it as the basis for a new field.
    ...
    ![Add fields from PDF](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-to-table-add-fields.png "Add fields from PDF")
...
6.  Choose a **Field type**.
    ...
    1.  If you have chosen to create a choice field, perform the following actions to populate options for the choice field.
        ...
        ![Adding a choice field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-add-choice-field.png "Adding a choice field")
...
Delete any additional reference tables that you add by selecting **Delete** from the Additional actions list in the top right corner of the table \( ![Additional actions list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-ellipsis-menu.png)\)
...
To open your data table in Table Builder, select **Open data table and form** above the displayed tables. For more information on editing your data tables in Table Builder, see [Table Builder](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../../../administer/form-builder/concept/tb-landing-page.md).

To add a reference table, see [Add a reference table from a PDF form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/pdf-extractor.md#).
...
3.  Enter the following properties for your reference table.
    ...
    |Make extensible|Option to allow other tables to share data from this table. For more information on table extension, see [Table extension](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/add-data.md#section_ebj_sdb_d5b).|
...
6.  Select fields from your original table to add them to your new reference table.
    ...
    ![Add a reference table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../image/pdf-to-table-add-reference-table.png "Add a reference table")
...
</table>    See [General navigation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/pdf-extractor.md#section_wkf_twk_gvb) for more information on additional navigational controls in the table pane.
