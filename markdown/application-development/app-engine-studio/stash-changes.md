...
-   **[Stash local changes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../task/source-control-stash-changes.md)**  
App developers can remove and save changes locally to apply them later in App Engine Studio \(AES\).
-   **[Manage stashes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/app-engine-studio/../task/source-control-manage-stashes.md)**  
