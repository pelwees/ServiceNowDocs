...
When a sandbox is allocated, it inherits the baseline data configuration of scoped apps, unless there is data that can't be copied. For more information on templates, see [Using sandbox templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/developer-sandboxes/../task/create-sandbox-template.md).
