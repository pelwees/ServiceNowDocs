...
6.  Iterate until the desired metadata changes are complete. For more information, see [Supported metadata in Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../reference/build-agent-supported-metadata.md).
...
9.  Deploy the application. For more information, see [Vibe coding, AI-assisted development, and deployment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../vibe-coding/concept/vc-and-deployment.md).
