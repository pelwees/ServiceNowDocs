...
-   Security in apps developed with Build Agent is at the application and API level, not at granular record and field level by default. However, you can vibe code security onto the app by making requests. For examples, see [Example prompts for vibe coding and AI-assisted development](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../../vibe-coding/reference/vibe-coding-example-prompts.md).
...
For details on troubleshooting, see [Troubleshooting in Build Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/application-development/../reference/build-agent-troubleshooting.md).
