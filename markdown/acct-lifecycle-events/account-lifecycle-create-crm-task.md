...
3.  If you have configured the **Create CRM task** option, you can see it on the Risk and Issue page.
    ...
    See [Enable integration with Microsoft Dynamics CRM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../concept/account-lifecycle-crm-integration.md) for details on configuring this option.
...
6.  Navigate to **Customer Success** &gt; **All Risks and Issues** and open an risk record.
    ...
    ![CRM Task worknotes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../image/account-lifecycle-crm-create-task-2.png)
    ...
    -   Customer Success Management application has been configured for Microsoft Dynamics CRM integration. See [Enable integration with Microsoft Dynamics CRM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../concept/account-lifecycle-crm-integration.md) for details.

**Parent Topic:**[Enable integration with Microsoft Dynamics CRM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../concept/account-lifecycle-crm-integration.md)
