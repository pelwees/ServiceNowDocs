...
![Risk portfolio page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../image/account-lifecycle-risk-port.png)
...
-   Select the ![](../../../common/image/icon-menu-square.png) icon to Create a risk signal manually. See [Create a risk signal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../task/account-lifecycle-create-risk-signal.md).
...
-   **[Risk and issues page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/account-lifecycle-risk-issues-page.md)**  
...
-   **[Associate risk signals](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../task/account-lifecycle-risk_signal_solution.md)**  
