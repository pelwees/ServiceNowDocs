...
For instructions on how to create the renewal playbook, see [Create a renewal playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/acct-lifecycle-events/../task/account-lifecycle-create-renewal-playbook.md).
