...
4.  Fill in the details \(by selecting the provider\).
    ...
    For more information on the field details, see [Create a new discovery schedule form reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-account-management/../../discovery/reference/create-a-new-discovery-schedule-form.md).
