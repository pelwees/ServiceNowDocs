...
5.  Follow the steps in [Create Group automation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/../../service-operations-workspace-itom/task/group-alert-sow-itom.md).
