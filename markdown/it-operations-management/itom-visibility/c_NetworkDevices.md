...
-   **[Load balancer discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/c_LoadBalancers.md)**  
Discovery can collect data about network routers, switches, and applications.
-   **[Layer 2 discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/c_Layer2Discovery.md#)**  
Discovery can detect the physical connections, known as layer 2, between network devices.
-   **[TCP connection discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoTCPConnections.md)**  
Discovery identifies and classifies information about TCP connections using the ADM and ADME probes.
-   **[IP address discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoIPAddress.md)**  
Discovery identifies and classifies information about IP addresses.
-   **[IP network discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoIPNetworks.md)**  
Discovery identifies and classifies information about IP networks.
-   **[Network printer discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoNetworkPrinters.md)**  
Discovery identifies and classifies information about network printers.
-   **[Network switch and router discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoNWRouteAndSwitch.md)**  
Discovery identifies and classifies information about network switches and routers.
-   **[IP service and daemon discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoServicesAndDaemons.md)**  
Discovery identifies and classifies information about services and daemons.
-   **[Uninterruptible power supply \(UPS\) discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r_DataCollDiscoUnintPowerSupp.md)**  
Discovery identifies and classifies information about an uninterruptible power supply \(UPS\).
-   **[IBM WebSphere DataPower discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/data-coll-datapower.md)**  
...
-   **[Cisco Unified Computing System \(UCS\)-HD device discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/../reference/r-CiscoUCSHD.md)**  
...
-   **[Dell Remote Assistant Card discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-visibility/c_DRACDiscovery.md)**  
