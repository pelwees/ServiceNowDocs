...
|Authentication failed|Service Observability can't connect to the data source. See [Connect a Service Observability data source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-observability/../task/connect-an-observability-data-source.md).|
