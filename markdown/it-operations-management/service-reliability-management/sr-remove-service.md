...
5.  In the dialog, review the details about the affected SLOs and then select **Remove service**.
    ...
    **Note:** If you receive an error when removing a service, see [Troubleshoot SRM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-reliability-management/../reference/srm-troubleshoot.md).
