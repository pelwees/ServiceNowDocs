...
1.  Navigate to **Workspaces** &gt; **Service Operations Workspace** &gt; **Teams \(![Teams icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-reliability-management/../image/icon-sr-teams.png)\)**.
...
5.  Fill in the fields.
    ...
    For more information on the field descriptions, see [Create a shift form in Service Reliability Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-reliability-management/../reference/sr-create-shift-form.md).

6.  Select **Create shift**.


-   **[Set on-call team preferences in SRM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-reliability-management/sr-set-on-call-prefs.md)**  
