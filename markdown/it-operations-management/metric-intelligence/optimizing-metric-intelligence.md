...
-   **[Create an anomaly test rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/anomaly-model-testing.md)**  
...
-   **[View metric to CI and resource binding](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/view-metric-to-CI-binding.md)**  
...
-   **[Disable a metric for a CI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/disable-metric-per-ci.md)**  
...
-   **[Disable event collection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/disable-event-collection.md)**  
...
-   **[Configure anomaly score thresholds](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/cnfgr-anomaly-score-thresholds.md)**  
...
-   **[View metric charts in Agent Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/view-metric-charts-workspace.md)**  
...
-   **[Configure metric charts for Agent Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/configure-metric-chart-workspace.md)**  
...
-   **[View self-health monitoring statistics for Metric Intelligence](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/xmlstats-oi-self-health.md)**  
...
-   **[Verify that the definitions for the Advanced Promotion Engine are active](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../agent-client-collector/task/verify-ape-definition-active.md)**  
Verify that the Advanced Promotion Engine definitions that come with the base system are active.
-   **[Create a definition for the Advanced Promotion Engine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../agent-client-collector/task/create-advanced-promotion-engine.md)**  
...
-   **[View the promoted events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../agent-client-collector/task/view-promoted-events.md)**  
...
-   **[View the promoted anomaly alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../agent-client-collector/task/view-promoted-alerts.md)**  
...
-   **[Create an event rule to bind metric events to host CIs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/metric-intelligence/../../event-management/task/event-rule-bind-metrics-to-host.md)**  
