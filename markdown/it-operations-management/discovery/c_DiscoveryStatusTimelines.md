...
![Discovery early phases on the timeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/disco-timeline-early-phases.png "Discovery (early phases) on the timeline")
...
**Parent Topic:**[Discovery status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/c_DiscoveryStatus.md)
...
6.  In the Device record, click the **Show Discovery Timeline** Related Link.
    ...
    ![Discovery Timeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/DiscoveryTimeline.png "Discovery Timeline")
...
9.  To limit the timeline to the length of the Discovery, click **Max**.
    ...
    ![Discovery Timeline Shazzam Sensor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/DiscoveryTimelineShazzamSensor.png "Discovery Timeline Shazzam Sensor")

    ECC Queue

    Double-click a span to open the ECC Queue record for that probe or sensor.

    ![Discovery Timeline ECC Queue](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/DiscoveryTimelineECCQueue.png "Discovery Timeline ECC Queue")
