...
-   **Device classification**
    ...
    -   The horizontal discovery process fails for the higher priority port probes \(WMI, SSH, and SNMP\) if the ports for those protocols are not open, or if discovery for those protocols fail. The horizontal discovery process can fail, for example, if SSH and SNMP credentials are not configured or are incorrect.
        ...
        **Note:** See [Port Probes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_PortProbes.md) for more details on how port scanning works and to see the priorities of the different protocols.
    ...
    For more information on port probes, see [Port probes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_PortProbes.md). For instructions on creating an HTTP classifier, see [Create an HTTP classification](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/create-an-http-classifier.md).
...
-   **IP address \(IP scan\) classification**
    ...
    ![IP acan classification](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/DiscoveryClassificationDiagram.png "IP scan classification")


See [Classification for IP address discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/ip-address-scanning-classification.md) for more details about the parameters available to classifiers for this type of discovery.
