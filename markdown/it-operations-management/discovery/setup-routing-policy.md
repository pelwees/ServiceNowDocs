...
2.  Select **New** and fill in the required fields on the form.
    ...
    **Note:**
    ...
    -   For more inforamtion about the fields and values on a routing policy form, see [.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/certificate-routing-policy-form-table.md)
