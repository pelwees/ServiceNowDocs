...
6.  Discovery performs the analysis on the CMDB using [CI identifiers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/c_DiscoveryIdentifiers.md). Discovery can update existing CIs in the CMDB or create new ones.
