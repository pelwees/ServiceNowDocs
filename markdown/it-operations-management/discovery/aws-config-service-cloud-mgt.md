...
5.  Enable **AWS** event recording.
    ...
    5.  Fill the values on the Edit settings form.
        ...
        For a description of the form fields, see [Edit settings form reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/edit-aws-event-recording-settings-form-reference.md).
...
After some events are generated, navigate to the [Cloud User Portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../cloud-management-v2-user/task/cloudmgt-view-cloud-events.md) to view the events.
