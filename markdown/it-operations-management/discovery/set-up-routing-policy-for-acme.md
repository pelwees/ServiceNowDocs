...
3.  On the **Certificate Routing Policy** form, fill in the fields.
    ...
    For the description of the field values, see [Certificate Routing Policy form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/certificate-routing-policy-field-values.md).
