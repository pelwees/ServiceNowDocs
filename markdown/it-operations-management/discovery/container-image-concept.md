...
![Container image scanning for software decomposition diagram](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/container-image-pattern.png)
...
-   For more information on scanning images using Aqua Trivy, see [Scan container images](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/container-image-task.md).
...
-   [Container image discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/container_image_scan_pattern.md)
-   [Kubernetes discovery using patterns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/kubernetes-discovery.md)
...
-   **[Link software package information to images only](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/link-software-package-only-image.md)**  
...
-   **[Map MID Server to container image repository](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/map-mid-server-container-repository.md)**  
...
-   **[Configure a proxy bypass for specific internal or private container registries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/configure-container-proxy-bypass.md)**  
...
-   **[Scan container images](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/container-image-task.md)**  
Enable container image scanning using the Aqua Trivy tool.
-   **[Configure the SBOM generation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/enable-sbom.md)**  
...
**Parent Topic:**[Kubernetes discovery using patterns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/kubernetes-discovery.md)

**Related topics**  


[Cloud Native Operations for Visibility](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../cloud-native-operations-visibility/concept/cnov-landing.md)
