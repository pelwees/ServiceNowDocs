...
For information about Service Mapping commands, see [Prerequisites for performing top-down discovery using Service Mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../service-mapping/reference/prerequisites-service-mapping.md).
...
|------------------|--------|
|SSH commands requiring a privileged user|[SSH commands requiring a privileged user during probe-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/discovery-ssh-command-require-priv.md)|
|SSH commands not requiring a privileged user|[SSH commands not requiring a privileged user during probe-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/discovery-ssh-probe-commands.md)|
|Windows commands and permissions|[Windows probes and permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_DiscoWinProbesAndPermissions.md)|
|Additional permissions|[Discovery probe permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_AdditionalPermissions.md)|
...
-   [View Patterns commands through the Discovery Patterns module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/view-command-pattern-discovery.md)\*
-   [View Patterns commands through the Command List module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/view-pattern-command-in-command-list.md)
...
-   [Validate commands used in pattern-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../it-operations-management/task/validate-discovery-commands.md)\*
-   [View command validation task results in pattern-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/view-command-validation-task-results.md)
