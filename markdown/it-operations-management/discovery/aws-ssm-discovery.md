...
Install the MID Server. For more information, see [Install and configure the MID Servers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../it-operations-management/task/mid-server-configuration-cloud.md).
...
-   **Configure MID Server properties**
    ...
    For more information, see [Configure MID Server for AWS S3 access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/configure-mid-server-aws-s3-access.md) and [Configure MID Server for AWS KMS access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/config-mid-server-aws-kms-access.md).
