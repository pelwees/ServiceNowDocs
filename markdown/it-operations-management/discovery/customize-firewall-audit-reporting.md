...
[Discovery properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_DiscoveryProperties.md) manage various aspects of the horizontal discovery process. This procedure explains how to assign default policy owner group and approval group names for approving firewall rule tasks.

## Procedure

1.  To edit [Discovery properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_DiscoveryProperties.md), navigate to **All** &gt; **Discovery Definition** &gt; **Properties**.

    For more information on properties, see [Discovery properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_DiscoveryProperties.md).
