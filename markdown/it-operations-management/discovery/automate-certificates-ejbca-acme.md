...
For more information, see [Create a routing policy for EJBCA ACME certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../discovery/task/routing-policies-ejbca-acme-certificates.md).
...
2.  [Configure your base API URL for EJBCA ACME](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../discovery/task/configure-base-api-url-for-ejbca-acme.md)
3.  [Validate your EJBCA ACME base API URL](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../../discovery/task/validate-ejbca-acme-base-api-url.md)
