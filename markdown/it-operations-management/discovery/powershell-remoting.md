...
See [Set up MID Servers to use PowerShell](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../task/t_SetUpAMIDServerToUsePowerShell.md) for more information.
...
![Windows — Active Connections probe configuration page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../image/powershell-remote-probe-config.png)
...
**Parent Topic:**[PowerShell for Discovery and Service Mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_PowerShellForDiscovery.md)
