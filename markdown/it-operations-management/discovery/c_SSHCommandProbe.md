...
-   **[SSHCommand parameters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_Parameters.md)**  
Several parameters are available for the SSHCommand probe.
-   **[SSHCommand path](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/c_SSHCommandPath.md)**  
The SSHCommand probe computes the default path from the following sources.
-   **[Shell script options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_ShellScriptOptions.md)**  
The SSHCommand probe supports the following scripting options in the ECC queue name field.
-   **[SSH commands not requiring a privileged user during probe-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/discovery-ssh-probe-commands.md)**  
...
-   **[SSH commands requiring a privileged user during probe-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/discovery-ssh-command-require-priv.md)**  
...
**Parent Topic:**[List of Discovery probes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/discovery/../reference/r_ListOfDiscoveryProbes.md)
