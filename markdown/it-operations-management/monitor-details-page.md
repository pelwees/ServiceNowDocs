...
You can use the **Details** tab to create a monitor or edit an existing one. See [Create and edit a synthetic monitor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/../task/create-synthetic-monitor.md) for more information.
