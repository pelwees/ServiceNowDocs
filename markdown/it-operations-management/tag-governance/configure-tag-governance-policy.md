...
2.  Select **New** and then fill in the Tag Policies form.
    ...
    The form fields are described in [Tag Policies form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/tag-governance/../../itom-cloud-accelerate/reference/tag-gov-tag-policies-form.md).
