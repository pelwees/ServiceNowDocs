...
-   The ServiceNow® [Event Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../../event-management/concept/c_EM.md) application
...
This plugin contains essential components for Health Log Analytics, such as the AI Engine and Elasticsearch.Health Log Analytics Core is a ServiceNow Store app. Once installed, the module is available, but you can choose not to interact with it.
 ...
 Dependency: The ServiceNow® [Event Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../../event-management/concept/c_EM.md) application.
