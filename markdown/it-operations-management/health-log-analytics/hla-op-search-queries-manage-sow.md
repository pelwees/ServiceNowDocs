...
2.  Define a search.
    ...
    1.  Select the selection icon \(![Selection icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../image/icon-selection-sow.png)\) and then select **New search**.
...
3.  Save the search.
    ...
    The saved search includes any selected filters. For information about filters, see [Filter search results on the Log Viewer in Health Log Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/hla-op-log-viewer-filter-sow.md).
    ...
    **Note:** If you are using Health Log Analytics application, Version 20.0.11 - July 2021, and the Health Log Analytics Viewer application, Version 20.0.4 - July 2021, available from the [ServiceNow Store](https://store.servicenow.com/sn_appstore_store.do#!/store/home), you can define an alert rule without saving the search. For more information, see [Define a Log Analytics alert rule in Health Log Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/hla-op-alert-rule-add-sow.md).
...
[Use or modify a saved log data search in Health Log Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/hla-op-search-queries-saved-sow.md)
