...
4.  Select the **Manage Attachments** icon \(![Manage Attachments icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../../agent-client-collector/image/paper-clip-icon.png)\) and attach the `keystore` and `truststore` files to the form.

5.  On the form, fill in the fields.

    For a description of the fields, see [ServiceNow Log Export data input configuration fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../reference/hla-data-input-log-export-ref.md).
