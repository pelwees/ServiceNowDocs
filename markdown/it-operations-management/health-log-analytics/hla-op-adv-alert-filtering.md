...
-   [Create advanced log alert filters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../task/hla-op-adv-alert-filter-crud.md)
...
-   Continue modifying the filter by reopening the filter record from the [filters list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../task/hla-op-search-queries-manage-sow.md). You can then edit, test, publish, and activate the filter.
