...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see [Amazon Data Firehose integration configuration fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../reference/il-connector-hla-firehose-fields.md).
