...
3.  On the form, update the settings.
    ...
    For a description of the settings, see [Define a Log Analytics alert rule in Health Log Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/hla-op-alert-rule-add-sow.md).
