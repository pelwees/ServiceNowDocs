...
For field descriptions, see [Log-based CI candidates fields in Health Log Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../reference/hla-cmdb-enrich-fields.md).
...
**Parent Topic:**[Enhancing the CMDB with host data Health Log Analytics found in logs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/health-log-analytics/../concept/hla-cmdb-enrich-concept.md)
