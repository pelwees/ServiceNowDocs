...
If there are configuration items \(CIs\) that Service Mapping could not map correctly, they appear on your service instance map with warning icons ![The warning icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/MapWarningIcon.png). Typically, mapping errors happen when Service Mapping fails to connect to a CI or fails to recognize it due to an inaccurate pattern.
...
2.  Ensure that the map opens in Edit mode displaying discovery messages and errors.
    ...
    ![Discovery Messages pane](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/MapEditDiscoveryMessages.png)

3.  Right-click the CI with the warning icon \(![The warning icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/MapWarningIcon.png)\) and select **Show discovery log**.

4.  Expand the failed pattern which appears above the result marked red.

    ![A failed pattern appears](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/DiscLogExpandPattern.png)

5.  Expand the failed section and click the failed step.

    ![A pattern section inside the pattern in the Discovery Log window.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/DiscLogExpandPatternSection.png)
...
7.  Click the first step and wait for Pattern Designer to run it.
    ...
    ![The debug session fails when Pattern Designer tries to run a faulty step.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/PatDefDebugStepFailure.png)
