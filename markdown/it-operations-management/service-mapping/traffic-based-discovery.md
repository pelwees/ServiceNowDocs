...
-   **Specific CI level**
    ...
    See [Enable traffic-based discovery for CI types or specific CIs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/t_CreateATrafficBasedDiscoveryRule.md) to learn more about creating rules for CI types or specific CIs.
...
[Remove CIs not belonging to application services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/remove-cis-not-belonging-business-services.md)
