...
To view preconfigured CI relationships which Service Mapping includes in application services during tag-based discovery, see [Preconfigured CI relationships in tag-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../reference/ci_relationships_tag_mapping.md).

To view properties installed with Service Mapping that relate to tag-based discovery, see [Properties related to tag-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../reference/properties_tag_mapping.md).

-   **[Include CIs based on classes in tag-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/include_cis_tag_discovery_configuration.md)**  
...
-   **[Exclude CIs based on their installation status in tag-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/exclude_cis_install_status_tag_mapping.md)**  
...
-   **[Exclude preconfigured CI relationships in tag-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/exclude_ci_relationships_tag_mapping.md)**  
...
-   **[Add or edit CI relationships in tag-based discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/edit_ci_relationships_tag_mapping.md)**  
...
-   **[Recalculate previously created application services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../task/recalculate_application_services.md)**  
...
**Parent Topic:**[Advanced Service Mapping configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/c_ConfigureSM.md)
