...
2.  To enable the new algorithm for deployments upgraded to Istanbul and earlier:
    ...
    3.  Configure MID Server selection criteria as described in [MID Server configuration for Service Mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../concept/configure-mid-service-mapping.md).
...
3.  To enable the legacy algorithm for the Australia deployment:
    ...
    3.  Configure MID Server selection criteria as described in [MID Server configuration for Service Mapping in upgraded deployments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../concept/MID-selection-criteria-upgrade.md).


**Parent Topic:**[MID Server configuration for Service Mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../concept/configure-mid-service-mapping.md)
