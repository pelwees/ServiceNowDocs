...
When you receive an email notification that the owner sent comments for this service instance, [review and implement the owner's requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/review-implement-business-service-maps.md).
