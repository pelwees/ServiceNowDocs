...
Analyse, review, and define tags as covered in [Prepare for mapping application services based on tags](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/prepare-map-service-tag.md).
...
![Comparison of pattern-based and tag-based mapping results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/pattern-vs-tags-maps-comparison.png "Comparison of pattern-based and tag-based mapping results")
...
8.  Click **Map selected**.
    ...
    3.  Click **OK** ![OK button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/BusinessMappingOKicon.png) to save the change.
...
![Tag-based service map.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../image/tag-based-map-example.png "The map for the Finance::Production service instance based on tags")
...
3.  To fine-tune or fix the tag-based services, [modify the tag categories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/modify-tag-category-family.md) that you used for the service family.
...
-   **[Prepare for mapping application services based on tags](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/prepare-map-service-tag.md)**  
...
[Choose the right method for discovery and mapping application services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../concept/choose-mapping-method.md)

[Tag-based discovery configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-mapping/../concept/tag_discovery_configuration.md)
