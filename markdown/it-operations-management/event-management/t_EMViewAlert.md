...
1.  Navigate to **All** &gt; **Event Management** &gt; **All Alerts**.
    ...
    ![Message to try Express list for visualization and management of alerts.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../image/em-express-list-msg.png)
...
The secondary alerts that are correlated with this alert, where this alert is the primary alert. For more information, see [Rule-based alert grouping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/c_EMEventCorrelationRules.md).
...
The primary alert that is correlated with this alert, where this alert is a secondary alert. For more information, see [Rule-based alert grouping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/c_EMEventCorrelationRules.md).
    ...
    |Impacted Services|The impacted services that are related to this alert are listed. For more information, see [View the impact tree](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMViewImpactTree.md).|
    |Flapping tab|
...
|Create an incident.|Click **Create incident**. For more information, see [Create incident or security incident from an alert](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMCreateIncidentfromAlert.md).|
|If Security Incident Response is activated, create a security incident response.|Click **Create Security Incident**.|
|Designate that the alert is in maintenance.|Select the **Maintenance** check box. For more information, see [View all alerts by the maintenance status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMViewAlertmaintenance.md).|
|Close the alert.|Click **Close**. For more information, see [Close an alert](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMCloseAlert.md).|

-   **[Priority group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/alert-priority-group.md)**  
...
-   **[Alert execution information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/alert-execution.md)**  
...
-   **[View alerts in the flapping state](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMViewAlertFlapping.md)**  
You can view alerts that are specifically in the flapping state.
-   **[View all alerts by the maintenance status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMViewAlertmaintenance.md)**  
...
-   **[Collaborate from within an alert](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/em-collaborate-from-alert.md)**  
You can collaborate with colleagues and write work notes while working in an alert.
-   **[Create incident or security incident from an alert](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/t_EMCreateIncidentfromAlert.md)**  
...
-   **[Alert insight information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/alert-insight-information.md)**  
