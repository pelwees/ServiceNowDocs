...
2.  Add the webhook to a trigger.
    ...
    4.  In the **Recipients** section, select **Add Recipient** and select the webhook created in step [1](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/honeycomb-event-integration.md#webhook-creation).
