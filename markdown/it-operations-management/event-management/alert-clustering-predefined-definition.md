...
2.  Select a predefined definition.
    ...
    **Note:** For a complete list of the available predefined definitions, see [List of predefined tag-based alert grouping definitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../reference/alert-clustering-predefined-definition-list.md).
