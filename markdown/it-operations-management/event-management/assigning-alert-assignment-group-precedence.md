...
2.  In the **Search** field, enter `evt_mgmt.alert_auto_assignment_field` and select the property record.
    ...
    For more information on the property, see [Team-based integration properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../reference/team-based-integrations-properties.md).
...
**Parent Topic:**[Alert assignment groups for teams](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/alert-assignment-group.md)
