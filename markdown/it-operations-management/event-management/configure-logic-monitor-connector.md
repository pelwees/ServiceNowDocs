...
3.  Enter values in the required fields, which are indicated by a red asterisk.
    ...
    ![Connector Instance name matching Source Instance name](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../image/logicmonitor-list.png)

    The source of events is**logicmonitor**so you should create an instance with the name`logicmonitor`.![Name is logicmonitor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../image/logicmonitor-list-results.png)
