...
-   **[Create an SLA configuration for CIs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/t_EMCreateAnSLAConfiguration.md)**  
Create an SLA configuration from the Event Management application to determine which CIs are available for SLAs.
-   **[Create an SLA definition for a CI or application service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/t_EMCreateSLADefForCI_BS.md)**  
