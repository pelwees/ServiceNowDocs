...
3.  On the **Push Connector Instance** form, fill in the fields.
    ...
    For more details, see [Push connector instance form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../reference/push-connector-instance-form.md).
