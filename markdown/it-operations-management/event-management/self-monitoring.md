...
-   Display the **ServiceNow Event Management** application services in Service Operations Workspace. Use Service Operations Workspace to view alerts by application service, technical service, and alert groups. You can double-click a tile to view general information about the service.
    ...
    ![Service Operations Workspace tile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../image/op-ws-tile.png)
...
-   **[Start or stop self-health monitoring](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/start-self-health.md)**  
...
-   **[Configure the Event Management - Insert Health Monitor scheduled job](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/EM-insert-health-job.md)**  
...
-   **[Monitor self-health with domain separation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/domain-self-health.md)**  
...
-   **[Configure a self-health monitor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/configure-threshold-monitoring.md)**  
...
-   **[Create a self-health monitor to use custom health monitor script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/custom-configure-threshold-monitoring.md)**  
...
-   **[View the Event Management self-health application services map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/view-self-health-manual-service.md)**  
