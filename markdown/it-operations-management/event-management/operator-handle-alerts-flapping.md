...
1.  Find alerts in the flapping state:
    ...
    2.  Modify the list of alerts by clicking the filter icon \(![Filter icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../image/filter-icon.png)\) and specifying criteria to find flapping alerts.
...
The state of the alert before it entered the flapping state.
    ...
    -   [Run a remediation workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/operator-run-remdiation.md) that might do something like reboot a server or reset a router.
    -   [Access a web application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/operator-launch-web-app.md), like the application for your event monitoring software on your network.
...
5.  After you are certain that the underlying issue is addressed, [close the alert](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/operator-close-alert.md).
