...
-   **mTLS**: A certificate-based authentication that uses the TLS protocol. For details, see [MID Web Server and agent mTLS Authentication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../concept/mid-web-server-mTLS-authentication.md).
...
Option for using the MID Server Unified Keystore option for a secure connection.Clear this option to use **Web Server Keystore**.
 ...
 For details, see [Configure a secure MID Web Server extension](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/event-management/../task/configure-midwebserver-extension-secure.md).
