...
[Configure Ansible Tower user name and password](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/../../cloud-management-v2/task/configure-ansible-creds.md)
...
[Create a workload provider type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/../../cloud-management-v2/task/create-workload-provider-type.md) and [Create an Ansible configuration management provider and run Discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/../../cloud-management-v2/task/create-chef-or-ansible-cfg-provider.md)
...
[Create an application profile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/../../cloud-management-v2/task/create-app-profile.md)
