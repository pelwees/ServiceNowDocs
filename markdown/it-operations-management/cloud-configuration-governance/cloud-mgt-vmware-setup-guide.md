...
-   **vCenter credentials**
    ...
    -   vCenter instance UUID. See [Create the credential and service account that will access your VMware data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/../task/vmware-create-creds-cloud-mgt-1.md) for instructions on how to obtain the UUID.
