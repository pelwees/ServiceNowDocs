...
-   **3. [Configure access to the AWS accounts using permanent AWS credentials](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-configuration-governance/../../it-operations-management/task/aws-create-creds-cloud-mgt.md)**
