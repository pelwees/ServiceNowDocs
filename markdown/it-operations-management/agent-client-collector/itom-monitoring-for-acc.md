...
See [Configure Agent Client Collector Apache HTTP server monitoring](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/acc-apache-http-server.md).
...
See [Configure Agent Client Collector Apache Tomcat monitoring](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/acc-apache-tomcat-monitoring.md).
