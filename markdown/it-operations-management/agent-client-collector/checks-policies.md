...
For details on the Agent Client Collector Framework default checks, see [Agent Client Collector Framework default checks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../reference/acc-framework-checks-policies.md).
