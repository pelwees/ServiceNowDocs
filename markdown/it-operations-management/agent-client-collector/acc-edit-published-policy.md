...
![Editing policy workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../image/ACC-Policy-Workflow.png)
...
4.  Select the **Edit in Sandbox** button.
    ...
    **Note:**
    ...
    -   Although the policy is in **Draft view**, its **Publish status** remains **Published**.
        ...
        ![Policy draft view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../image/ACC-Policy-Draft-View.png)
