...
1.  Ensure that you’ve configured the Agent Client Collector web server. For details, see [Configure the websocket server on the MID Server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-configure-web-server.md).
...
2.  To perform installation using the wizard:
    ...
    2.  Select **Next** until you reach the **MID Web Server Connection Settings** page.
        ...
        ![MID Connection Settings page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../image/ACC-MID-Connection-Settings-Updated.png)
    ...
    4.  Select **Next**.
        ...
        ![Create Local User Account page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../image/ACC-Create-Local-User-Account.png)
...
Due to Windows UAC restrictions, running the agent as a local SYSTEM account is necessary to perform an upgrade via **msiexec**.
    ...
    7.  To enable the **Allow-List** containing the checks enabled to run after setup, select the **Enable executing command allow list** check box on the resulting page.
        ...
        ![Allow list check box](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../image/ACC-Allow-List-Windows.png)
...
-   **[Upgrade the Agent Client Collector manually on a Windows system](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-install-upgrade-windows.md)**  
Perform a manual upgrade of your existing Agent Client Collector version on a system running a Windows OS.
-   **[Uninstall the Agent Client Collector manually from a Windows machine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-uninstall.md)**  
