...
-   **[Configuring MID-less Agent Client Collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-configuring-without-mid.md)**  
...
-   **[Configure an agent registration key](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/agent-registration-key-configuration.md)**  
...
-   **[Agent Client Collector installation on a macOS system](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-install-mac-os.md)**  
...
-   **[Perform Zscaler remediation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/zscaler-remediation-concept.md)**  
...
-   **[Choose and configure metrics to monitor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../../event-management/task/configure-metric-monitors.md)**  
...
-   **[Create a configuration settings rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../../event-management/task/create-config-overriding-rule.md)**  
...
-   **[Understanding the Monitoring Technology Dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/monitor-tech-dashboard-concept.md)**  
...
-   **[Setting exclusion lists for IPs and NICs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-v-set-exclusion-lists-for-ips-and-nics.md)**  
...
-   **[Identify software editions on Windows devices](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/identify-sw-edition.md)**  
...
-   **[Generate a Pattern allow list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/generate-patterns-allow-list.md)**  
