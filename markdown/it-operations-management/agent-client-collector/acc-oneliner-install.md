...
-   Verify that your server's OS and version matches the list of supported OS versions as described in [Agent Client Collector installation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../concept/acc-installation.md).
...
5.  Run the single-line command \(specified in step [2](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/acc-oneliner-install.md#command), above\) on the server where the Agent Client Collector is installed.
