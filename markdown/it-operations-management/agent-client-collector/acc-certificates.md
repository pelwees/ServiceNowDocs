...
-   **[Manually refresh Agent Client Collector certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/manually-sync-certificates.md)**  
...
-   **[Enable OpenSSL secure signing for plugins](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/acc-signing-mechanism.md)**  
...
-   **[Add a self-signed certificate to your operating system's truststore](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/add-certificate-trust-store.md)**  
...
-   **[Import a self-signed certificate](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/import-self-signed-certificate.md)**  
...
-   **[Revoke Agent Client Collector certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/revoke-agent-certificate.md)**  
...
-   **[Agent certificate rotation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/agent-certificate-rotation.md)**  
...
-   **[Run Certificate Discovery via Agent Client Collector for Visibility - Content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/run-cert-discovery-accvc.md)**  
