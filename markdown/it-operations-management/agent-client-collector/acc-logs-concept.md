...
For details on locating and managing Agent Client Collector logs, see [View the Agent Client Collector logs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/agent-client-collector/../task/acc-view-log.md).
