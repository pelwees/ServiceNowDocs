...
For more information on creating scan configuration, see [Create a scan configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-cloud-accelerate/../task/create-ccg-scan-configuration.md).
