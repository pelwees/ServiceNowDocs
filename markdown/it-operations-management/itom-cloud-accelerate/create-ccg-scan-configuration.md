...
3.  Fill the values on the Scan Configuration form.
    ...
    For a description of the form fields, see [Cloud Configuration Governance Scan configuration form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/itom-cloud-accelerate/../reference/ccg-scan-configuration-form.md).
