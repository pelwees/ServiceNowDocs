...
6.  Create Service Account and the keys \(credentials\) in Google Cloud if you don not have it.
    ...
    For more information, see [Set up Google Cloud Platform service accounts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-services-catalog/../../it-operations-management/concept/set-up-gcp-service-accounts.md).
...
7.  Set up a cloud account and a service account for Google Cloud Platform.
    ...
    For more information, see [Set up a cloud account and service account for Google Cloud Platform](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-services-catalog/../../cloud-management-v2-setup/task/gcp-first-cld-and-srvc-accts.md).


**Parent Topic:**[Cloud Services Catalog setup for the Day 1 configuration task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/cloud-services-catalog/../concept/setting-up-cloud-services.md)
