...
5.  For the integration that you want to deactivate, select the Ellipses icon \(![Ellipsis horizontal icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-operations-workspace-for-itom-apps/../../../reuse/icons/product-icons/ellipsis-horizontal-fill-24.svg)\) and then select **Deactivate**.

    ![Option to deactivate connector.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-operations-workspace-for-itom-apps/../image/deactivate-connector.png)
