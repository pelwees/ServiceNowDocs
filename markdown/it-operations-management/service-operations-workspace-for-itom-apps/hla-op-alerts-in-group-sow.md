...
For a detailed description of Log Analytics groups and Log Analytics alerts, see [Types of Health Log Analytics alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-operations-workspace-for-itom-apps/../reference/hla-op-log-analytics-alert-types.md).
...
1.  On the **Overview** tab for a Log Analytics alert, go to the **Alerts in group** card and select the **View all** link.
    ...
    ![Alerts in group section on the Related records tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-operations-workspace-for-itom-apps/../image/alerts-in-group-list-sow.png "Alerts in group section on the Related records tab")
...
**Parent Topic:**[Sections and cards on the Overview tab for a Log Analytics group in Health Log Analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-operations-management/service-operations-workspace-for-itom-apps/../reference/hla-op-ovrvw-tab-log-anltcs-alerts-sow.md)
