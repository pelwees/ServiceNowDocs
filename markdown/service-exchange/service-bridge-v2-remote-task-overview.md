...
For more information, see [Create a remote task definition in Service Exchange for Providers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/service-exchange/../task/service-bridge-v2-create-remote-tasks-defs.md).
