...
2.  In the **Condition** field, select the Lookup using list icon, and then either select an existing condition or create a new condition![Lookup using list icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/service-exchange/../../../common/image/List_SearchIcon.png).
...
For a description of the field values, see [Consumer criteria new record form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/service-exchange/../reference/service-bridge-v2-consumer-criteria-new-record-form.md).
...
![Consumer criteria configuration example 1](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/service-exchange/../image/service-bridge-v2-consum-crit-ex1.jpg)
...
![Consumer criteria configuration example 2](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/service-exchange/../image/service-bridge-v2-consum-crit-ex2.jpg)
...
![Consumer criteria configuration example 3](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/service-exchange/../image/service-bridge-v2-consum-crit-ex3.jpg)
