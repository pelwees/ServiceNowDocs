...
4.  On the View Rule form, fill in the fields.
    ...
    For a description of the fields on the View Rule form, see [View rule form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/privacy-workspace/../reference/prm-view-rule-form.md).

5.  Select **Submit**.


-   **[View rule form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/privacy-workspace/../reference/prm-view-rule-form.md)**  
