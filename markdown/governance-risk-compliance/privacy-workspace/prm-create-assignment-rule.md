...
4.  On the Assignment Rule form, fill in the fields.
    ...
    For a description of the field values on the Assignment Rule form, see [Assignment rule form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/privacy-workspace/../reference/prm-assignment-rule-form.md).

5.  Select **Submit**.


-   **[Assignment rule form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/privacy-workspace/../reference/prm-assignment-rule-form.md)**  
