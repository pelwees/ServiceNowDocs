...
![BIA impact categories that are installed with demo data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/bia-impact-categories.png)
...
![Details of the legal impact category.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/configure-impact-category-for-bia.png)
...
-   **Helper text**
    ...
    ![Helper text in the Impact Rating record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/imact-category-helper-text.png)


## Impact category configuration by BCM administrators

For more information on how to configure an impact category with the sn\_bcm.admin role, see [Configure impact category for BIA](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/configure-impact-category-uib-ws.md).
...
![Impact ratings that are installed with demo data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/configure-impact-category-for-bia.png)

The impact ratings for an impact category are shown in the example.

![Impact ratings for an impact category.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/question-text.png)
...
For more information on how to configure an impact rating with the sn\_bcm.admin role, see [Configure impact ratings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/configure-impact-rating-uib-ws.md).
