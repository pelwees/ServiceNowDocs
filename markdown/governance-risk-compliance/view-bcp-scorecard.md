...
4.  Click the link to the plan record in the **Name** column.
    ...
    **Note:** If your plan is in **Approved** state, then you can view the **Plan Usage and Results** section. However, you can view all the details of a plan in the **Plan Details** section irrespective of the plan being in any state. For more information, see [Plan overview scorecards for plan usage details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../concept/plan-overview-scorecards.md).

5.  To complete the documentation sections that are in **Pending** state, identify teams and individuals for the unassigned recovery teams, or assign groups to carry out specific plan activities, click go to section icon \(![Go to section icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/GoToSectionIcon.png)\) in the respective scorecard widget to add the required information and set the plan to complete.

6.  To add contributors to the plan, click the **Contributors** field to select the users.

    ![Contributors card in the Overview tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/PlanContributorsCard.png "Contributors card in the Overview tab")
