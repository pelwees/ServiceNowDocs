...
-   **[Activate GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/activate-grc-workbench.md)**  
The GRC: Workbench plugin is not activated by default, it is available as a separate subscription within the GRC Suite.
-   **[Create entity class using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/create-profile-class-using-grc-workbench.md)**  
...
-   **[Create relationships between entity classes using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/create-relationships-between-profile-classes.md)**  
...
-   **[Visualize and edit entity dependencies using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/visualize-edit-profile-dependencies.md)**  
...
-   **[Delete entity dependencies using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/delete-profile-dependencies.md)**  
...
-   **[Delete an entity class using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/delete-profile-class-workbench.md)**  
Deleting an entioty class, deletes all relationships below it.
-   **[Create a risk using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/create-risk-using-grc-workbench.md)**  
Risk managers can create risks directly from the GRC: Workbench.
-   **[Visualize and edit risk dependencies using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/visualize-edit-risk-dependencies.md)**  
...
-   **[Delete risk dependencies using the GRC: Workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/delete-risk-dependencies.md)**  
...
**Parent Topic:**[Using Risk Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../grc-risk/concept/using-risk-mgmt.md)
