...
</table>**Parent Topic:**[Create a risk event response template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/create-risk-event-response-template.md)
