...
4.  To fill in the fields for the risk appetite section, see [Define the risk appetite for a risk statement](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../grc-workspace-risk/task/define-risk-appetite-on-risk-statement.md).
