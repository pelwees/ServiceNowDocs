...
6.  To reassign the project, select the ![more actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../grc-compliance-case-mgmt/image/more-actions-vertical-icon.png) icon, and select **Reassign**.
