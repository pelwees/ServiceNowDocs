...
For step-by-step instructions about how to set up your ServiceNow AI Platform instance and install the GRC Mobile application, see [Set up checklist for the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-setup-risk-app.md). For instructions about how to log in, see [Log in to the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-login-risk-mobileapp.md).
...
-   **[Log in to the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-login-risk-mobileapp.md)**  
Open the GRC Mobile application and add a ServiceNow AI Platform® instance with Risk Management to your mobile device.
-   **[Process pending Risk acceptance tasks with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-risk-accpt-tasks.md)**  
Process pending approval requests for Risk Management acceptance tasks that are submitted to you.
-   **[Assign Risk Management indicator tasks with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-indic-tasks.md)**  
...
-   **[Assign Risk Management issues with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-risk-issues.md)**  
...
-   **[Assign Risk Management remediation tasks with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-risk-remed-tasks.md)**  
...
-   **[Reassign overdue Risk Management assessments with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-risk-assessments.md)**  
Reassign overdue risk assessments to another member of your assignment group.
-   **[Reassign overdue Risk Management issues with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-risk-reassign-issues.md)**  
Reassign overdue Risk Management issues that are assigned to your assignment group.
-   **[Filter records with the GRC Mobile application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/mobile-risk-set-filters.md)**  
