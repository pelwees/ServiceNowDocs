...
![Accessing the formula tree. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../metrics/image/metric-formula-tree.png "Example of accessing a formula tree")

![Viewing the formula tree. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../metrics/image/metric-formula-tree-view.png "Example of a formula tree")
...
![Viewing an empty page. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../metrics/image/formula-tree-empty.png "Example of an empty page")

![Viewing an empty page. For the text description, refer to the text that preceded this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../../metrics/image/formula-tree-error.png "Example of an error page")

To learn more about formula trees, see:

-   **[View the calculation breakdown in a formula tree](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/../task/view-formula-tree-irm.md)**  
View a structured and visual representation of the entire calculation chain.

**Parent Topic:**[Using GRC: Metrics to provide data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-risk-management-workspace/using-metrics-irm.md)
