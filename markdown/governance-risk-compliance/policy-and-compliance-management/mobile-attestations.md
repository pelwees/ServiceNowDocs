...
2.  With the Policy and Compliance screen displayed, under the section titled, `Team's Overdue Work`, tap **Attestations**.
    ...
    ![Attestations applet highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/mobile_Policy_and_Compliance_applet_Attestations.png)

    The Attestations screen is displayed with a list of records.

    ![Attestations list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/mobile-attest-list.jpg)
...
4.  To reassign an attestation directly from the list of records displayed on the Attestations screen, swipe left on a record to open the menu.
    ...
    ![Attestations swipe menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/mobile-attest-swipe.jpg)
...
9.  Choose one from the following table to continue.
    ...
    ![Attestation record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/mobile-attest-record.jpg)
...
Tap the menu icon \(![Top menu icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../../grc-common/image/mobile-top-menu.png)\) to reassign the attestation.
