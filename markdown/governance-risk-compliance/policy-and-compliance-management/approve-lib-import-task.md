...
4.  On the form, click **Import** or **Reject**.
    ...
    ![Import or reject a library import task.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/import-or-reject-lit.png "Import or reject a library import task")
...
5.  Click **Submit for approval**.
    ...
    ![Task submitted for approval.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/lit-submitted-for-approval.png "Task submitted for approval")
...
6.  Review the library import task and click **Approve**.
    ...
    **Note:** Clicking **Reject** rejects the library import task and moves it to New state again as shown in the following example.
    ...
    ![Library import task in Ready for import state.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/lit-ready-for-import.png "Library import task in Ready for import state")

    When the task is in the Ready for import state, the Import action is displayed as shown in the following example.

    ![Task to be imported.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/lit-import.png "Task to be imported")
...
7.  Click **Import**.
    ...
    ![Authority documents table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/lit-authority-documents.png "Authority documents table")
    ...
    ![Import or reject actions for a new document.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/import-reject-import-actions.png "Import or reject actions for a new document")
    ...
    ![Ignore action for no change in the document status.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../image/ignore-import-action.png "Ignore action for no change in the document status")
