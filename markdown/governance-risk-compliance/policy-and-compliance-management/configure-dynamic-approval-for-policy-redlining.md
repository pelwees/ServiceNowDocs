...
3.  Navigate to **Compliance library** &gt; **My policies** and open a policy record.
    ...
    You can [create a new policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../../grc-workspace-compliance/task/create-policy-ws.md) or open a policy record to enable the redlining feature.
