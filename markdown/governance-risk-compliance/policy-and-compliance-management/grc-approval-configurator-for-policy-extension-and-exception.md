...
-   **[Enable GRC Approval Configurator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../task/enable-grc-approval-configurator.md)**  
Enable the GRC Approval Configurator from the Policy and Compliance Properties page.
-   **[Define policy exception and extension rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/policy-and-compliance-management/../task/define-policy-exception-verification-rules.md)**  
