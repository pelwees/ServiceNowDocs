...
-   **[Install the GRC integration with Thomson Reuters Regulatory Intelligence application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/install-trri-integration.md)**  
...
-   **[Establish an SFTP or REST API connection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-conn-record-tr-int.md)**  
...
-   **[Modules in the GRC integration with Thomson Reuters Regulatory Intelligence application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/modules-in-the-application.md)**  
The GRC integration with Thomson Reuters Regulatory Intelligence application includes various modules.

**Parent Topic:**[Governance, Risk, and Compliance integrations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-common/reference/grc-integrations.md)
