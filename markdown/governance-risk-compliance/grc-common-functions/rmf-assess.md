...
-   **[Review and perform control attestations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/rmf-perform-control-attestations.md)**  
Review and perform control attestations relating to NIST RMF security attestations.
-   **[Review and evaluate control effectiveness](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/rmf-evaluate-control-effectiveness.md)**  
Review and evaluate the effectiveness of the controls through the execution of control tests related to NIST-800.53.r4.
-   **[Manage and address risks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/rmf-manage-address-risks.md)**  
Review and manage all risks stemming from risk statements having the content source of NIST 800-53.r4.
-   **[Review and perform risk assessments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/rmf-perform-risk-assessment.md)**  
Review and execute the risk assessments relating to NIST RMF security assessments.
-   **[Manage and address issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/manage-address-issues.md)**  
Review all issues stemming from controls and risks with NIST 800-53.r4 as the source and address them.
-   **[Manage and address remediation tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/manage-address-remediation-tasks.md)**  
Review all remediation tasks stemming from controls and risks with NIST 800-53.r4 as the source and address them.
-   **[Monitor the NIST RMF Assess dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/monitor-rmf-assess-dashboard.md)**  
The NIST RMF assess dashboard provides insights into the overall status of the target.

**Parent Topic:**[NIST RMF process overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/nist-rmf-process.md)
