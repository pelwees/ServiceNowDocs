...
Activate the Third-party Risk Management \(com.sn\_vdr\_risk\_asmt\) plugin.
 ...
 For more information, see [Configuring Third-party Risk Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-vendor-risk/concept/tprm-configuring.md) and the instructions for activating an entitled GRC application from the ServiceNow® Store: [Activate an entitled GRC ServiceNow Store application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-common/task/activate-entitled-grc-app.md) and [Download a GRC application from the ServiceNow Store for the first time](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-common/task/download-grc-first-time.md).
...
**Parent Topic:**[Standardized Information Gathering \(SIG\) Questionnaire Integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../concept/grc-sig-integration.md)
