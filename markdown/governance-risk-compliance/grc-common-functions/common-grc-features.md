...
-   **[Assignment Configurator for non-regulatory alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/assignment-configurator-for-non-regulatory-alerts.md)**  
...
-   **[Regulatory Agency Library](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-rcm/concept/regulatory-agency-library-rcm.md)**  
Regulatory Agency Library is a new application available in the ServiceNow Store for download and activation.
-   **[Recommendation contexts and templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-rcm/concept/recommendation-contexts.md)**  
...
-   **[Mobile experience for Governance, Risk, and Compliance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/mobile-grc-ovrvw.md)**  
...
-   **[GRC notification redirection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/email-notification-redirection.md)**  
...
-   **[Governance, Risk, and Compliance application nomenclature updates and industry terminology](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/grc-terms.md)**  
The following terms are used within GRC applications and/or within the GRC industry.
-   **[Governance, Risk, and Compliance content packs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/grc-content-packs.md)**  
...
-   **[Governance, Risk, and Compliance integrations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/grc-integrations.md)**  
...
-   **[Governance, Risk, and Compliance use case accelerators](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/grc-use-case-accelerators.md)**  
...
-   **[360° Relationship Visualization](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-360-degree-rel-vis/concept/grc-360-deg-rel-vis.md)**  
...
-   **[Tagging records with functional domain](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/tagging-records-with-functional-domain.md)**  
...
-   **[Using the item generation process to generate controls and risks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/item-generation-process.md)**  
...
-   **[Using Approver Configurator for setting up approvals](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/approval-configuration.md)**  
...
-   **[Confidential records](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/confidential-records.md)**  
...
-   **[User hierarchy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/user-hierarchy.md)**  
With a user hierarchy, your managers can see the records of those users who report to them.
-   **[User group-based access on the GRC tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/user-groups.md)**  
...
-   **[Content references in GRC](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/content-references.md#)**  
...
-   **[Entity Based Access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/entity-based-access.md)**  
...
-   **[Manage issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/manage-issues-common-core.md)**  
...
-   **[Domain separation in GRC](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/grc-domain-separation.md)**  
...
-   **[Breadcrumb navigation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/breadcrumb-navigation.md)**  
...
-   **[Taxonomy management in GRC](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/taxonomy-management.md)**  
...
-   **[Landing Page Configurations module](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/admin-config-using-grc-common.md)**  
...
-   **[My tasks in the workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-common-workspace/concept/configuration-of-tasks.md)**  
...
-   **[Exploring the entities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/exploring-the-entities.md)**  
...
-   **[Viewing and updating Governance, Risk, and Compliance exceptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-risk/task/viewing-and-updating-grc-exceptions.md)**  
...
-   **[Cybersecurity Executive dashboard for Chief Information Security Officers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/grc-ced-ciso-db.md)**  
...
-   **[Advanced Governance, Risk, and Compliance Application Risk dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/advanced-grc-dashboard.md)**  
...
-   **[GRC licensing summary dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/grc-licensing-summary-dashboard.md)**  
...
-   **[document-designer-template.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/document-designer-template.md)**  

-   **[Workspace page configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/workspace-page-configuration.md)**  
A common record page can be used and configured within all the GRC applications.
-   **[Governance, Risk, and Compliance reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/grc-reference.md)**  
Reference topics provide information about tables, roles, and properties installed with the GRC application.
-   **[Anonymous Reporting Center](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/grc-anonymous-reporting-center.md)**  
...
**Parent Topic:**[Governance, Risk, and Compliance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/r_WhatIsGRC.md)
