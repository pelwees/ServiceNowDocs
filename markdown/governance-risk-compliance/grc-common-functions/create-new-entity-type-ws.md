...
4.  To save the entity type, click **Save**.
    ...
    -   Content References
    -   Privacy Assessments
    See [An entity in the workspace view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../concept/entities-in-risk-ws.md) for more information.

5.  To save the entity type, click **Save**.


**Parent Topic:**[Entity types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../concept/entity-type-in-risk-ws.md)
