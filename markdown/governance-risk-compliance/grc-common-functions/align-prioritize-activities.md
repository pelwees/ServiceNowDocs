...
-   **[Generate a target for an entity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/generate-target.md)**  
Generate a target record for an entity to track NIST CSF attributes for that entity.
-   **[Set up target for NIST CSF framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/setup-target-use-nist-csf-framework.md)**  
Set up a target record to use with NIST CSF framework after you've identified a target.
-   **[Orient target](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/orient-target.md)**  
After you've identified a target, orient the target to use with the NIST CSF framework.
-   **[Create activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-activity.md)**  
Create a cybersecurity activity for a target.
-   **[Perform gap analysis](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/perform-gap-analysis.md)**  
Perform a Gap analysis of cybersecurity activities.
-   **[Review action plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/review-action-plan.md)**  
...
**Parent Topic:**[NIST CSF process overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/nist-csf-process.md)
