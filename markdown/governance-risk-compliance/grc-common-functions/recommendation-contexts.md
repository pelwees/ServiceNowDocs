...
For more information about creating a recommendation context, see [Create a recommendation context](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/configure-recommendation-context.md).

For more information about creating a recommendation template, see [Create a recommendation template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-a-recommendation-template.md).
...
For more information about the user roles that can access this menu item, see [User roles for recommendation contexts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/user-roles-for-recommendation-contexts.md).

The following example shows the GRC Administration menu.

![Navigation screen to recommendation contexts.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/reco-context-grc-admin-menu.png "GRC Administration menu")

You can select an item that fits the context to build a template for recommending relevant records. You can use the existing configurations as is or update them. You can also select the AI search type that matches a user's needs for recommending relevant items that are based on the context and criteria. In addition, you can configure the relationship section that displays the related items for each recommendation and specifies their titles. For more information, see [Create a recommendation template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-a-recommendation-template.md).
...
-   **[User roles for recommendation contexts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/user-roles-for-recommendation-contexts.md)**  
Users with different roles can read, create, or edit recommendation contexts for a regulatory alert.
-   **[Extension points](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/extension-points.md)**  
...
-   **[Create a recommendation context](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/configure-recommendation-context.md)**  
Create a recommendation context to define a configuration that builds a template for recommending relevant records.
-   **[Create a recommendation template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-a-recommendation-template.md)**  
