...
For more information on risks, see [Using Risk Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-risk/concept/using-risk-mgmt.md).
...
![Item generation process flow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/item-gen-process-flow.png "Item generation process flow")
...
![Message for upgrading the applications.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/item-gen-upgrade-message.png "Message for upgrading the applications")
...
![Configure the frequency of the scheduled job.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/action_queue_processor.png "Configure the frequency of the scheduled job")
...
![Item generation action event queue.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/activate-document-in-the-queue.png "Item generation action event queue")
...
![Initiation of the item generation process.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/relationshop-bet-risks-controls.png "Initiation of the item generation process")
...
![Script includes action handlers.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/script-includes-menu.png "Script includes action handlers")
...
![Base functions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/base-functions.png "Base functions")
...
![Override the base functions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../image/override_base_class_functions.png "Override the base functions")

-   **[Components installed with the item generation process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/components-item-gen-process.md)**  
...
-   **[Operational changes in item generation of common controls](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/item-gen-action-types.md)**  
