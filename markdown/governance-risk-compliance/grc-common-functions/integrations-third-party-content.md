...
For more information on the user roles, see [User roles for the integration process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/int-integrator-user-roles.md) and [Create a user with the sn\_grc\_cim.admin role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-user-with-cim-manager-role.md).

-   **[User roles for the integration process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/int-integrator-user-roles.md)**  
...
-   **[Create a user with the sn\_grc\_cim.admin role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/create-user-with-cim-manager-role.md)**  
