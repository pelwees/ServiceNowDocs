...
Template used for this skill.
    ...
    For more information, see [Choose input data form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/input-data-rcm-skill.md).
