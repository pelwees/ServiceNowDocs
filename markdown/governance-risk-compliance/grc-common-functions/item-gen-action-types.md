...
**Note:** For more information on reliant entity associations for a common control, see [Create a control using the Compliance Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-workspace-compliance/task/create-control-ws.md) and [Convert standard control to common control and add reliant entities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../../grc-workspace-compliance/task/convert-standard-control-common.md).
