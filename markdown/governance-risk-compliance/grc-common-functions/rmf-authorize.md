...
-   **[Authorize targets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/rmf-authorize-targets.md)**  
Authorize a target record based on the overall security posture determined by the security officer.
-   **[Monitor the NIST RMF Authorize dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/monitor-rmf-authorize-dashboard.md)**  
