...
4.  Open the target record again and update the following fields in the NIST RMF section:
    ...
    **Note:** Review [NIST RMF supporting concepts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../reference/grc-nist-rmf-key-concepts.md), for more detailed information about these fields.
...
**Parent Topic:**[Categorize targets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../concept/rmf-categorize.md)
