...
-   **[Generate target from profile or entity type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/generate-target-from-profile.md)**  
Generate a target record for a profile to track NIST RMF attributes.
-   **[Set up a target for use with NIST RMF](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/set-up-target-nist-rmf.md)**  
Set up a target and populate the basic information.
-   **[Perform preliminary risk assessment and impact analysis](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/perform-risk-assess-impact-analysis.md)**  
Perform a preliminary risk assessment and impact analysis of the target.
-   **[Monitor the NIST RMF Categorize Overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/grc-common-functions/../task/monitor-rmf-categorize-dashboard.md)**  
