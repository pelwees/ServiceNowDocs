...
-   **Loss of Windows Servers**
 ...
 You can also create a loss scenario and add it to the template. For more information on creating a loss scenario, see [Add loss scenarios](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-loss-scenario-recovery-task-bcp-uib-ws.md).
...
</table>**Parent Topic:**[Configure the business continuity plan template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/configure-a-bcp-template-uib-ws.md)
