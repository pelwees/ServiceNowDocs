...
1.  Navigate to **Business Continuity** &gt; **Everbridge Contact Configuration** &gt; **Contacts**.
    ...
    The contacts are displayed in the list view as shown in the example.![Contacts in the list view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/ebn-contacts-list-view.png)

2.  Select **New**.

    The Contact form is shown in the example.![Contact form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/contacts-ebn.png)
...
3.  On the form, fill in the fields.
    ...
    For more information on the fields, see [Contact form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/contact-form.md).

4.  Select **Submit**.

5.  To import contacts based on contact sync rules, select the **Import users** button.

    To import the contacts using a sync rule, you must first [Create the contact import rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/create-contact-import-rules.md). Refresh the form page to get the imported list of users.
...
-   **[Contact form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/contact-form.md)**  
Use the Contact form to create the contacts manually and then synchronize the contacts with Everbridge.
-   **[Create the contact import rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/create-contact-import-rules.md)**  
...
**Parent Topic:**[Setup for Everbridge notifications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../concept/setup-steps-for-emergency-notification-uib-ws.md)
