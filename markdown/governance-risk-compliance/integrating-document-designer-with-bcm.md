...
See [Set up the template configurations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/set-up-document-designer-templates.md) for more information.
...
Configure data relationships in the templates so that they’re displayed in the Microsoft Word reports. See [Configure the data relationships](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/create-data-rel-fortemp-config.md), [Set up the content configurations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/create-content-config-for-temp-config.md), and [Define the scripted variables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/create-scripted-vari-for-temp-config.md) for more information.
...
Install the add-in into your Microsoft Word document. See [Install the Document designer add-in](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/install-docu-designer-add-in-for-bcm.md) for more information.
