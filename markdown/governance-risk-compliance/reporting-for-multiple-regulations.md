...
For information on setting up the entities, see [Set up entities for the targets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/set-up-entities-for-targets.md).
...
For information on mapping regulations and setting up action task templates, see [Map regulations to the entities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/configure-case-types-map-regu.md) and [Set up action task templates in Regulatory agency profile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/set-up-action-task-templates.md).

For information on completing action tasks, refer to [Complete action tasks and report incidents associated with regulations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/work-on-action-tasks.md).
