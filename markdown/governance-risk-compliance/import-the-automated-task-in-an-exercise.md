...
3.  Fill in the required fields in the **Details** tab.
    ...
    For more information on the fields, see [Create New Event Task form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/create-new-event-task-form-uib-ws.md).
