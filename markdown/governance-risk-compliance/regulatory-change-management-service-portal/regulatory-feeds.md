...
-   **[Perform actions on regulatory alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/regulatory-change-management-service-portal/../task/perform-actions-reg-event-feeds.md)**  
...
-   **[Add an AI-recommended citation to a regulatory alert](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/regulatory-change-management-service-portal/../task/add-recommended-citations-to-a-regulatory-alert.md)**  
Add an AI-recommended citation to a regulatory alert by using the GRC: Predictive Intelligence application.
-   **[Manage and assign regulatory event alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/regulatory-change-management-service-portal/../task/manage-regulatory-feeds.md)**  
...
-   **[Train and use the similarity solution to recommend citations on regulatory alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/regulatory-change-management-service-portal/../task/retrain-ml-reg-compliance-mapping.md)**  
...
-   **[Manage and assign source document alerts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/regulatory-change-management-service-portal/../task/manage-source-document-feeds.md)**  
