...
For the initial setup checklist for Smart Assessment Engine, see [Configuring Smart Assessment Engine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../../assessment-engine/concept/smart-assessment-engine-cf-config.md).
...
3.  On the form, fill in the fields.
    ...
    For more information on the fields in the form, see [BIA template form for the legacy assessment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/bia-template-new-record-form.md).
...
4.  Select **Smart Assessment** as the assessment type.
    ...
    ![Smart Assessment type.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/bia-smart-asmt-type.png)
    ...
    The Impact assessment template is the Smart Assessment template you configured following the steps outlined in [Create Smart Assessment templates for BIA](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/conf-impact-asmt-template.md).
...
8.  To display result fields on the assessment card in the Impact analysis record within the Workspace, open the BIA template, map the BIA fields to the Impact assessment template, and save the mapping.
    ...
    ![Related list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/bia-rel-list.png)
    ...
    ![BIA fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/asmt-temp-bia-field.png)
    ...
    ![Cards.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/bia-asmts-based-on-imp-asmt-templates.png)
...
-   **[BIA template record form for the Smart assessment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/bia-smart-temp-ref-form.md)**  
