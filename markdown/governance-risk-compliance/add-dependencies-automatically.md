...
For information on the Data Relationships Framework and main node configuration, see [Data Relationships Framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../../grc-common/concept/data-relationship-framework.md) and [Create a main node configuration record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../../grc-common/task/create-a-main-node-config-record.md).
