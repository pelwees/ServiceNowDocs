...
-   For more information on creating an exercise, see [Create an exercise](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/start-exercise-event-in-uib-ws.md).
-   For more information on adding assets and plans to the exercise, see [Track impacted assets and add associated plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-asset-and-plan-to-exercise-event-uib-ws.md).
-   For more information on adding an event task to the exercise, see [Monitor event tasks and create ad-hoc tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-an-event-task-to-exercise-event.md).
-   For more information on submitting the event task for the exercise event, see [Request an approval and approve the event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/submit-an-event-task-uib-ws.md).
...
For more information on bulk editing of tasks, see [Structured workflows for crisis events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/perform-tasks-to-manage-crisis-events.md).
...
-   **[States for an exercise and crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/states-for-exercise-events.md)**  
This section describes the states of progression for an exercises and crisis event.
-   **[Event assets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/event-assets.md)**  
When an event is initiated, event assets are managed by using different recovery management methods.
-   **[Mapping event tasks to phases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/mapping-event-tasks-to-phases.md)**  
...
-   **[Using nested plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/creating-nested-plan-in-event.md)**  
...
-   **[Adding dependencies of impacted assets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/import-event-dep-updates.md)**  
...
-   **[Enhancing event task management with Hierarchical view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/managing-enhanced-hierarchical-view-in-event-tasks.md)**  
...
-   **[Create an exercise](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/start-exercise-event-in-uib-ws.md)**  
...
-   **[Update the event dependencies](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/update-event-dep-manually.md)**  
...
-   **[Track impacted assets and add associated plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-asset-and-plan-to-exercise-event-uib-ws.md)**  
...
-   **[Creating action items in events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/creating-action-items-in-events.md)**  
...
-   **[Creating similar tasks groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/identifying-running-dup-tasks-once.md)**  
...
-   **[Import plans and recovery tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/import-the-automated-task-in-an-exercise.md)**  
...
-   **[Monitor event tasks and create ad-hoc tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-an-event-task-to-exercise-event.md)**  
...
-   **[Start an event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/start-event.md)**  
...
-   **[Request an approval and approve the event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/submit-an-event-task-uib-ws.md)**  
Approve the exercise in BCM UIB Workspace.
-   **[View recovery tasks from Self-Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/view-recovery-tasks-from-self-service-uib-ws.md)**  
...
-   **[View 360° relationships for exercises and crises](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/relationship-view-exercise-crisis.md)**  
...
-   **[Generate event reports in PDF or Microsoft Word](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/generate-pdf-for-events.md)**  
