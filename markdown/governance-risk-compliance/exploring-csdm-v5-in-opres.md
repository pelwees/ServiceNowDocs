...
For more information on the tables that are relevant to the CSDM data model, see [Tables relevant to CSDM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/csdm-v5-ref.md). For information on the pillars, see [Pillars overview tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../../grc-operational-res-ws/concept/pillars-ov.md).
