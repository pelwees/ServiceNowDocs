...
-   For more information on reporting a crisis event, see [Start a crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/start-crisis-event-in-uib-ws.md).
-   For more information on adding an asset and plan to the crisis event, see [Track impacted assets and add related plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-asset-plan-to-crisis-event-uib-ws.md).
-   For more information on adding an event task to the crisis event, see [Add a task to the crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-event-task-to-crisis-event.md).
-   For more information on submitting the event task, see [Request an approval and approve the crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/submit-event-task-for-crisis-event-uib-ws.md).
...
![Bulk edits.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/transition-of-the-states.png)
...
![Update the state of the event task.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/updating-ui-states-for-event-task-ui16.png)
...
For information on importing the automated task in an event, see [Import automated tasks and start an event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/import-the-automated-task-in-an-event.md).

-   For information on reporting a crisis event from the Home page, see [Home page view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/home-page-uib-ws.md).
-   For information on managing threats, feeds, and alerts in the Crisis map interface, see [Crisis map interface](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/threats-feeds-alerts-crisis-map.md).
-   For information on performing administrative tasks in the Crisis map interface, see [Setup for Crisis map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/crisis-map-admin-tasks.md).

-   **[Start a crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/start-crisis-event-in-uib-ws.md)**  
...
-   **[Track impacted assets and add related plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-asset-plan-to-crisis-event-uib-ws.md)**  
...
-   **[Add a task to the crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/add-event-task-to-crisis-event.md)**  
...
-   **[Import automated tasks and start an event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/import-the-automated-task-in-an-event.md)**  
...
-   **[Creating action items in crisis events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/creating-action-items-in-crisis.md)**  
...
-   **[Create a similar tasks group in a crisis](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/create-sim-tasks-grp-crisis.md)**  
...
-   **[Request an approval and approve the crisis event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/submit-event-task-for-crisis-event-uib-ws.md)**  
