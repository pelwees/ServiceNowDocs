...
3.  On the form, fill in the fields.
    ...
    For a description of the field values on the GRC State Model form, see [GRC State Model form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/compliance-case-management/../reference/grc-state-model-form.md).

4.  Select **Submit**.


-   **[GRC State Model form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/compliance-case-management/../reference/grc-state-model-form.md)**  
