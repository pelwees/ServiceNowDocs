...
|State Model|
|State Model|Workflow states for the case type. For more information, see [Create a compliance state model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/compliance-case-management/../task/create-state-model.md).|
|Assessment Configuration|
|Assessment templates|Assessment template for the case type. If the **sn\_grc\_case\_mgmt.enable\_smart\_assessments** system property is set to **true**, then you can specify the Smart assessment templates that you want to use for performing smart assessment on action tasks. For more information, see [Create an assessment template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/compliance-case-management/../task/ccm-create-assessment-template.md). For information on|
...
**Parent Topic:**[Create a case type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/compliance-case-management/../task/create-case-type.md)
