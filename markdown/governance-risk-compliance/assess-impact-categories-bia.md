...
4.  To update an existing BIA, click the link to the record in the **Name** column.
    ...
    ![Impact assessment and dependency view of BIA](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/BIAImpactAssessmentDependencyView.png "BIA impact assessment and dependency views")
    ...
    -   **Impact Assessment Result**
        ...
        **Note:** You can configure the mapping of recovery tiers to RTOs as per your requirement.
        ...
        ![Impact assessment result.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/ImpactAssessmentResult.png "Impact assessment result")
    ...
    -   **Impact Assessment Progress**
        ...
        ![Impact assessment progress component.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/ImpactAssessmentProgressRibbon.png "Impact assessment progress component")
    ...
    -   **Dependent Assessment Progress**
        ...
        ![Dependency assessment progress pie chart.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/DependencyAssessmentProgress.png "Dependency assessment progress pie chart")
...
6.  To answer questions on the data value of the asset in terms of its impact on the business and its data change frequency, click **RPO Impact Assessment** tab.
    ...
    For more information, see [Assess RPO impact of technology assets on the business](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/RPO-asset-impact-assessment.md).
