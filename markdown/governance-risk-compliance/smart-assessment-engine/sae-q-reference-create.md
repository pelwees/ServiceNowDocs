...
A setting on choice-type questions that lets template builders define which answers are considered "preferred". This Option is in the configuration options menu \(![Additional attributes menu icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/../../grc-business-continuity-management/image/AlertMenuIcon.png)\).
