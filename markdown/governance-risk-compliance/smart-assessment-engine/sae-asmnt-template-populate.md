...
6.  Select a section in the list and then select **Add question**.
    ...
    ![Configuring a question. Descriptions for the sections of the form appear in the following list.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/../image/sae-create-question-form-annotated.png)
    ...
    |-----------|--------|
    |Create and configure text type questions.|[Create a text question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-text-create.md)|
    |Create and configure drop-down list type questions.|[Create a drop-down list question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-drop-down-create.md)|
    |Create and configure radio button type questions.|[Create a radio button question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-radio-button-create.md)|
    |Create and configure check box type questions.|[Create a check box question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-check-box-create.md)|
    |Create and configure number type questions.|[Create a number question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-number-create.md)|
    |Create and configure reference type questions.|[Create a reference question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-reference-create.md)|
    |Create and configure attachment type questions.|[Create an attachment question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-attachment-create.md)|
    |Create and configure date type questions.|[Create a date question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-date-create.md)|
    |Create and configure code type questions.|[Create a code question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/sae-q-code-create.md)|
