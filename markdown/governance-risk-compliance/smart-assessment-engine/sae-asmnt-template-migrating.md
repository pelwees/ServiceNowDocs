...
2.  Start the migration process. The following activities then transform the metric type data into an SAE assessment template:
    ...
    **Note:** The template definitions are migrated as response options if the metric data type is a template.
    ...
    For more information, see [How legacy metric types are migrated to sections in templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/../reference/sae-how-legacy-metrics-migrated.md).
...
For more information about migrating the legacy metric types, see [Migrate a legacy metric type to an assessment template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/../task/sae-asmnt-tmplt-migrate-metrics-to.md).
