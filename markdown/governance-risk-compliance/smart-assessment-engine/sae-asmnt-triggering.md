...
-   **Trigger an assessment from Workflow Studio**
    ...
    For more information, see [Configure the Trigger Smart Assessment Flow action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/../task/sae-asmnt-trigger-from-flow.md).
...
-   **Trigger an assessment from a script**
    ...
    For more information, see [Trigger assessments from a script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/smart-assessment-engine/../task/sae-asmnt-trigger-from-script.md).
