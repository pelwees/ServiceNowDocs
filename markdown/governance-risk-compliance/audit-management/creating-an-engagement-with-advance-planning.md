...
**Note:** To know more about the applications in GRC module, see [Governance, Risk, and Compliance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/audit-management/../../grc-common/reference/r_WhatIsGRC.md).
...
-   Quality Audit
-   Project Audit
 **Note:** For more information on the types of audits, see [Audit types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/audit-management/../reference/types-of-audit.md).
...
-   Closed Complete
-   Closed Incomplete
 **Note:** For more information on each of these states, see [Manage engagements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/audit-management/../concept/c_Engagements.md).
...
-   Closed
 **Note:** For more information on the Follow Up and Closed states, see [Manage engagements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/audit-management/../concept/c_Engagements.md).
