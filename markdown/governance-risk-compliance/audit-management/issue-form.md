...
-   The issue manager receives an email notification when the assigned-to user [provides requested information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/audit-management/../../grc-policy-and-compliance/task/remediate-issue.md).
