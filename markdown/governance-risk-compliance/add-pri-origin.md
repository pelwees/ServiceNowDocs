...
4.  Update the source record in the **Source record** field in the Primary origin section of the **Details** tab and select **Save**.
    ...
    If you add the source in the **Source** field and the source record in the **Source record** field in the Primary origin section of the **Details** tab, the system automatically edits the primary origin and displays it on the **Primary origin** tab. In the following example, the Source Table is Business Service, the Source is Business service, and the selected source record is BS1000.![Source field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/pri-origin-src-field.png)

    As shown in the example, the source record BS1000 is automatically updated as the primary origin on the **Primary origin** tab.![Primary origin tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/pri-origin-updated.png)
    ...
    ![Primary origin impacted area.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/pri-ori-imp-area.png)
    ...
    ![Dependency.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/pri-ori-up-dep-1.png)![Upstream dependencies.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/pri-ori-up-dep-2.png)
...
5.  On the **Primary origin** tab, select **Add**.
    ...
    ![Primary origin added.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/op-vul-pri-ori.png)
...
7.  To view the status of the uploaded upstream assets of the primary origin, select the **View progress** UI action.
    ...
    ![Impacted areas.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../image/op-vul-pri-ori-view-progress.png)
