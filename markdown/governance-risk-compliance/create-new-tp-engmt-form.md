...
The **Latitude** and **Longitude** values are used to mark the location on the Risk concentration map. See [TPRM Risk concentration map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../../grc-workspace-vrm/concept/tprm-ws-risk-concentration-map.md).
...
</table>**Parent Topic:**[Create a third-party engagement and enhance digital resilience data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../task/create-drtp-reg-tp-engagement.md)
