...
3.  On the form, fill in the fields.
    ...
    You can fill in the details of the application service in the form. For information on the fields, see [Create New Service Instance form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/../reference/create-new-appl-service-form.md).
