...
-   **Inherent Risk Questionnaire \(IRQ\) process**
    ...
    ![Infographic that shows the IRQ process in the due diligence workflow. For the text description, refer to the process steps that follows.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-workspace-vrm/image/mmasset0020741-IRQ-process-landing.png)
...
-   **Due diligence process: Compliance verification**
    ...
    ![Infographic that shows the due diligence process in the due diligence workflow. For the text description, refer to the process steps that follows.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-workspace-vrm/image/mmasset0020742-due-diligence-process-vertical.png)
...
![Notification that the responses are copied from an earlier questionnaire.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../image/tprm-pre-populate-q-aire.png)
