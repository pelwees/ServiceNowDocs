...
3.  Select the Metric Categories related list, the category name, and then select the question from the Assessments Metrics related list that you want to configure.
    ...
    For more information on the different types of questions and how to define them, see [Define a question](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk-implementation/task/tprm-questions-create.md).
