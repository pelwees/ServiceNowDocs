...
**Note:** For more information about using the GRC: SIG Questionnaire Integration plugin, see [Standardized Information Gathering \(SIG\) Questionnaire Integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-sig-questionnaire/concept/grc-sig-integration.md), [Install the GRC: SIG Questionnaire Integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-sig-questionnaire/task/install-grc-sig-plugin.md), and [Verify the SIG Questionnaire Integration in Third-party Risk Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-sig-questionnaire/task/verify-grc-sig-vendor-risk.md).

For instructions that you can send to third-party contacts, see [Respond using the SIG](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../task/tprm-tpcontact-use-sig.md).
