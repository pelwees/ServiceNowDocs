...
For more information on creating risk statements and risks in Risk Management, see [Create a risk statement](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-risk/task/t_CreateRiskState.md), [Create a risk manually](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-risk/task/t_CreateRisk.md), and [Generate a risk from a risk statement](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-risk/task/t_GenRiskFromRiskFrameProfile.md).

To understand the difference between a control objective and a control, see [Relationship between risks, risk events, and risk statements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-risk/reference/manage-risk-events.md#).

## Procedure

1.  Navigate to **Workspaces** &gt; **Vendor Management Workspace**.

2.  Select the list icon \(![List icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-cam-workspace/image/ws-list-icon.png)\) and then navigate to **Third parties** &gt; **All third parties** or **Engagements** &gt; **All engagements**.
...
6.  On the form, fill in the fields.
    ...
    For descriptions of all these fields, see [Create new risk form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk/reference/tprm-risk-record-form.md).

7.  Select **Submit**.

    For more information on managing risks, see [Manage risks, risk statements, and risk frameworks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-risk/reference/r_RiskRegister.md).

    The risk is created and all related lists are visible.


-   **[Create new risk form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk/reference/tprm-risk-record-form.md)**  
...
**Parent Topic:**[Integrating Third-party Risk Management with Risk Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../concept/rm-assessment-integration.md)

**Related topics**  


[Integrating Third-party Risk Management with Risk Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../concept/rm-assessment-integration.md)
