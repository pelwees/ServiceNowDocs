...
4.  On the **Collection task** tab of the due diligence request, select the External assessment \(VRA\) number to open the external assessment for collecting elements.
    ...
    For descriptions of all fields, see [Third-party element form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-workspace-vrm/reference/tprm-tpe-form.md).
...
2.  Select the engagement you want and then navigate to the **Engagement elements** tab.
    ...
    For descriptions of all these fields, see [Third-party element form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-workspace-vrm/reference/tprm-tpe-form.md).
