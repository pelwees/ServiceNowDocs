...
-   **When Maximum normalization input is not selected**
    ...
    ![Option to select maximum normalization input.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk/image/tprm-q-choice-no-max-norm-input.png)
...
-   **When Maximum normalization input is selected**
    ...
    ![Option to select maximum normalization input.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk/image/tprm-q-choice-max-norm-input.png)
...
-   **When Maximum normalization input is not selected**
    ...
    ![Option to select maximum normalization input.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk/image/tprm-q-multi-sel-no-max-norm-input.png)
...
-   **When Maximum normalization input is selected**
    ...
    ![Option to select maximum normalization input.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk/image/tprm-q-multi-sel-max-norm-input.png)
