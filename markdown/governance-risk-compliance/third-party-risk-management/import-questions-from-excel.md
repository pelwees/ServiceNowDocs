...
3.  Complete any or all of the steps in the **Prepare your Excel file** section:
    ...
    -   Select **Format guidelines** to view [Guidelines for importing spreadsheet data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../concept/excel-formatting-guidelines.md).
...
[Guidelines for importing spreadsheet data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../concept/excel-formatting-guidelines.md)

[Import existing data from other systems](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/governance-risk-compliance/third-party-risk-management/../../grc-vendor-risk-implementation/task/tprm-historical-data-import.md)
