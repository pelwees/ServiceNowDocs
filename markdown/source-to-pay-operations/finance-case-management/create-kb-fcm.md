...
6.  On the Create New Knowledge form, fill in the fields.
    ...
    For more information on the form fields and descriptions, see [Create knowledge base article form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/finance-case-management/../reference/create-kb-form.md).
...
Publish the knowledge article. For information, see [Publish a knowledge base article](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/finance-case-management/../concept/configure-kb-fin-ops-ws.md#).
