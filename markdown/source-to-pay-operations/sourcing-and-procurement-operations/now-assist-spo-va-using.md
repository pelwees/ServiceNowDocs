...
To start a conversation, navigate to **All** &gt; **Self-Service** &gt; **Employee Center** and select the Virtual Agent chat icon \(![Chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../supplier-lifecycle-operations/image/open-chat-window-icon.png)\).
...
![Show all my options in the starting screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/na-va-start.png "Starting screen for the Now Assist for SPO in a Virtual Agent chat")

Then, select the **Request to buy something** topic as shown in the following example.

![Request to buy something was selected in All Topics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/now-assist-spo-request-buy.png "All topics in the Now Assist for SPO in a Virtual Agent chat")
...
![List of products that is based on a search result.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/now-assist-spo-products.png "Products available based on search results")
...
![Catalog conversation.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/conv-catalog.png "Catalog conversation")
...
![Off-catalog conversation.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/conv-off-catalog.png "Off-catalog conversation")
...
![Track purchases and procurement requests.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/now-assis-spo-track-purchase.png)
...
![Purchase requisition inquiry.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/conv-pr-inquiry.png "Purchase requisition status inquiry")
...
![Purchase requisition inquiry response.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/conv-pr-response.png "Purchase requisition inquiry response")
...
-   The Now Assist for SPO in a Virtual Agent chat provides you options to understand your requirement.
    ...
    ![Now Assist for SPO in a Virtual Agent provides you options to understand your requirement.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/na_disambiguation_input.png)

-   The Now Assist for SPO in a Virtual Agent chat displays the results based on your request:

    ![Now Assist for SPO in a Virtual Agent displays the result based on your request.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/na_disambiguation_output.png)
...
-   The Now Assist for SPO in a Virtual Agent chat instructs users up to two times to rephrase their request before displaying the following message:
    ...
    ![Now Assist for SPO in a Virtual Agent chat instructs a user twice before displaying this message.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/na-va-unable-find.png)
...
-   If there’s no chat activity for 900 seconds, the Now Assist for SPO in a Virtual Agent chat ends as shown in the following example.
    ...
    ![Message shown after prolonged inactivity.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../../source-to-pay-operations/image/conv-inactivity.png)
...
For information on configuring Now Assist for SPO, see [Configure Now Assist for Sourcing and Procurement Operations \(SPO\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../task/configure-now-assist-for-spo.md).

**Parent Topic:**[Use Now Assist for Sourcing and Procurement Operations \(SPO\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/now-assist-spo-using.md)

**Related topics**  


[Summarize a record by using Now Assist for Sourcing and Procurement Operations \(SPO\) in Source-to-Pay Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../task/now-assist-spo-summarize-record.md)

[Summarize a record by using Now Assist for Sourcing and Procurement Operations \(SPO\) in Shopping Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../task/now-assist-spo-summarize-shopping.md)

[Request the generative AI capabilites in Now Assist for Sourcing and Procurement Operations \(SPO\) by using Now Assist panel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../task/request-gen-ai-capabilities-spo-now-assist-panel.md)

[Generate email responses](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../task/email-response-na-spo.md)

[Analyze sentiment in procurement cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../task/analyze-sentiments-na-spo.md)
