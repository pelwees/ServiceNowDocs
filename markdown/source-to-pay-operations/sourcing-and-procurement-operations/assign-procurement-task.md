...
7.  In the **What task would you like to create?** field, select a task type.
    ...
    For information on the task types, see [Purchasing tasks and procurement cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../reference/purchasing-tasks.md).
