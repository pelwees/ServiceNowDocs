...
![Shopping Hub product page showing "Purchase on behalf of" checkbox with "Andrew Griffin" selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-field.png)
...
![Request to buy dialog showing purchase details for Andrew Griffin with delivery and cost center options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-details.png)
...
![My purchases page with the filter drop-down showing a list of users.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-my-purchases.png)
...
![My purchases page showing card actions menu with Inquire, Add to cart, and View purchase options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-cards.png)

You can also view the carts of users on whose behalf you are making purchases.

![Shopping cart interface showing user drop-down with Shirley Ross and Warren Summers options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-cart.png)
...
![Shopping Hub interface showing "Shopping as" drop-down with Warren Summers selected](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-list.png)

![Shopping Hub product page with disabled "Purchase on behalf of" check box showing Warren Summers selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/sourcing-and-procurement-operations/../image/sh-purchase-behalf-disabled.png)
