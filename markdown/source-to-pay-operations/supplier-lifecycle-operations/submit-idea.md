...
6.  Select the Add attachments icon \(![Add attachments icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/supplier-lifecycle-operations/../image/attachments-icon.png)\) to add attachments, such as documents and image files, to the request.
