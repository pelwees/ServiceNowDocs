...
4.  Select the **KPI Template** tab and select **Add**.![Selectd option to create a new template.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/supplier-lifecycle-operations/../image/add-kpi-template-segmentation-rule.png)
