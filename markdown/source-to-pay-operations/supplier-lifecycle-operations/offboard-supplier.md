...
4.  From the **Case type** field, **Offboard a supplier**.![Selected dropdown option for offboarding a supplier.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/supplier-lifecycle-operations/../image/supplier-offboard-source-to-pay-workspace.png)
...
The supplier manager or supplier owner can continue to offboard the supplier using the **Playbook** tab on the **Case Details** page. For more information, see [Offboard suppliers using the supplier offboarding playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/supplier-lifecycle-operations/../concept/offboard-suppliers-using-playbook.md).

-   **[Offboard suppliers using the supplier offboarding playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/supplier-lifecycle-operations/../concept/offboard-suppliers-using-playbook.md)**  
