...
![Look up primary data in Oracle Financial Cloud](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/source-to-pay-operations/source-to-pay-integration-framework/../../source-to-pay-operations/image/oracle-fin-lookup-primary-data.png "Look up primary data in Oracle Financial Cloud")
