...
Financial baselines for the selected demands are migrated to Next Experience and you can view them in the [Baselines view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/../../portfolio-planning/concept/using-financials-pp.md#section_bkp_g2l_2zb).

## What to do next

[View and compare the migrated baselines](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/../../portfolio-planning/task/create-compare-baselines-pp.md) with any existing baselines or current baseline \(![Flag icon to indicate current baseline.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/../../spw-financials/images/fin-current-baseline-flag.png)\).
