...
To [create demand tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/../task/create-demand-task.md), scroll to the **Demand Tasks** related list on the Demand form and select **New** to create a record.
...
2.  On the Requirement form, fill in the fields. For a description of the field names, see [Requirement form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/../reference/requirement-form.md).
...
This link appears only if you have the [Investment Funding](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/../../investment-funding/task/activate-investment-funding.md) plugin activated, an existing corresponding investment record for this demand, and the investment\_user role.
...
[RIDAC \(Risk, Issue, Decision, Action, and Request Changes\) records for a demand](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/demand-management/ridac-entries-for-demand.md)
