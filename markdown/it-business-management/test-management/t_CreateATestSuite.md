...
-   Create a copy of this test suite by clicking the **Create duplicate** related link. For more information, see [Create a copy of an existing test suite](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/test-management/t_CopyATestSuite.md).
-   Associate test cases to this test suite by using the Test Cases related list. For more information, see [Add a test case to a test suite](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/test-management/t_AddANewTestCaseToATestSuite.md).
