...
2.  From the Agile structure section of the left navigation panel, choose an ART and select **Planning Board**.
    ...
    -   The planning board shows the current iteration for the ART by default. You can select a different iteration.
        ...
        ![Planning Interval selection in EAP Planning Board.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/enterprise-agile-planning/../images/eap-planning-board-change-pi-art.png)
...
4.  Enable the **Capacity** toggle to view the workload of the teams for each Sprint.
    ...
    ![Team workload utilization in EAP planning board.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/enterprise-agile-planning/../images/eap-team-capacity-bar.png)
