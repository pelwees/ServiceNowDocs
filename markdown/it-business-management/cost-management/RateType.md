...
**Note:** A user can enter a rate type only if it is permitted by the users [Time sheet policies](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/cost-management/../../../administer/task-table/concept/time-sheet-policies.md).

**Parent Topic:**[Manage a labor rate card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/cost-management/../task/t_ManageALaborRateCard.md)

**Related topics**  


[Create a rate type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/cost-management/../task/CreateRateType.md)
