...
3.  View the business service map by selecting the dependency views icon \(![Dependency views.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/cost-management/../image/dependency-views.png)\).
    ...
    ![Cost Demo Server Expense](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/cost-management/../image/CostDemoServerexp.png "Example server expenses")
    ...
    For more information on expense aggregation, see [Enable relationship aggregation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/cost-management/t_EnableRelationshipAggregation.md).
