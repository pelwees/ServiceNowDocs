...
-   **Show items based on their last updated date**
    ...
    ![Board preferences filter to show only work items that are updated within 7, 30, 90, 120 days, or 1 year.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/collaborative-work-management/../images/cwm-board-pref-filter.png)

-   **Show or hide completed items**

    Choose to show or hide the work items that are marked as Closed complete.

    ![Board preferences toggle to show or hide completed work items on the CWM Board.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/collaborative-work-management/../images/cwm-board-pref-toggle.png)
