...
|Field|Description|
|-----|-----------|
|Checklist|[Checklist](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../task/t_CreateAProjectTaskChecklist.md) to track items that must be completed for the task.|
