...
3.  On the Add dependency form, fill in the following fields:
    ...
    -   Dependency Type: The [type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/external-dependency-types.md) of external dependency: **Hard** or **Soft**.
4.  Select **OK**.
...
![External dependency example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../image/ExternalDependencyExample.png)

## What to do next

Check for any external dependency related [notifications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../reference/r_PlanningConsoleTasks.md) that may impact the project or its tasks.
