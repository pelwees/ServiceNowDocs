...
**Note:** The colors of the task bars on the Gantt chart can be configured from [program](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../program-management/task/t_AccessTheProgramWorkbench.md) workbench.
...
-   **[Gantt chart options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../reference/r_EditTasks.md)**  
