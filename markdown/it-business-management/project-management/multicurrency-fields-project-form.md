...
-   **Project currency**: Project status report is created in the local currency that is selected. If you select Project currency, you can view the planned cost and actual cost in the selected project currency.
 ...
 To view the status report of the project, see [View project status reports](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../project-management/task/project-status-report.md).
