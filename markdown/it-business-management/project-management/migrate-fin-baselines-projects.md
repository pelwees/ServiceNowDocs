...
For detailed information and use cases on using financials in Next Experience, see [Managing financials for planning items in Portfolio Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../portfolio-planning/concept/using-financials-pp.md).
...
Financial baselines for the selected projects will be migrated to Next Experience and you can view them in the [Baseline view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../pw-financials/concept/using-financials-prj-wrkspc.md#section_bkp_g2l_2zb).

## What to do next

[View and compare the migrated baselines](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../pw-financials/task/create-compare-baselines-pws.md) with any existing baselines or current baseline \(![Flag icon to indicate current baseline.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../spw-financials/images/fin-current-baseline-flag.png)\).
