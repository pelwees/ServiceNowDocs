...
For more information, see [Components installed with PPM Collaboration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../reference/components-installed-with-ppm-collab.md).

## What to do next

[Setting up PPM collaboration for Slack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/set-up-collab-ppm.md).
