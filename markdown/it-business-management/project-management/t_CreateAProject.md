...
**Note:** You can also create a project from the [demand workbench](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../planning-and-policy/task/t_CrtArtftDmdMnu.md).
...
3.  In the Create a project modal, fill in the details and select **Confirm**.
    ...
    For field information, see [../reference/create-a-project-form.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../reference/create-a-project-form.md).
...
[../reference/create-a-project-form.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../reference/create-a-project-form.md)

[Schedule a project from a start date](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/schedule-a-project-pm.md)

[Project Portfolio Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../project-portfolio-suite/concept/c_ProjectPortfolioSuite.md)
