...
Right-click a task and select **Add External Dependency**. Select the project and task to which the [dependency is added](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../task/create-external-dependency-planning-console.md).
...
Select the save icon to commit changes made in the planning console. The option is available only when [Client Side Planning Console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/client-side-planning-console.md) is enabled.
...
Select the show or hide columns in gantt icon, and then select the level from the [WBS](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/c_WorkBreakdownStructure.md) **Depth** list.
...
Select the more options icon, and then select **Create new baseline**. See [Create baseline of a project](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../task/t_CreateAProjectBaseline.md) for more information.
...
Select the critical path icon. For more information on the critical path, see [Gantt chart](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/c_GanttChart.md).
...
Select the **Planning Console** selection arrow on the banner and select **Project Workbench**. For more information, see [Using Project workbench - Legacy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/c_ProjectWorkbench.md).
...
Select the more options icon, and then select **Export Planning Console**. For more information, see [Export project data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../task/t_ExportAProjectWithTheProjectForm.md).
