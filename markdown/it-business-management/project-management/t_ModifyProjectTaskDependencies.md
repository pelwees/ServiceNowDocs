...
1.  Double-click a dependency on the Gantt chart of the [planning console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../concept/c_TheProjectPlanningConsole.md).

2.  On the form, fill in the details.

    For more information, see [Planned Task Relationship form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../reference/planned-task-relationship-form.md).

    ![Planned Task Relationship form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../image/planned_task_relationshipform.png "Planned Task Relationship form")
