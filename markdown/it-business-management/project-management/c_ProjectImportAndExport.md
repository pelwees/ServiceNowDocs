...
You can choose to export the project data in MPP, XML, or CSV file formats. For more information, see [Project export to Microsoft Project](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/c_ProjectExportToMicrosoftProject.md).
