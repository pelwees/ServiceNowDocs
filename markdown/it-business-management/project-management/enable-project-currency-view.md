...
To navigate to the Project form, see [../../project-management/reference/create-a-project-form.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../project-management/reference/create-a-project-form.md).
...
To navigate to the Cost Plan form, see [Create a project cost plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../project-management/task/t_CreateAProjectCostPlan.md).
...
To navigate to the Cost Plan Breakdown form, see [Update a cost plan breakdown](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../project-management/task/update-cost-plan-breakdown.md).
...
To update a benefit plan breakdown, see [Update a benefit plan breakdown](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-management/../../project-management/task/update-benefit-plan-breakdown.md).
