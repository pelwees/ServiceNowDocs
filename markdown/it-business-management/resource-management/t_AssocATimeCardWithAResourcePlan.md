...
-   A resource plan can be associated with a time card only if the resource plan contains [hard allocations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../reference/r_AllocatingResources.md) for the user.
...
4.  In the **Resource plan** field, select the plan to which the time card should be allocated.
    ...
    ![Screenshot for a time card configured with Resource Plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../image/ResourceCostsTimeCard.png "Time Card with Resource Plan")
