...
-   If a [rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../../project-portfolio-suite-with-financials/concept/rate-model.md) is populated on the project or demand to which the resource plan is associated, the hourly rate is derived from the rate model.
...
**Parent Topic:**[Resource Plan form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/rsrc-plan-form.md)
