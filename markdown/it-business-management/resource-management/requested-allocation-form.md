...
-   [Rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../../project-portfolio-suite-with-financials/concept/rate-model.md), if it’s populated on the project or demand to which the resource plan is associated.
-   Labor rate card for user resource plans.
-   Role rate when resource is requested by [resource role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../task/create-resource-role.md), if the role has a rate.
