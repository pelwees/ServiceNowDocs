...
The hourly rate is derived from one of the following sources:-   [Rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../../project-portfolio-suite-with-financials/concept/rate-model.md), if it is populated on the operational resource plan.
...
Amount of confirmed or allocated hours multiplied by the hourly rate of the confirmed or allocated resources. Provides a more accurate estimation of the cost of the plan that is confirmed or allocated. The hourly rate is derived from one of the following sources:
 ...
 -   [Rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../../project-portfolio-suite-with-financials/concept/rate-model.md), if it is populated on the operational resource plan.
-   Labor rate card, if rate model is not available.
-   System property **com.snc.time\_card.default\_rate** if all the other conditions fail.
