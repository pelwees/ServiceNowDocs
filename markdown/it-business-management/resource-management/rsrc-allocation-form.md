...
-   [Rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../../project-portfolio-suite-with-financials/concept/rate-model.md), if it is populated on the project or demand to which the resource plan is associated.
