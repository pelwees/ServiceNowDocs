...
Alternatively, resource managers are encouraged to use the interactive Overview Dashboard in the Resource Management Workspace. For more information about dashboards, see [Overview dashboard in Resource Management Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../../resource-management-workspace/concept/using-rmw.md#section_v4k_rtg_1fc).

You can generate reports for the following types of information:

-   **Availability**

    Total time that the resources are available after both [Soft and hard allocations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../reference/r_AllocatingResources.md#booking_typ). Availability is capacity minus allocation. ![A group availability report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../image/group_availability_report1.png)

-   **Forecasted Utilization**

    Percentage of forecasted resource time utilization. It is calculated as sum of allocated and confirmed hours, divided by the total capacity. ![Forecasted utilization report for a group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../image/group_utilization_forecasted.png)

-   **Committed Utilization**

    Percentage of committed resource time utilization. It is calculated as allocated hours divided by the total capacity. ![Committed utilization report for a group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../image/group_utilization_committed.png)

-   **Allocation**

    Resource capacity, allocations, availability, and utilization. ![Allocation report for a group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../image/allocation_report_user1.png)
...
-   **Allocation details**
    ...
    ![Allocation details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../image/group_member_allocation_details1.png)


-   **[View availability, utilization, and allocation reports](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../task/t_GenAvailUtilAllocationReport.md)**  
You can view resource reports that focus on resource availability, utilization, and allocations.
-   **[Edit a resource management report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/resource-management/../task/ReportsNew.md)**  
