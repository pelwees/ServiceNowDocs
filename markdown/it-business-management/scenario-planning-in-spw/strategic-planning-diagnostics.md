...
![Portfolio Planning diagnostics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../../it-business-management/image/SPW-diagnostics.png)
...
Verifies that entities enabled for high-level planning have a Rank configuration.
 ...
 If this test fails, see [Create rank configuration for high-level planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/create-rank-configuration-enable-high-level-planning.md) to fix failure.
...
Verifies that all the lens entities that are enabled for high-level planning have the required Form section views.
 ...
 To learn how to fix these, see [Create form views for new planning item tables in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/create-form-views-for-planning-item-tables-in-apw.md).
...
Verifies that all the lens entities that are enabled for high-level planning have the required List views.
 ...
 To learn how to fix these, see [Create list views for new planning item tables in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/create-list-views-for-new-planning-item-tables-in-strategic-planning.md).
...
Verifies that all the planning items that are allowed on portfolio plans have the Default view's workspace view rule.
 ...
 To learn how to fix these, see [Create workspace view rules for new planning item forms in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/create-workspace-view-rules-for-planning-item-tables.md).
