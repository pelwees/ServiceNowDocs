...
-   **[Import goals and targets data from a spreadsheet](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/import-goals-and-targets-data-from-a-spreadsheet-apw.md)**  
With the admin role, you can import your existing goals and targets data from a spreadsheet to the Goal Framework tables.
-   **[Migrate existing goals data to Goal Framework tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/migrate-existing-goals-data-apw.md)**  
...
-   **[Configure goal preferences](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/configure-goal-preferences-apw.md)**  
...
-   **[Customize label for Goal and Target tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/customize-labels-for-goal-and-target-tables.md)**  
...
-   **[Configure a table for an assigned entity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/configure-assigned-entity-egm.md)**  
...
-   **[Create goals demo data with target breakdowns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/create-goals-demo-data-with-target-breakdowns.md)**  
...
-   **[Update a schedule job to automate Actual value of the targets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/schedule-a-job-to-automate-actual-value-of-the-targets-apw.md)**  
...
-   **[Set display limit for goals and targets in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/set-display-limits-for-goals-and-targets-spw.md)**  
Update system property value to set the display limit for goals on the Goals page in Strategic Planning.
-   **[Migrate target breakdowns](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/migrate-target-breakdowns-spw.md)**  
...
-   **[Migrate goal relationships for assigned entities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../task/migrate-goal-relationships-for-assigned-entities-egm.md)**  
...
-   **[Configuring target source for target automation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/setting-targets-for-a-goal-and-automating-the-actual-value-using-agf-apw.md)**  
...
-   **[Defining a custom unit of measure](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/defining-a-custom-unit-of-measure.md)**  
...
**Parent Topic:**[Configuring Strategic Planning Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../../alignment-planner-workspace/concept/setting-up-alignment-planner-workspace.md)
