...
You can add more tags.
 ...
 ![Add tags to a planning item from the grid view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/add-tags-to-planning-items-from-grid.gif)
...
2.  Select the Tag icon \(![Add tag to a planning item.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/icon-tag-outline.png)\) next to the name of the planning item in the form header.
...
You can add more tags.
 ...
 ![Add tags to a planning item from the details page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/add-tags-to-planning-items-from-details-page.gif)
...
4.  To change the visibility setting of the tag, on the Details page of the planning item, select the tag and change the **Viewable by** setting.
    ...
    ![Edit tag in Strategic Planning.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/edit-tag-in-spw.png)
