...
4.  Select the Personalize icon \(![Personalize icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../../alignment-planner-workspace/images/icon-settings.png)\) to update the view, based on your preferences.
...
Choose the fields that you want to view on the cards. Use the toggle buttons for the **Owner** and **Item type** fields, for the other fields use the drop-downs.![update the fields to show on the card.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/show-on-card.gif)**Note:** Your Kanban preferences will be saved at the portfolio plan level.

</td></tr></tbody>
</table>    See [Customize the planning item display preferences for Prioritization and Roadmap](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../../spw-roadmap/task/configure-source-table-preferences-for-roadmap.md).![Using the Kanban side-panel, drag and drop, and changing the lanes functionality.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/using-kanban.gif)
