...
4.  Select **Update**.
    ...
    **Note:** If an attribute is enabled for capacity planning, it is enabled for resource management by default.
    ...
    ![Group planning attribute enabled for Capacity.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/cp-group-planning-attribute.png)

5.  Repeat the steps 2 through 4 for the **Skill** and **Role** attributes.

    ![Enabled planning attributes for Capacity.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/cp-enable-planning-attributes.png)

    You can create custom attributes and map them to resources. For more information, see [Create or edit planning attributes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../../project-management/task/configure-planning-attributes.md#).
