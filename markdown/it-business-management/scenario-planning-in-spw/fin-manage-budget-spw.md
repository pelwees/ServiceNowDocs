...
-   As an Admin, enable the property to work on budgeting. For more information, see [Enable financial budget allocation for planning items in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/enable-fin-budget-spw.md).
...
4.  Enable the **Budget allocation** toggle \(![Budget allocation toggle enabled to view budget.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/fin-budget-allocation-toggle.png)\).
...
5.  You can manage the budget by one of the following ways for the selected time scale at monthly, quarterly, or yearly level.
    ...
    **Note:** Unapproved budget values are indicated with ![Tick mark in a circle representing the unapproved budget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/fin-copy-budget-icon.png) icon.

6.  Select **Approve budget** \(![Approve budget button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/fin-approve-budget-icon.png)\).
...
7.  On the confirmation window, select **Approve** \(![Approve button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/scenario-planning-in-spw/../images/fin-approve-icon.png)\).
