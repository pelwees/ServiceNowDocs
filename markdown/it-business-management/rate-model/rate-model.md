...
3.  Returns the rate if one or more rate lines match the request.
    ...
    If no rate lines match the request, then the request uses the [default rate card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../../cost-management/reference/r_InstalledWithCostManagement.md).


-   **[Create or modify a rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../task/create-rate-model.md)**  
...
-   **[Define criteria of a rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../task/define-rate-model-criteria.md)**  
...
-   **[Create a rate line](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../task/create-rate-line.md)**  
In a rate model, create a rate line to define an hourly rate based on a set of criteria for a given date range.
-   **[Export rate lines to a file](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../task/export-rate-lines.md)**  
...
-   **[Import rate lines into a rate model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../task/import-rate-lines.md)**  
Use the import rate lines function to quickly add multiple rate lines from an export file into a rate model.

**Parent Topic:**[Project Portfolio Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/rate-model/../../project-portfolio-suite/concept/c_ProjectPortfolioSuite.md)
