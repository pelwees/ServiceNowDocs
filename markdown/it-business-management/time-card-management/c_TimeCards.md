...
-   **[Create a time card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/time-card-management/../task/t_CreateATimeCard.md)**  
You can create time cards to log time against the work you have done.
-   **[Submit a time card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/time-card-management/../task/submit-time-card.md)**  
...
-   **[Approve or reject a time card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/time-card-management/../task/approve-time-card.md)**  
As a time card approver, you can view and approve or reject a submitted time card.
-   **[Recall a processed time card](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/time-card-management/../task/recall-approved-time-card.md)**  
...
-   **[Map a time card category with operational work types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/time-card-management/../task/map-time-card-category.md)**  
