...
5.  On the Create status report form, fill in the fields.
    ...
    For a description of the field values, see [Create status report form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../reference/create-status-report-form.md).

6.  Select **Submit**.

    ![Sample status report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../image/status-report-ACME.png)
...
9.  Observe and monitor the report.
    ...
    For more information on viewing and analyzing status reports, see [Analyze the status report in Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/view-status-report-in-project-workspace.md).
...
-   **[Status report tracking by status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../concept/analyzing-status-report-states.md)**  
