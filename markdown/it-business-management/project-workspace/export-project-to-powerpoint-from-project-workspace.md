...
2.  From the More actions menu \(![More actions menu icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../project-management/image/more_options_icon.png)\), select **Export project**.
