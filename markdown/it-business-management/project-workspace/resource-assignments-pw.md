...
-   **[Create resource assignments using Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/create-resource-assignment-prj-wksp.md)**  
Create an attribute-based resource assignment in the Project Workspace application for any project or project task.
-   **[Update resource assignment from Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/update-resource-assignment-pw.md)**  
Update a resource assignment that is associated with a project or project task.
-   **[Assign a resource using AI resource finder](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../project-workspace/task/assign-resources-using-resource-finder-pw.md)**  
Use AI resource finder to identify and assign a resource to an unassigned resource assignment.
-   **[Manage resources from resource page in Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/manage-resource-assignment-pw.md)**  
...
-   **[Access, assign, and approve unassigned work in Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/assign-approve-unassigned-work-pw.md)**  
View, assign and authorize resources directly from Project Workspace without navigating to Resource Management Workspace.
-   **[Move a resource assignment in Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/move-resource-assignments-project-workspace.md)**  
...
-   **[Extend a resource assignment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/extend-resource-assignment-pw.md)**  
Extend the date of an allocated resource assignment and allocate resources for the extended period.
-   **[Delete a resource assignment from Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/delete-resource-assignment-pw.md)**  
...
-   **[Update the resource allocation in a heatmap](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/view-allocations-heatmap-prj-wksp.md)**  
Use the allocation heatmap capability in Project Workspace to view and update the resource allocation.
-   **[Realign resource assignment to project task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../task/realign-resource-assignment-to-task.md)**  
...
**Parent Topic:**[Resource planning with Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/use-resource-mgmt-prj-wksp.md)
...
[Resource plans](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../resource-management/concept/c_ResourcePlans.md)
