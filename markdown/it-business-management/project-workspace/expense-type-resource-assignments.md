...
2.  Enable expense type on resource assignments.
    ...
    4.  Select the **Personalize List** \(![Gear icon to personalize the list view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../alignment-planner-workspace/images/personalize-icon-product-idea.png)\) icon.
