...
3.  Select **Generate tasks** to use Now Assist to generate tasks.
    ...
    ![Generate tasks using Now assist.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../now-assist-spm/images/generate-tasks-now-assist-spm.png)
...
6.  Review the task details for a project on the planning page.
    ...
    ![AI-generated tasks for a project in Project Workspace.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../now-assist-spm/images/generated-tasks-page-na-spm.png)
