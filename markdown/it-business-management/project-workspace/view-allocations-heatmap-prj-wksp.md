...
3.  Edit the desired field and select anywhere on the data grid to save the details.
    ...
    ![heatmap -legend](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../image/heatmap-legend.png)

4.  Edit the resource allocation window by selecting the allocation hours cell.

    ![allocation-hours-cell](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../image/resource-allocation-cell.png)
...
6.  Send a direct message to the project owner on Microsoft Teams by selecting the **Project Owner** field.
    ...
    ![resource-allocation-window](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../image/resource-allocation-window.png)
