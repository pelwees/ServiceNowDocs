...
2.  From the More actions menu \(![More actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../alignment-planner-workspace/images/icon-more-actions.png)\), select **Export status report**.

3.  On the Export status report form, fill in the fields for an existing project.

    For field information, see [Export status report form on Project Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../reference/export-status-report-form-project-workspace.md).
...
6.  On the Export status report form, create a status report for a project by selecting the **Please create a status report to be able to export** link.
    ...
    ![Export status report window on project workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../image/export-status-report.png)

7.  On the **Status Report** Tab, create a status report by clicking **Create New**.

8.  On the Status Report form, fill in the fields.

    For field information, see [Create a project status report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../../project-management/task/t_CreateAProjectStatusReport.md).

9.  Select **Submit**.

10. Select the Export to PowerPoint icon \(![Export to PowerPoint icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/project-workspace/../image/export-to-powerpoint-icon.png)\).
