...
You must perform the following steps on the [Target form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../../spw-goals/reference/target-form-egm.md) to enable target automation for the target.
...
2.  Select the **Automate actual value** field.
    ...
    ![Enabling target automation in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../image/target-automation-enabling-strategy.png)
...
3.  Select a target source in the **Actual value source** field, from which the value must be fetched for target automation.
    ...
    ![Selecting target source for automating target actuals in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../image/target-aitomation-selecting-target-source-strategy.png)
    ...
    -   Benefit Plans target source - A target source that is created using a custom script where the actual benefit value of benefit plans of the planning items associated with the goal or target fetches the target actuals. Then the application updates the actual value of the target based on the actual benefit value.
        ...
        **Note:** Only benefit plans of the planning items associated with the goal or target will be available to select in the **benefit\_plan** field as a source for target automation.
        ...
        ![Benefit plan variables for target source in Strategic Planning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../image/target-aitomation-selecting-benefit-plan-strategy.png)

    -   Custom target source - Create a custom target source and configure it as a source to update the actual value of the target. For instructions on how to create a target source, see [Create a target source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../../spw-goals/task/create-target-source-for-automating-the-actual-value-of-the-targets-apw.md).
    For instructions on creating targets for a goal, see [Add a target for goal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../task/set-target-for-goal-strategy.md).


**Related topics**  


[Create a goal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../task/create-goal-strategy.md)

[Add a target for goal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../task/set-target-for-goal-strategy.md)

[Duplicate a goal or target](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../task/duplicate-goal-target-strategy.md)

[Send a reminder for target actuals check in](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/strategic-planning/../task/send-reminder-target-checkin-strategy.md)
