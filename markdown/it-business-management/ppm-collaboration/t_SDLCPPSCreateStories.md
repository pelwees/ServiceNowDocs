...
3.  From the Stories related list, select one of the following:
    ...
    -   **New** to create a story and add it to this project.
        ...
        For information on the form fields, see the descriptions in [Story form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/ppm-collaboration/../../agile-development/task/create-a-story.md#table_story_form).
...
-   Create scrum tasks for this story. See [Create a scrum task for Agile Development 2.0 stories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/ppm-collaboration/../../agile-development/task/create-a-scrum-task.md).
-   Use the related links and lists of the story for more actions that you can perform. See [Related links and lists for a Story in Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/ppm-collaboration/../../agile-development/reference/agile-2-0-story-related-lists-related-links.md).
-   [Add dependencies for Agile Development 2.0 stories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/ppm-collaboration/../../scrum-programs/task/Add-dependencies-to-stories.md)
-   You can create a story with the same details as this story by using the **Insert** or **Insert and Stay** options from the story additional actions \(![Additional actions icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/ppm-collaboration/../../agile-development/image/additional-options.png)\).
...
**Parent Topic:**[Agile Development 2.0 integration with Project Portfolio Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/ppm-collaboration/../concept/c_SDLCIntegrationWithProjectPortfolioSuite.md)
