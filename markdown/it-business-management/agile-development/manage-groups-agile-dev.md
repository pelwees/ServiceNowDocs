...
For information on the procedure to add members to groups, see [Add members to an assignment group in Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../task/add-group-members-to-group.md)
...
-   **[Create an assignment group in Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../task/create-an-agile-group.md#)**  
Create an assignment group of the type Agile Team so that you can assign these groups to a product or a release.
-   **[Convert a release team to a group \(only for existing customers having release teams\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../task/convert-release-team-to-group.md)**  
...
-   **[Add members to an assignment group in Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../task/add-group-members-to-group.md)**  
Add members who would work on the scrum stories and tasks.

**Parent Topic:**[Managing your product development using Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/using-agile-development-2-0.md)
