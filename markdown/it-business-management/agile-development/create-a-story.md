...
Defect that is associated with the story. This field is a reference field from the Defect \[rm\_defect\] table. This field is required if the story is created for a defect.Click the search icon \(![Search icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../../project-workspace/image/lookup_icon.png)\) in this field to display the existing defects or to open a new defect.
 ...
 For more information on defects, see [Reporting defects in Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../concept/defect-reports.md#).
...
Enhancement associated with the story. This field is a reference field from the Enhancement \[rm\_enhancement\] table. This field is required if the story is created for an enhancement.Click the search icon \(![Search-icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../../project-workspace/image/lookup_icon.png)\) in this field to display the existing enhancement requests or to open a new enhancement.
 ...
 For more information on enhancements, see [Enhancement requests in Agile Development 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../concept/enhancement-requests.md#).
...
-   You can create a story with the same details as this story by using the **Insert** or **Insert and Stay** options from the story additional actions \(![Additional actions icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-business-management/agile-development/../image/additional-options.png)\).
