...
-   **[Create an access control list for an insurance policy table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../task/create-an-access-control-list-for-the-insurance-policy-table.md)**  
...
-   **[Grant the Insurance claims roles access to an insurance policy table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../task/grant-insurance-claims-roles-access-to-the-insurance-policy-table.md)**  
...
-   **[Apply coverages to an insurance policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../task/apply-coverage-to-an-insurance-policy.md)**  
...
-   **[Add a policy participant to an insurance policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../task/add-a-policy-participant-to-an-insurance-policy.md)**  
Add a customer to an insurance policy as the insured entity by using the Insurance claims application.
-   **[Add a related list to an insurance product model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../task/add-related-list-to-insurance-product-model.md)**  
...
**Parent Topic:**[Setting up the policy data for Insurance claims](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/set-up-policy-data-for-insurance-claims.md)
