...
![Infographic that shows a typical workflow for an insurance claim. For the text description, refer to the steps that follow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../image/insurance-claims-workflow.png)
...
|Support for single and multiple adjusters|[Work on Insurance claims adjuster tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/../task/manage-an-insurance-claims-flow-case.md)|Claims adjusters or claims managers|
...
-   [Setting up Insurance claims](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/setting-up-insurance-claims-flow.md)
-   [Using Insurance claims](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/using-insurance-claims-flow.md)
-   [Insurance claims reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/insurance-claims/insurance-claims-flow-reference.md)
