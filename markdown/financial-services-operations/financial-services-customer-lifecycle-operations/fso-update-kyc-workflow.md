...
![Workflow that shows how the KYC for a consumer is updated using the Client Lifecycle application. For the text description, refer to the workflow steps that follow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-customer-lifecycle-operations/../image/update-kyc-workflow.png "Update personal KYC workflow example")
