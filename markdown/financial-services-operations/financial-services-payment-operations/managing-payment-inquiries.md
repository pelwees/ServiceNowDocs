...
-   **[Create a payment inquiry case for an external inquiry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-payment-operations/../task/create-payment-inquiry-case-external-inquiry.md)**  
As an inquiry agent, you can create an inquiry case for an external inquiry that you receive from a third-party bank.
-   **[Submit a payment inquiry request for an internal inquiry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-payment-operations/../task/submit-payment-inquiry-request.md)**  
...
-   **[Assign a payment inquiry case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-payment-operations/../task/assign-payment-inquiry-case.md)**  
...
-   **[Investigate a payment inquiry case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-payment-operations/../task/investigate-payment-inquiry-case.md)**  
Investigate the payment inquiry case so that you can get enough information about the case to resolve it.
-   **[Propose a solution for an inquiry case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-payment-operations/../task/propose-solution-inquiry-case.md)**  
...
-   **[Close a payment inquiry case](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-payment-operations/../task/close-payment-inquiry-case.md)**  
