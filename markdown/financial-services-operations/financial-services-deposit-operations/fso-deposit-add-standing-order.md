...
![Workflow that shows how a deposit request for adding a standing order is resolved using the Deposit Operations application. For the text description, refer to the workflow steps that follow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/financial-services-deposit-operations/../image/add-standing-order-workflow.png "Adding standing order workflow example")
