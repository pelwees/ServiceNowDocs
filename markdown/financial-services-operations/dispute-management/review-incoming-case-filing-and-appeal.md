...
14. If the response is **Unresolved**, select `Yes` in the **Create appeal** drop-down.
    ...
    An appeal can be created only if certain conditions are met. For more information, see [Allocation workflow overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/financial-services-operations/dispute-management/../concept/allocation-workflow.md).
