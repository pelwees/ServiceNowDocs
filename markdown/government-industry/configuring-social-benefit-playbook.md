...
|Task|Description|
|----|-----------|
|[Install Social Benefits Playbook for Public Sector Digital Services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/government-industry/../task/install-psds-social-benefits-playbook.md)|Install Social Benefits Playbook \(app-psds-social-benefits\) from the ServiceNow® Store.|
