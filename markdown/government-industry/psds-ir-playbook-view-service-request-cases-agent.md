...
3.  In the Information Requests section, select a list that is described in the following table.
    ...
    For a detailed description of the fields under each list, see [Information Request case form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/government-industry/../reference/information-request-case-form.md#).
