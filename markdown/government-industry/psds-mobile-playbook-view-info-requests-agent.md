...
3.  Select the information request case that you want to see more details for.
    ...
    For a detailed description of the information request case fields, see [Information Request case form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/government-industry/../reference/information-request-case-form.md#).
