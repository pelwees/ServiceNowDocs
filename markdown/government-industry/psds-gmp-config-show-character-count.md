...
2.  Select **Character counter for text area \(journal and multi line text fields\)**.
    ...
    ![Show character count prompt.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/government-industry/../image/psds-config-gmp-character-counter-field.png)
...
3.  Navigate to a playbook form activity and verify that the character counter is visible.
    ...
    ![Program information activity.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/government-industry/../image/psds-gmp-character-count.png)
