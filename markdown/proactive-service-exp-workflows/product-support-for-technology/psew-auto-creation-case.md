...
For more information to generate proactive cases, see [Redirection to the right case type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/proactive-service-exp-workflows/product-support-for-technology/../task/generate-proactive-cases.md).
...
-   **[Setting major case threshold for auto generated cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/proactive-service-exp-workflows/product-support-for-technology/../task/psew-set-major-case-threshold.md)**  
Set the threshold value for major cases generated from incidents in the system properties.
-   **[Redirection to the right case type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/proactive-service-exp-workflows/product-support-for-technology/../task/generate-proactive-cases.md)**  
