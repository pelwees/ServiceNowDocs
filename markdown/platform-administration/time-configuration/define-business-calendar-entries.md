...
Unique reference name for the business calendar entry. To select a business calendar name or to create one: 1.  To search for an existing business calendar entry name, select ![Search button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../../search-administration/image/SearchIcon.png).
...
**Note:** To learn how to create business calendar entry names, see [Create business calendar entry names](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/define-business-calendar-entries.md#).
