...
-   **Business calendar filter options**
    ...
    To learn more about creating filtering options for a business calendar, see [Create a business calendar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/create-business-calendar.md).
...
-   **Calendars for package**
    ...
    To learn more about associating a business calendar with a package, see [Pair business calendars with packages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/pair-business-calendars-with-packages.md).
...
In this example, you create a fiscal calendar with 4 quarters and 12 fiscal periods. ![Business calendar example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../image/fiscal-calendar-ex_updated.png)
...
![Business calendar schedule example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../image/business-calendar-schedule-ex_updated.png)
...
**Note:** For Strategic Portfolio Management \(SPM\) applications, you must define Fiscal Calendars using the [Generate a fiscal calendar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../../../product/it-finance/task/t_GenerateFiscalCalendar.md) feature.
...
-   **[Create a business calendar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/create-business-calendar.md)**  
...
-   **[Create a business calendar group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/create-business-calendar-group.md)**  
...
-   **[Create a business calendar span using a Script includes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/create-a-business-calendar-span-using-a-script-includes.md)**  
...
-   **[Define business calendar entries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/define-business-calendar-entries.md#)**  
...
-   **[Define business calendar filtering options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/define-business-calendar-filtering-options.md)**  
...
-   **[Pair business calendars with packages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../task/pair-business-calendars-with-packages.md)**  
