...
-   **[Creating business calendars](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/concept/business-calendars.md)**  
...
-   **[Defining fiscal calendars](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/../../product/it-finance/concept/c_FiscalCalendar.md)**  
...
-   **[Define a relative duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/task/t_DefineARelativeDuration.md)**  
Define relative durations to calculate duration time for SLAs based on business schedules and specific time requirements.
-   **[Use a relative duration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/task/t_UseARelativeDuration.md)**  
When you define an SLA, you can set the **Duration type** to be a relative duration.
-   **[Create schedule entries in the Schedule calendar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/task/create-events-next-experience-ui.md)**  
Add events such as meeting, time-off, or appointment to display them in the schedule calendar.

**Parent Topic:**[Time configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/time-configuration/time-configuration-landing.md)
