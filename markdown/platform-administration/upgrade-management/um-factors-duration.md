...
After upgrading the first non-production instance, examine the [Upgrade Summary Report](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/upgrade-management/../reference/um-complete-summary.md) for data to help estimate the impact of these factors.
