...
For information about the fields that are shown in the System Mailbox, see [System email log and mailboxes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../time/reference/r_EmailLogs.md). You can configure the layout of a system mailbox to show any of the email log fields, not only the ones that are shown by default.
