...
-   When you create a custom field, use one of the supported field types described in [Field types reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../reference/r_FieldTypes.md). Other field types, such as User Input, are for internal use only and aren't supported for custom fields.
