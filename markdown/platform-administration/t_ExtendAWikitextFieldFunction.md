...
3.  In the **Dependent** field of the dictionary form, enter the field you want to use for linking to other pages.
    ...
    ![Wiki field dictionary example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../image/WikiPluginNewFieldDict.png)
    ...
    The following [dictionary attributes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../reference-pages/concept/c_DictionaryAttributes.md) are available for wiki\_text fields.
