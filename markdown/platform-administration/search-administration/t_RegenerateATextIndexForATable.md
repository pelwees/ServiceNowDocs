...
3.  Select the **Regenerate Text Index** related link, then select **OK**.
    ...
    ![Regenerate the text index for the task table.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/search-administration/../image/regenerate-text-index.png)
...
-   **[Reindex a table without impacting text search results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/search-administration/real-time-reindexing.md)**  
...
-   **[Regenerate the text index for a single record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/search-administration/regenerate-text-index-one-record.md)**  
