...
2.  Calculation of the session display value returned from getDisplayValue\(\), which performs conversions to the required currency.
    ...
    **Note:** To learn more about these settings, see [Specify the rate table and date source for currency conversions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/currency-administration/../task/fx-currency-conv-rate-table-date-source.md).
