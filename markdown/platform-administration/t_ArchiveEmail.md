...
4.  Select **Run Archive Now**.
    ...
    **Note:** You can also [Create an archive rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../database-rotation/task/t_CreateAnArchiveRule.md#).


**Parent Topic:**[Email retention](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../concept/email-retention.md)
