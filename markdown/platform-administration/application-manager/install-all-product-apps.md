...
3.  Review the technical details of each included application to verify that you have access to all required dependencies.
    ...
    2.  Procure any dependencies that aren't licensed from the ServiceNow Store.
        ...
        For more information, see [Getting apps and trials from the ServiceNow Store](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/application-manager/../../servicenow-store/concept/getting-apps-trials.md).
...
**Parent Topic:**[Installing applications, plugins, and products](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/application-manager/../concept/installing-apps-app-manager.md)
