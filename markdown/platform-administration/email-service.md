...
By default, Email Service only allows admin users to access the [Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/api-reference/rest-apis/email-api.md). Administrators can [grant access to the Email API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../task/grant-access-to-email-api.md) by:
...
-   **[Create a system address filter](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../../administer/notification/task/create-system-address-filter.md)**  
Define how email address filters apply to inbound and outbound email.

**Parent Topic:**[Creating an email account](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../../administer/notification/concept/using-email-admin.md)
