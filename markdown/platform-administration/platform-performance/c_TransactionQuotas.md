...
5.  Sleeps until the next heartbeat, which is controlled by the **glide.quota.manager.heartbeat** [system property](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/platform-performance/../reference/r_ConfigureTransactionQuotaProps.md).
