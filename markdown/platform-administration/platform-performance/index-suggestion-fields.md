...
|State|Processing state of the index. For details, refer to [Index suggestions for slow queries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/platform-performance/../concept/index-suggestions.md) to see index suggestion states and table.|
