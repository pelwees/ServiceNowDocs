...
3.  On the Operational Toggle Level form, fill in the fields.
    ...
    For a description of the field values, see [Operational toggle level form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/platform-performance/../reference/operational-toggle-level-form.md).
