...
3.  Configure the form and add the **Force delivery** field.
    ...
    **Note:** This field does not appear by default.
    ...
    3.  Select **Save**.
        ...
        For more information about configuring the form, see [Configuring the form layout](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../form-administration/concept/configure-form-layout.md#).
