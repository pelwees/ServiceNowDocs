...
To learn more about searching with fuzzy numeric search, see [Fuzzy numeric search in AI Search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../concept/fuzzy-numeric-search.md).
