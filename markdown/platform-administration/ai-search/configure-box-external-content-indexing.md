...
1.  In the Box developer console, create a new OAuth 2.0 application for the Box external content connector.
    ...
    2.  Select **Create Platform App**, then select **Custom App**.
        ...
        ![My Platform Apps screen in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-create-platform-app.png)

    3.  In the Create a Custom App window, enter a name for your app and specify its purpose, then select **Next**.

        ![Create a Custom App screen 1 of 2 in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-create-custom-app-1.png)

    4.  In the Create a Custom App windows, select **Server Authentication \(with JWT\)**, then select **Create App**.

        ![Create a Custom App screen 2 of 2 in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-create-custom-app-2.png)
...
2.  Configure your new OAuth 2.0 application with required settings and generate a public/private keypair for it.
    ...
    1.  In the App Access Level section, select the **App + Enterprise Access** option.
        ...
        ![App Access Level configuration settings in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-app-access-level.png)
    ...
    2.  In the Application Scopes section, under the **Content Actions** heading, select the **Read all files and folders stored in Box** and **Write all files and folders stored in Box** options if they're not already selected.
        ...
        ![Application Scopes configuration settings in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-application-scopes.png)
    ...
    3.  In the Advanced Features section, select the **Make API calls using the as-is header** and **Generate user access tokens** options.
        ...
        ![Advanced Features configuration settings in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-advanced-features.png)

    4.  In the Add and Manage Public Keys section, select **Add a Public Key**.

        ![Add and Manage Public Keys configuration settings in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-add-manage-public-keys.png)
    ...
    5.  In the Add a new Public Key dialog box, paste the PEM-encoded public key text, including the `-----BEGIN PUBLIC KEY-----` and `-----END PUBLIC KEY-----` markers, into the **Public Key** field, then select **Verify and Save**.
        ...
        ![Add a new Public Key dialog box in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-add-new-public-key.png)

    6.  Copy the public key ID string that Box displays for the new public key and store it in a secure location.

        ![ID shown for new public key in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-copy-public-key-id.png)
    ...
    7.  In the App Settings section, select **Download as JSON**, then save the downloaded JSON-format settings file in a secure location.
        ...
        ![App Settings section in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-configuration-download-json-file.png)
...
3.  Submit an authorization request for your new OAuth 2.0 application.
    ...
    2.  Select **Review and Submit**.
        ...
        ![Review and Submit option in Box developer console authorization settings.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-authorization-review-submit.png)
    ...
    3.  On the Review App Authorization Submission screen, enter a description for your OAuth 2.0 application, then select **Submit**.
        ...
        ![Review App Authorization Submission screen in Box developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-review-app-authorization-submission.png)
...
4.  In the Box Admin UI portal, authorize your new OAuth 2.0 application.
    ...
    4.  Open the app entry's context menu by selecting its overflow icon ![](../image/box-admin-ui-overflow-icon.png), then select **Authorize App**.
        ...
        ![Platform Apps Manager screen in Box Admin UI portal.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-platform-apps-manager-authorize-app.png)

    5.  On the Authorize App screen, select **Authorize**.

        ![Authorize App screen in Box Admin UI portal.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/box-authorize-app.png)
...
-   The public key ID string that you copied in step [2.f](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/configure-box-external-content-indexing.md#copy-public-key-id-step).
-   The JSON-format settings file that you downloaded in step [2.g](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/configure-box-external-content-indexing.md#download-json-settings-file-step).
...
For details on creating and configuring a Box Cloud external content connector, see [Create a Box external content connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/create-ext-cont-connector-box.md).
