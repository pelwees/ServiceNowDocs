...
3.  On the User form, configure the layout to show the **Managed domain**, **Domain**, and **Domain Path** fields.
    ...
    To learn how to show or hide fields on a form, see [Configuring the form layout](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../../form-administration/concept/configure-form-layout.md#).
...
**Parent Topic:**[External Content Connectors reference](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../concept/reference-ext-cont-connectors.md)
