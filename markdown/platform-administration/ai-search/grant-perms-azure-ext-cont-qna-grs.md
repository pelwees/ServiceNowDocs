...
1.  Access your OAuth 2.0 application's settings in Microsoft Azure portal.
    ...
    2.  In the **Azure services** section, select **App registrations**.
        ...
        ![Microsoft Azure portal with App registrations service highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-app-reg.png)

    3.  Select **All applications** or **Owned applications**.

        ![Microsoft Azure portal with All applications and Owned applications categories highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-all-owned-apps.png)
    ...
    4.  In the search field, enter the name or application \(client\) ID of the OAuth 2.0 application you created for External Content Q&amp;A Genius Results, then select that application's display name from the list of results.
        ...
        ![Microsoft Azure portal with search term and matching application display name highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-app-srch.png)
...
2.  Add an AllSites.FullControl SharePoint API delegated permission to your OAuth 2.0 application.
    ...
    1.  In the menu, select **Manage** &gt; **API permissions**.
        ...
        ![Microsoft Azure portal application page with API permissions menu item highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-api-perms.png)

    2.  Under the **Configured permissions** heading, select **Add a permission**.

        ![Microsoft Azure portal application page with Add a permission link highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-add-perm.png)

    3.  In the **Request API permissions** window's **Select an API** section, select **Microsoft APIs**, then select the **SharePoint** API.

        ![Microsoft Azure portal Request API permissions page with Microsoft APIs category highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-req-ms-apis.png)

        ![Microsoft Azure portal Request API permissions page with SharePoint API highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-req-sharepoint-api.png)

    4.  When prompted, select **Delegated permissions** as the type of permission to add.

        ![Microsoft Azure portal Request API permissions page with delegated permissions type highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-req-delegated-perms.png)

    5.  In the **Select permissions** section, select **AllSites** &gt; **AllSites.FullControl**, then select **Add permissions**.

        ![Microsoft Azure portal Request API permissions page with AllSites category, AllSites.FullControl selected permission, and Add permissions button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-allsites-perm.png)
    ...
    6.  Under the **Configured permissions** heading, select **Grant admin consent for ServiceNow**.
        ...
        ![Microsoft Azure portal application page with Grant admin consent for ServiceNow link highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-grant-admin-consent.png)

    7.  In the **Grant admin consent confirmation** dialog box, select **Yes**.

        ![Microsoft Azure portal application page with Grant admin consent confirmation dialog box's Yes button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/azure-portal-grant-confirmation.png)
