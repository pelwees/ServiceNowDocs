...
For details on creating or modifying a view configuration, see [Create or edit an EVAM view definition](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/ais-admin-console-evam-configurations.md).
