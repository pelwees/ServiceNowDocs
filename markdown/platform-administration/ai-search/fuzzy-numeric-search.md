...
**Note:** For more details on the AND and OR operators, see the description of the **glide.ais.query.search\_operator** system property in [AI Search system properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../reference/system-properties-ais.md).
