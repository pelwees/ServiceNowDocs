...
For more information on creating field settings, see [Create a field setting for an AI Search indexed source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/create-field-setting-ais.md).
...
-   Type: string
-   Value: Name of the AI Search field that you want to map the selected field's display values to. For details on AI Search index fields, see [AI Search index fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/index-fields-list-ais.md).
