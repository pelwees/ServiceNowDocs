...
3.  In the System Property form's **Value** field, enter one of the following values:
    ...
    For details on these system property values, see the [System properties for factoid extraction in Q&amp;A Genius Results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../reference/sys-props-factoid-extract-qna-gr.md) section.

4.  Save the modified System Property record by selecting **Submit** or **Update**.


**Parent Topic:**[Q&amp;A Genius Results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../concept/genius-result-q-a-ais.md)
