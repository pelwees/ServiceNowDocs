...
1.  In the Atlassian Developer console, register a new OAuth 2.0 integration for the Atlassian Confluence Cloud external content connector.
    ...
    2.  In the My apps section, select **Create** &gt; **OAuth 2.0 integration**.
        ...
        ![Create button and OAuth 2.0 integration menu item on Atlassian Developer console My apps page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-create-oauth2-app.png)
    ...
    3.  Enter a name for your OAuth 2.0 integration, select the option to agree to Atlassian's developer terms, and select **Create**.
        ...
        ![OAuth 2.0 (3LO) integration name, Atlassian developer terms option, and Create button on Atlassian Developer console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-name-oauth2-app.png)
    ...
    4.  Navigate to the OAuth 2.0 integration's Permissions page, then select **Add** in the Confluence API row.
        ...
        ![Add Confluence API button on Atlassian Developer console Permissions page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-add-conf-api-perms.png)

    5.  In the Confluence API row, select **Configure**.

        ![Configure Confluence API button on Atlassian Permissions console.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-conf-conf-api-perms.png)
    ...
    6.  On the Granular scopes tab, select **Edit Scopes** and then select the options for each of the following scopes:
        ...
        ![Edit Scopes button on Atlassian Developer console Permissions page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-conf-api-edit-scopes.png)

    7.  Select **Save**.

        ![Save button in Atlassian Developer console Edit Confluence API dialog box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-conf-api-save-scopes.png)
    ...
    8.  Navigate to the OAuth 2.0 integration's Authorization page, then select **Add** in the row for the OAuth 2.0 \(3LO\) authorization type.
        ...
        ![Add OAuth 2.0 (3LO) authorization button on Atlassian Developer console Authorization page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-auth-add.png)
    ...
    9.  Enter `https://<instance-name>.service-now.com/oauth_redirect.do` as the callback URL, replacing `<instance-name>` with your ServiceNow AI Platform® instance name, then select **Save changes**.
        ...
        ![Callback URL field and Save changes button on Atlassian Developer console Authorization page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-auth-redirect-url.png)

    10. Navigate to the OAuth 2.0 integration's Settings page and record the Client ID and Secret values in a secure location.

        ![Client ID and Secret fields on Atlassian Developer console Settings page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-ad-settings.png)
...
2.  In Atlassian Administration, create a new admin API key.
    ...
    2.  Select **Settings** in the tab list.
        ...
        ![Atlassian Administration console Settings tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-admin-settings.png)

    3.  Select **API keys**, then select **Create API key**.

        ![Create API key button on API keys page of Atlassian Administration console Settings section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-admin-api-keys.png)

    4.  On the Before you begin page, select **API key without scopes**, then select **Next**.

        ![API key scopes options in Atlassian Administration console dialog box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-admin-api-key-scopes.png)

    5.  Enter a name and an expiration date for your new API key.

        ![API key name field, expiration-date field, and Create button in Atlassian Administration console dialog box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-admin-create-api-key.png)
    ...
    7.  Record the value of the API key in a secure location.
        ...
        ![API key in Atlassian Administration console dialog box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/conf-cloud-admin-copy-api-key.png)
...
-   The OAuth 2.0 integration's Client ID and Secret values that you recorded in step [1.j](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/cfg-conf-cc-ext-cont-connector.md#record-client-id-and-secret-step).
-   The API key's value that you recorded in step [2.g](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/cfg-conf-cc-ext-cont-connector.md#record-api-key).
