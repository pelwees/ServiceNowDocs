...
For details on creating or modifying a facet, see [Create a facet in an AI Search application configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/create-facet-ais.md).
...
To learn about **dot\_walk\_fields** field settings, see [Enable indexing of referenced table fields for an AI Search indexed source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/enable-ref-table-field-index-ais.md).
