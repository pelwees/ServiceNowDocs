...
3.  Select **Create an App**.
    ...
    ![Your Apps page with Create an App button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-your-apps.png)
...
4.  In the Create an app dialog box, select **From scratch**.
    ...
    ![Create an app dialog box with From scratch option highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-create-app.png)
...
5.  In the Name app &amp; choose workspace dialog box, specify a name and workspace for your application.
    ...
    ![Name app & choose workspace dialog box with application name and workspace highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-name-app-choose-workspace.png)
...
6.  In the App Credentials section, select **Show** to display the **Client Secret** field value, then record the application's **Client ID** and **Client Secret** values in a secure location.
    ...
    ![App Credentials section of Basic Information settings page with application client ID and client secret values highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-app-credentials.png)
...
8.  On the OAuth &amp; Permissions page, configure a redirect URL for the application.
    ...
    1.  In the Redirect URLs section, select **Add New Redirect URL**.
        ...
        ![Redirect URLs section of OAuth & Permissions features page with Add New Redirect URL button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-add-new-redirect-url.png)
    ...
    4.  Select **Save URLs**.
        ...
        ![Redirect URLs section of OAuth & Permissions features page with Save URLs button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-save-redirect-urls.png)
...
9.  On the OAuth &amp; Permissions page, in the Scopes section's Bot Token Scopes subsection, configure each of these bot token scopes for the application.
    ...
    1.  Select **Add an OAuth Scope**.
        ...
        ![Scopes section of OAuth & Permissions features page with Add an OAuth Scope button in Bot Token Scopes subsection highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-add-oauth-bot-scope.png)
...
10. On the OAuth &amp; Permissions page, install the application into your Slack workspace.
    ...
    1.  In the OAuth Tokens section, select the link to install the application to your Slack workspace.
        ...
        The installation link's text will include the name of your Slack workspace. ![OAuth Tokens section of OAuth & Permissions features page with installation button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-install-workspace.png)

    2.  On the confirmation page, select **Allow**.

        ![Confirmation page for installation of application with Allow button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-install-allow.png)
...
11. On the OAuth &amp; Permissions page, opt into token rotation for the application.
    ...
    1.  In the Advanced token security via token rotation section, select **Opt In**.
        ...
        ![Advanced token security via token rotation section of OAuth & Permissions features page with Opt In button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-opt-in-token-rotation.png)

    2.  On the confirmation page, select **Opt in**.

        ![Confirmation page for token rotation opt-in with Opt in button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/slack-api-opt-in-confirmation.png)
...
-   The Slack API application client ID and client secret that you recorded in step [6](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/cfg-src-sys-settings-slack-ext-cont-connector.md#record-client-id-and-secret-step).
...
For details on creating and configuring a Slack external content connector, see [Create a Slack external content connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/create-ext-cont-connector-slack.md).

**Parent Topic:**[Slack external content connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../concept/slack-external-content-connector.md)
