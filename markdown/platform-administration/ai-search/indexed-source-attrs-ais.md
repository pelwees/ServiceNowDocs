...
For instructions on defining AI Search indexed source attributes, see [Create an indexed source attribute in AI Search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/create-indexed-source-attr-ais.md).
...
Control automatic captioning behavior for images in attachments for records on this table. To learn more about automatic image captioning, see [Activate automatic image captioning for attachments from an indexed source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/activate-automatic-image-captioning.md).Supported values:
