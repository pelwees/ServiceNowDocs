...
-   **Powerful query language**
    ...
    For a complete guide to supported query language syntax and operators, see [AI Search query language](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/query-language-ais.md).
