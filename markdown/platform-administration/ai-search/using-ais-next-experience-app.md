...
![Unified Navigation search field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../../../get-started/servicenow-overview/image/pol-nav-global-search.png)

![Unified Navigation search field with search terms entered, showing the View results link.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-terms.png)
...
![Detail of global search results page with Incident source facet bucket option selected, showing only incident search results.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-source-facet-buckets.png)
...
![Detail of global search results page with Incidents source facet bucket and State: In Progress facet bucket selected and filters list showing additional facet filter options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-facets.png)
...
AI Search administrators can define facets in search application configurations. For details, see [Create a facet in an AI Search application configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/create-facet-ais.md).

In the base system, facets don't appear in the Filters list until you've selected a source facet bucket. Administrators can override this behavior and show all available facets in the Filters list by creating a **glide.ui.ais.show\_all\_facets** system property record and setting its value to **true**. For more details on this system property, see [AI Search for Next Experience properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../reference/ai-search-next-experience-properties.md).
...
![Detail of global search results page with search results sort order menu highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-sort-results.png)

AI Search administrators can configure search result sort options. For details, see [Search result sort options in AI Search application configurations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/sort-options-srch-app-cfg-ais.md#).
...
![Detail of global search results page with Dashboards Overview return link highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-return-link.png)
...
![Unified Navigation search field showing Recent Searches auto-complete suggestions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-suggs-click.png)

Other suggestion types appear when you begin typing your search query into the search field.

![Unified Navigation search field showing Suggested Queries and Suggested Results auto-complete suggestions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-suggs-type.png)

AI Search administrators can configure auto-complete suggestions. For details, see [Auto-complete suggestions in AI Search applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/auto-complete-ais.md#).
...
![Global search field displaying exact match record preview.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/unified-nav-ai-search-exact-match.png)
...
![Global search field displaying search context menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../../../get-started/servicenow-overview/image/pol-search-context.png)
...
-   [Now Assist in AI Search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../reference/now-assist-ais.md) is installed.
...
**Parent Topic:**[AI Search for Next Experience](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/ais-next-experience-app.md)
