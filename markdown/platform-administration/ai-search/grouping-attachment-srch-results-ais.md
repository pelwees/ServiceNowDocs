...
![Search results page showing incident search result with three grouped attachment results and Show more link indicating that two additional grouped attachments are hidden.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/group-attachments-show-more.png)
...
![Search results page showing incident search result with five grouped attachment results and Show less link.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/group-attachments-show-less.png)
...
**Note:** When you select a grouped attachment search result, AI Search logs click rank signal data for the parent record search result. All other search signal data is specific to the selected attachment record. For more details on search signal logging, see [Search signal tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../../search-administration/reference/search-signal-tables.md).

-   **[Group attachment search results with their parent results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/group-attachment-srch-results-ais.md)**  
...
**Parent Topic:**[Search application configurations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/defining-search-app-cfgs-ais.md)
