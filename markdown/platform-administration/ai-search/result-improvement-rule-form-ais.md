...
For details on creating or editing result improvement rules, see [Create a result improvement rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/create-result-improve-rule-ais.md).
