...
![Diagram showing es-MX user session language and es fallback language.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/diagram-fallback-language.png "Search result languages with a fallback language")
...
![Diagram showing fr-CA user session language, fr fallback language, and en global fallback locale.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../image/diagram-fallback-language-locale.png "Search result languages with a fallback language and a global fallback locale")

For details on configuring a global fallback locale, see [Enable a global fallback locale for translated content](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/../task/enable-global-fallback-lang-ais.md).

**Parent Topic:**[Internationalization support for AI Search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/ai-search/international-language-support-ais.md)
