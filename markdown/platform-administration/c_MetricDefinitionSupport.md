...
You can report on a metric by using a [Working with database views for reporting](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/c_DatabaseViews.md) that links the metric to the table on which it is defined.
