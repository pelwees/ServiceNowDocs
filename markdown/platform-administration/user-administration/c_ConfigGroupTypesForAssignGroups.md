...
**Note:** Dictionary overrides enable administrators to filter a group type on an extended table using a simple [reference qualifier](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../../script/server-scripting/concept/c_ReferenceQualifiers.md) override.
