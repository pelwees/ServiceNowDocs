...
It designates a user as a non-interactive user. This field is available with [Non-Interactive Sessions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../concept/c_NonInteractiveSessions.md#).**Note:** The Web service access only check box is automatically enabled when you select **Machine** in the Identity type field. The Web service access only check box is automatically disabled when you select **Human** or **AI**.
...
4.  Add **Roles**, **Groups**, **Delegates**, **Skills**, and **Subscriptions** to the user.
    ...
    For more information, see [Managing roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../roles/concept/ua-creating-roles.md), [Creating groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../roles/concept/ua-creating-groups.md), and [Delegating roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../roles/concept/c_DelegateRoles.md).
