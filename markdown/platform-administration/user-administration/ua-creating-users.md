...
-   **[Create a user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../users-and-groups/task/t_CreateAUser.md)**  
You can add a user to your instance to enable them to log in and use designated application features.
-   **[User self-registration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../users-and-groups/concept/c_UserRegistration.md#)**  
...
**Parent Topic:**[Creating users, companies, and departments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/using-user-administration.md)
