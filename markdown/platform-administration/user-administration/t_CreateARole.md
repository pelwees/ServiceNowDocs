...
For a complete list of the roles included with the base instance, see [Base system roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../reference/r_BaseSystemRoles.md)
...
-   **[Grant a role access to applications and modules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/t_GrantARoleAccessToAppsAndModules.md)**  
...
-   **[Assign a role to a group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/t_AssignRoleToGroup.md)**  
You can assign a role to a group to grant access to applications and modules to group members.
-   **[Assign a role to a user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../users-and-groups/task/t_AssignARoleToAUser.md)**  
...
-   **[Add a role to an existing role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/t_AddARoleToAnExistingRole.md)**  
When you add a new role to an existing role for a user, the user inherits the access that is granted by the new role.
-   **[Create a group role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/t_CreateAGroupRole.md)**  
