...
1.  [Subscription Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../subscription-management/reference/subscription-management-landing-page-v2.md)
    ...
    Subscriptions may include per-user subscriptions. For more information, see [Managing per-user subscriptions in Subscription Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../subscription-management/concept/managing-user-subscriptions-v2.md).

2.  [Creating users, companies, and departments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/using-user-administration.md)
...
3.  [Creating groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/ua-creating-groups.md)
...
4.  [Managing roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/ua-creating-roles.md)
    ...
    For a complete list of the roles included with the ServiceNow AI Platform, see [Base system roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../reference/r_BaseSystemRoles.md).

    Role records are stored in the Roles \[sys\_user\_role\] table.

5.  [Monitoring instance usage](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../../subscription-management/concept/usage-analytics-module-subscription.md)
...
6.  [Monitoring user activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/user-admin-tools-landing.md)

    Users with the admin role can impersonate users, manage user sessions, and leverage non-interactive sessions.


![Create users and add them to groups. Create and assign roles to both users and groups.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../image/users-groups-roles.png "User administration workflow")
...
For a complete list of the roles included with the ServiceNow platform, see [Base system roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/user-administration/../reference/r_BaseSystemRoles.md).
