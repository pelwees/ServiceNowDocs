...
If an error occurs while registering a target instance see [Troubleshooting for registering target instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../reference/register-target-instance-troubleshooting.md).
