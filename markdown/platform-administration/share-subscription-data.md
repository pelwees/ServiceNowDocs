...
For more information about modifying the trust configuration for an instance, see [Basic trust configuration for data sync applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../core-configuration/concept/grant-access-other-instances.md).
...
**Parent Topic:**[Configuring Subscription Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../concept/configuring-subscription-management-v2.md)
