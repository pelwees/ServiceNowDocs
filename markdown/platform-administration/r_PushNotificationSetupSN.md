...
![Push notification setup tasks for the ServiceNow mobile app](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../image/PushNotificationSNSetup.png "Push notification setup tasks for the ServiceNow mobile app")
...
-   **Create the push message**
    ...
    Before creating a push notification, create the [push message](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../task/t_CreateAPushMessage.md) with the actual message content \(JSON payload\) to be included in the push notification.
