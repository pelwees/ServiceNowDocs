...
2.  Configure the list and create new fields.
    ...
    For more information, see [Configuring lists on the ServiceNow AI Platform](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../list-administration/concept/c_ListConfiguration.md).
