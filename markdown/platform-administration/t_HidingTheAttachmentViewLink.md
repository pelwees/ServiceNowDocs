...
1.  Add the **glide.ui.disable\_attachment\_view** and **glide.ui.attachment\_popup** properties.
    ...
    For instructions on adding properties to the platform, see [Add a system property](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../../reference-pages/reference/r_AvailableSystemProperties.md#).
