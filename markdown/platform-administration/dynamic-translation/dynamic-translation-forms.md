...
To enable dynamic translation at the field-level on Platform forms, see [Enable dynamic translation for a field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/dynamic-translation/../task/configure-field-translation.md). After dynamic translation is enabled, select the translate icon \(![Translate icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/dynamic-translation/../image/Translation.png)\) to show or hide the translated content.
...
Use the dynamic translation properties to enable or prevent the option for dynamic translation in the activity stream of the tables you list. When enabled, select the translate icon \(![Translate icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/dynamic-translation/../image/Translation.png)\) to show or hide the translated content for each comment or work note in the activity stream. For more information, see [Dynamic Translation properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/dynamic-translation/../reference/dynamic-translation-properties.md).
