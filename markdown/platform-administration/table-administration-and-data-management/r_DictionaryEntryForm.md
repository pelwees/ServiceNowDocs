...
Defines the field type of the column or, if the **Type** is **Collection**, indicates that the dictionary entry represents the table. For more information, see [Field administration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../reference-pages/concept/c_IntroductionToFields.md).You can change the type of a field. To preserve existing data, only change between logical types that map to the same physical type on the database. For example, Choice and String.
...
Determines whether this field must contain a value to save a record. For more information, see [Make a field mandatory](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../field-administration/task/t_MakingAFieldMandatory.md).**Note:** You can override this option for extended tables.
...
Alters the behavior of a field or functionality that depends on the field. For more information, see [Dictionary Attributes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../reference-pages/concept/c_DictionaryAttributes.md). Attributes can be overridden for extended tables with [dictionary overrides](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../concept/c_DictionaryOverrides.md). You can also configure attributes for this dictionary entry through the **Attributes** related list.
...
Specifies a field on which the current field depends. For more information, see [Make a field dependent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../field-administration/task/t_MakingAFieldDependent.md) **Note:** You can override this value for extended tables.
...
-   List menu with -- None --
-   [Suggestion field type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../field-administration/task/t_AddingASuggestionField.md)

 If a choice is used, either define a [Choice list field type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../field-administration/concept/c_ChoiceLists.md) or use the fields **Choice** table and **Choice** field to copy choices from another field elsewhere in the dictionary.
...
</table>**Parent Topic:**[Modify dictionary entries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/t_ModifyADictionaryEntryFromAForm.md)
