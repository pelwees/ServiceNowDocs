...
\[Mandatory\] Define the field type for the column. See [Field administration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../reference-pages/concept/c_IntroductionToFields.md) and [Field types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../reference-pages/reference/r_FieldTypes.md). To preserve existing data, only change fields between the same basic type \(for example, **Choice** and **String**\). A warning appears if a change to a custom field results in data loss. You cannot change a base system field, that results in data loss.
...
Make the field into a [Reference field type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../field-administration/concept/c_ReferenceField.md) by entering the referenced table name.
...
Indicate whether this field is the [Display values](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../field-administration/concept/c_DisplayValues.md) \(appears on records that reference this table\).
 ...
 **Note:** This option does not control whether this field is displayed on lists or forms.
    ...
    |Live feed|Select the check box to enable record feeds for the table. This option adds the **Show Live Feed** icon \(![Show Live Feed icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/LiveCompanyFeed.png)\) in the form header.|
...
2.  Open the field record that you want to change, and make your updates. For a description of each field, see [Field Label table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../localization/reference/r_FieldLabelTable.md).

-   **[Global default fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../../build/applications/reference/r_GlobalDefaultFields.md)**  
