...
-   Export an individual record to a PDF or XML file directly from a form. See [Export data from a record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/export-form-data.md).
-   Export multiple records to a CSV, Excel, PDF, XML, or Google Sheets file directly from a list. See [Export data from a list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/export-list-data.md).
-   Export multiple records from a table using the CSV, Excel, PDF, or XML processor in a URL with optional parameters. See [Export directly from a URL](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/t_ExportDirectlyFromTheURL.md).
