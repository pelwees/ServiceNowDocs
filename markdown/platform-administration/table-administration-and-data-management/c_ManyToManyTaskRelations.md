...
-   **[Request many to many task relations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/t_RequestManyToManyTaskRelations.md)**  
...
-   **[Plugin manifest](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../reference/r_PluginManifest.md)**  
When the plugin is activated, the Task Relationships application is available with certain modules.
-   **[Define a relationship type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/t_DefineARelationshipType.md)**  
Create type codes that define the relationship between parent and child tasks.
-   **[Define a task relationship allowed from the task relationship type record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/t_DefineATaskRelationshipAllowed.md)**  
Define the Task Relationships Allowed from the Task Relationship Type record.
-   **[Modify the displayed field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../task/t_ModifyTheDisplayedField.md)**  
The list view of the Reference Lookup defines the fields displayed in the Task Relations field and editing interface.
-   **[Mark as Solution button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/c_MarkAsSolutionButton.md)**  
...
-   **[Task relationships with UI actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../reference/r_UIActions.md)**  
