...
Administrators can view the status of flattened table hierarchies, but cannot flatten additional hierarchies. You can [configure the form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../form-administration/concept/configure-form-layout.md#) to add the **Extension model** field if necessary.
...
**Parent Topic:**[Table flattening](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../concept/c_TaskTableFlattening.md)
