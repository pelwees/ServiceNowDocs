...
-   **Example: __sysparm\_display\_value__ = __true__**
    ...
    ![Example: sysparm_display_values = true](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/XLSX-sysparm-display-value-true.png)

-   **Example: __sysparm\_display\_value__ = __false__**

    ![Example: sysparm_display_values = false](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/XLSX-sysparm-display-value-false.png)
...
-   **Example: __displayvalue__ = __true__**
    ...
    ![Example: displayvalue = true](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/json-displayvalue-true.png)

-   **Example: __displayvalue__ = __false__**

    ![Example: displayvalue = false](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/json-displayvalue-false.png)

-   **Example: __displayvalue__ = __All__**

    ![Example: displayvalue = all](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/json-displayvalue-all.png)
...
-   **Example: __sysparm\_export\_column\_header\_label__ = __true__**
    ...
    ![Example: sysparm_export_column_header_label = true](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/sysparm_export_column_header_label-true.png)

-   **Example: __sysparm\_export\_column\_header\_label__ = __false__**

    ![Example: sysparm_export_column_header_label = false](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/sysparm_export_column_header_label-false.png)
