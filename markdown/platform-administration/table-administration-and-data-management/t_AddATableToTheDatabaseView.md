...
![Database View Table form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../image/Dbviews4.png "Database View Table form")

**Note:**

-   Database views cannot be created on tables that participate in [table rotation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../../administer/platform-performance/concept/c_TableRotation.md).
...
To see an example of using left joins to create a view, see [Example left join in creating a database view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/example-left-join-db-view.md).
...
2.  [Configure the form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/table-administration-and-data-management/../../../administer/form-administration/concept/configure-form-layout.md#) and add the **Left join** field \(a check box\) to the form.
