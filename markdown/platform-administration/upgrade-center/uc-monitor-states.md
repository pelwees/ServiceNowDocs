...
![Image showing no scheduled upgrade over monitor view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/upgrade-center/../image/uc-monitor-no-upgrade1.png)
...
There is an upgrade that has been scheduled to start at a given time.![Image showing a scheduled upgrade over monitor view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/upgrade-center/../image/uc-monitor-scheduled-upgrade.png)
...
![Image showing the error message "Detected an issue with one or more upgrade jobs. Your next upgrade might not run. Select here to fix the upgrade jobs."](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/upgrade-center/../image/uc-monitor-issue.png)
