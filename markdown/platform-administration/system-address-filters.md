...
1.  [Set email address filters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../task/set-email-address-filters.md)

    Specify which domains and email addresses are allowed or disallowed.

2.  [Create a system address filter](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../task/create-system-address-filter.md)
...
-   **[Set email address filters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../task/set-email-address-filters.md)**  
Specify which domains and email addresses are allowed or disallowed.
