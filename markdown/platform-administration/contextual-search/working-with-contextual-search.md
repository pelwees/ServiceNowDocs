...
-   **[Set a search context as default](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/set-a-contextual-search-as-default.md)**  
...
-   **[Set the default source for search context](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/set-source-search-context.md)**  
You can decide which source to set as the default search source.
-   **[View a searcher](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_ViewASearcher.md)**  
View the details of a searcher to know which search resources it searches and which search contexts use it.
-   **[Show the related search box in a form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/show-related-search-box-from-form.md)**  
Enable agents to search for related content without having to modify the text in the **Short description** field.
-   **[Add multiple search fields for contextual search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/add-multiple-search-fields.md)**  
...
-   **[Add additional resources to the source selector of a form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/add-addi-resource-to-source-list.md)**  
...
-   **[Edit search resource display field record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/edit-addi-resources-field.md)**  
Use the search result display fields to provide titles, descriptions, and additional details for contextual search results.
-   **[Specify fields for the Cxs\_popup view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/def-fields-addi-resource-preview.md)**  
...
-   **[Modify or disable search actions available for contextual search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/modify-search-actions-avail-for-cxs.md)**  
...
-   **[Define contextual search for record producer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_CntxtSearchRP.md)**  
...
-   **[Define email configuration for contextual search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/define-email-configuration-for-cxs.md)**  
Define email configurations to allow the system to include search results with an email notifications.
-   **[Edit an email notification for the search results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_ConfigureAnEmailNotification.md)**  
Include search results in an email notification sent to users.
-   **[Attach a Knowledge article](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_AttachAnArticle.md)**  
...
-   **[Feedback information on contextual search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../reference/r_QueryFeedbackInformation.md)**  
