...
-   **[Search resource](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_ApplyConfigurationToSearch.md)**
    ...
    **Note:**
    ...
    -   A search resource uses the [Zing search engine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../../search-administration/reference/features-search-administration.md) to search a table.
-   **[Searcher](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_ViewASearcher.md)**
...
-   **[Additional resources](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/add-addi-resource-to-source-list.md)**
    ...
    **Note:**
    ...
    -   An additional resource performs the search based on the type of the source:
        -   Table: The [Zing search engine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../../search-administration/reference/features-search-administration.md) to used to search a table.
...
-   **[Search result display fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/edit-addi-resources-field.md)**
...
-   **[Search context](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_DefineSearchContext.md)**
...
-   **[Searcher text](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_DefineSearchContext.md)**
...
-   **[Search on tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/t_DefineSearchContext.md)**
...
-   **[Search actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/contextual-search/../task/modify-search-actions-avail-for-cxs.md)**
