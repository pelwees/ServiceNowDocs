...
-   The included spreadsheet template \(ServiceNow\_Glossary\_Template.xlsx\) must be used when creating a glossary. For details see [Upload glossaries to Language Asset Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../task/lw-lam-upload-glossaries.md).
-   Any editing or modification to the contents of existing glossaries can be done in the UI. For details see [Edit a glossary in Language Asset Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../task/lw-lam-edit-glossary.md).
...
-   **[Edit a glossary in Language Asset Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../task/lw-lam-edit-glossary.md)**  
