...
2.  Select **Import Glossary**.
    ...
    ![In the Language Asset Management area, the Import Glossary button is highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-import-glossary-button-a.png)
...
3.  In the **Import existing glossary** modal window, select the **ServiceNow\_Glossary\_template.xlsx** attachment and download it.
    ...
    ![On the modal window titled Import existing glossary, the template download area is highlighted. The template filename is ServiceNow_Glossary_Template.xlsx](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-upload-glossaries-dl-template-a.png)
...
You can add you own columns for self-localized languages. If you create a column, use only language ID codes that exist in your sys\_language table as the column headers.
    ...
    ![Saving the completed spreadsheet. The file format Excel Workbook (.xlsx) is highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-upload-glossaries-fileformat-a.png)
...
8.  On the **Load Data** window: use the default settings \(Existing table = glossary\_import\_set and Source of the import = File\), and select **Choose File**.
    ...
    ![The Load Data window. The default settings are highlighted: Existing table with glossary_import_set, and Choose File.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-upload-glossaries-reupload.png)
...
10. When the **Progress** window displays Completion code: Success, select the **Run Transform** link.
    ...
    ![In the modal window, "Completion code: Success" is highlighted. Under Next Steps, the Run Transform link is also highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-upload-glossaries-run-transform-a.png)
...
11. At the **Specify Import set and Transform map** window, keep the default Import set and selected map \(GlossaryTransformMap\), then scroll down to select the **Transform** button.
    ...
    ![On the Specify Import set and Transform map window, the Transform button is highlighted. The defaults for Import set and map are selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-upload-glossaries-transform-a.png)

12. You can view the import set, Transform history, or Import log by selecting the appropriate link.

    ![The transform reports a State of Complete. Under Next steps, links for the import set, transform history, and Import log are available.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/../image/lw-lam-upload-glossaries-final-a.png)
...
To add or edit source terms, or make any modifications after the initial upload, see [Edit a glossary in Language Asset Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/localization-workspace/lw-lam-edit-glossary.md).
