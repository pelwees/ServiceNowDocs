...
1.  [Set the instance locale](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/c_DefineLocales.md#)
...
2.  [Activate a language](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/../task/t_ActivateALanguage.md)
...
3.  [Set the default language for an instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/../reference/r_GlobalLanguage.md)

    Select a default language for an instance if it should be a language other than American English.

4.  [Set a fallback language](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/../task/set-fallback-language.md)
...
5.  [Set up locations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/../task/t_LocationSetup.md)

    Configure the locations that your organization supports to help identify users, assets, incidents, and more by location.

6.  [Create regions for language selection in portals](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/../../localization-framework/task/create-regions.md)

    Map languages to regions to organize the language selector for guest users.

7.  [Ensure that translated choices appear for applications added by plugins](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/system-localization/../task/activate-translated-choices-plugins.md)
