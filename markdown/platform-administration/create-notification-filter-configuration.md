...
6.  Select the User Criteria from the list of target records or create a new [user criteria](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/platform-administration/../reference/user-criteria-form-notifications.md).
