...
For more information about input mapping in a decision node or a guidance node, see [Linking inputs in decision tree nodes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/guided-decision-tree-input-mapping.md).
