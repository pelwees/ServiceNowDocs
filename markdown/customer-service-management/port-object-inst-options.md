...
Option to display the service definitions associated with the record under **Actions**. For details, see [Service definitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-service-definitions.md).
...
[Add and configure the Portal Object widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/add-conf-port-object-widget.md)
