...
![Initiate transaction tracking guidance configuration that includes node name, guidance selected, and input mapping between this guidance and question nodes.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/ex-trxn-tracking-guidance.png)

## Procedure

1.  Select **Add node** on the Amount-is-debited path.

    ![the Add node button in the Decision Tree Builder to configure a question or guidance node.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/ex-amt-debited-guidance.png)
...
5.  In the **Set field inputs to pass data into this guidance** section, link the task input from the previous question node.
    ...
    ![Linking the task input from the previous question node to this guidance node.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/gd-task-input-mapping.gif)
...
6.  In the **Set more field inputs to show to users** section, link guidance inputs to the inputs from the previous question node.
    ...
    1.  Select the Link input icon \(![Link input icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/icon-link-input.png)\) next to the field.
...
1.  Add a new path by selecting the Add path icon \(![Add path icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/icon-add-path.png)\) on the Initiate transaction tracking guidance node.
...
2.  [Configure a question node for further assistance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/configure-a-question-node-for-further-assistance.md).
