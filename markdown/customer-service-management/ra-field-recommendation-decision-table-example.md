...
|[Configure a resource generator for providing assignment group as an outcome](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/ex-resorce-generator-assignment-grp.md)|Configure a resource generator that you can use while configuring a field recommendation to provide the appropriate assignment group for the router issue.|
|[Create a field recommendation for recommending assignment group field value](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/ex-create-field-recommendation-assg-grp.md)|Create an action of type field recommendation for recommending a field value for the assignment group.|
|[Create a rule from the Case context record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/ex-create-rule.md)|Create a rule to show recommendations for active cases that meet the condition specified in this rule.|
|[Create a recommendation with the field recommendation as an action type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/ex-create-recommendation-field.md)|Create a recommendation to surface the recommendation for the assignment group field value on a case record.|
