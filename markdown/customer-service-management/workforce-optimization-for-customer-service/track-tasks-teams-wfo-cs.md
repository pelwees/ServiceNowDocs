...
2.  Select the **Work Scheduler** icon.
    ...
    -   In the contextual side panel, select the Filter icon \( ![Filter icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/filter-icon.png)\) and then select any filter, add the desired criteria, and select **Apply** to narrow down the display of the team members in the calendar. You can filter based on your team's assignment group, skills, location, schedule plan, or shift plan.
3.  If you don’t have any queue configurations in the Work scheduler, select the queue settings icon \(![Queue Settings icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/queuefilter.png)\) and then enable up to five work item types.
...
6.  Assign a work item to an agent.
    ...
    1.  Select a task that you want to assign to an agent.
        ...
        To add your own matching rule, see [Create a criteria for a matching rule in Work scheduler](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/assignment-rules-work-scheduler-wfo-cs.md).
...
7.  Update a work item from the calendar.
    ...
    ![Infographic displaying the Work Scheduler form with work queues based on unassigned incidents.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../../configurable-workforce-optimization-itsm/image/work-scheduler-ui.png)


**Parent Topic:**[Assigning work using Work Scheduler in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../concept/work-scheduler-wfo-cs.md)
