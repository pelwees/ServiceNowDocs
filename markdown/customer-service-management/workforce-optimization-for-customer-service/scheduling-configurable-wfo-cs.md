...
-   **[Create a shift plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/create-shift-plan-configurable-wfo-cs.md)**  
...
-   **[Create a schedule plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/create-schedule-plan-configurable-wfo-cs.md)**  
...
-   **[Publish a schedule plan for visibility into team coverage](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/generate-preview-schedule-plan-configurable-wfo-cs.md)**  
...
-   **[Track and manage your team schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/track-manage-teams-schedule-configurable-wfo.md)**  
...
-   **[Create recurring meetings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/create-recurring-meeting-wfo.md)**  
...
-   **[Analyze staff alignment using Demand Forecast](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/analyze-staff-alignment-configurable-wfo-cs.md)**  
Use Demand Forecast to plan the number of staff members that you require so that you have enough agents to do the job.
-   **[Add events to the team calendar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/adding-event-calendar-configurable-wfo-cs.md)**  
Create a meeting, training, time-off request, or an ad hoc work event from the team calendar.
-   **[Swap agent shifts in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/swap-agent-shifts-configurable-wfo-cs.md)**  
Swap an agent's shift in an assignment group with another agent who can work on that shift and skip the approval process.
-   **[Enable your teams to sign up for work shifts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/agent-shift-signup-wfo-csm.md)**  
Empower your teams to sign up for work shifts based on their availability and preference.
-   **[Sign up for your preferred shifts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../task/sign-up-preferred-shifts-wfo-csm.md)**  
