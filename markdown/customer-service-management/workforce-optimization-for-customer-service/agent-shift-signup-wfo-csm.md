...
2.  Select the Schedule icon \(![Schedule icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/schedule-icon.png)\).

3.  Add a schedule plan.

    1.  Select the **Team Calendar** tab.

    2.  In the Contextual side panel, click the Show Schedules icon ![Show Schedules icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/show-schedules-icon.png) to display the schedules.

        **Tip:** Select the filter icon \(![Filter schedule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/show-filter-icon.png)\) and then select the desired sign-up state and sign-up dates to narrow down the schedule plans enabled for sign-up.
...
2.  Select **Apply**
    ...
    4.  Fill in the required fields on the form.
        ...
        ![Create shift sign-up](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/create-shift-signup.png)
...
4.  Add a work shift to the schedule plan.
    ...
    1.  Select the schedule plan you've created.
        ...
        ![Select schedule for shift sign-up](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/select-schedule-shift-signup.png)

    2.  Select **Add Shift**.

        The image below provides an example of a form to enter the details for a shift.

        ![Add shift sign-up](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/workforce-optimization-for-customer-service/../image/add-shift-signup.png)
