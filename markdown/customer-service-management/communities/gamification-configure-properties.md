...
4.  Click **Save**.
    ...
    Additional properties can be configured for the gamification feature. For more information, see [Gamification properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/communities/../reference/communities-properties.md#table_wdb_cts_r1b).
