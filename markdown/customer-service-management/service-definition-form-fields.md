...
The image associated with the service definition.Service definitions appear in the [case type selector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-case-type-select-modals.md) or [case task type selector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-case-task-type-select-modal.md) in a card view. The image appears in the card for a service definition along with the name and description.
