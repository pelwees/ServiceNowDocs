...
-   [CSM Configurable Workspace form ribbon and components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/csm-agent-workspace-ribbon.md)
