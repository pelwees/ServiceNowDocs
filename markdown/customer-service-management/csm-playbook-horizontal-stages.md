...
The Case playbook: horizontal stages record page is created from the [Case playbook: horizontal stages template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-playbook-templates.md#section_uyk_sp3_cxb).
