...
5.  In the **Generator type** field, select a generator type.
    ...
    For more information, see [Resource generator types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/ra-csm-resource-generators.md#section_xh5_4tw_15b).
...
8.  On the Generator input form, fill in the fields.
    ...
    For a description of the field values, see [Resource generator inputs form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/ra-csm-resource-generator-form.md).
