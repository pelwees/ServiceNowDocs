...
-   The Walk-up Check-in widget must be configured. For more information, see [Add a Walk-up Experience online check-in link on the Service Portal home page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/../task/csm-walkup-add-checkin-icon.md).

**Parent Topic:**[Walk-up Experience for Customer Service Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/csm-walkup-experience.md)
