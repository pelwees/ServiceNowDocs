...
-   At least one taxonomy associated with your portal. For more information, see [Add a taxonomy to your portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/add-taxo-to-portal.md).
...
9.  Select the Pencil icon \(![Pencil icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/../image/icon-pencil-ac.png)\).

10. On the Instance form, fill in the fields.

    For a description of the field values, see [Portal Browse Taxonomy widget instance options form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/../reference/port-browse-taxo-widget-inst-options.md).
