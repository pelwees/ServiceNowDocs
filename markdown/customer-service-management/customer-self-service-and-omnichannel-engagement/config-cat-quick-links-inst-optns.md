...
11. On the Instance form, fill in the fields.
    ...
    For a description of the field values, see [Portal Catalog Quick Links widget instance options form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/../reference/port-cat-quick-links-inst-options.md).
