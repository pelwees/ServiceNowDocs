...
1.  Configure the instance option.
    ...
    3.  In **Heading**, enter the desired text.
        ...
        For details on filling the Heading field, see [Portal Banner widget instance options form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-self-service-and-omnichannel-engagement/../reference/banner-widget-inst-options.md).
