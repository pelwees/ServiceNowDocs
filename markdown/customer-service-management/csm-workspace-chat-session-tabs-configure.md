...
Enable the [chat session tabs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-workspace-chat-session-tabs.md) feature and select the workspace that the feature applies to.

You can configure a minimum of one and a maximum of three chat SLA threshold timers for a workspace. These timers alert agents to unread messages by changing the [tab colors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-workspace-chat-session-tabs.md#section_rsb_4j2_fdc) of the inactive chats.
