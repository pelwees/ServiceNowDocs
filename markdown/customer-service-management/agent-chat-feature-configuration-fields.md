...
Determines the chat options for managing various conversation features.For more information, see [Chat Setup configuration form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/em-advanced-chat-setup.md).
...
![Engagement Messenger home page displaying a Chat with an agent widget to initiate a chat with Virtual Agent.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/em-agent-chat-widget.png "Agent chat widget")

</td><td>

![Widget displaying the Chat with us and Submit a case features along with their description.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/em-chat-launcher.png "Chat feature launcher widget")
