...
2.  From the list, select a customer order number to view its details.
    ...
    For a description of the fields, see [Customer Orders form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/business-portal-blsp-track-customer-order.md)
