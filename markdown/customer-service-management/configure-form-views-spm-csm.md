...
2.  Add the sn\_customerservice\_manager role.
 If you do not see the **Edit** button enabled, see [Assign roles for Service Portfolio Management integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/assign-roles-spm-csm.md) for more details.
