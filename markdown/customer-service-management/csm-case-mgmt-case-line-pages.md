...
The following record pages use the [CSM default record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-default-record-page.md) to display case line, case line task, and case line characteristic information in CSM Configurable Workspace.
...
|[Case line task page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-case-lines-case-line-task-page.md)|The case line task page displays information about a task created for a case line item.|
