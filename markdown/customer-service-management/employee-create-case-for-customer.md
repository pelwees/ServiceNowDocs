...
Install the [CSM Extension for Proxy Contacts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/csm-extension-for-proxy-contacts.md) to use this functionality.
