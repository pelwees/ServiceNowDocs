...
-   CSM Configurable Workspace: Open a case and select **New** on the [Case Line list action bar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-case-mgmt-case-lines-create-case-line.md#section_h41_s1h_5cc) to open a new case line record in the Draft state.
