...
![Workflow displaying the case management process. For the text description, refer to the preceding text in the Getting to know the case management process.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/case_management_overview.png "High-level process flow for the case management process")
...
To learn more about case workflows, see [Configure proactive case flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/configure-flow-designer.md).
...
To learn more about case types, see [Customer Service Case Types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-service-case-types.md).
...
To learn more about the service definitions, see [Service definitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-service-definitions.md).
...
To learn more about playbooks, see [Playbooks for Customer Service Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/customer-service-case-playbooks.md).
...
To learn more about major issue management, see [Major issue management overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/major-issue-management.md).
...
To learn more about customer project management, see [Integrate with Customer Project Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-ppm-configuration.md).
