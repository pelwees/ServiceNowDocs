...
![Inputs screen for the Get All Opportunities action showing the action input and its default value.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/get-all-opportunities-action-input.jpg)

## Pre-processing step

The pre-processing script step takes the action input as its own.

![Pre-processing step screen showing the action input with a pill picker to generate a query.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/get-all-opportunities-pre-processing.jpg)
...
![Output variable section showing the query parameter as an output.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/get-all-opportunities-pre-processing-output.jpg)
...
![REST step screen showing connection details and request details for verification.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/get-all-opportunities-rest.jpg)

## Post-processing step

The post-processing script step takes the action input and REST step output as its inputs.

![Post Processing step screen showing the inputs, including the action input and input variables.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/get-all-opportunities-post-processing.jpg)
...
![Output variable screen within the Post Processing step showing records, error_messages, info_messages, and status variables.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/get-all-opportunities-post-processing-output.jpg)
