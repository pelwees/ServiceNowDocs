...
6.  In the Modify quantity dialog box, you can swap the values fully or partially in the **Quantity** field for both the contract lines.![Modify quantity dialog box](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../images/modify-quantity.png)
