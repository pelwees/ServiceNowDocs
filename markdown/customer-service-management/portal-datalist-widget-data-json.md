...
For details, see [Configure public access on the Portal Data List widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/config-data-list-widget-inst-guest-access.md).
