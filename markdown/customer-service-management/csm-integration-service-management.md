...
For more information, see [Create incident, problem, change, and request records from cases](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-item-agent-tasks.md#).
...
For more information, see [View case records from the Customer and Consumer Service Portals](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/view-related-records-from-portal.md).
