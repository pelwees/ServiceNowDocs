...
For more information about adding staff members to an external business location, see [Add staff members to a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/add-staff-members-biz-loc.md).
...
List of external business location records.For more information about creating external business locations, see [Create an external business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-external-business-location.md).
...
-   A location manager can see projects of their respective and child business locations. To learn more about roles, see [Service Model Foundation roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-data-model-roles.md).
...
For more information about creating an account staff relationship, see [Create an account staff relationship](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-staff-account-relationship.md).
...
For more information about creating a consumer staff relationship, see [Create a consumer staff relationship](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-staff-consumer-relationship.md).
...
For more information about creating a household staff relationship, see [Create a household staff relationship](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-staff-household-relationship.md).
