...
4.  Fill the details in account address form and select **Submit**.
    ...
    For more information about the table fields, see [Account Address table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/account-address-table.md).
