...
3.  On the Extension Point form, select a script include to use the sn\_chat\_zoom.ZoomInteractionExtPoint extension point.
    ...
    -   Create and register a custom script include.
        ...
        For more information, see [Registering custom script includes against the scripted extension points](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../../../build/applications/concept/impl-scripted-ext-pts-custom-code.md).
