...
2.  Select the Show column search row icon \(![Show column search icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/Search_icon_eaaI.jpg)\).
