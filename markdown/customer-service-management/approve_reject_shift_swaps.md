...
5.  Review the details of the shift swap request and do one of the following:
    ...
    If you approve a shift swap, the application moves the request to your manager's approval queue. For more information, refer to [Schedule in Workforce Optimization for Customer Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/scheduling-configurable-wfo-cs.md).
