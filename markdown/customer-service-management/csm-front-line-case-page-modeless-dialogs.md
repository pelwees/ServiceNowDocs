...
Select the pop out \(![modeless dialog pop out icon which is a smaller solid square within a larger square](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/modeless-dialog-pop-out-icon.png)\) icon to open a comment or work note in a modeless dialog.You can open a modeless dialog before or after you start entering text in the Compose window.
...
After opening a comment or work note in a modeless dialog, you can return the text to the Compose window in the activity stream in the following ways:-   Select the Continue editing in compose \(![square icon with down arrow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/modeless-dialog-continue-editing-icon.png)\) button at the top of the modeless dialog.
...
To minimize a modeless dialog, select the Minimize dialog \(![minimize icon is a flat white line at the bottom of a black box](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/modeless-dialog-minimize-icon.png)\) button in the window header. Minimized modeless dialogs appear in the dock at the bottom of the workspace. For more information, see [Workspace dock](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-config-ws-bottom-utility-bar.md).
...
To discard a comment or work note:1.  Select the Close dialog \(![close icon is a white X on a black background](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/modeless-dialog-close-icon.png)\) button in the modeless dialog header.
...
Select the pop out \(![modeless dialog pop out icon which is a smaller solid square within a larger square](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/modeless-dialog-pop-out-icon.png)\) icon to open an email in a modeless dialog.You can open a modeless dialog either before or after you start entering text in the Compose window.
...
1.  Select the Apply templates icon \(![Apply templates icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-apply-template.png)\) in the Compose email modeless dialog footer to display a list of available templates.
...
Select the Pop out icon \(![modeless dialog pop out icon which is a smaller solid square within a larger square](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/modeless-dialog-pop-out-icon.png)\) in the Compose Email window header to open the draft email in a subtab.The Compose Email window closes when the email opens in the subtab.
...
Select the View drafts icon \(![Compose email view drafts icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-view-drafts.png)\) in the Compose Email window footer. Selecting this icon displays a list that includes the most recent email drafts. The list also includes the following actions:
...
Select the View drafts icon \(![Compose email view drafts icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-view-drafts.png)\) in the Compose Email window footer. Selecting this icon displays a list that includes the most recent email drafts. You can select a recent draft from this list.
...
1.  Select the Discard draft icon \(![Compose email discard draft icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-discard-draft.png)\) in the Compose Email window footer.
...
1.  Select the View drafts icon \(![Compose email view drafts icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-view-drafts.png)\) in the Compose Email window footer.
...
You can expand and collapse the email header as needed by selecting the expand header \(![Compose email expand header icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-header-expand.png)\) and collapse header \(![Compose email collapse header icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-header-collapse.png)\) icons.
...
Discard draft \(![Compose email discard draft icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-discard-draft.png)\)
...
Apply template \(![Compose email apply templates icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-apply-template.png)\)
...
View drafts \(![Compose email view drafts icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-view-drafts.png)\)
...
Attach file \(![Compose email attach file icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-email-modeless-dialog-attach-file.png)\)
