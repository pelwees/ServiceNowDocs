...
![Recommended actions and Search tabs in the contextual side panel in CSM Configurable Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/ra-actions-overview-2.png "Recommended Actions in CSM Configurable Workspace")
...
For end-to-end configurations of recommended actions for specific scenarios, see [Example configurations of recommended actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/recommended-actions-use-case.md).

## Action types for Recommended Actions

With the Recommended Actions application, you can create the following types of actions for agents to take. For more information, see [Recommended Actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/configure-nba.md).
...
Agents can access recommended actions in a workspace such as CSM Configurable Workspace by selecting the Recommended Actions icon \(![Recommended Actions icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/nba-icon.png)\) in the contextual side panel. For more information, see [Using the Recommended Actions application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/ra-csm-using-recommended-actions.md).
...
[Install the Recommended Actions application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/install-recommended-actions-cs-app.md)
...
[Assign roles to Recommended Actions users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/ra-csm-installed-components.md)
...
[Configuring the Recommended Actions application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/configure-recommended-actions.md)
