...
-   For more information about how to manage a callback from an agent using Engagement Messenger, see [Working with callback requests using Engagement Messenger](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/request-callback-from-em.md#)
