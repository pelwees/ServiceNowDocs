...
Script to show or hide the data list category on the widget. For more information, see [Hide or show categories in the Data List widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-cond-script-datalist-widget.md).Script to modify the view on the data list widget. For details, see, [Modify view in the Data List widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/update-view-in-datalist-widget.md).

Script to filter records in the Data List widget. For details, [Filter records in the Data List widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/filter-records-in-datalist-widget.md).
...
[Add and configure the Portal Data List widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/config-data-list-widget-inst-optns.md)

[Hide or show categories in the Data List widget](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-cond-script-datalist-widget.md)
