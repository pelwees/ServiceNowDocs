...
For more information, see [Add staff members to a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/add-staff-members-biz-loc.md).
...
List of internal business location of the current parent business location.For more information, see [Create an internal business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-internal-business-location.md).
...
List of external business location of the current parent business location.For more information, see [Create an external business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-external-business-location.md).
...
List of all associated assigned groups of the internal business location.For more information, see [Setting up assignment groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/setting-up-assignment-groups.md).
...
List of services supported by the business location.For more information, see [Setting up products and available services at a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/products-services-at-bus-loc.md).
...
To learn more about project creation, see [Create customer projects](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-customer-projects.md).
...
List of all cases requested by the internal business location to work.For more information, see [Create and manage cases for a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/manage-business-location-cases.md)
...
Cases that have been created and assigned to this location. For more information, see [Create and manage cases for a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/manage-business-location-cases.md).
...
For more information, see [Create an account staff relationship](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-staff-account-relationship.md).
...
For more information, see [Create a consumer staff relationship](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-staff-consumer-relationship.md).
...
For more information, see [Create a household staff relationship](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-staff-household-relationship.md).
...
Sold products that have been created for customers at this location.For more information, see [Create and manage sold products for a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-sp-for-business-location.md).
...
Install base items that have been created for customers at this location.For more information, see [Create and manage install base items for a business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-ib-items-for-business-locations.md).

</td></tr></tbody>
</table>**Related topics**  


[Create an internal business location](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/create-internal-business-location.md)

[Service Model Foundation relationships](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/csm-data-model-relationships.md)
