...
This feature is available for the following CSM Configurable Workspace [record pages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-config-workspace-record-pages.md):
...
-   [Front-line case page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-front-line-case-page.md)
-   [CSM Interaction record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-interaction-record-page.md)
-   [CSM default record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-default-record-page.md)
-   [CSM voice interaction record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-native-voice-record-page.md)
-   [CSM centered chat interaction record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-centered-chat-interaction-page.md)
-   [Email Interaction record page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-email-interaction-record-page.md)
...
This property is available for the following CSM Configurable Workspace [record pages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/csm-config-workspace-record-pages.md):
...
![Window displaying special handling information for records requiring attention, based on priority. For the text description, refer to the preceding text in the Special handling notes section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-config-workspace-special-handling-note.png "Special handling notes pop-up window")
...
For more information about configuring the special handling notes feature, see [Special handling notes overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/c_OnScreenAlerts.md).

## Agent actions

Actions available to customer service agents appear in the form header as buttons or menu items.

For CSM Configurable Workspace, you can link UI actions to form actions. For more information, see [Set up a form action in CSM Configurable Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/config-csm-config-ws-form-action.md).
...
For more information on how to enable Recommended Actions - AI search and disable Agent Assist, see [Enable AI search in Recommended Actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/migrate-ra-agent-assist.md).

## Account hierarchy

From the Account form, customer service agents can click the open hierarchy icon \(![Open hierarchy icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/workspace-account-hierarchy-icon.jpg)\) in the **Name** field to see the parent-child account relationships in the Account Hierarchy pop-up window. The account hierarchy is available for accounts that have a parent or child account.

![Window displaying the parent-child relationship for an account. For the text description, refer to the text that follows in the Account Hierarchy section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/csm-config-workspace-account-hierarchy.png "CSM Workspace Account Hierarchy pop-up window")
...
For information about creating an account hierarchy, see [Account hierarchy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../concept/c_AccountHierarchy.md).
