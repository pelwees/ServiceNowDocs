...
![The Action status column on the Case list displays color-coded indicators and messages for cases that are blocked or need attention.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../image/case-action-status-csm-config-workspace.png "Action status column on the Case list")

## Actionable case flows

The case action status feature uses [actionable case flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/case-action-status-triggers.md) to automatically determine the action status for customer service cases. These flows create and resolve blocking tasks for different case-related actions and automatically update the action status indicators. Certain agent actions trigger these case flows, which in turn create and resolve the blocking tasks.
...
A [blocking task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/case-action-status-blocking-tasks.md) is something that prevents an agent from making progress toward case resolution. For example, a case might have one or more open related case task records or be waiting for customer feedback.
...
-   **[Actionable case flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/case-action-status-triggers.md)**  
...
-   **[Blocking tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/case-action-status-blocking-tasks.md)**  
...
-   **[Case action status analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/case-action-status-dashboard.md)**  
...
-   **[Case action status logging](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../reference/case-action-status-logging.md)**  
...
[Configure case action status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/configure-case-action-status.md)

[Activate Case Action Status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/customer-service-management/../task/activate-case-action-status.md)
