...
![The Natural Language Understanding section displays on the Properties tab when NLU is enabled. Select an existing NLU model and associated intent or create new ones.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/nlu-language-mapping-intent-new.png)
