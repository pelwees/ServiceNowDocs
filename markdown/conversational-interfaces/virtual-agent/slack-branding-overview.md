...
4.  Select the Manage Bot icon and select **Manage Virtual Agent**.![The Manage Virtual Agent option displays on the Manage bot menu for the Slack channel.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/manage-slck-snow-bot.png)
...
5.  On the Branding tab, provide the following details:
    ...
    ![In the chat window, you can modify the chat window header, the title that appears in the Slack navigation panel, and the name and icon in the conversation body.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/slack-branding-bot-name.png "Branded Slack conversation body")
