...
2.  [Create a topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/create-virtual-agent-topic.md) in your primary instance of Virtual Agent.
...
**Previous topic:**[Create an auth token in the ServiceNow secondary instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/create-auth-token-sn-secondary-instance.md)

**Next topic:**[Enable live agent connection on the primary instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/enable-live-agent-connection-on-the-secondary-instance.md)
