...
-   End state—Defined by default in 12 ways. For more information, see [Formula override examples](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../reference/formula-override-examples-pae.md).
...
2.  Select the formula you want to override.
    ...
    ![Formula Override record page showing existing formula.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/dashboard-formula-override-with-script.png)
...
6.  Click **New** to create a formula override record that overrides the default formula.
    ...
    ![Formula Override new record form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/dashboard-formula-override.png)
