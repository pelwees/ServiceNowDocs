...
</table>![Virtual Agent detects an utterance in Spanish and asks the user if they want to switch, in both English and Spanish.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../../now-assist-in-va/image/nava-lang-detect-updated-buttons.png "Example of a Virtual Agent LLM standard chat conversation using language detection")
