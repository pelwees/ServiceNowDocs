...
The Custom Events tab shows the dates when custom events were triggered. If no one [created custom events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/set-up-custom-events-pae.md), the list of custom events is empty. The maximum number of custom events displayed is 20.
