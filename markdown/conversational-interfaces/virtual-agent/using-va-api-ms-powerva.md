...
1.  [Create a JavaScript function in Microsoft Azure using Visual Studio Code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/create-js-function-azure-mspv-sec-bot.md)  
...
2.  [Locate and copy the Direct Line secret key in Microsoft Power Virtual Agents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/get-dl-secret-key-mspva.md)  
...
3.  [Add the Direct Line secret key to your Virtual Agent Bot Interconnect instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/add-dl-secret-key-sn-instance.md)  
...
4.  [Create a Virtual Agent Bot Interconnect shell topic to call Microsoft Power Virtual Agents topics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/create-primary-va-topic-ms-pva.md)  
