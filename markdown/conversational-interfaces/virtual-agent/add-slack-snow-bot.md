...
3.  Under the Available Channels section in the Slack tile, select **Add Integrations**, and select **Integrate with ServiceNow Virtual Agent**.
    ...
    **Note:** The **Add Integrations** drop-down is available only after installing the Conversational Integration with Slack plugin \(sn\_va\_slack\) on your ServiceNow instance.
    ...
    ![Slack Add integration drop-down list. The Integrate with ServiceNow Virtual Agent option is highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/add-slack-snow-integ.png)

4.  Enter your Slack workspace URL to sign into your Slack workspace, and select **Continue**.

    ![Enter your workspace URL to sign in.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/sign-into-slack-workspace.png)
...
6.  Select **Allow** when Slack requests permission to access your workspace.
    ...
    ![Logging into the Slack workspace to integrate with your Now Virtual Agent requires you to accept the requested permissions to access the workspace.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-request-permission.png)
...
7.  If the selected workspace ant has already been assigned to Virtual Agent, you must first uninstall from the previously associated instance.
    ...
    **Note:**
    ...
    ![A message appears when the Slack workspace is already associated with a ServiceNow instance.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/slack-new-proceed-install.png)
...
![Manage Slack channel view in Conversational Interfaces General settings. The plus icon in the ServiceNow Virtual Agent tile and the Add Integration list are highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/add-integration-icon-slck.png).

For more information, see [Manage the ServiceNow Virtual Agent integration with Slack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/configure-va-slack.md).
