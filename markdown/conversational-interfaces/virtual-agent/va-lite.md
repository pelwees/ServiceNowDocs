...
-   Control topic discovery and visibility.
    ...
    For more information about using these options, see [Control topic discovery and visibility](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/manage-topics-task.md).
...
Set up and configure Virtual Agent Lite. For details, see [Quick start for Virtual Agent Lite](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/quick-start-va-lite.md).
