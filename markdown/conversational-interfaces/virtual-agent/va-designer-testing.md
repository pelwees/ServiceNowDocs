...
![NLU/Keyword testing options are available on both theAssistant Designer Asset library canvas and theVirtual Agent Designer home page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-test-ui-options-nlu-2.png "Example NLU/Keyword test options")
...
![Conversation test tabs shown in the chat test window, with Analyze test phrases, Variables, Context, and Logs options highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-test-tabs.png "Example Natural Language Understanding (NLU) chat test window and test tabs")
...
![Analyze test phrases tab, showing test phrase results for multiple intent matches.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-test-phrases-multiple-results.png "Example Analyze test phrases tab for NLU/Keyword topics")

If an utterance doesn't match a current intent, you can add or change utterances in Virtual Agent Designer. For more information, see [Modify NLU utterances and entities for a Virtual Agent topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/modify-nlu-utterances-va-topic.md).
...
![Variables tab that shows the input variables and values, next to a screen capture of the conversation flow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-test-variables-tab.png "Example list of input variables")
...
![Variables tab separated by group, with the node and Group name highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/vad-grouped-choice-variables.png "Example list of grouped choice variables")
...
For more information about defining context variables, see [Configure context variables for storing chat-related information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../../conversational-interfaces/task/ac-configure-context-variables.md). For more information about live agent variables that are included with Virtual Agent, see [Live agent chat context variables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/live-agent-chat-context-vars.md).

![Context tab with the context portal value of IT Express.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-cce-it-express.png "Example Context tab")
...
![Logs tab that contains processing information about the topic.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-conv-preview-logs2.png "Example Logs tab")
...
-   **[Train and test your NLU model in Virtual Agent Designer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/train-test-publish-nlu-model-vad.md)**  
...
-   **[Automated testing for Virtual Agent topics that use NLU topic discovery](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/automated-testing-va-topics.md)**  
...
**Parent Topic:**[Getting started with Virtual Agent Designer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md)
