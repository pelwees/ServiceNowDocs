...
-   Review [Getting started with Virtual Agent Designer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../reference/conversation-designer-virtual-agent.md).
-   Configure Virtual Agent settings. For example, if you're creating large language model \(LLM\) topics, turn on Now Assist in Virtual Agent. For more information, see [Configuring assistants overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../../now-assist-in-va/task/configure-now-assist-va.md). If you're creating Natural Language Understanding \(NLU\) topics, configure NLU settings. For more information, see [Configure Natural Language Understanding in Virtual Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/configure-nlu-settings.md).
-   Plan your conversation before you begin. For more information, see [Designing a Virtual Agent topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/design-va-topic.md).
...
3.  Select the type of topic.
    ...
    -   For LLM topics:
        1.  Select **Create asset**.
            ...
            ![Select Create asset to create a new LLM topic on the Virtual Agent Designer Asset library page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/vad-home-2.png)
    ...
    -   For NLU/Keyword topics, select **Create topic**.
        ...
        ![Assistant Designer Asset library set to NLU/Keyword view, with NLU/Keyword selection switch and Create topic button highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/vad-home-nlu.png)

4.  On the form, fill in the fields.

    For a description of the field values, see [Create a topic form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../reference/vad-topic-creation-form.md).
...
For details about each control and the corresponding properties that you define, see [User inputs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../reference/va-user-inputs.md), [Bot responses](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../reference/va-bot-responses.md), and [Utilities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../reference/va-utilities.md).
...
[Publish](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/publish-virtual-agent-topic.md) the topic to deploy the topic to your Virtual Agent clients. The topic state changes to Active.
...
-   **[NLU model mapping in Virtual Agent Designer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/nlu-model-binding-vad.md)**  
...
-   **[Topic mapping to a multilingual NLU model group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/multilingual-nlu-model-group-topic-mapping.md)**  
...
-   **[Modify NLU utterances and entities for a Virtual Agent topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/modify-nlu-utterances-va-topic.md)**  
View, test, and modify NLU utterances for a Virtual Agent topic on the **NLU Intent** tab in Virtual Agent Designer.
-   **[Add NLU to an existing keyword topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/add-nlu-existing-keyword-topic.md)**  
Create and map an NLU model group and intent for the topic from Assistant Designer.
-   **[Add nodeless NLU entities as input variables to a topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/add-nodeless-entities-input-vars.md)**  
...
-   **[Branch a Virtual Agent conversation with a Decision utility](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/add-decision-utility-va-topic.md)**  
...
-   **[Insert a header card in a Static Choice or Dynamic Choice control](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/insert-header-card-user-input-control.md)**  
...
-   **[Change the application scope for Virtual Agent Designer topics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/change-application-scope-vad.md)**  
...
-   **[Define script variables for a topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/define-script-variables-topic.md)**  
...
-   **[Create a small talk topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/create-small-talk.md)**  
...
-   **[Control topic discovery and visibility](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/manage-topics-task.md)**  
...
-   **[Use system-derived entities in an NLU topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/use-system-entities-va-topic.md)**  
