...
-   **[Enable synthesized response in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/va-api-enable-synthesized-response.md)**  
You can now enable synthesized response in the conversations with the primary bot.
-   **[Configure interaction record to store clientSessionId in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/va-api-interaction-record-third-party-chat.md)**  
You can configure to store **clientSessionId** to support third-party chat applications.
-   **[Configure to support chat history in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/va-api-support-chat-history.md)**  
You can now support your live agents to see chat history in their conversations with the primary bot.
-   **[Enable Now Assist experience in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/enable-now-assist-in-virtual-agent-experience-in-virtual-agent-api.md)**  
Enable Now Assist experience in Virtual Agent API to support generative AI skills across multiple provider channels.
-   **[Enable premium chat experience in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/va-api-enable-premium-chat.md)**  
Enable premium chat experience in Virtual Agent API to support generative AI skills across multiple provider channels.
-   **[Configure multiple provider applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/configure-multiple-provider-applications.md)**  
...
-   **[Transform Virtual Agent API request and response](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/transform-virtual-agent-api-request-and-response.md)**  
...
-   **[Enable synchronous support in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/virtual-agent-api-enable-synchronous-support.md)**  
You can support synchronous mode for your conversation with primary bot.
-   **[Virtual Agent bot-to-bot integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/bot2bot.md)**  
...
-   **[Closing idle bot-to-bot conversations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/va-b2b-open-conversation.md)**  
...
-   **[Controls in Virtual Agent API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/va-api-controls.md)**  
