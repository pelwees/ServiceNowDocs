...
![Dialog box with block and allow buttons, and message from anonymized website requesting to know user's location.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/allow-or-block-location-info.png "User permission prompt")
...
For information about how Virtual Agent uses AI Search, see [Improving the user experience with AI Search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/va-ai-search.md). To learn more about Virtual Agent chat experiences and how to configure them, see [Customizing a Virtual Agent chat experience](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../concept/va-conversation-settings.md).
