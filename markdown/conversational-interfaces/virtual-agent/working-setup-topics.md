...
**Note:** Setup topics in conversations are discoverable \(via topic discovery\) only when they're [configured in a Virtual Agent chat experience](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/configure-default-chat-experience.md) using the **Custom Greetings and Setup** option. If any setup topics are not included in a chat experience, those setup topics are not listed in the chat window's All Topics menu \(topic picker\) and cannot be discovered by Virtual Agent.
...
Anything Else Topic. Virtual Agent asks users if they need further assistance.
 ...
 ![Anything else topic in Virtual Agent web client.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/setup-va-anything-else.png)
...
Live Agent Support. Tells users that a live agent transfer is in process:
 ...
 ![Live agent topic presented in Virtual Agent web client.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/setup-va-live-agent.png)
...
Error Handling Topic. Displays a generic error message to the user when the Virtual Agent encounters a problem that it can't resolve \(unrecoverable system error\) and transfers the user to a live agent.
 ...
 ![The Virtual Agent chat window displays, "An recoverable error has occurred. Please stand by while I connect you to a live agent."](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-error-transfer.png)
...
Greetings. Starts a conversation by greeting users and giving them the option to enter a request or see the items that the Virtual Agent can assist with.
 ...
 ![Greeting topic in Virtual Agent web client.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/setup-va-greeting.png)
...
![Survey feedback choice list showing Good, Neutral, and Bad reply options.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-survey-choice-list.png "Example survey feedback choices")

 After the users provide their feedback, a message confirms that their feedback has been received:

 ![Survey feedback received.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/va-survey-feedback-received.png)
...
Closing Conversation. Displays a closing message to the user that ends the conversation:
 ...
 ![Closing topic in Virtual Agent web client.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/setup-va-closing.png)
...
-   Users indicate that the AI Search results aren't helpful.
 ...
 ![Error handling topic and live agent transfer triggered by an unrecoverable system error.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/fallback.png)
...
Virtual Agent Capabilities. Enables users to ask for assistance during a conversation and view a list of items that the Virtual Agent can assist with \(Virtual Agent capabilities\).
 ...
 ![Explore help topic presented in Virtual Agent web client.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/setup-va-capabilities.png)

</td></tr></tbody>
</table>-   **[Change text in the Show me everything button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/change-va-showme.md)**  
...
-   **[Hide or reveal the Show me everything button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/hide-reveal-showme-button.md)**  
...
-   **[Change the Virtual Agent greeting messages in the Greeting setup topic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/va-welcome-topic-selection-msgs.md)**  
...
**Parent Topic:**[Customizing a Virtual Agent chat experience](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/va-conversation-settings.md)
