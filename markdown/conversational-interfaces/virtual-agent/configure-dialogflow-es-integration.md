...
1.  [Create a service account and private key in Google Dialogflow ES](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/vad-create-srvc-acct-key-dialogflow.md)  
...
2.  [Generate a Java Keystore \(JKS\) file and configure security on your ServiceNow instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/vad-configure-dialogflow-security.md)  
...
3.  [Activate the Google Dialogflow ES service and enable it in your instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/activate-ggl-df-es-service.md)  
...
4.  [Test Virtual Agent with Google Dialogflow ES NLU in Virtual Agent Designer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/test-va-nlu-dialogflow.md)  
