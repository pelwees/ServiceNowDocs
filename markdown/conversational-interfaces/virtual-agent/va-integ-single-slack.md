...
-   **[Create a bot in Slack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/create-self-config-bot-slack.md)**  
You must create a self-configured bot in the targeted workspace in Slack to be able to integrate with the Virtual Agent.
-   **[Retrieve self-configured bot details](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/setup-slack-bot-snow.md)**  
Retrieve the details of the bot that you created in the Slack workspace to integrate with the ServiceNow instance.
-   **[Integrate your ServiceNow instance with a self-configured bot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/integ-slack-self-config-bot.md)**  
Add the self-configured bot to your ServiceNow instance to complete the integration with Slack.
-   **[Manage the self-configured bot integration with Slack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/manage-slack-self-bot.md)**  
...
-   **[Remove the self-configured bot integration with Slack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/remove-slack-self-config-integ.md)**  
Remove the self-configured bot integration from your ServiceNow instance to disassociate the Slack app.

**Parent Topic:**[Integrating ServiceNow Virtual Agent with Slack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/va-integ-slack.md)
