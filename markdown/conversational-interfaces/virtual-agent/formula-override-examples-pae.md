...
To create these groupings of the 12 end states, follow the instructions for [creating a formula override](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/set-up-custom-definitions-pae.md) and use the following script.
...
**Parent Topic:**[Create custom override definitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../task/set-up-custom-definitions-pae.md)
