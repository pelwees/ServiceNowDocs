...
![In Microsoft Teams, this notification shows the title "New Date/Time" and a date/time picker to schedule an appointment. When done, the user selects the Submit button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/notification-title-msteams.png "Notification with title")
...
![Start typing in the choice list to find the correct response. For example, start typing "s" to find the "Software" choice.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/virtual-agent/../images/msteams-type-head-option.png)
