...
5.  Select a voice personality.
    ...
    1.  Select the language your assistant will use as the default speaking language for interacting with the callers.
        ...
        -   Spanish
        -   Japanese
        See [Multilingual support for voice assistants](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../reference/multi-lingual-support-for-voice-assistants.md) for more information.
