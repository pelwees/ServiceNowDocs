...
![Chat bubble button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAVA-FAB.png "Example of the Now Assist in Virtual Agent standard chat widget button")

![Sparkle button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NASS-dynamic-window-FAB.png "Example of the Now Assist in Virtual Agent enhanced chat widget button")
...
![A synthesized response appears for an order a laptop prompt in the Now Assist tab.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-full-page-now-assist-tab-zp4.png "Example of the chat tab, labeled Now Assist, in the full-page experience")
...
Each Virtual Agent response includes a feedback icons panel. The feedback icons panel appears on the latest Virtual Agent response and whenever you hover over any previous Virtual Agent response. You can indicate if the response was helpful by selecting the like thumbs up icon \(![Thumbs up icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../virtual-agent/images/llm-thumbs-up-like.png)\). If the response wasn't helpful, select the dislike thumbs down icon \(![Thumbs down icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../virtual-agent/images/llm-thumbs-down-dislike.png)\). This feedback is used to train the LLM model and improve responses over time. Depending on the context of the response, an additional go to search results icon \(![Go to search results icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-search-result-icon.png)\) may appear in the feedback icons panel. This icon appears alongside synthesized responses in Virtual Agent, clarifying questions in Virtual Agent, and fallback topics whenever a synthesized response is unavailable but there are regular search results available. When the full-page experience is on and you select the go to search results icon \(![Go to search results icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-search-result-icon.png)\), you’re redirected to the **Search** tab. After redirecting to the **Search** tab, a search query using the last five chat utterances you entered begins.Additionally, a copy message icon \(![](../image/dw-feedback-copy-message-icon.png)\) appears on received Virtual Agent responses.
...
![Chat window controls include New Chat, Chats, Support, and Settings.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-full-page-now-assist-tab-figure-zp4.png "Example of chat controls")
...
1. Chats \(![Chats icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/list-hamburger-icon.png)\)

</td><td>

All chats appear.

 Chats are organized with the most recent conversations at the top. Selecting a chat opens the chat in the conversation area. If there are unread chats or notifications, a badge number appears on the Chats icon \(![Chats icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/list-hamburger-icon.png)\). Any unread chat or notification appears with a red dot next to it and the chat title appears in bold. Additionally, if you switch to a new chat while another active chat is ongoing, a pop-up message on the Chats icon \(![Chats icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/list-hamburger-icon.png)\) appears: `Your previous chat was saved. You can revisit all of your past chats and continue ones that are still active.` The following list includes the chat sections that you may see in the chats area.
...
3. New chat \(![New chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-new-chat-icon.png)\)
...
4. Support and settings \(![Support and settings icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../../reuse/icons/product-icons/ellipsis-vertical-outline-24.svg)\)
...
-   ![Request in Chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-bubble-icon.png) \(Request in Chat\)

    The ![Request in Chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-bubble-icon.png) \(Request in Chat\) icon opens the conversational catalog into a new chat.

-   ![Open in New Tab icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-open-new-tab-icon.png) \(Open in New Tab\)

    The ![Open in New Tab icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-open-new-tab-icon.png) \(Open a New Tab\) icon redirects you to either complete a catalog form or view content in a new tab.


![Order a laptop search results appear in the Search tab of the full-page experience.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-full-page-search-tab-zp4.png "Example of Search tab in full-page experience")
...
-   The portals search results page's synthesized response via chat icon \(![Request in Chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-bubble-icon.png)\) or Request in chat link from popover.
-   Notifications

</td><td>

-   Entering an utterance into the portal's search bar.
-   The go to search results icon \(![Go to search results icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-search-result-icon.png)\) from an enhanced chat's chat window response.
...
-   For more information on enhanced chat, see [Enhanced chat](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/nava-enhanced-chat.md).
