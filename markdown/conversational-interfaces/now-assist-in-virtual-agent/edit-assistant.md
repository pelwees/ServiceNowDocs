...
3.  From the Overview page, select the appropriate button or link to make your edits.
    ...
    ![Overview page when editing an assistant.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-edit-overview-122025.png "Overview page when editing an assistant")

    The main action buttons include:

    -   **Save**: Saves updates made to the assistant configuration.
    -   **Test assistant**: Test panel is an overlay. For more information about testing a chat assistant, see [Test a chat assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/test-assistant.md).
    ...
    2.  Customize assistant settings by selecting **Go to settings** link. For more information, see [Create a chat assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/create-assistant.md).
...
4.  From the **Information sources** tab, select the page that needs editing.
    ...
    ![Edit information sources of your assistant.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-edit-info-sources-122025.png "Edit information sources") ![]( "Edit information sources")
    ...
    -   In **Asset types**, add assets or migrate NLU topics. For more information, see [Add assets to a chat assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/add-assets.md).
...
5.  From the **Settings** tab, select the page that needs editing.
    ...
    ![Edit assistant settings.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-edit-settings-122025.png "Edit assistant settings")
    ...
    -   In **AI agent support**, you can prioritize AI agents during skills discovery. For more information, see [Use agentic support for a chat assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/use-agentic-support.md).
    ...
    -   In **Branding**, configure branding for standard, enhanced, or premium chat experiences. For more information, see [Brand an assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/brand-assistant.md).
    -   In **Chat features**, by default, all chat experiences except web search, are turned on. For more information, see [Enable additional chat features](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/additional-chat-features.md).
