...
![Voice dashboard page in Assistant analytics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice.png "Voice dashboard page in Assistant analytics")
...
-   **Percent voice conversations deflected**
    ...
    ![Percent voice conversations deflected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-percent-deflected.png "Percent voice conversations deflected")
...
-   **Total Deflected Conversations Over Time**
    ...
    ![Total deflected conversations over time screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-deflection-trend.png "Total deflected conversations over time")
...
-   **Total conversations**
    ...
    ![Total voice conversations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-total-conv.png "Total conversations")
...
-   **Total conversations over time**
    ...
    ![Total voice conversations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-conv-trend.png "Total conversations over time")
...
-   **AI voice agents in use**
    ...
    ![Total number of AI voice agents used by the assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-agents-active.png "AI voice agents in use")
...
-   **AI voice agents in use over time**
    ...
    ![Trend of AI voice agents invoked by the assistant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-agents-invocation-trend.png "AI voice agents in use over time")
...
-   **Conversations transferred to a live agent**
    ...
    ![Conversations transferred to a live agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-conv-live-agent.png "Conversations transferred to a live agent")
...
-   **Number of tickets created**
    ...
    ![Number of tickets created.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-tickets-created.png "Number of tickets created")
...
-   **Conversations disconnected**
    ...
    ![Conversations disconnected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-conv-disconnect.png "Conversations disconnected")
...
-   **Immediate live agent transfers**
    ...
    ![Immediate live agent transfers.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-immediate-transfers.png "Immediate live agent transfers")
...
-   **Inferred customer satisfaction \(CSAT\) score**
    ...
    ![Inferred customer satisfaction (CSAT) score.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-inferred-csat.png "Inferred customer satisfaction (CSAT) score")
...
-   **Average voice conversation duration**
    ...
    ![Average voice conversation duration.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-average-duration.png "Average voice conversation duration")
...
-   **50th percentile response time**
    ...
    ![50th percentile response time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-50th-response.png "50th percentile response time")
...
-   **90th percentile response time**
    ...
    ![90th percentile response time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-90th-response.png "90th percentile response time")
...
-   **99th percentile response time**
    ...
    ![99th percentile response time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-99th-response.png "99th percentile response time")
...
-   **Executions by tool type**
    ...
    ![Executions by tool type.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-tool-executions.png "Executions by tool type")
...
-   **50th percentile response time**
    ...
    ![Tool 50th percentile response time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-tool-50th-response.png "Tool 50th percentile response time")
...
-   **90th percentile response time**
    ...
    ![Tool 90th percentile response time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-tool-90th-response.png "Tool 90th percentile response time")
...
-   **99th percentile response time**
    ...
    ![Tool 99th percentile response time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-tool-99th-response.png "Tool 99th percentile response time")
...
-   **AI voice agent summary**
    ...
    ![Deflection by AI agent.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-voice-number-deflect.png "AI voice agent summary")
