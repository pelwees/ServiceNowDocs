...
![Type-ahead portal search for what is spam.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-portal-typeahead-zp4.png "Example of type-ahead portal search")
...
When you're using enhanced chat and you enter a search query through your portal's search bar, you’re redirected to the portal's search results page. At the top of the search results page, you see Genius Results in a synthesized response generated by Now Assist. This synthesized response answer provides inline citations that appear at the end of each sentence. You can select citations and if applicable, such as for conversational catalog items, select whether to ![Request with form icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-open-new-tab-icon.png)**Request with form** or ![Request in chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-bubble-icon.png)**Request in chat**. Similar options also appear in the regular search results area, as indicated by the request in chat icon \( ![Request in chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-bubble-icon.png)\) and request with form icon \(![Request in form icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-open-new-tab-icon.png)\). Depending on your selection, the catalog request flow launches within either the Virtual Agent chat or a form.

![A synthesized response appears at the top of the search results after a search query for request laptop was made.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-synthesized-response-search-bar.png "Example of enhanced chat synthesized response on the portal's search results page")
...
![Portal search page results with entry points into chat.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-syntheszied-response-search-bar-request-variations.png "Example of chat entry points on the portal's search results page")

![Chat widget button on portal.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-widget-button-portal.png "Example of a chat widget button")
...
-   ![Expand icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-expand-icon.png): Selecting the expand icon ![Expand icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-expand-icon.png) expands the chat into a 90% screen-size window. The 90% screen-size window can’t be resized or moved. Selecting outside of the 90% screen-size chat window resizes the chat back into the floating window.
-   ![Pinned right-hand side icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-pin-icon.png): Selecting the pin icon ![Pinned right-hand side icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-pin-icon.png) pins the chat to the side of the browser but you can still resize this window to fill half the browser, if desired. When you duplicate a browser tab, open a new tab, or use the browser back button, the chat window state persists as long as you have not minimized the chat.
...
-   ![Down-arrow minimize icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-minimize-icon.png): Selecting the down arrow ![Down-arrow minimize icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-minimize-icon.png) minimizes the chat and the chat widget button reappears.

![Enlarged chat window to take up 90% of the screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-90-modal-yp6.png "Example of a 90% screen-size window")

![Pinned chat window to the right-hand side of the screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-pinned-yp6.png "Example of a pinned chat")
...
![Chat window controls include New Chat, Chats, Support, and Settings.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-controls-yp6.png "Example of chat controls")
...
If Now Assist Guardian is enabled and your request contains profane content, the Virtual Agent responds with a message prompting you to re-enter an appropriate request without profanity or offensive content.If your request is too ambiguous on the portal search, a synthesized response appears along with an **Ask a follow up** option. Selecting the **Ask a follow up** option redirects you to a Virtual Agent chat. In the Virtual Agent chat, you can submit your follow-up question or request, but the synthesized response links are only available to select on the portal page and are unavailable to select in the chat window. If your follow-up question or request is too ambiguous in the Virtual Agent chat, Virtual Agent asks a clarifying question and displays the go to search results icon \(![Go to search results icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-search-result-icon.png)\) in the feedback panel.

![Ask a follow up from the portal's synthesized response leads to a Virtual Agent chat where you can enter additional content.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../virtual-agent/images/enhanced-chat-ask-follow-up-example.png "Example of Ask a follow up in Virtual Agent")
...
![Catalog confirmation card appears in the chat.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-catalog-order-confirm-yp6.png "Example of summary card for catalog order in chat")

## Topic, subflows, or actions citations

These assets are associated with the chat icon \(![Request in chat icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-chat-bubble-icon.png)\) and if selected, that flow begins within Virtual Agent. The popover is not applicable to these types of assets.

## Q&amp;A Knowledge Base citations

The answer is shown with the option to view your sources through the numbered inline citations icon \(![Numbered citations icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAVA-citations-icon.png)\) and in the **Show sources** section. These Knowledge Base inline citations show which ServiceNow knowledge articles were used to generate the response.
...
![Knowledge base article source and popover.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/nass-dw-kb-citation-popover-yp6.png "Example of Knowledge Base inline citation, popover, and Show sources expanded")

## External content connections citations

The answer is shown with the option to view your sources through the numbered inline citations icon \(![Numbered citations icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAVA-citations-icon.png)\) and in the **Show sources** section. If external search sources are added to your information sources when [Configuring assistants overview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../task/configure-now-assist-va.md), you can search through external content connections. This can include information from attachments and knowledge blocks, or from the following list of content connections:
...
![People popover card appears when selecting Lucius Bagnoli and presents information about Lucius.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NASS-dw-people-citation-hover-card-yp10-zp4.png "Example of people citation's popover")
...
![Example conversation.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-kg-nlq-view-records.png "Example of extended entities and view records")

## Chatting with a live agent in Virtual Agent

You can chat with a live agent if you need more support. Select the **Contact Live Agent** button found in the Support and settings \(![Support and settings icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../../reuse/icons/product-icons/ellipsis-vertical-outline-24.svg)\) option, enter a request such as `Chat with live agent` into the chat, or select the **Request a live agent** fallback option. After an agent has accepted your chat, the agent's name and avatar appears at the top of the chat in a banner. Only one live agent chat at a time is permitted. To exit the live chat, select **End live chat**. The chat history then moves to the Closed chat section.

**Note:** When enhanced chat is turned on, post-chat surveys only appear after a live agent conversation has ended.

![End live chat button appears in a banner at the top of the chat.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-end-live-chat-yp6.png "Example of the live chat banner")

## Fallback options

**Note:** For more information about where and how to enable fallback options, see [Manage an assistant chat experience](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../task/manage-assistant-chat-experience.md).
...
![Search the web and Create a generic ticket buttons are fallback options for end users.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-web-search-fallback-example.png "Example of multiple fallback options")
