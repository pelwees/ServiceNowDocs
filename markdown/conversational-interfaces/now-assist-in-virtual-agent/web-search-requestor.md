...
![Web search mode providing results and including in-line citations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-web-search-example.png "Example of enhanced chat's web search mode")

![Web search mode providing results and including in-line citations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/standard-chat-web-search-example.png "Example of standard chat's web search mode")
...
![Search the web button is a fallback option for end users.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/dw-web-search-fallback-example.png "Example of enhanced chat's search the web fallback option")

**Note:** When entering web search via the Start web search icon \(![Start web search icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../dynamic-translation/image/Globe.png)\), the prior conversational history is blanked out. When entering web search via the fallback **Search the web** option, only the last query prior to entering web search mode is taken into account.

To exit out of web search mode and return to internal search results, do one of the following:

-   Enter `Exit`.
-   Select the End web search icon \(![End web search icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../dynamic-translation/image/Globe.png)\).
