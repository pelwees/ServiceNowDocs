...
![Sentiment dashboard page in Assistant analytics.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment.png "Sentiment dashboard page in Assistant analytics")
...
-   **Overall Sentiment**
    ...
    ![Overall Sentiment.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-overall.png "Overall Sentiment")
...
-   **Conversations Analyzed**
    ...
    ![Conversations Analyzed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-conv-analyze.png "Conversations Analyzed")
...
-   **High Empathy Rate**
    ...
    ![High Empathy Rate.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-high-empathy.png "High Empathy Rate")
...
-   **Conversations with Negative Emotions**
    ...
    ![Conversations with Negative Emotions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-conv-neg-emotions.png "Conversations with Negative Emotions")
...
-   **Average Inferred CSAT Over Time**
    ...
    ![Average Inferred CSAT Over Time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-avg-csat.png "Average Inferred CSAT Over Time")
...
-   **Transfers and Escalations Over Time**
    ...
    ![Transfers and Escalations Over Time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-transfer-time.png "Transfers and Escalations Over Time")
...
-   **Average Inferred CSAT \(Virtual Agent\)**
    ...
    ![Average Inferred CSAT (Virtual Agent).](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-avg-csat-virtual-agent.png "Average Inferred CSAT (Virtual Agent)")
...
-   **Average Inferred CSAT \(Live Agent\)**
    ...
    ![Average Inferred CSAT (Live Agent).](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-avg-csat-live-agent.png "Average Inferred CSAT (Live Agent)")
...
-   **Average Inferred CSAT \(Session\)**
    ...
    ![Average Inferred CSAT (Session).](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-avg-csat-session.png "Average Inferred CSAT (Session)")
...
-   **Assistant Recommended Next Steps**
    ...
    ![Assistant Recommended Next Steps.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-assistant-steps.png "Assistant Recommended Next Steps")
...
-   **Conversation Insight Inferred Resolution State**
    ...
    ![Conversation Insight Inferred Resolution State.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-conv-state.png "Conversation Insight Inferred Resolution State")
...
-   **Empathy Levels Distribution Over Time**
    ...
    ![Empathy Levels Distribution Over Time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-empathy-levels.png "Empathy Levels Distribution Over Time")
...
-   **Negative Emotion Feedback Over Time**
    ...
    ![Negative Emotion Feedback Over Time.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../image/NAinVA-assistant-designer-analytics-sentiment-negative-emotion.png "Negative Emotion Feedback Over Time")
