...
![Fully streamed response example showing six lines of text before the Show more link and Sources section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/now-assist-in-virtual-agent/../../now-assist-in-va/image/nava-streamed-full-message.png "Example of a standard chat streamed synthesize response fully loaded")
