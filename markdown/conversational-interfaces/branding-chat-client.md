...
-   **Colors and fonts**
    ...
    ![UI features in the chat window include the logo, menu icon, avatar, bot bubble, timestamp, chat background, user bubble, etc.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/../image/chat-window-labels.png "UI items in the chat window")
...
-   **Chat menu items**
    ...
    ![The chat menu includes the menu title, menu icon, menu label, and a toggle switch to enable audible alerts.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/../image/support-menu-callouts.png "Chat menu")
...
-   **[Create a new user for a branded bot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/../task/ci-create-new-branded-bot.md)**  
...
-   **[Set up your Virtual Agent bot's branding](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/../task/ac-configure-chat-branding.md)**  
