...
For more information, see [Components installed with Agent-initiated messaging interface](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/conversational-interfaces/agent-chat/../reference/installed-with-agent-init-messg.md).
