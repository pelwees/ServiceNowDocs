...
You can configure the properties for the IsNullOrWhiteSpace component. For more information about these components, see [Properties of the String Utilities components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/util-stringutil-prop.md).
