...
For more information on using a UAC, see [Use the Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/configure-uac.md).
...
![UIA and AA modes appear when you capture an element in Windows application screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-capture-elements-both-modes.png "Modes in Capture element")

For more information about capturing an element in the Windows application, see [Use the Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/configure-uac.md).
...
![UI Automation and Active Accessibility modes appear when you select Show Elements option from the Windows application screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-show-elements-both-modes.png "Modes in Show Elements options")
...
-   **[Use the Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/configure-uac.md)**  
...
-   **[Use the Click method for Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-click-method-uac.md)**  
Use the Click method to perform a click action on an element.
-   **[Use the GetValue method for Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-getvalue-method-uac.md)**  
Use the GetValue method to retrieve a value from an element.
-   **[Use the SetValue method for Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-setvalue-uac.md)**  
Use the SetValue method to assign a specified value into an element.
-   **[Use the Start method for Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-start-method.md)**  
...
-   **[Use the WaitForAnyScreen method for Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-the-wait-for-any-screen-method.md)**  
...
-   **[Find the elements on the application screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/find-elements-screen-uac.md)**  
...
-   **[Additional options for application screens and elements in Universal App Connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/contextmenu-application-screens.md)**  
...
-   **[Methods of UI Automation mode and Active Accessibility mode](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/uac-windows-uia-aa-methods.md)**  
