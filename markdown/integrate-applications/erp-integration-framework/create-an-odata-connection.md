...
4.  Create a system with the HTTP connection.
    ...
    For more information, see [Create an ERP system in Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/create-an-erp-system.md).
...
6.  Create a model and, after saving, open the model record.
    ...
    For more information, see [Create a model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erpc-add-new-data-model.md).
...
10. Select **Select entity**.
    ...
    2.  In **Select service**, search for and select a service, for example **API\_BUSINESS\_PARTNER \(Remote API for business partner\)** in the OData service catalog.
        ...
        If you cannot find the service you need, see [Add a service manually in Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erp-add-a-service-manually.md).

    3.  In **Select the endpoints**, search for and select an endpoint, for example **A\_BusinessPartnerType**.

        ![Add entity modal with OData service and endpoint specified.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../image/erp-create-odata-conn1.png)
...
11. Select **Specify inputs** to check the information and edit as needed.
    ...
    For more information, see [Manage input parameters for a Zero Copy Connector for ERP model operation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erpc-manage-model-inputs.md).
...
15. Check the heartbeat and retrieval status until they're successful.
    ...
    ![ERP system record with HTTP heartbeat status and OData retrieval status highlighted.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../image/erp-create-odata-conn2.png)
...
18. Select **Select entity**.
    ...
    4.  Select **Add entity** and wait for retrieval to complete.
        ...
        ![Add entity form with type, service, and endpoint specified.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../image/erp-create-odata-conn3.png)
