...
3.  To view the logs, navigate to **All** &gt; **Zero Copy Connector for ERP** &gt; **Open Debug Logs**.
    ...
    For details about the columns in debug logs, see [Zero Copy Connector for ERP debug logs field descriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../reference/erp-canvas-debug-logs-columns.md).
