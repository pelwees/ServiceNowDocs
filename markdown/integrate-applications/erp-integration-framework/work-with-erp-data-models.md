...
For more information, see [Managing how models read and update the ERP system](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erpc-managing-models-read.md).

-   **[Zero Copy Connector for ERP content packs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erp-canvas-content-packs.md)**  
...
-   **[View and edit the foundation of ERP models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/view-and-work-with-erp-data-models.md)**  
...
-   **[Using model versioning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erp-use-model-versioning.md)**  
...
-   **[Clone an ERP model in Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erp-canvas-clone-data-model.md)**  
...
-   **[Create a model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erpc-add-new-data-model.md)**  
...
-   **[Export and import custom models in Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erpc-export-and-import-custom-models.md)**  
...
-   **[Managing how models read and update the ERP system](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erpc-managing-models-read.md)**  
...
-   **[Add an operation to a model in Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erpc-manage-models-read-op.md)**  
...
-   **[Set operation-level security on a model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erp-canvas-set-operation-level-security-on-a-model.md)**  
Control access to model operations with user roles and groups.
-   **[Add an entity to a model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/add-an-entity-to-model.md)**  
...
-   **[Add joins between ERP tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erp-canvas-add-join-data-model.md)**  
...
-   **[Manage input parameters for a Zero Copy Connector for ERP model operation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erpc-manage-model-inputs.md)**  
...
-   **[../task/erpc-manage-model-inputs-rest.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erpc-manage-model-inputs-rest.md)**  

-   **[Choose output parameters for a model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erp-canvas-manage-outputs.md)**  
...
-   **[../task/erp-canvas-manage-outputs-rest.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erp-canvas-manage-outputs-rest.md)**  

-   **[Edit input and output mapped value name in Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/erp-edit-mapped-value-name-in-model-manager.md)**  
...
-   **[Specifying where ERP system data is saved](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/erpc-call-response-data.md)**  
...
-   **[Debug Zero Copy Connector for ERP models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/debug-zero-copy-connector-for-erp-models.md)**  
...
**Parent Topic:**[Using Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/work-with-erp-systems-connections-and-remote-tables.md)
