...
For process details, see [Monitor Zero Copy Connector for ERP transactions and logged errors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../task/monitor-erp-data-hub-logged-extraction-and-remote-lookup-transactions.md).
