...
2.  Open the Remote tables page by selecting the remote tables icon ![](../image/erpc-remote-table-icon.png) in the side panel.
    ...
    ![Remote tables list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../image/erpc-remote-tables-list.png)
...
5.  Edit the remote table details as needed.
    ...
    For a description of the field values, see [Zero Copy Connector for ERP remote table form field descriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../reference/erp-canvas-remote-table-descriptions.md).
