...
5.  In the **Clone this model** modal, enter the new **ERP model name**.
    ...
    ![Clone this model modal.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../image/erpc-clone-model.png)
...
7.  Change information about the cloned model on the **Details** tab, such as updating the name.
    ...
    **Warning:** Changing the ERP system connected to the ERP model affects the available remote tables and extraction tables. If you change the ERP system, you must confirm the change on a warning modal.
    ...
    For a description of the field values, see [Zero Copy Connector for ERP clone model field descriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-integration-framework/../reference/erp-canvas-clone-model-fields.md).
