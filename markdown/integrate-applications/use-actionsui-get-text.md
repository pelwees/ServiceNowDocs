...
The properties of the Get Text component are common with other Actions UI components, to configure these properties, see [Properties of Actions \(UI\) components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/properties-actions-ui-components.md).
...
3.  In the Get Text component, click the camera icon \(![Camera icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/camera-icon.png)\).
...
6.  Drag the green plus icon \(![Green plus icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/green-plus-icon.png)\) to the area in the captured image where you want to capture the text.
...
8.  Capture one or more alternate images by doing the following actions:
    ...
    5.  Drag the green plus icon \(![Green plus icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/green-plus-icon.png)\) over the captured image and place on the location where you want the component to perform an action.
...
![Extract a line of text from a window and display with the Show component.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/Actionc_GetText.PNG)
