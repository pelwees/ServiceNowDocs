...
For information about setting up the spoke, see [Set up the Microsoft SCCM spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../../integrationhub-store-spokes/task/set-up-sccm.md#).
...
To set up the MID Server for this spoke, see [Set up MID Server for a spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../../integrationhub-store-spokes/task/config-adv-mid-settings-for-oauth-on-mid.md).
