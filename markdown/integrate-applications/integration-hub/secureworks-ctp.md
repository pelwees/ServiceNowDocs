...
For information about setting up the spoke, see [Set up the Secureworks CTP spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-secureworks-ctp.md#).
