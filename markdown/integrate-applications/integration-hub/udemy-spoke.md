...
For information about setting up the spoke, see [Set up the Udemy spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-udemy-spk.md#).
