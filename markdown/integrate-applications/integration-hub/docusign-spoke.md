...
-   You can choose to set up the Docusign spoke using [authorization code grant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-docusign-authorization-code.md#) or [JWT grant](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-docusign-jwt.md#).
...
-   Your company may have a Docusign account for each department that uses Docusign. To use multiple accounts with this spoke, create a child alias for each account. Also, ensure that you override the base alias with the child alias in your flows. At runtime, the system identifies the child alias associated with the account and sends the correct connection and credential information in the request.
    ...
    -   For more information about child alias and overriding the base alias, see [Supporting multiple connections](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../../integrationhub/concept/support-multiple-connections.md).
    -   For information about setting up multiple accounts, see [Create child aliases for additional Docusign accounts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/create-aliases-docusign.md).
