...
3.  For **WS-Security Username Profile**, select the security username profile you had created for the Workday Financials spoke.
    ...
    See [Create a WS-Security Username Profile for the Workday Financials spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-workday-fin-spoke.md#) for more information.
...
2.  Navigate to Search and enter `Register API Client for Integrations` task. ![Search for Register API client for integrations in Workday account](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wkdy-fin-reg-api-client-integ.png)
...
-   [Generate client ID and client secret for Workday Financials spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-workday-fin-spoke.md#)
-   [Generate token URL for Workday Financials spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-workday-fin-spoke.md#)
-   Role required: admin
...
1.  Calculated field 1:
    1.  Create increment and decrement type calculated field named **CF\_Last\_functionally\_updated\_-1**.
        ...
        ![Calculated field named CF_Last_functionally_updated_-1.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-1.PNG)
    ...
    2.  Create Lookup Value As Of Date type calculated field named **cf\_assigned\_to\_worker\_previous** and use **CF\_Last\_functionally\_updated\_-1** in this field.
        ...
        ![Calculated field named cf_assigned_to_worker_previous.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-2.PNG)

2.  Calculated field 2:
    1.  Create text constant type calculated field named **Cf\_text\_0**.

        ![Calculated field named Cf_text_0.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-3.PNG)

    2.  Create text constant type calculated field named **CF\_Text\_as\_1**.

        ![Calculated field named CF_Text_as_1.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-4.PNG)

    3.  Create true/false condition type calculated field named **cf\_competed\_by\_is\_not\_equal\_old\_assignee**.

        ![Calculated field named cf_competed_by_is_not_equal_old_assignee.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-5.PNG)

    4.  Create evaluate expression calculated field named **CF\_EE\_Completed\_by\_admin\_exist\_as\_old\_Assignee\_or\_not**.

        ![Calculated field named CF_EE_Completed_by_admin_exist_as_old_Assignee_or_not.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-6.PNG)

3.  Calculated field 3:
    1.  Create text constant type calculated field named **CF\_Text**.

        ![Calculated field named CF_Text.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-7.PNG)

    2.  Create Lookup related value type calculated field named **CF\_Action\_Event**.

        ![Calculated field named CF_Action_Event.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-8.PNG)

    3.  Create Concatenate text type calculated field named **CF\_inbox\_SUbject**.

        ![Calculated field named CF_inbox_SUbject.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-9.PNG)

4.  Calculated field 4:
    1.  Create text constant type calculated field named **CF\_url**.

        ![Calculated field named CF_url.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-10.PNG)

    2.  Create Lookup related value type calculated field named **CF\_business\_pro\_transaction**.

        ![Calculated field named CF_business_pro_transaction.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-11.PNG) ![]()

    3.  Create Lookup related value type calculated field named **CF\_BP\_Wid**.

        ![Calculated field named CF_BP_Wid.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-12.PNG)

    4.  Create Concatenate text type calculated field named **CF\_Inbox\_url**.

        ![Calculated field named CF_Inbox_url.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-13.PNG)

5.  Calculated field 5:
    1.  Create Lookup related value type calculated field named **cf\_step\_id**.

        ![Calculated field named cf_step_id.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-14.PNG)

    2.  Create Lookup related value type calculated field named **CF\_subject\_id**.

        ![Calculated field named CF_subject_id.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-15.PNG)

    3.  Create Lookup related value type calculated field named **CF\_subject\_and\_step\_id**.

        ![Calculated field named CF_subject_and_step_id.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-16.PNG)

6.  Calculated field 6: Create Lookup related value type calculated field named **CF\_sent\_back**.

    ![Calculated field named CF_sent_back.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-17.png)
...
7.  Calculated field 7:
    1.  Create Lookup related value type calculated field named **CF\_Business Process Definition on Action Event**.
        ...
        ![Calculated field named CF_Business Process Definition on Action Event.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-18.PNG)
    ...
    2.  Create Lookup related value type calculated field named **Cf\_parent\_business\_process\_definition** and use **CF\_Business Process Definition on Action Event** in it.
        ...
        ![Calculated field named Cf_parent_business_process_definition.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-19.PNG)

8.  Calculated field 8:
    1.  Create increment and decrement type calculated field named **CF\_Last\_updated\_on-1**.

        ![Calculated field named CF_Last_updated_on-1.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-20.PNG)
    ...
    2.  Create Lookup Value as of date type calculated field named **cf\_status\_as\_of\_moment** and use **CF\_Last\_updated\_on-1** in this field.
        ...
        ![Calculated field named cf_status_as_of_moment.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-21.PNG) ![]()

9.  Calculated field 9: Create Lookup Value as of date type calculated field named **CF\_Action\_Event**.

    ![Calculated field named CF_Action_Event.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-22.PNG)
...
10. Calculated field 10: Create Lookup Value as of date type calculated field named **CF\_worker** and use **CF\_Action\_Event** as lookup field.
    ...
    ![Calculated field named CF_worker.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-23.PNG)

11. Calculated field 11: Create True/False condition type calculated field named **CF\_Awaiting\_person\_is\_ISU**.

    ![Calculated field named CF_Awaiting_person_is_ISU.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-24.PNG)
...
6.  Ensure that the temporary report option is cleared and click **Ok**.
    ...
    ![Create the report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-25.PNG)

7.  Select the report business object and report fields.

    ![Select the required fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-26.PNG)

    ![Select the required fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-27.PNG)
...
8.  In Group column heading section, select all business objects.
    ...
    ![Select the business objects.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-28.PNG)

9.  In the **Filter** section, select the value as shown and ensure that you add parenthesis.

    ![In the Filter section, select the required values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-29.PNG)

    ![In the Filter section, select the required values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-30.PNG)

    ![In the Filter section, select the required values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-31.PNG)

    ![In the Filter section, select the required values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-32.PNG)

10. In prompt section, clear the **Populate Undefined Prompt Defaults** check box.

    ![Clear the Populate Undefined Prompt Defaults check box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-33.PNG)
...
11. Select the value of prompts in the **Prompt Defaults** section.
    ...
    ![Select the value of prompts in the Prompt Defaults section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-34.PNG) ![Select the value of prompts in the Prompt Defaults section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-35.PNG) ![Select the value of prompts in the Prompt Defaults section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-36.PNG) ![Select the value of prompts in the Prompt Defaults section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-37.PNG) ![Select the value of prompts in the Prompt Defaults section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-38.PNG)
...
13. After report configuration is done, click the three dots icon and navigate **Web Service** &gt; **View URLs**.
    ...
    ![Click View URLs.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-39.png)

14. Select the required date time range in below parameters and click **OK**.

    ![Select the required date time range.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-40.PNG)

15. In View URLs Web Service page, click the marked icon under **CSV** section.

    ![Click the marked icon in the CSV section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-41.png)
    ...
    ![RaaS URL of the report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-to-do-42.PNG)
...
6.  Clear the **Temporary Report** check box and click **OK**.
    ...
    ![Create the RPT_ledger_account report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-1.PNG)

7.  Select the report business object and report fields.

    ![Select the report fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-2.PNG)

8.  In **Filter** section, select the value as shown and ensure that you add parenthesis.

    ![Select the required values in the Filter section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-3.PNG)

9.  In prompt section, clear the **Populate Undefined Prompt Defaults** check box.

    ![Clear the Populate Undefined Prompt Defaults check box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-4.PNG)

10. Select the value of prompts in the Prompt default section.

    Ensure that the **Label For Prompt XML Alias** of all prompt fields must be same as shown.

    ![Verify the Label For Prompt XML Alias values.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-5.PNG)
...
12. After report configuration is done, click the three dots icon and navigate **Web Service** &gt; **View URLs**.
    ...
    ![Click View URLs.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-6.png)

13. Select the required date time range in below parameters and click **OK**.

    ![Select the required date time range.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-7.PNG)

14. In View URLs Web Service page, click the marked icon under the **CSV** section.

    ![Click the marked icon under the CSV section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-8.png)
    ...
    ![RaaS URL of the report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-led-acct-9.PNG)
...
6.  Clear the **Temporary Report** check box and click **OK**.
    ...
    ![Create the CR Payment status report report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-1.PNG)

7.  Select the report business object and report fields.

    ![Select the required fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-2.PNG)

    ![Select the required fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-3.PNG)
...
9.  In **Filter** section, select the value as shown and ensure that you add parenthesis.
    ...
    ![Select the required values in the Filter section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-5.PNG)

10. In prompt section, clear the **Populate Undefined Prompt Defaults** check box.

    ![Clear the Populate Undefined Prompt Defaults check box.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-6.PNG)

11. Select the value of prompts in the Prompt default section.

    Ensure that the **Label For Prompt XML Alias** of all prompt fields must be same as shown.

    ![Value of prompts in the Prompt default section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-7.PNG)

12. In the Advanced section, select **Enable as webservice** option and click **OK**.

13. After report configuration is done, click the three dots icon and navigate **Web Service** &gt; **View URLs**.

    ![ClickView URLs.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-8.png)

14. Select the required date time range in below parameters and click **OK**.

    ![Select the required date time range.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-9.PNG) ![]()

15. In View URLs Web Service page, click the marked icon under **CSV** section.

    ![Click the marked icon under CSV section.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-10.png) ![]()
    ...
    ![RaaS URL of the report.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/wd-fin-pat-st-11.PNG)
