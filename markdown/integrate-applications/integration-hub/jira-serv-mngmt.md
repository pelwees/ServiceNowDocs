...
For information about setting up the spoke, see [Set up the Jira Service Management spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-jira-serv-mgmt.md#).
