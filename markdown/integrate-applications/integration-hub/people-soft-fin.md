...
For information about setting up the spoke, see [Set up the Oracle Peoplesoft Financial spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-pplsoftfin-spoke.md).
