...
For information about setting up the spoke, see [Set up the Azure Application Insights spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-msazure-app-insight.md#).
