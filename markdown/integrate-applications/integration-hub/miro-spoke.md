...
For information about setting up the spoke, see [Set up the Miro spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-miro.md#).
