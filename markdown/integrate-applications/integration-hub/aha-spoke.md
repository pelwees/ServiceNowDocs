...
For information about setting up the spoke, see [Create an Aha! OAuth2 application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/create-aha-oauth2-authentication.md) and [Set up ServiceNow instance for Aha!](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-servicenow-instance-to-authorize-aha.md).
