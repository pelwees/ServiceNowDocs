...
-   If the MID Server is installed on a Linux machine, perform the configurations as outlined in [Set up the SAP S4 HANA RFC spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-saphana-rfc.md).
