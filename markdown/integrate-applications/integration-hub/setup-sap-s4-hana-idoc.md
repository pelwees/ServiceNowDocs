...
**Note:** To retrieve information, use the Execute RFC spoke action in the [SAP S4 HANA RFC Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../concept/sap-s4hanarfc-spoke.md).
