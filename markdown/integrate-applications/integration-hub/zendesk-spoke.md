...
Permanently deletes the specified user from an account.Before you can permanently delete the user, you must first delete the user using the [Delete User](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/zendesk-spoke.md#delete-user) action.
...
For information about setting up the spoke, see [Set up the Zendesk spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-zendesk.md#).
