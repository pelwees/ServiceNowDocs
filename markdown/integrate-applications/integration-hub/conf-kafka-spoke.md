...
For information about setting up the spoke, see [Set up the Confluent Kafka REST Proxy spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-kafka-spoke.md).
