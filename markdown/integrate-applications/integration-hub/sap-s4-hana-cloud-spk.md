...
For information about setting up the spoke, see [Setup the SAP S4 HANA Public Cloud spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-sap-s4hana-cloud-spk.md).
