...
For information about setting up the spoke, see [Set up Jenkins spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/set-up-jenkins-v1.md#).
