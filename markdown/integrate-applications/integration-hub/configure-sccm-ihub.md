...
-   **[Configure the Application Administrator role on the SCCM server](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/csd-conf-sccm.md)**  
...
-   **[Update the SCCM cmdlet libraries](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/csd-cmdlet-lib.md)**  
Ensure that the System Center Configuration Manager SCCM Cmdlet Library is up-to-date.
-   **[Configure the MID Server for SCCM activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/csd-mid-sccm.md)**  
...
-   **[Create Connection and Credential alias for SCCM deployments](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/create-win-credentials-ihub.md)**  
...
-   **[Retrieve SCCM data for client software distribution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/retrieve-sccm-data-ihub.md)**  
Retrieve the collections and the list of applications available for deployment from your SCCM servers.
-   **[Set up a software model for an SCCM application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/csd-sw-model.md)**  
...
-   **[Define an SCCM configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/csd-sccm-collections.md)**  
...
-   **[Create a catalog item for an SCCM application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/create-cat-item-ihub.md)**  
