...
For information about setting up the spoke, see [Set up the Google Cloud Pub Sub Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-google-pubsub.md#).
