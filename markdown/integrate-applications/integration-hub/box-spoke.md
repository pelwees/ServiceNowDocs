...
-   In your ServiceNow instance, select the required language by navigating to **User Profile** &gt; **Preferences** &gt; **Display**.
    ...
    ![Set language in ServiceNow instance.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/servicenow-language.png)

-   In your Box account, select the required language by navigating to **Account Settings** &gt; **Account** &gt; **General Options**.

    ![Set language in Box account.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/box-language.png)
...
The Box spoke requires creating a custom app on your Box account to generate OAuth 2.0 tokens. See [Create an OAuth application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-box-spoke.md#).
