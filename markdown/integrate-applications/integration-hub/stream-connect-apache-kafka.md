...
![Diagram showing an overview of Stream Connect components.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/stream-connect.png "Stream Connect overview")
...
When you [Configure an Extract Transform Load \(ETL\) consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-etl-consumer.md), [Configure a Transform Map consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-transform-map-consumer.md), or [Configure a script consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-script-consumer.md), you also need to [Create a Kafka stream](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/create-kafka-stream.md).
...
For more information, see [Stream Connect Message Replication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/stream-connect-message-replication.md).
...
![Diagram showing Stream Connect components and how they relate to Kafka, ServiceNow, and the Hermes Messaging Service.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/stream-connect-architecture.png "Stream Connect architecture diagram")
...
![Stream Connect example import diagram.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/sc-example-import.png)
...
-   **Guidance**
    -   Define topics with a naming convention to clearly direct the processing of the messages. For example, if the data is coming from a Solarwinds monitoring tool source, the topic might be named sn\_streamconnect.solarwinds. Topics can be found in the navigator under **Hermes Messaging Service** &gt; **Topics**.
        ...
        ![Stream Connect example screenshot that shows a Kafka topic named sn_streamconnect.solarwinds.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/sc-example-name.png)
    ...
    -   Utilize a Script Consumer or Flow Trigger Consumer for the ingest of transactional data. Following the example, the script consumer could be named similarly, such as “Solarwinds script consumer”. Script consumers can be found in the navigator under **IntegrationHub** &gt; **Consumers** &gt; **Script Consumers**.
        ...
        ![Stream Connect example screenshot showing a Kafka script consumer record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/sc-example-script.png)
    ...
    -   The script consumer script parses the message content to identify what device the message was related to and processes it accordingly.
        ...
        ![Stream Connect example screenshot showing code creating a ServiceNow Event table record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/sc-example-code.png)
...
-   **[Stream Connect Message Replication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/stream-connect-message-replication.md)**  
Replicate data between your Apache Kafka environment and ServiceNow.
-   **[Stream Connect alerting](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/stream-connect-alert.md)**  
Receive alerts and alert notifications for Stream Connect integrations.
-   **[Using the Stream Connect Dashboard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/stream-connect-dashboard.md)**  
...
-   **[Schema management in Stream Connect](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/schema-management.md)**  
Import and create schemas to send and receive messages in an Apache Avro format. Using an Avro format can reduce the size of the payload and simplify your integration to your local Kafka instance.
-   **[Configure an Extract Transform Load \(ETL\) consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-etl-consumer.md)**  
Import and process data from your Kafka environment using your existing Robust Transform Engine \(RTE\) configurations.
-   **[Configure a Transform Map consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-transform-map-consumer.md)**  
Import and process data from your Kafka environment using your existing transform map configurations.
-   **[Configure a script consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-script-consumer.md)**  
Use a script to import and process data from your Kafka environment.
-   **[Create a Kafka stream](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/create-kafka-stream.md)**  
...
-   **[Viewing Kafka subscriptions and statistics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/kafka-subscriptions-statistics.md)**  
...
-   **[Viewing producer statistics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/producer-statistics.md)**  
...
**Parent Topic:**[Importing and streaming data in Integration Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/importing-streaming-data-ih.md)
