...
For information about setting up the spoke, see [Set up the AWS Certificate Manager spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-aws-cert-manager.md#).
