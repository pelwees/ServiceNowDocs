...
For information about setting up the spoke, see [Set up the Guidewire spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/set-up-guidewire-spoke.md#).
