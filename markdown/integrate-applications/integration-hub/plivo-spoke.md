...
For information about setting up the spoke, see [Set up the Plivo spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/plivo-setup.md#).
