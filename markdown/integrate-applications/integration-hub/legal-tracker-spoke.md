...
For information about setting up the spoke, see [Set up the Legal Tracker spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-legal-tracker-spoke.md#).
