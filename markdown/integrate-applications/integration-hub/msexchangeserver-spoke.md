...
For information about setting up the spoke, see [Set up the Microsoft Exchange Server spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-msexchange.md#).
