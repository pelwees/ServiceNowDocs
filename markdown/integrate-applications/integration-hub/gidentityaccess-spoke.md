...
For information about setting up the spoke, see [Set up the Google Identity and Access Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-gidentityaccess.md#).
