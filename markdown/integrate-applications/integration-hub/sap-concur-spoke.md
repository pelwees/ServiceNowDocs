...
-   SAP Concur API user with these roles:
    ...
    -   Invoice User
    ![SAP Concur API user roles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/sap-concur-user-roles.png)

-   SAP Concur API user with these Expense API and Invoice User permissions.

    ![Expense API permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/sap-concur-expense-prms.png)

    ![Invoice API permissions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/sap-concur-invoice-prms.png)
...
|Module|Description|
|------|-----------|
|SAP Concur Expense Entries|View details of the expense entries. After you [Set up the SAP Concur spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-sapconcur-spk.md) and map the users in the SAP Concur User Mappings module, the system retrieves details of the expense entries and populates in this module.|
...
|SAP Concur Expense Reports|View the expense reports. After you set up the [Set up the SAP Concur spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-sapconcur-spk.md) and map the users, the system retrieves details of the expense reports and populates in this module.|
...
For information about setting up the spoke, see [Set up the SAP Concur spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-sapconcur-spk.md).
