...
For information about setting up the spoke, see [Set up the Amazon S3 spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/setup-amazon-s3.md#).
