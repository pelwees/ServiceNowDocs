...
![Diagram showing Stream Connect producers and consumers and how they connect to a Kafka environment, described as the "customer site", through the Hermes Messaging Service.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/stream-connect-architecture.png "Stream Connect producers and consumers")
...
4.  And [Use the ETL and Transform Map consumers to import data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/stream-connect-quick-start.md#). ETL definitions and transform maps specify the transformation logic to use when pulling data through scheduled imports. You can use the same ETL definitions and transform maps to transform the events received through Kafka.
    ...
    **Note:** To use the ETL consumer, you need a [robust import set transformer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../../import-sets/concept/robust-import-set-transformers.md). Likewise, to use the Transform Map consumer, you need a [transform map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../../../script/server-scripting/concept/c_CreatingNewTransformMaps.md).
...
-   The second part of this section shows you how to use the Script consumer to consume messages. For more information, see [Configure a script consumer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/configure-script-consumer.md).
...
2.  Create a flow trigger to consume messages from the topic.
    ...
    4.  In the trigger section, select **Add a trigger**, then select **Kafka Message** as the trigger type.
        ...
        ![Kafka Message is the trigger type for the flow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/select-kafka-trigger.png)

    5.  Select the Topic1 topic.

        ![Select topic1 for the Topic field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/select-kafka-topic.png)
    ...
    9.  Drag the **Payload** data pill to the **Message** field, then select **Done**.
        ...
        ![Topic1 Consumer flow trigger.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/add-log-action.png)
    ...
    12. Create a new entry and enable reporting to the flow created above.
        ...
        ![Creating a new Setting record to enable reporting for the flow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/enable-flow-reporting.png)
    ...
    14. To view your topic subscription, navigate to **All** &gt; **Integration Hub** &gt; **Stream Connect** &gt; **Subscriptions**.
        ...
        ![The subscription for the topic1 topic.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/topic1-subscription.png)
...
3.  Publish messages to the topic using the Kafka command-line tool.
    ...
    2.  Navigate back to the flow and select **Executions**.
        ...
        ![Select Executions to navigate to the flow execution view.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-flow-executions.png)

    3.  Open the flow execution.

        ![Execution details for the flow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-flow-details.png)
    ...
    4.  To view the statistics for this subscription, navigate to **All** &gt; **Integration Hub** &gt; **Stream Connect** &gt; **Subscriptions**, open the subscription, and go to the statistics view.
        ...
        ![The Kafka statistics for the subscription.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-flow-statistics.png)
...
4.  Create a Script consumer to consume messages from the topic.
    ...
    4.  Set the script to log the message by adding the following logic in the script box.
        ...
        ![Kafka script consumer showing the script in the Event consumer field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-script-example.png)
    ...
    7.  On the Kafka Stream form, set the following field values.
        ...
        ![The Kafka Stream record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-stream-example.png)
    ...
    9.  To view the messages, navigate to **All** &gt; **System logs** &gt; **System log** and filter messages that start with Received message.
        ...
        ![List of the received messages.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/received-messages-example.png)
...
2.  Create an ETL Consumer to consume data from the topic.
    ...
    6.  Set the **Column mapping** to **Label**.
        ...
        ![The Kafka ETL Consumer form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-consumer-example.png)

    7.  Save the form.

    8.  [Create a Kafka stream](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/create-kafka-stream.md) for the consumer.
    ...
    10. Select the **Activate** link under Related Links.
        ...
        ![Example Kafka Stream form for topic2.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-stream-topic2.png)
...
3.  Publish messages to topic2.
    ...
    3.  Navigate back to the ETL Consumer you created.
        ...
        ![The Kafka Consumer form with the Import sets tab filled in.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-consumer-import.png)

    4.  To view detailed information about the import set, select the import set number.

        ![Detailed view of the import set.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-import-set.png)

    5.  To view detailed information about an import set row, select the import set row number.

        ![Detailed view of the import set row](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-import-row.png)
...
4.  Create a Transform Map Consumer to consume data.
    ...
    4.  For the **Transform Map** field, select an existing transform map.
        ...
        ![The Transform Map Consumer form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/transform-map-consumer.png)

    5.  Save the form.

    6.  [Create a Kafka stream](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../tasks/create-kafka-stream.md) for the consumer.
    ...
    8.  Select the **Activate** link under Related Links.
        ...
        ![Kafka Stream form for the Transform Map Consumer with subscription information.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/transform-map-stream.png)
...
2.  Publish messages from the instance using a flow step.
    ...
    4.  Add a **Kafka Producer** step to the action.
        ...
        ![Add the Kafka Producer step to the action.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/add-kafka-producer-step.png)
    ...
    6.  In the **Message** field, enter a message.
        ...
        ![Fill in the fields for the Kafka Producer step.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../images/kafka-producer-step-fields.png)
