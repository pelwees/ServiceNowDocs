...
8.  Copy these two values to a text file so that you can use them when you [Register Google Cloud DNS as an OAuth provider](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/setup-gcloud-dns.md#).
...
5.  On the form, fill these values.
    ...
    ![Credential record for the Google Cloud DNS spoke.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/gcloud-dns-cred.png)
