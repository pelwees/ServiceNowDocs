...
4.  Right-click on the banner of the record and select **Save**.
    ...
    ![Save button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/oracle-hcm-spoke-upload-jks-file.png)

5.  Select the **Manage Attachments** icon \(![Manage Attachments icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/manage-attachments-icon.png)\) to attach the Java KeyStore file.
    ...
    1.  In the filter field of your instance, enter `sys_properties.LIST` and press **Enter**.
        ...
        ![Filter field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/oracle-hcm-spoke-troubleshooting.png)

    2.  In the Name field of the System Properties page, enter `glide.security.file.mime_type.validation` and press **Enter**.

        ![Name field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/oracle-hcm-spoke-system-property.png)
