...
5.  Locate the **AD\_v2** connection alias and click **View Details**.
    ...
    ![Configure connection and credentials for Microsoft Active Directory v2.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/click-add-connection-ad-v2.png)

    If you are configuring the spoke for the first time, click **Configure**. Otherwise, click **Edit**

    ![Configure the default alias.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/configure-def-alias-adv2.jpg)
...
6.  Enter the following details in the form.
    ...
    ![Configure connection form.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../image/create-connection-form.png "Create connection form")
