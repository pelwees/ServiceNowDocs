...
For information about setting up the spoke, see [Set up the Workday Learning spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/integration-hub/../task/wd-learning-setup.md#).
