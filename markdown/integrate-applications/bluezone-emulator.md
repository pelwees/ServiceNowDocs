...
2.  Select **Configure**.
    ...
    ![Configure option that you navigated to in Step 1.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-connector-right-click-object.png)

3.  On the Terminal Connector window, select **Bluezone**.

    ![BlueZone emulator option selection in the Terminal Connector window.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-conn-bluezone-selection.png)

    **Tip:** To load a BlueZone emulator screen that doesn't appear in the list, select the refresh icon \(![Screen refresh icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/connector-refresh-icon.png)\).

4.  Capture a BlueZone emulator screen.

    1.  In the BlueZone list, select a BlueZone Mainframe emulator screen.

        ![BlueZone emulator session selection.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-conn-bluezone-screen-selection.png)
    ...
    2.  Select **Add Screen**.
        ...
        ![BlueZone emulator screen added in the terminal Connector window and Project Explorer.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-conn-bluezone-screen-added.png)
...
5.  Capture an element from the BlueZone emulator screen.
    ...
    1.  Right-click the screen that you have captured and select **Add Element**.
        ...
        ![Add Element option for BlueZone screen.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/PCOMM-capture-element.png)
    ...
    2.  In the TERMINAL PREVIEW screen, move your mouse device to the element that you want to capture.
        ...
        ![BlueZone emulator screen field information.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/PCOMM-emulator-text-info.png)
    ...
    3.  Add the element as a single field by right-clicking the element and selecting **Add as Field**.
        ...
        ![Mainframe screen field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-conn-mainframe-field.png)
    ...
    4.  Add fields after selecting them in a tabular format.
        ...
        ![Field selection. For the text description, refer to the text that follows this example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-conn-fields-as-table.png)
    ...
    5.  In the context dialog box, enter the name of the field or table in the **NAME** field.
        ...
        ![Context dialog box that shows the POSITION, LENGTH, and NAME fields.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/terminal-connector-context-dialog.png)

    6.  Select the Add Field icon ![Add field icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/add-element-icon-RPA.png).
    ...
    7.  Close the **TERMINAL PREVIEW** screen by selecting **OK**.
        ...
        ![Text field added in the Screens and elements pane under the TerminalSession_0 object.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/PCOMM-text-field-added.png)
...
[Rocket BlueZone emulator methods](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/bluezone-emulator-methods.md)
