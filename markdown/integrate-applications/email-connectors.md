...
![Infographic for using the Email connector. For the text description, refer to the text that follows.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/email-automation-example.png "Example automation using the Email connector")
...
-   For information about using connectors in RPA Desktop Design Studio, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-connector.md).
-   For information about making connector methods visible in RPA Desktop Design Studio, see [Use connector method](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-connector-method.md).
-   To learn how to use connector methods, see [Use a component in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/configure-components.md).

-   **[Email connector methods](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/email-connector-methods.md)**  
...
-   **[Email method properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/email-method-properties.md)**  
