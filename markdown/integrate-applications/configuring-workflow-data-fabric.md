...
1.  Install other required Workflow Data Fabric applications that aren’t already installed.
    ...
    |-----------|------|----|
    |Zero Copy Connectors|\(sn\_data\_fabric\_zcc\) and \(sn\_data\_fabric\)|[Configuring Zero Copy Connectors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../zero-copy-connectors/concept/configuring-zcc.md)|
    |Workflow Data Fabric Credits|\(sn\_wdf\_token\)|[Workflow Data Fabric Credits](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../create-integrations-apps/concept/credits.md#)|
...
2.  Install the Connect Hub \(sn\_wdf\_connect\_hub\) store application. The applications listed in the table are installed automatically with Connect Hub and enable the Workflow Data Fabric experience.
    ...
    For more information, see [Install Workflow Data Fabric Home store applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/install-workflow-data-fabric.md).
...
3.  Configure the Now Assist for Workflow Data Fabric \(WDF\) \(sn\_nowassist\_wdf\) plugin. Create a ServiceNow Product Documentation connector and activate the flow generation skill to enable full AI agent capabilities.
    ...
    For more information, see [Configure Now Assist for Workflow Data Fabric \(WDF\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/configure-now-assist-for-workflow-data-fabric.md).
...
4.  Assign Workflow Data Fabric roles to users to control access to features, capabilities, and data in Workflow Data Fabric Home.
    ...
    For more information, see [Assign roles to Workflow Data Fabric Home users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/assign-roles-to-wdf-users.md).
