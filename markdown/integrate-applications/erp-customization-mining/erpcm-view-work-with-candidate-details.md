...
Additional information about the candidate.
    ...
    For more information, see [Check candidate recommendations in ERP Semantic Mining](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/erpcm-work-with-recommendations.md).
...
5.  View details about tables relevant to the candidate and the ERP system scan details by selecting the **ERP scan results** tab.
    ...
    For a description of the field values, see [ERP Semantic Mining candidate scan results field descriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/../reference/erpcm-candidate-scan-results-descriptions.md).
...
8.  Research candidates related to the current candidate and their tables by selecting the **Similar candidates** tab.
    ...
    For a description of the field values, see [ERP Semantic Mining similar candidates field descriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/../reference/erpcm-similar-candidates-field-descriptions.md).
...
-   [Check candidate recommendations in ERP Semantic Mining](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/erpcm-work-with-recommendations.md).
-   [Save potential candidates to replatform](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/erpcm-find-candidates.md).
-   Continue building remote table and extraction tables in the relevant ERP model in Zero Copy Connector for ERP, making the data available on the ServiceNow AI Platform. For more information, see [Using Zero Copy Connector for ERP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/../../erp-integration/concept/work-with-erp-systems-connections-and-remote-tables.md).
