...
6.  View the information for each task and note actions that you must take by scrolling to the task list.
    ...
    For a description of the field values, see [ERP Semantic Mining task list field descriptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/erp-customization-mining/../reference/erpcm-task-list-details.md).
