...
Install the Unattended Robot. For more information, see [Install Unattended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/install-rpa-runtime.md).

Install the Unattended Robot Login Agent. For more information, see [Install Unattended Robot Login Agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/install-rpa-runtime-login-agent.md).

If you are selecting **mTLS** as the type of the authentication in the following task, install a user certificate, if you have the admin role. For more information, see [Install the user-generated certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-core/concept/use-user-certificates-rpa.md#).

For high density robots, ensure that the following requirements are met:

-   Set up the environment for high density robots on a Windows Server machine. For more information, see [Set up Windows Server machine for high density robots](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/setup-windows-server-hdr.md).
-   Familiarize yourself with high density robots concepts. For more information, see [High density robots in Unattended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../concept/high-density-robots-uat.md) and [High density robots in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-hub/concept/high-density-robots-rpa-hub.md).
...
1.  From your desktop, to open the Unattended Robot, do either of the following tasks:
    ...
    -   Double-click the Unattended Robot icon \(![Unattended Robot icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/rpa-robot-runtime-desktop-icon.png)\).
    -   In the notification area \(system tray\) in the taskbar, select and hold \(or right-click\) the Unattended Robot icon \(![Unattended Robot icon in the notification area.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/rpa-robot-runtime-desktop-icon.png)\) and select **Settings**.
...
You must set up Windows server for high density robots. For more information, see [Set up Windows Server machine for high density robots](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/setup-windows-server-hdr.md).
...
Perform the following actions to select a certificate:1.  Select the three-dot menu \(![Three-dot menu.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/rpa-runtime-run-three-dot-menu.png)\) next to the **Certificate** field.
...
Run an unattended robot to execute the unattended bot process. For more information, see [Run an automation using Unattended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/run-rpa-robot.md).

**Related topics**  


[Install the user-generated certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-core/concept/use-user-certificates-rpa.md#)
