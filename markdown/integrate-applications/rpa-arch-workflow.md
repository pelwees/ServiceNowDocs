...
![High-level architecture of the Robotic Process Automation Hub application.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/rpa-hub-architecture.png "High-level architecture of the Robotic Process Automation (RPA) Hub application")
