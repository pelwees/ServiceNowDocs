...
-   Enable the latest versions of the ServiceNow RPA Edge Extension and the ServiceNow RPA Chrome Extension. To enable, see [Add the ServiceNow RPA Chrome extension](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-hub/task/add-google-chrome-extension-rpa.md) and [Add the ServiceNow RPA Edge extension](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/add-servicenow-edge-extension.md).
-   Ensure you have installed the Chromium plugin on the RPA Desktop Design Studio. To install, see [Manage plugins in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/install-plugins-rpa-studio.md).
-   To use the Chromium connector, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-connector.md).
-   To configure the Google Chrome connector, see [Configure the Chromium connector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/configure-chrome-connector.md).
...
-   **[Use the Capture element dialog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-context-dialog.md)**  
Identify and capture the elements on a web-based, Java, or Windows application screen by using the Capture element dialog.
-   **[Chromium connector methods](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/connectors-chrome-methods.md)**  
...
-   **[Add the ServiceNow RPA Edge extension](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/add-servicenow-edge-extension.md)**  
