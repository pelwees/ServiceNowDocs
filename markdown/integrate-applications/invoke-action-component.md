...
3.  On the Design surface, select the Configure button ![Configure icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/component-settings-icon.png) of the InvokeAction component to show the InvokeAction dialog box.
