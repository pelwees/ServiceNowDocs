...
To create an activity manually, see [Create and use an activity in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/configure-activity-rpa-studio.md).
...
1.  In the Project Explorer pane of RPA Desktop Design Studio, navigate to **Activities**.
    ...
    ![Main activity is displayed in the RPA Desktop Design Studio when a new project is initiated.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/example-activity-screen.png "Example: Activity in RPA Desktop Design Studio")

2.  In the Project Explorer pane, right-click **Activities** and select **New activity using Now Assist**.

    ![RPA Desktop Design Studio user interface that shows the New activity using the Now Assist option.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/create-activity-now-assist-rpa.png "Create an activity using Now Assist")
...
3.  In the New activity window, enter the Now Assist instructions.
    ...
    ![New activity window that shows the instructions that are used by Now Assist to generate an automation workflow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/new-activity-directions.png "Example: New activity window")
...
5.  In the New Activity window, regenerate a preview, clear a workflow, cancel an automation, or add an activity.
    ...
    **Note:**
    ...
    ![New activity window displays the options to regenerate a preview, clear a workflow, cancel an automation, or add an activity.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/new-activity-options.png "Example: New activity options")
...
![Generated automation workflow that is displayed on the design surface.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/activity-now-assist-last-screen.png "Example: Automation workflow on the design surface")
...
For more actions on the activity, see [Create and use an activity in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/configure-activity-rpa-studio.md).
