...
You can configure the properties for the AttendedConfigurations component. For more information about these properties, see [Properties of the Forms components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/sn-forms-properties.md).
...
4.  Select one or more applicable attended configurations.
    ...
    ![Select attended configurations.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/attended-config-forms-studio.png "Example: Select attended configurations")
