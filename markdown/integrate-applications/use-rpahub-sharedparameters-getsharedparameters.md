...
Set multiple shared parameters and associate multiple bot processes on the RPA Hub. For more information, see [Create a shared parameter in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-hub/task/create-shared-parameter.md) and [Assign a bot process to a shared parameter in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-hub/task/assign-botprocess-shared-parameter.md).
...
You can configure the properties for the GetSharedParameters component. For more information about these properties, see [Properties of the shared parameters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/properties-rpahub-shared-parameters.md).
...
**Parent Topic:**[Shared Parameters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../concept/shared-parameters.md)
