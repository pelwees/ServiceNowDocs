...
1.  [Download Attended Robot from RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-hub/task/download-installer-rpa.md).
...
2.  [Install Attended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/install-rda-runtime.md)

    You can install the Attended Robot application in your Windows machine if you have the admin role.

3.  [Set up Attended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/set-up-rda-runtime.md)

    Establish a connection between the Attended Robot and the ServiceNow RPA Hub instance.

4.  [Connect to an RPA Hub instance from Attended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/connect-rda-instance-rpa.md)
