...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the Fivetran collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/prepare-to-run-fivetran-collector.md).
...
**Parent Topic:**[Fivetran metadata collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../concept/fivetran-metadata-collector.md)
