...
To use the custom probe activities, you must [request activation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../task/t_ActivateAnActivityPack.md) of the Orchestration - Probe plugin.
