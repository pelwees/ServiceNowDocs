...
![Authentication error message](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/AuthenticationErrorMsg.png "Authentication error message")

**Parent Topic:**[PowerShell protocols and troubleshooting](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../reference/powershell-protocols.md)
...
4.  Attempt to create the object.
    ...
    **Note:** The majority of the return codes listed in the MID Server log for this error are **1**s and **3**s. This is because the Active Directory activities use the ADSI provider and not WMI or WinRM. An error code of **1** means the account was able to connect with the test account, but running the script failed.
    ...
    ![Sample error code of 1](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/ErrorCode1.png)
    ...
    ![Sample error code of 3](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/ErrorCode3.png)
...
3.  Create a user using the `New-mailbox` Exchange commandlet.
    ...
    ![Creating a new user in Exchange](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/ExchangeCommandConsole.png "Creating a new user in Exchange")
...
![Authentication failure error message](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/AuthenticationErrorMsg.png "Authentication failure error message")
...
![MID Server error code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/MIDServerErrorCode.png "MID Server error code")
