...
1.  Drag output variables from an activity in this tab into the inputs of another activity on the workflow canvas to link the activities together.
    ...
    ![Reusing output variables from the data tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/WorkflowDataTab.png)
...
2.  Point to an activity to display information about it in a pop-up window.
    ...
    ![Databus output information screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/DatabusPop-up.png)
