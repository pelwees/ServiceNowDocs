...
</table>2.  You can add more widgets to the dashboard by clicking the **Add Content** icon \(![Add Content icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../../../use/homepages/image/AddContent.png)\) in the upper right corner of the dashboard.
