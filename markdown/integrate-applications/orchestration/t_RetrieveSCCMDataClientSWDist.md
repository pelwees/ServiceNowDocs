...
-   [Configure a user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/t-config-SCCM-deployment-manager.md) with the Application Deployment Manager role on the SCCM server.
...
5.  Open the new SCCM record and click **Discover now** under **Related links**.
    ...
    ![SCCM server instance record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/SCCMServerInstance.png "Retrieving SCCM data with Discovery")


**Parent Topic:**[Configuring SCCM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../concept/configuring-sccm.md)
...
Users run the **Discover SCCM** workflow from an [SCCM Server Instance record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/t_RetrieveSCCMDataClientSWDist.md#) to populate the following ServiceNow tables:
...
</table>**Note:** For details about the custom activities used in this workflow to extract data from an SCCM server, see [Orchestration SCCM activity pack](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../../../administer/orchestration-activities/concept/c_SCCMActivityPack.md).
