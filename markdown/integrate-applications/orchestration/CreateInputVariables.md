...
1.  Click the **+** icon to create a new input variable.
    ...
    ![Creating an input variable](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/InputsNewVariable.png)
...
6.  To delete a variable, click the delete icon \(![delete icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/DeleteVar.png)\) in the row.
...
1.  To map a variable, drag it into the appropriate field.
    ...
    ![Mapping input variables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/InputsMapping.png)
...
1.  Drag variables from the list of inputs and drop them into command fields.
    ...
    ![PowerShell execution command](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/PowershellExecutionCommand.png "PowerShell execution command")
...
1.  Click **Test Inputs**.
    ...
    ![Test value for input variable](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/TestDesignerSOAPInputValues.png)
...
4.  When your test values are configured correctly, click **OK**.
    ...
    ![Response payload from inputs test](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/TestDesignerSOAPInputsResponse.png "Response payload from inputs test")

5.  To map appropriate parameter values in the payload to variables in the **Outputs** stage automatically, select an [auto-mapping option](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/automap-output-variable-inputs.md).
