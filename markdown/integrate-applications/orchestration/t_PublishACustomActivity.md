...
3.  Click the menu icon in the title bar and select **Versions** from the context menu.
    ...
    ![The version history displays information about who checked out the activity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../image/CustomActivityVersions.png)
