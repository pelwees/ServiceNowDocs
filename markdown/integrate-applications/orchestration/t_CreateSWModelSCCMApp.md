...
3.  To link to an existing model, click the magnifying glass icon in the **Model** field and select a model from the list.
    ...
    ![SCCM application record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/orchestration/../../../administer/integrationhub/images/SCCMApplicationRecord.png "SCCM application record")
