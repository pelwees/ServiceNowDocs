...
-   **[Use the Number component](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-random-number-component.md)**  
Generate any random number between two integers by using the Number component in RPA Desktop Design Studio.
-   **[Use the Password component](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-utilities-random-password.md)**  
Generate any random password by using the Password component in RPA Desktop Design Studio.
-   **[Use the String component](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-utilities-random-string.md)**  
Generate a random string by using the String component in RPA Desktop Design Studio.
-   **[Properties of the Random components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/properties-random-component.md)**  
