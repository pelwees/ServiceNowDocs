...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the PostgreSQL collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/prepare-to-run-postgresql-collector.md).
...
**Parent Topic:**[PostgreSQL metadata collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../concept/postgresql-metadata-collector.md)
