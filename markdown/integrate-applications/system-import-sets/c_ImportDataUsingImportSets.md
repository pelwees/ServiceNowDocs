...
-   **[Create a data source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/c_CreateNewDataSource.md)**  
Create a data source record to define what data an import set should import.
-   **[Data source fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../reference/r_DataSourceFileTypeFields.md)**  
...
-   **[Mapping options](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../../../script/server-scripting/concept/c_MappingOptions.md)**  
...
-   **[Create a field map](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../../../script/server-scripting/task/t_CreatingAFieldMap.md)**  
Field maps establish a relationship between a field in an import set table and a field in the target table.
-   **[Field map script variables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../reference/r_FieldMapScriptVars.md)**  
...
-   **[Importing date/time values](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/importing-date-time-values.md)**  
Considerations when importing data containing date/time values.
-   **[Review the import set](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../task/t_ReviewTheImportSet.md)**  
...
-   **[Viewing the import log](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../../managing-data/concept/c_ViewingTheImportLog.md)**  
The import log is where you can find information about the internal processing that occurs during an import operation.
-   **[Import run history](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../reference/r_ImportRunHistory.md)**  
...
-   **[Monitor concurrent import sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../task/monitor-concurrent-import-sets.md)**  
...
-   **[Monitor concurrent import set jobs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../task/monitor-concurrent-import-set-jobs.md)**  
Check the status of concurrent import set jobs.
-   **[Post CSV or Excel files directly to an import set](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../task/t_PostCSVOrExcelFilesToImportSet.md)**  
An administrator can post CSV or Excel files directly to instance.
-   **[Delete import sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../task/delete-import-sets.md)**  
Delete import sets to clean up your database on a scheduled basis, one time only, or on demand.
-   **[Delete import set tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../task/delete-import-set-tables.md)**  
