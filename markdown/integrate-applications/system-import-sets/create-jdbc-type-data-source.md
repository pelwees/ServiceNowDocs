...
For additional information, see [JDBC type data source](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../reference/r_JDBCTypeDataSource.md#).
...
Connection alias to use to connect to this data source. For additional details, see [Create an import connection alias](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/system-import-sets/../reference/r_JDBCTypeDataSource.md#).
