...
-   All per-requisite tasks are completed. For more information, see [Prepare to run the Oracle collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/prepare-to-run-oracle-collector.md#).
