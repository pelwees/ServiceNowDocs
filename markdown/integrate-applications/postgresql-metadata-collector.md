...
-   **[Prepare to run the PostgreSQL collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/prepare-to-run-postgresql-collector.md)**  
Create a PostgreSQL user and configure permissions before running the collector.
-   **[Create a PostgreSQL metadata collector](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/create-postgresql-metadata-collector.md)**  
