...
If user certificates are generated by your organization, then you can skip this procedure. You can proceed with [installing the user certificate.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md#)
...
2.  Select the ![Plus icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/icon-plus-user-cert-rpa.png) icon.
...
5.  In the Custom Extended Key Usage dialog box, select the ![Plus icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/icon-plus-user-cert-rpa.png) icon.

6.  In the Add Custom Extended Key Usage dialog box, in the Object Identifier field, enter `1.3.6.1.5.5.7.3.2 clientAuth`.

![Add Custom Extended Key Usage dialog box with Client Auth value selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/add-custome-key-usage-rpa.png)
...
Install the generated client authentication and code signing certificate. For more information, see [Install the user-generated certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md#).
...
Generate a client authentication and a code signing certificate. For more information, see [Generate a user certificate from KeyStore Explorer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md#).
...
Add the user to manage private keys. For more information, see [Add user to manage private keys](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/use-user-certificates-rpa.md#).
...
-   To set up the Unattended Robot. For more information, see [Set up Unattended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-runtime/task/set-up-rpa-runtime.md).
-   To publish an automation project in RPA Desktop Design Studio. For more information, see [Publish an automation project in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-studio/task/publish-automation-project.md).
