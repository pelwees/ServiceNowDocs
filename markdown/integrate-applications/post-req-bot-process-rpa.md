...
-   **[Associate a credential group to a bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/map-credential-groups-to-bot-process.md)**  
Enable a robot to perform an automation in RPA Hub by mapping a credential group to an unattended bot process.
-   **[Assign a robot to a bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/assign-robots.md)**  
Assign a robot to an unattended bot process to execute the automation \(package\) that is mapped to it.
-   **[Assign a process robot credential within a bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/assign-process-robot-cred-botprocess.md)**  
...
-   **[Create a schedule within a bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/create-schedule-botprocess.md)**  
...
-   **[Create a process parameter within a bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/create-process-parameter-botprocess.md#)**  
...
-   **[Assign an attended user or group to an attended bot process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/assign-rda-users-botprocess.md)**  
...
-   **[Unassign an attended user or group from an attended bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/unassign-rda-users.md)**  
Unassign an attended user or a group from an attended bot process if the user is moving out of the business process.
-   **[Create a process field parameter in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/create-process-field-param-rpa.md)**  
Define process field parameters \(dynamic parameters\) that are required in the automation \(bot process\).
-   **[c to the bot process from the related list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/associate-queue-botprocess.md)**  
...
-   **[View skill package versions in a bot process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/view-skill-package-version-bp.md)**  
...
-   **[Override a skill version for a bot process in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/override-skill-version-rpahub.md)**  
...
**Parent Topic:**[Configuring a bot process record in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/create-botprocess.md)
