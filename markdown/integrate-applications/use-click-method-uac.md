...
8.  After selecting the required element, select the Add Element icon \(![Add Element icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/add-element-icon-RPA.png)\) and select the mode as **UIA**, to capture the element
    ...
    **Note:** You must add at least one element to continue.
    ...
    For example, select the button element by selecting the Login button.![The Badge Tool application shows Capture element dialog that captures the Login button in UIA mode. This button can be added as an element using the Add element button.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-click-button-capture.png)
...
9.  In the Configure screens and elements window, right-click the captured element, choose **Select** and select **Done**.
    ...
    **Note:** Select at least one element to perform the action. If none are selected, the action won't be executed. To proceed without selecting, select **OK**.
    ...
    ![Configure screens and elements window displaying the Select option on an element level.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-click-select-element.png)

10. Right-click the Click method and select either **Run From Here** or **Run This**.

    In this scenario, the captured element "Login" button is clicked and the next screen appears.![The captured element "Login" button is clicked and the next screen appears.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-click-final-result.gif)
