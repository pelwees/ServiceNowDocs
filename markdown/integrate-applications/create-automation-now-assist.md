...
To create an automation project manually, see [Create an automation project manually](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/create-automation-project.md).
...
2.  In the Build an automation window, select the **Build with Now Assist** option.
    ...
    ![Build an automation window that displays Build with Now Assist and Build manually options to start creating automations. The Build with Now Assist option is selected.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/start-build-now-assist-rpa.png "Build with Now Assist")
...
4.  In the Build with Now Assist window, enter the Now Assist instructions.
    ...
    ![Build with Now Assist window that shows the instructions that are used by Now Assist to generate an automation workflow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/build-now-assist-example.png "Build with Now Assist window")
...
6.  In the Build with Now Assist window, regenerate a preview, clear the workflow, stop creating an automation, or select next if you like the automation preview.
    ...
    **Note:** You can’t make any changes In the Automation preview screen because it’s read-only. You can maximize it and use the scroll options to view the entire generated automation workflow.
    ...
    ![Build with Now Assist window displays options to regenerate a preview, clear the workflow, stop creating an automation, or select next if you like the automation preview.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/text-bot-preview-options.png "Build with Now Assist options")
...
If the automation preview looks good, select **Next**.
    ...
    ![Create new automation window that displays a form so that you can fill in the automation information for the generated workflow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/create-new-automation-now-assist.png "Create new automation window")
...
Location of the automation project or the default location.
    ...
    **Important:** The automation is generated by Now Assist. Be sure to check it for accuracy and make any edits before running.
    ...
    ![Generated automation workflow that is displayed on the design surface.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/now-assist-automation-legal-notice.png "Automation workflow on the design surface")
