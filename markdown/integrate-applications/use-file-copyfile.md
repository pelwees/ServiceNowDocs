...
You can configure the properties for the CopyFile component. For more information about these properties, see [Properties of the File components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/util-file-prop.md).
...
3.  To configure the input fields, see by doing the following steps.
    ...
    3.  Enter details for the following fields, [Configure port properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/configure-input-port-properties.md).
