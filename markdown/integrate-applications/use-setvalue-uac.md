...
9.  In the Configure screens and elements window, right-click the captured element, choose **Select** and select **Done**.
    ...
    **Note:** Select at least one element to perform the action. If none are selected, the action won't be executed. To proceed without selecting, select **OK**.
    ...
    ![Configure screens and elements window displaying the Select option on an element level.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-set-value-select-element.png)
...
String
    ...
    The input value is displayed in the captured element. In this scenario, ServiceNow is displayed in the **User Name** Field.![ServiceNow displayed in the captured element that is the User Name field.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/uac-set-value-final-result.png)
