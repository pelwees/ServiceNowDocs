...
Proceed from the **Select a spoke** section. For information on selecting a spoke, see [Select a spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/automation-center/select-spoke.md).
...
1.  Select an action.
    ...
    If you want to create a new action, select **Create action**. For detailed information, see [Creating an action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/automation-center/../concept/creating-action.md).
