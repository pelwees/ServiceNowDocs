...
6.  Select an instance where you want to migrate the automations.
    ...
    For information on how to configure an instance, see [Configure an instance for migration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/automation-center/../task/config-instance.md).
...
-   **[Configure an instance for migration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/automation-center/../task/config-instance.md)**  
