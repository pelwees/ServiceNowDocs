...
Custom message that describes the insight.For example, `Time to Cleanup Automation Tasks. The count is {0}.`
 ...
 To configure the variable, such as \{0\}, see [Write a script for an automation message variable](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/automation-center/../task/create-message-variable-auto-center.md).
