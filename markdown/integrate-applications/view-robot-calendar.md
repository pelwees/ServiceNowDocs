...
View events in the calendar for a particular day. See the following example for a snapshot of the Robot calendar view.![Example: Snapshot of the Robot Calendar view for a day, October 20, 2022.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/day-rc-rpa.png "Example: Snapshot of the Robot calendar view for a day (October 20, 2022)")
...
View events in the calendar for a particular week. The week view starts from Sunday to Saturday. The default first day of the week is Sunday. See the following example for a snapshot of the Robot calendar view.This is the default view of the robot calendar.
 ...
 The events are generated based on the **Start Date** field on the schedule form. For more information, see [Schedule form in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/create-robot-schedule.md#).

 ![Example: Snapshot of the Robot Calendar view for a week, November 13 to 19, 2022.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/week-rc-rpa.png "Example: Snapshot of the Robot calendar view for a week (November 13 to 19, 2022)")
...
View events in the calendar for a particular month. See the following example for a snapshot of the Robot calendar view.![Example: Snapshot of the Robot Calendar view for a month, November 2022.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/month-rc-rpa.png "Example: Snapshot of the Robot calendar view for a month (November 2022)")
...
View new or updated schedules on the robot calendar by selecting the refresh icon \(![Refresh icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/refresh-rc-icon.png)\).
...
Show or hide events for the particular day, week, or month by selecting the agenda icon \(![Agenda icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/agenda-rc-rpa-icon.png)\). See the following example for a snapshot of the show or hide agenda filter view.![Show or hide the agenda view filter.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/agenda-view-rc-rpa.gif "Show or hide agenda view filter")
...
Select the filter icon \(![Filter icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/filter-rc-rpa.png)\) to view the filter options.

 In the Process Name list or the Life Cycle Stage Status list, perform any of the following actions:

-   To add items to the selection, double-click an available item on the left or select an item and select the add icon \(**&gt;**\). Then, select **Apply**. The new item is added at the bottom of the selected items column on the right.![Process Name filter.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/filter-process-name-rc-rpa.gif) ![Life-cycle stage status filter.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/filter-lcss-rc-rpa.gif)
...
View the event cards in the Scheduled events section.Limited information about the associated bot process and its schedule is displayed.
 ...
 ![Example: Snapshot of the event cards on the robot landing page.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/event-card-rc-rpa.png "Example: Snapshot of the event cards")
...
To view more event details of the bot process and its schedule, double-click an event card.![Event details snapshot of the associated bot process whose interval type is Daily.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/event-details-rc-rpa.gif "Example: Event details snapshot of the associated bot process whose interval type is Daily")

 ![Event details snapshot of the associated bot process whose interval type is Hours.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/rpa-rc-snap-bot-process.jpg "Example: Event details snapshot of the associated bot process whose interval type is Hours")

 ![Event details snapshot of the associated bot process whose interval type is Weekly.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/event-card-weekly.png "Event details snapshot of the associated bot process whose interval type is Weekly")
...
On the event pop-up window, select the following icons to view, edit, and delete a schedule:-   Select the view bot process details icon \(![View bot process details icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../../release-notes/image/icon-view-bp-rpa.png)\) to get the bot process details in a new tab.
-   Select the view event details icon \(![View event details icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../../release-notes/image/icon-view-event-rpa.png)\) to view more details about the schedule in the contextual side panel.
-   Select the edit schedule icon \(![Edit schedule icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../../release-notes/image/icon-edit-schedule-rpa.png)\) to edit an existing schedule.
-   Select the delete schedule icon \(![Delete schedule icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../../release-notes/image/icon-delete-schedule-rpa.png)\) to delete a schedule that you no longer need.
![Snapshot of an event card pop over.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/event-pop-card-icons.png "Example: Icons on the pop over event card")
