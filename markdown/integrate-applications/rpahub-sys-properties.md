...
For more information, see [Run an automation using Attended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rda-runtime/task/run-rda-robot.md).
...
For more information about installing a user certificate, if you have the admin role, see [Install the user-generated certificates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-core/concept/use-user-certificates-rpa.md#).
...
For more information about execution logs, see [Bot Process form in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/select-botprocess.md#).
...
For more information about the robot calendar, see [Using the robot calendar for RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../concept/robot-calendar-rpa.md).
...
For more information about the queue form, see [Queue form in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/queue-form.md).
...
If this value is set to No, then the users added in the Assigned Studio Users tab in the Robot form can impersonate as robot from the RPA Desktop Design Studio. For more information about adding the assigned studio users, see [Add assigned studio users to an unattended robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/assigned-studio-users-rpa.md).

For more information about assign bot process to an automation project, see [Assign bot process to an automation project](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../rpa-studio/task/assign-bot-process.md).
