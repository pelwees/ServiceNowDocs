...
![Add The SSH plugin in the Plugins Manager](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/ssh-plugin-add.png "SSH plugin")
...
-   To use a connector in RPA Desktop Design Studio, see [Use a connector in RPA Desktop Design Studio](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/use-connector.md). Add the Secure Shell connector in the Global Objects.

    ![Add Secure Shell connector in the Global Objects](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/ssh-connector-add-global-object.png "Add Secure Shell connector in the Global Objects")

-   To learn more about the various methods in the SSH connector, see [Secure Shell \(SSH\) connector methods](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/connector-ssh-methods.md).

-   **[Secure Shell \(SSH\) connector methods](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../reference/connector-ssh-methods.md)**  
