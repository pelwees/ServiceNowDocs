...
![Attended Robot authentication journey.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/auth-journey-attended-auto.png "Attended Robot authentication journey")
...
7.  After the automation execution is initiated, if the user selects the **Close** button on the Attended Robot, after performing few pre-validations, it halts the bot process, logs out the user session, and closes the Attended Robot. For more information about stop and close actions, see [Run an automation using Attended Robot](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../task/run-rda-robot.md).

    ![Stop and Close actions in the Attended Robot.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/attended-robot-actions.png "Stop and Close actions in the Attended Robot")

8.  After the automation is executed, the process job record is marked as success or failure after the automation flow ends.

    ![Post automation execution screen in the Attended Robot.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../image/attend-robot-actions-greyed.png "Post automation execution screen in Attended Robot")
