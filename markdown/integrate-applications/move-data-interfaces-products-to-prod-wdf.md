...
-   Zero-copy connectors for all source systems are configured in the production instance. For setup instructions, see [Zero copy connectors documentation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/../../../build/zero-copy-connectors/concept/zero-copy-connectors.md).
-   Role required: Admin
