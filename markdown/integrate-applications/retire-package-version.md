...
-   Retire a package and all the associated package versions are also retired automatically. For more information about retiring a package, see [Retire a package in RPA Hub](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/integrate-applications/retire-package.md).
