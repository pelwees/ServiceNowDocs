...
3.  On the My Promotion form, fill in the fields.
    ...
    For a description of the field values, see [All promotion form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/manufacturing/../reference/mco-all-promotion-form.md).

4.  Select **Save**.

5.  Select **Create checklist**.

    To learn how to create checklist, see [Create a checklist template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/manufacturing/../concept/mco-create-checklist.md).
...
**Parent Topic:**[Sales promotion management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/manufacturing/../concept/mco-sls-pro-mgmt.md)
