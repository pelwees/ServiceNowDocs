...
-   **Default Template**
    ...
    To learn more about how to create a default template, see [Create a default template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-default-templates.md).
