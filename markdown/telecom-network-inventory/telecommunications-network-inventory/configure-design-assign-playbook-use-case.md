...
</table>    To learn more about the detailed steps, see [Create a Change Model for Design and Assign function](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-change-model-design-assign-playbook.md).
...
</table>    To learn more about the detailed steps, see [Create a record producer for the Design and Assign function](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-record-producer-design-assign-playbook.md).
...
</table>    To learn more about the detailed steps, see [Create variables for Design and Assign function](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-variables-record-producer-design-assign-playbook.md).

4.  Select **DA common variables** as a variable set to the record producer.

    To learn more about the detailed steps, see [Add variable set to the record producer for Design and Assign function](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/add-variable-set-record-producer-design-assign-playbook.md).
...
</table>    To learn more about the detailed steps, see [Create subflow for Design and Assign function](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-subflow-design-assign-playbook.md).
...
![Playbook in Workflow Studio with the list of activities.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../image/playbook-configure-example.png "Example of the playbook in Workflow Studio")

## Adding playbook to home page

You add the sys\_id of the Network Service Automated Flow Change model in the `sn_ni_ws.tni_design_assign_chg_models` record. To learn more about the detailed steps, see [Update system property to configure the Design and Assign home page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/update-system-property-configure-design-assign-home-page.md).
...
2.  Select the design and assign icon \(![Design and Assign Icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../image/icon-design-assign.png)\) to open the Design and Assign home page.
...
![Playbook view with the list of activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../image/design-assign-playbook-example.png "Example of playbook")

**Parent Topic:**[Configuring Design and Assign function for your network services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/configure-playbooks-design-assign-function.md)

**Related topics**  


[Configuring Design and Assign function for your network services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/configure-playbooks-design-assign-function.md)
