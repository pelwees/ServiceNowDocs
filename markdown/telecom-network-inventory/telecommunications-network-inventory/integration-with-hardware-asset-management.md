...
1.  Create a service request for the bill of materials. To learn more, see [Create a service request to procure assets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-service-request-procure-assets.md).
...
-   **[Create a service request to procure assets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-service-request-procure-assets.md)**  
