...
-   **[Create and execute a change task in Telecommunications Network Inventory](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-change-task-in-tni.md)**  
...
-   **[Create a Link Aggregation Group using design and assign function](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create_a_change_request_by_using_the_design_assign_link_aggregation_group.md)**  
...
-   **[Add or remove a member to Link Aggregation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-a-change-request-to-add-or-remove-member-to-link-aggregation.md)**  
...
-   **[Modify logical connection endpoints model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-a-change-request-by-using-modify-logical-connection-endpoints-model.md)**  
...
-   **[Modify physical connection endpoints](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-a-change-request-by-using-modify-physical-connection.md)**  
...
-   **[Add or remove a member to network topology record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/modify-network-topology-record-design-assign.md)**  
...
-   **[Create a cable record by using design and assign](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-cable-record-using-design-assign.md)**  
...
-   **[Add a card to equipment](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/add-card-equipment-design-assign-function.md)**  
...
-   **[Add an equipment or rack to logical composite](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/add-equipment-rack-logical-composite.md)**  
Add equipment or rack to a logical composite using design and assign.
-   **[Remove an equipment or rack from logical composite](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/remove-equipment-rack-logical-composite.md)**  
Remove a rack or equipment from a logical composite using design and assign.
-   **[Add an equipment to rack or cabinet](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/add-equipment-rack.md)**  
...
-   **[Remove an equipment or shelf from a rack or cabinet](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/remove-equipment-shelf-rack-cabinet.md)**  
...
-   **[Create logical connection record using design and assign](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-logical-connection-record-using-design-assign.md)**  
...
-   **[Create physical connection using design and assign](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create-physical-connection-design-assign.md)**  
...
-   **[Revise a configuration item using design and assign](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/revise-a-configuration-item.md)**  
Revise a CI \(Configuration Item\) of the connection to update a CI in the Telecommunications Network Inventory application.
-   **[Operationalize a configuration item](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/operationalize-a-configuration-item.md)**  
Operationalize a Configuration Item so that you can finalize the changes and apply them on the original CI.
-   **[Allocate phone number](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/allocate-phone-number.md)**  
