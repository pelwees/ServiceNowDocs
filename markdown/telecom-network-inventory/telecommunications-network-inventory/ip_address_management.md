...
-   **Managed Network**: A managed network is a list of all existing networks or new networks. By using a managed network, you can assign a network to an IP pool or to an allocated IP address. To learn more, see [Create Managed Network](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../task/create_managed_network.md).

To learn more about how to manage IP addresses, see [IP address inventory management data model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-network-inventory/telecommunications-network-inventory/../reference/data_model_of_ip_address_inventory_management.md).
