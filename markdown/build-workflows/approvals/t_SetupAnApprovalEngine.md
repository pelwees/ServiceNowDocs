...
1.  Navigate to **All** &gt; **System Properties** &gt; **Approval Engines**.
    ...
    ![Approval engine page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/approvals/../image/ApprovalEnginePage.png)

2.  Select the [approval engine option](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/approvals/../concept/c_ApprovalEngines.md#table_ApprovalEngineOptions) for each Task table from the choice list.
