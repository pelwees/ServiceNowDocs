...
Ensure that the workflow field you want to use as the stage field is configured to properly display stages. For detailed steps, see [Create a workflow stage field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/t_CreateAWorkflowStageField.md).
...
**Parent Topic:**[Create a workflow stage field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/t_CreateAWorkflowStageField.md)
