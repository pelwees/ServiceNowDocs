...
**Note:** An updated method for managing workflow stages as a set is also available. For information about grouping and reusing stages, see [Workflow stage sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/c_WorkflowStageSets.md#).
...
![Gathering stage values for workflow activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/ScReqStagesDiagram.png)
...
-   **[Use workflow stages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../task/t_UsingWorkflowStages.md)**  
You can add or modify workflow stages.
-   **[Add and translate stages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../task/add-translate-stages.md#)**  
You can add default stages to use for a table, and stages to existing workflow
-   **[Workflow stage sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/c_WorkflowStageSets.md#)**  
...
-   **[Create a workflow stage field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../../workflow-administration/task/t_CreateAWorkflowStageField.md)**  
...
-   **[Workflow fields with deleted records](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../../workflow-administration/concept/c_WorkflowFieldsWithDeletedRecords.md)**  
