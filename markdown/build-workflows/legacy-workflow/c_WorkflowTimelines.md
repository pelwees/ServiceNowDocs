...
3.  In **Related Links**, click **Show Timeline** to display the timeline for the entire context.
    ...
    ![Workflow timeline iPhone](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelineIPhone4.png)

4.  Use the Range Selectors at the top of the timeline to change the perspective.

    ![Timeline perspective bar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/TimelinePerspectiveBar.png)
...
6.  Use the pink slider at the bottom of the timeline to change the perspective.
    ...
    ![Workflow timeline slider](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelineSlider.png)
...
7.  To focus the timeline view on selected activities, expand or collapse the activity tree.
    ...
    ![Workflow timeline collapsed](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelineCollapsed.png)
...
8.  Hover over an activity span to display a tooltip with information about the activity.
    ...
    ![Workflow timeline tooltip](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelineTooltip.png)
...
9.  Hover over the transition between two activities to highlight the activity and the predecessor activity in the activity pane.
    ...
    ![Workflow timeline transitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelineTransitions.png)
...
10. Double-click a span to display a history record for that activity.
    ...
    ![Workflow timeline history popup](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelineHistoryPopup.png)
...
5.  Collapse the tree to confine the view even further.
    ...
    ![Partial workflow timeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowTimelinePartial.png)
