...
-   **Publishable:** Yes
-   **Runnable:**Yes
-   **Related Information:** [Workflows used as subflows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../../workflow-activities/reference/workflows-as-subflows.md)
...
-   Changing the data types of [input variables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../../using-workflows/concept/c_UsingVariablesInAWorkflow.md#). Verify that all parent workflows cited in this validation report can pass the correct value type.
...
**Parent Topic:**[Workflow validator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../reference/r_WorkflowValidator.md)
