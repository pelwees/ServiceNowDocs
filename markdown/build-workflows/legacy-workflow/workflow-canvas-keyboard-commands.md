...
![Workflow Editor Drawing Canvas - Tab Sequences / Elements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowCanvasAccesibilityArrows.png)
...
1.  Press **Tab** until ![Information icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/WorkflowPropertiesIcon.png) is highlighted.
2.  Press **Enter** to open [Workflow Properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../../workflow-administration/reference/r_WorkflowProperties.md).
...
1.  Within an activity box, select ![Condition Properties icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/ConditionProperties.png) to access **Condition Properties**.
...
1.  Press **Tab** until ![Validate icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/ValidateWorkflowIcon.png) is highlighted.
...
1.  Press **Tab** until ![Run icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/RunWorkflowIcon.png) is highlighted.
...
1.  Press **Tab** until ![Close icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/CloseWFEditorCanvas.png) \(on the right side of the tab that contains the name of the workflow\) appears.
...
After tabbing through the entire workflow, ![The Jump to top button](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/legacy-workflow/../image/JumptoTop.png) appears at the bottom of the listing. Press **Enter** to jump to the top of the Workflow drawing canvas.
