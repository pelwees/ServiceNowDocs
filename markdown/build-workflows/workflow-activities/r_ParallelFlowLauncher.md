...
-   **[WorkflowCoordinator object](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-activities/../concept/c_WorkflowCoordinatorObject.md)**  
A WorkflowCoordinator object specifies which subflows to run and the input variables to pass to those subflows.
-   **[Completed subflow values in scripts](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-activities/../concept/c_CompletedSubflowValuesInScripts.md)**  
The **Parallel Flow Launcher** activity exposes additional variables you can use in scripts.
-   **[Parallel Flow Launcher example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-activities/r_ParallelFlowLauncherExample.md)**  
...
**Parent Topic:**[Subflow activities in workflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-activities/../concept/c_SubflowActivities.md)
