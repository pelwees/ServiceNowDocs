...
Condition type \(Standard, Else, or Error\) is used. For more information, see [Manage workflow activity conditions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-activities/../../using-workflows/task/t_ManageActivityConditions.md#).

![](../image/ConditionPropertiesHardware.png "Hardware group condition")

**Parent Topic:**[Condition Workflow activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-activities/r_ConditionActivites.md)
