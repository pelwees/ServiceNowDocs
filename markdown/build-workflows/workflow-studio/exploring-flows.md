...
![Parts of a flow including a trigger, flow steps, and a result](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/images/MMASSET0020954-flows-infographic.svg)
...
-   **2. Action section**
    ...
    The Actions section is where you select and configure the steps that make up your flow. You can add [actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/concept/actions.md), [flow logic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/concept/flow-logic.md), and [subflows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/concept/subflows.md) to a flow by opening the associated picker.
...
-   **4. Data panel**
    ...
    ![Example flow data in the data panel.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/images/data-pane-example.png "Example flow data in the data panel")
...
![Use the action picker to find actions that you can add to your flow.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/images/action-picker.png "Action picker menu")
...
![Example flow with detailed descriptions of data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/images/example-flow-data-descriptions.png "Example flow with descriptions of data")
