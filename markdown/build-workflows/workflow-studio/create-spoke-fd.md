...
3.  On the Spoke Info screen, specify if you want to create the spoke in a new scope or an existing scope.
    ...
    1.  If you choose to create the spoke in a new scope, select an image as the logo for your integration and fill in the fields.
        ...
        ![Create spoke in new scope.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-new-scope.png)
...
</table>        ![Create spoke in an existin scope.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-existing-scope.png)

4.  Click **Continue**.

    Based on the provided name and description, if there are any matching spokes on Store, the spoke details are displayed.![Matching spokes found on Store.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spoke-gen-store-apps.png)
...
7.  Select **OpenAPI Specification** and click **Continue** to import an OpenAPI specification.
    ...
    ![Select the method by which you want to create your spoke.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-open-api.png)
...
9.  On the Import new OpenAPI source screen, perform one of these two steps.
    ...
    1.  If you want to import using an URL, select **Import from URL** for **Import method** and specify the URL in **OpenAPI URL**.
        ...
        ![Import new OpenAPI source.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-import-openapi-url.png)
    ...
    2.  If you want to import manually using JSON or YAML code, select **Import from JSON or YAML manually** for **Import method** and provide the code in **JSON or YAML**.
        ...
        ![Create spoke manually by importing JSON or YAML.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-import-openapi-json.png)
...
</table>    ![Create connection alias for the spoke.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-conn-alias.png)
...
14. On the same screen, fill in the fields to configure the alias.
    ...
    ![Configure connection and credential records.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-conn-alias-2.png)
...
16. Click **Generate operations**.
    ...
    ![Generate operations for the spoke.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-fin-buildinfo.png)
...
17. Select the required operations.
    ...
    ![Search for the required actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spoke-gen-search-act.png)

18. Click **Publish**.

    Alternatively, you can also select **Save actions as Draft** to save the actions as draft, modify them as per your requirement, and publish them later.![Create spoke actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-actions.png)
