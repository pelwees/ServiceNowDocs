...
**Note:** When a data pill is dropped into the **SQL Statement** input for a [JDBC step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/jdbc-step.md), the sanitize SQL transform function category automatically appears.
