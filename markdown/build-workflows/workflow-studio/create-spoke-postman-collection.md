...
3.  On the Spoke Info screen, specify if you want to create the spoke in a new scope or an existing scope.
    ...
    1.  If you choose to create the spoke in a new scope, select an image as the logo for your integration and fill in the fields.
        ...
        ![Create application in a new scope.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-notion-new-scope.png)
...
An existing application name or scope.![Select an existing scope.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-notion-existing1.png)
...
</table>        ![Create a spoke in an existing scope.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-notion-existing2.png)
...
7.  Select **Postman collection** and click **Continue** to import a Postman collection.
    ...
    ![Select the method by which you want to create your spoke.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-postman.png)
...
9.  On the Import new postman collection source screen, perform one of these two steps.
    ...
    1.  If you want to import using an URL, select **Import from URL** for **Import method** and specify the URL in **Postman collection URL**.
        ...
        ![Import a new postman collection source manually from URL.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-spk-import-postman-url.png)
    ...
    2.  If you want to import manually using JSON code, select **Import from JSON manually** for **Import method** and provide the code in **JSON**.
        ...
        ![Import a new postman collection source manually using JSON.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-postman-json.png)
...
</table>    ![Create alias record for the spoke.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-alias-postman.png)
...
14. On the same screen, fill in the fields to configure the alias.
    ...
    ![Configure alias record.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-postman-conf-alias.png)
...
17. Select the required operations.
    ...
    ![Search for the required actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-actions-postman.png)
...
18. Click **Publish**.
    ...
    ![Publish the required actions.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/spk-gen-publish-actions-postman.png)
