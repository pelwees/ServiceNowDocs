...
Workflow Studio does not display step input variables in the data pane. The output variables produced by each step are available in the data pane as part of the step that created them. For more information on using input and output variables to create a custom action, see [Building actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../concept/actions.md).

![Screen shot of the Workflow Studio data panel. The Input Variables section contains a record data pill labelled Incident. The Output Variables section contains a record data pill labelled Problem.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/action-input-outputs-data-pane.png "Sample Workflow Studio data panel")
...
-   **[Approval rules data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/approval-rules-data.md)**  
Store the conditions for approving or rejecting an approval requests.
-   **[Array.Boolean data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/array-boolean-data.md)**  
Store a sequence of true or false values in an array.
-   **[Array.Choice data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/array-choice-data.md)**  
Store a sequence of choice list values in an array.
-   **[Array.Datetime data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/array-datetime-data.md)**  
Store a sequence of date-time values in an array.
-   **[Array.Integer data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/array-integer-data.md)**  
Store a sequence of numeric integer data in an array.
-   **[Array.Object data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/array-object-data.md)**  
Store a sequence of JavaScript objects in an array.
-   **[Array.String data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/array-string-data.md)**  
Store a sequence of alphanumeric text values in an array.
-   **[Choice data](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/choice-data.md)**  
Store choice list values for a specific choice field.
-   **[Conditions data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/conditions-data.md)**  
Store a set of conditions for a specific type of record. You must select a source table to define the conditions.
-   **[Datetime data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/datetime-data.md)**  
Store date-time values.
-   **[File attachment data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/file-attachment-data-type.md)**  
...
-   **[Integer data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/integer-data.md)**  
Store numeric integer data. Integers are whole numbers only. Fractions and decimals values are not supported.
-   **[JSON data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/json-data-type.md)**  
...
-   **[Object data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/object-data.md)**  
Store a JavaScript object.
-   **[Password \(2 Way Encrypted\) design considerations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/password-2-data.md)**  
...
-   **[String data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/string-data.md)**  
Store alphanumeric text values using JavaScript data conventions.
-   **[Table name data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/table-name-data.md)**  
Store a table name value as specified in the database dictionary. Table names are always alphanumeric strings.
-   **[True/false data type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/true-false-data.md)**  
