...
2.  Click the ellipses action menu icon \(![Playbook action menu icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../image/playbook-ellipses.png)\) in the playbook header.

3.  Click **Cancel Playbook**.

4.  Provide a reason for canceling the playbook.

    ![Cancel playbook through which you provide reason for cancellation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../image/playbook-cancel-modal.png)
...
5.  Click **Cancel Playbook**.
    ...
    ![Canceled banner](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../image/playbook-cancel-banner.png)
