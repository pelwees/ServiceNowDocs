...
Additionally, you can add an activity just using an [automation asset](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/automation-assets.md).
...
-   **Interactive Activities**
    ...
    When an interactive activity runs, it prompts a user for input in your playbook as it runs. For more information, see [Interactive activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/interactive-activities.md).

-   **Non-Interactive Activities**

    When a non-interactive activity runs, it runs entirely behind-the-scenes and requires no user input. For more information, see [Non-Interactive activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/non-interactive-activities.md).

-   **Optional Activities**

    An optional activity can be inserted by agents and fulfillers during a playbook run. For more information, see [Optional activities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/optional-activities.md#).
...
-   To change default inputs and outputs for the activity, open and edit the source flow in Workflow Studio by selecting the **Open link** icon \(![Open link icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/external-link-icon.png)\) next to the **Automation** field.

    For more information on how to work with the default inputs and outputs for activities in Playbooks, see [Create an action as an activity automation plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/create-automation-plan.md).

    **Note:** You must have the appropriate user roles to access Workflow Studio and Workflow Studio. For more information, see [User access to Workflow Studio flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/concept/user-access-flow-designer.md).
...
**Parent Topic:**[Understanding the playbook components](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/playbook-building-blocks.md)
