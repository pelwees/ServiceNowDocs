...
3.  In the **New Playbook** window:
    ...
    5.  Select **Standalone** for the **Execution type**:
        ...
        ![Playbook user interface that shows how to select the Standalone option.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/create-standalone-playbook.png)
...
7.  Select **Save and close**.
    ...
    For more information about creating a playbook, see [Create a playbook](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/create-process-definition.md).
