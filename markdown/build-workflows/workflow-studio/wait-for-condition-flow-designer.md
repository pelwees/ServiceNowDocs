...
-   **Conditions**
    ...
    **Note:** For conditions that depend on a specific duration, consider using [Wait for a duration flow logic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../concept/flow-logic-wait-for-a-duration.md) instead.
...
![Condition met for a Wait for Condition action in Flow Designer.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/wait-for-condition-flow-met-example.png "Valid wait condition")
...
![Condition not met for a Wait for Condition action in Flow Designer.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/wait-for-condition-flow-not-met-example.png "Invalid wait condition")

## Wait for incident state closed

![Condition met for a Wait for Condition action in Flow Designer.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/wait-for-condition-flow-met-example.png)
