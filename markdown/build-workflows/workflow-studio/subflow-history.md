...
![Six components available in the flow history view for a sample subflow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/flow-history-view-subflow-parts-of-ui.png "Flow history components of a subflow")
...
![FIlter options by flow history entry type and user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/flow-history-filter-popup-02.png "Flow history filter options")
...
-   **[View subflow history](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/view-subflow-history.md)**  
View the change history of a subflow by date and user.
-   **[Add an annotation to a subflow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/add-annotation-to-subflow-history-entry.md)**  
...
-   **[Delete a subflow's flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/delete-subflow-history-entry.md)**  
Delete a subflow's flow history entry from the flow history list.
-   **[Restore a subflow to a previous flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/restore-subflow-to-previous-flow-history-entry.md)**  
Restore a subflow to a previous configuration. Create a new flow history entry for the restore operation.
-   **[Save a copy of a subflow's flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/save-copy-subflow-history-entry.md)**  
Create a copy of a flow history entry and save it as a new subflow.

**Parent Topic:**[Building subflows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/subflows.md)
