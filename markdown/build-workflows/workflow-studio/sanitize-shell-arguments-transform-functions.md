...
**Note:** When a data pill is dropped into the **Command** input for an [SSH step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/ssh-step-action-designer.md), the sanitize shell arguments transform function category automatically appears.
