...
-   Import a copy of a pre-defined stage set from the Stage Sets table. To learn more about stage sets, see [Workflow stage sets](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../using-workflows/concept/c_WorkflowStageSets.md#). Any changes made to the copy do not affect the original stage set record.
...
If using the [Service Catalog trigger](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/create-sc-flow.md), the flow must be associated with the Service Catalog item through the **Flow** field. Remove any workflows associated with the item by clearing the **Workflow** and **Execution Plan** fields. The **Stage** field displays the current stage state on any list view of the Requested Items \[sc\_req\_item\] table.
...
![List of parent flow stages including the Manager Approval, Fulfillment Subflow stages, and Completed stages.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/example-subflow-stages-05-parent-flow-stages.png "Sample flow and subflow stages")
...
-   **[Configure stages and add them to a flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/add-stages.md)**  
...
-   **[Show subflow stages in a parent flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/show-subflow-stages-in-a-parent-flow.md)**  
