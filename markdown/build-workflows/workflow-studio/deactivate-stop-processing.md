...
2.  Create multiple flows with an inbound email trigger.
    ...
    For more information, see [Create a flow with an inbound email trigger](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/task/create-inbound-email-flow.md).
...
**Parent Topic:**[Create a flow with an inbound email trigger](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../flow-designer/task/create-inbound-email-flow.md)
