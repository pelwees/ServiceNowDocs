...
-   **[Show flow priority field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/show-flow-priority-field.md)**  
Configure the Setting list and form to show the Flow Priority field.
-   **[Set flow priority](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/set-flow-priority.md)**  
