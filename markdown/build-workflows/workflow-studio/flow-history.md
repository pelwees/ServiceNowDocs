...
![Six components available in the flow history view for a sample flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../images/flow-history-view-parts-of-ui.png "Flow history components of a flow")
...
-   **[View flow history](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/view-flow-history.md)**  
View the change history of a flow by date and user.
-   **[Add an annotation to a flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/add-annotation-to-flow-history-entry.md)**  
Add a text description to a flow history entry. Summarize the purpose or contents of a particular flow history entry.
-   **[Flow history compare view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/flow-history-compare-view.md)**  
...
-   **[Delete a flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/delete-flow-history-entry.md)**  
Delete a flow history entry from the flow history list.
-   **[Restore a flow to a previous flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/restore-flow-to-previous-flow-history-entry.md)**  
Restore a flow to a previous configuration. Create a new flow history entry for the restore operation.
-   **[Save a copy of a flow history entry](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../task/save-copy-flow-history-entry.md)**  
