...
-   **[Benchmarks Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/benchmarks-actions.md)**  
Provides read-only actions for the read-only Benchmark Recommendation Evaluator flow.
-   **[Connect spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/connect-spoke.md)**  
...
-   **[Customer Service Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/customer-service-actions.md)**  
...
-   **[External Related Files spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/ext-related-files.md)**  
...
-   **[Field Service Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/field-service-actions.md)**  
Provides actions for flow designers to use when creating Field Service Management business processes.
-   **[ITSM spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/itsm-spoke.md)**  
Provides flow and actions associated with ITSM. Requires the ITSM application suite.
-   **[Machine Learning solutions for Flow Designer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/predictive-intelligence-spoke.md)**  
...
-   **[Robotic Process Automation \(RPA\) Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/rpa-actions.md)**  
...
-   **[Security Operations spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../../integrationhub/reference/secops-spoke.md)**  
Provides Security Operations actions for flow designers to manage Security Incident Response flow templates.
-   **[Visual Task Board \(VTB\) Spoke](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/../reference/vtb-actions.md)**  
Provides VTB actions for flow designers to manage the boards, lanes, cards, board members, and assignees.

**Parent Topic:**[Workflow Studio flow integrations](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/build-workflows/workflow-studio/flow-designer-integrations.md)
