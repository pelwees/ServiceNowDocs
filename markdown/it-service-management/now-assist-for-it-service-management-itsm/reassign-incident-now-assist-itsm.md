...
2.  Select **Update** or right-click the header menu and select **Save**.
    ...
    ![Assign dialog box with work notes generated by Now Assist.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/now-assist-for-it-service-management-itsm/../image/itsm-now-assist-assign-modal.png)
