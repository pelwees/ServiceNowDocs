...
-   The user is configured as a shift manager for a group. For information on configuring group preferences, see [Configure preferences for a user group](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/on-call-scheduling/../task/config-group-prefs-oncall.md).
...
</table>**Parent Topic:**[Defining On-Call Scheduling escalation process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/on-call-scheduling/../../user-administration/concept/defining-escalation-process-and-template.md)
