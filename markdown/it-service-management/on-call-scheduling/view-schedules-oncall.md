...
2.  In the **All On-Call Schedules** tab, pin a shift card by pointing to the card and clicking the Pin icon \(![Pin icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/on-call-scheduling/../image/view-pin-icon.png)\).
