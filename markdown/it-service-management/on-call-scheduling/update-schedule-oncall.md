...
-   **On-Call**: Displays information about the current on-call shift. From here, you can:
    ...
    -   View the roster and escalation details of the current shift. When you click **Roster and escalation details**, a dialog box displays the following tabs:
        ...
        -   Contact Preferences: The contact preferences set for the primary on-call member. ![On-Call Scheduling roster and escalation settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/on-call-scheduling/../image/roster-escalation-settings.png)
