...
6.  Reload the form to view the [counter results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/software-asset-management/t_ViewASoftwareCounterResult.md).
...
Select the check box to generate the details of the entitlement records. For more information, see [Setting Up Quick Counters](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/software-asset-management/../concept/c_SetUpQuickCounters.md).
...
\[Required\] Select the method for counting licenses. For example, Per named user or Per workstation.
 ...
 For more information, see [License Calculation Types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/software-asset-management/../reference/r_LicenseCalculationTypes.md).
...
Displays all [results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/software-asset-management/t_ViewASoftwareCounterResult.md) for this software counter.
