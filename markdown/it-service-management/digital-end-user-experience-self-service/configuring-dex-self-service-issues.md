...
For information about how device health is calculated, see [Device heath check calculation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-end-user-experience-self-service/../reference/Device-health-check-calculation.md).
