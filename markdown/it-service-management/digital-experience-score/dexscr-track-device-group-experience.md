...
5.  View the Device groups list page by selecting either a number in the **No. of device groups** column or the **View all device groups** link.
    ...
    ![Device groups list page displaying names of operating systems installed on devices, experience scores, and the number of devices on which the operating systems are installed.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-experience-score/../image/dex-score-device-grp-list.png)
