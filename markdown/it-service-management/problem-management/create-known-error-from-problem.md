...
5.  On the form, fill in the fields.
    ...
    **Note:** Click **Search for Duplicates** to search for existing known error articles. The search is based on short description, category, and topic.
    ...
    For a description of the field values, see [Known error article form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/problem-management/../reference/known-error-article-form.md).
...
**Parent Topic:**[Communicating the outcome of a problem](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/problem-management/../concept/communicate-outcome-of-problem.md)
