...
2.  View the record for the VIP caller in the list of incident records.
    ...
    ![Incident list with flagged VIP caller](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../image/VIPCallers.png)

3.  Click the record to view the VIP status in the **Caller** field.

    ![VIP caller](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../image/VIPCallerIndication.png)
