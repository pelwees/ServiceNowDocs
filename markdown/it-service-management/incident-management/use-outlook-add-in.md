...
You must activate and deploy the ServiceNow Add-in for Microsoft outlook. For more information, see [Configuring Microsoft Outlook to create incidents and VTB tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../concept/create-incident-outlook.md)

Role required: none

## Procedure

1.  On the Microsoft Outlook Home tab, click the **ServiceNow** icon \(![OutlookAddInIcon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../image/outlook-add-in-icon.png)\) and select **Create Incident** or **Create VTB Task**.
