...
-   **[Create incident template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../task/t_CreateAnIncidentTemplate.md)**  
...
-   **[Create a module that uses incident template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../task/t_UseATemplateFromAModule.md)**  
Create a module to log an incident with pre-filled field values from an existing template.
-   **[Create a record producer to log incidents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../task/t_CreateARecordProducer.md)**  
Create record producers to log incidents directly from Service Catalog.
-   **[Create a record producer using a template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/incident-management/../task/t_CreateRecProducWithTempl.md)**  
