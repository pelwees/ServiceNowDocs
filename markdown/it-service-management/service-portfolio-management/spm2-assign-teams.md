...
2.  Open the service offering that you want to assign support teams.
    ...
    ![Offering record example.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-portfolio-management/../image/spm2-teams-offering.png "Offering record example")

3.  In the first **Team** tab on the offering record, use the Search icon \(![Search icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-portfolio-management/../../site-reliability-ops/image/icon-search.png)\) to select the support group for this service offering, and then **Save** the page.
