...
|---------------|-----------|
|Remedial Action|[Remedial action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/proactive-engagement/remedial-action.md) triggers an action on the end user device.|
