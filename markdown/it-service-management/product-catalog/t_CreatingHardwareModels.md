...
3.  Complete the form.
    ...
    For general field descriptions, see [Model form fields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/product-catalog/../reference/r_ModelFormFields.md). The hardware model fields listed are found in the Information section of the form.
...
-   **[Add compatible models to a hardware model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/product-catalog/t_AddingCompModelsToHrdwreModel.md)**  
