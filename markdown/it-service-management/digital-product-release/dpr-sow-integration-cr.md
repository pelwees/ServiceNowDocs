...
For more information, see [Create a change request in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../../service-operations-workspace/task/create-change-sow.md#step-create-CR-link-release).
...
For more information, see [Create a change request in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../../service-operations-workspace/task/create-change-sow.md#step-create-CR-add-cis-rls).
...
[Manage change requests in a release](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../task/dpr-work-release-change-request.md)

[Change Management in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../../service-operations-workspace/concept/change-sow.md)
