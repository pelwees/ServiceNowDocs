...
[Work on a release for a single product or service![Single product release icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../image/dpr-icon-rls-single.png)Learn about working on a stage-oriented release to deliver a single product or service.](../task/dpr-work-stage-release.md#)

</td><td>

[Work on a release for multiple products![Multi-product release icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../image/dpr-icon-rls-multi.png)Learn about working on a stage-oriented release to deliver multiple products.](../task/dpr-work-release-stage-multi.md)
