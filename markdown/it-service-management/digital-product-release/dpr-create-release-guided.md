...
6.  In the **Version details** step, select a product or service from the **Primary product or service** and select an existing version or enter a new version number.
    ...
    **Note:** If a new version number is entered, it’s automatically created and associated with the release.
    ...
    -   To remove an existing Included product from the list, select the remove included product icon \(![Remove included product icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/../image/dpr-icon-release-remove.png)\) against the product.
...
7.  In the **Release template** step, select a release template to apply to the release.
    ...
    A release structure is generated based on the selected release template. For more information about a release template, see [Create a release template](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-product-release/dpr-create-release-template.md#).
