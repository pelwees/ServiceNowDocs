...
Select a metric rule name to customize. The rules trigger actions based on specific metric thresholds.**Note:** To edit or add a metric rule, see [Creating a metric rule](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-end-user-experience-dex/../concept/create-metric-rules.md).
    ...
    For more information on the compliance report, see [DEX Insights](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-end-user-experience-dex/../concept/dex-workspace-insights-tab.md).
