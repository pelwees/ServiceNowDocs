...
5.  On the form, edit the required fields.
    ...
    For more information on each field, see [Edit web or installed application form](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-end-user-experience-dex/../reference/admin-edit-app-form.md).
