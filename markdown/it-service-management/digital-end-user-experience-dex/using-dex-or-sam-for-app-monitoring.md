...
</table>For more information for application monitoring with DEX, see [Add an application for monitoring](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-end-user-experience-dex/../task/add-new-application.md).
