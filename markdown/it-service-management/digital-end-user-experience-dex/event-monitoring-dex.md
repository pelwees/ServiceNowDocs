...
You can configure up to 25 events for each operating system type. See [Add an event to monitor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/digital-end-user-experience-dex/../task/add-event-to-monitor.md) to create a custom event rule.
