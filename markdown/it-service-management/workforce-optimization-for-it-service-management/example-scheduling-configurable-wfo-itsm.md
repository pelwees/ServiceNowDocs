...
5.  Agents make requests to change the schedule or take time off
    ...
    For more information, refer to [Service Operations Workspace - Scheduling](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/workforce-optimization-for-it-service-management/../../service-operations-workspace/concept/itsm-sow-workspace-scheduling.md).
