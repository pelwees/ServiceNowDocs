...
3.  On the **Unassigned incidents** screen with the list of incidents, swipe left on an incident to open the menu.
    ...
    ![Unassigned Incidents](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/unassigned-incidents.png)

4.  On the menu, choose one of the actions to process the incident.

    |Action|Description|
    |------|-----------|
    |**Add comments**|Add any additional comments or work notes about the incident in this field and tap ![send icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/mobile_instances_send_droid.png).|
    |**Assign to me**|Use this action to assign an incident to yourself.|
    |**Assign**|On the Assign incident screen, tap the **Assignment group** field to change the assignment group, select the agent from the list in the **Assigned to** field and add any notes in the **Work notes** and tap ![send icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/mobile_instances_send_droid.png) to submit.|
...
6.  On the **Unassigned Incidents** screen as shown in the following figure, choose one of the actions in the table as appropriate.
    ...
    ![Unassigned incident process](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/unassigned-process.png)
...
-   At the top right of the screen, tap the menu icon ![mobile top menu](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/mobile-top-menu.png) to reassign, assign, edit or propose the incident as a major incident.
