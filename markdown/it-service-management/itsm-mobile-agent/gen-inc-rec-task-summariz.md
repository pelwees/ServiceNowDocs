...
![Summarize option for incident record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/itsm-ma-summarize-option.png)
...
You can also customize the information summary \(prompt\) from Now Assist for ITSM admin console. For more information, see [Customize a Now Assist for IT Service Management \(ITSM\) skill](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../../now-assist-itsm/task/cust-now-assist-itsm-skill.md).

![Incident record summarized as work notes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-mobile-agent/../image/itsm-ma-summarize-worknote.png)
