...
To pin a schedule, hover over the schedule tile and click the pin icon \(![pin icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../image/pin-icon.png)\). The schedule appears under **Pinned Schedules**. To unpin a tile, click the pin icon again.
...
Click a tab to view a Change Schedule. For more information, refer [Change schedules view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/change-schedules-view.md).
