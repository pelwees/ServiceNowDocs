 ...
 **Note:** For standard change proposals, the **Change**, **Proposal**, and **Change Request Values** tabs provide information on change request meeting, proposal, and change request values. The show form \(![Show form icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../image/show-form.png)\) and the show calendar \(![Show calendar icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../image/show-calendar.png)\) icons do not appear for standard change proposals.
