...
**Note:** The change states functionality has been replaced with change models since the Quebec release. For more information, see [Create a Change model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../task/create-a-change-model.md).

![State transitions in a normal change request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../image/change-state-model.png "Example of state transitions for a normal change request")
...
-   **[Legacy: Add a state to the state model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../task/t_AddANewState.md#)**  
...
-   **[Legacy: Configure state model transitions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/../task/t_ConfigStateModelTransit.md)**  
