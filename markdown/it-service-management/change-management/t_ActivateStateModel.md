...
If you upgraded from a release prior to Geneva, you must [update old state labels to new state labels](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/state-model-activate-tasks.md).

-   **[Update change request states](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/change-management/state-model-activate-tasks.md)**  
