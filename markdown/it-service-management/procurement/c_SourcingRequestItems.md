...
-   **[Create a purchase order from a request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/procurement/../task/t_CreatingPurchOrderFromRequest.md)**  
...
-   **[Create a transfer order from a request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/procurement/../task/t_CreatingTransferOrderFromReq.md)**  
You can create a transfer order directly from a request to source hardware items and consumables from stockrooms.
-   **[Source requests from local stockrooms](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/procurement/../task/consume-local-asset-stock.md)**  
Get visibility into local stockrooms at the time of sourcing requests.
-   **[Add an assignment from a request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/procurement/../task/t_AddingAssignmentsFromReq.md)**  
...
[Track a request from the service catalog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/procurement/../task/t_TrackReqFromServiceCatalog.md)
...
[Bundled models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/procurement/../../product-catalog/concept/c_CreatingBundledModels.md)
