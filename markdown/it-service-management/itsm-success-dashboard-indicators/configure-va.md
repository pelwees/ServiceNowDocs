...
-   **[Configure Virtual Agent topics for ITSM Success Dashboard indicators](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-success-dashboard-indicators/../task/instrument-virtual-agent-sdb.md)**  
Configure the Virtual Agent \(VA\) topics for ITSM Success Dashboard indicators so that data is displayed correctly if you have topics other than the base system topics.
-   **[Configure Virtual Agent topics for ITSM Success Dashboard using self-service analytics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-success-dashboard-indicators/../task/instrument-va-sdb2.md)**  
Configure the Virtual Agent \(VA\) topics for ITSM Success Dashboard indicators using the self-service analytics.

**Parent Topic:**[ITSM Success Dashboard Admin console](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/itsm-success-dashboard-indicators/admin-console-sd.md)
