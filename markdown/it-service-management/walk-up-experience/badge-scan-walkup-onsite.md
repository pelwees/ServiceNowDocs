...
You can view the Badge Scanner Integration scan logs and fix the errors to connect to the badge reader. For more information, see [View Badge Scanner Integration scan logs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/walk-up-experience/../task/view-badge-read-integ-scan-logs.md).

-   **[Activate Badge Reader Integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/walk-up-experience/../task/activate-badge-reader-integration.md)**  
...
-   **[Walk-up Experience Badge Reader Integration setup and configuration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/walk-up-experience/walkup-badge-read-integ-config.md)**  
