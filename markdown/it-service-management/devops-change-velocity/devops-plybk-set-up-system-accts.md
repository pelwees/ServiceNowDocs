...
![Setting up new integration user password through workspace.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/setupsystemaccountwrk1.png)

4.  By default, the DevOps integration user is selected. You can also select another user from the list.

![Selecting a DevOps integration user through workspace.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/setupsystemaccount-2.png)
...
![Selecting Set password for DevOps integration user account through workspace.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/setupsystemaccount-3.png)
...
-   [Onboard to DevOps Change Velocity using Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/onboarding-using-devops-change-workspace.md)
-   [Start integrating DevOps Change Velocity with third-party tools](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/integrating-devops-change-with-third-party-tools.md).
