...
![Maintained by field in the tool record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/credentials-expiry-maintainedby.png)
...
-   **Universal task**
    ...
    ![Bell notifications on credentials expiration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/credentials-expiry-bell-notifications.png)

    ![Email notification on credential expiration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/credentials-expiry-email-notification.png)

    ![Open task on landing page on credential expiration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/credentials-expiry-landing-page.png)

-   **Banner message**

    A banner message is displayed on the tool record to all users with access to the tool record.

    ![Banner notification on credential expiration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/credentials-expiry-banner-notification.png)
...
-   **Field message**
    ...
    ![Proactive field notification before credential expiration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/credential-expiry-proactive-field.png)
...
**Parent Topic:**[Update third-party tool credentials in DevOps Change Velocity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/update-third-party-tool-credentials-in-devops-change-velocity.md)
