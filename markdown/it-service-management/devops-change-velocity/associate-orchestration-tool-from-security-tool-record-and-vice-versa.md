...
5.  In the Select tool dialog box, select the orchestration tools you want to associate with your security tool, and select **Associate orchestration tools**. ![Associate orchestration tool for a security tool](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/asso-orch-tool-sec-01.png)

6.  In the Add custom action dialog box, copy the required custom action code for your orchestration tool, and add it as a step in your pipelines. ![Add custom action to your pipeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/asso-orch-tool-sec-02.png)
