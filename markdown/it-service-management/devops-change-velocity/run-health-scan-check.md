...
4.  Select **Execute suite scan**.
    ...
    For information on the scans available for the DevOps suite, see [DevOps Change Velocity suite health scan checks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../reference/devops-change-velocity-suite-health-scan-checks.md).
...
[DevOps Change Velocity suite health scan checks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../reference/devops-change-velocity-suite-health-scan-checks.md)
