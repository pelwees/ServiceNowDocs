...
4.  In the DevOps Tool Onboarding form, enter the tool details:
    ...
    For a list of all the permissions required on the credentials for connecting to JFrog, see JFrog permissions in [Permissions required for DevOps tools](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../reference/tool-req-permission.md).
