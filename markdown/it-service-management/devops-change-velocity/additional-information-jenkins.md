...
-   **[Connect to Jenkins using API token authentication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/authenticate-jenkins-using-api-token.md)**  
Connect to Jenkins using API token authentication instead of user name and password.
-   **[Reduce calls from Jenkins to ServiceNow DevOps to fetch pipeline information](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/reduce-pipeline-info-calls-jenkins.md)**  
...
-   **[Using a declarative or scripted pipeline in DevOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/dev-ops-scripted-pipeline.md)**  
...
-   **[Configure SonarQube scans on Jenkins pipelines](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/config-sonarqube-jenkins-devops.md)**  
Configure SonarQube scans on Jenkins pipelines.
-   **[Notify change request rejection or cancellation reason to Jenkins pipeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/update-jenkins-change-reject-reason.md)**  
...
-   **[Notify ServiceNow DevOps change request number to Jenkins pipelines](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/devops-change-number-notify-jenkins.md)**  
Send change request numbers to the Jenkins pipeline steps or logs when a change request is created in ServiceNow DevOps.
-   **[Get change request number in Jenkins pipeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/get-change-request-number-in-jenkins-pipeline.md)**  
...
-   **[Nested and parallel stages in Jenkins pipelines](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/nested-parallel-stage-support-jenkins.md)**  
...
-   **[Jenkins log levels and Log Recorders](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../reference/devops-jenkins-log-recorders.md)**  
