...
**Note:** ServiceNow [Change Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../../change-management/concept/c_ITILChangeManagement.md) must be installed for change acceleration.

Enable and set up change control when you model your pipeline in DevOps:

-   [Model an Azure pipeline in DevOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/model-azure-pipeline-dev-ops.md)
-   [Model a GitLab basic CI pipeline in DevOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/model-gitlab-pipeline-dev-ops.md)
-   [Model a Jenkins pipeline in DevOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/model-jenkins-pipeline-dev-ops.md)
...
This flow gathers DevOps data and runs the DevOps Change Request Minimal Automation Policy, which determines if the change should be auto-rejected, auto-approved, or sent for manual approval. This flow is triggered for DevOps change requests whose type or model is set to normal.
 ...
 Activate this flow if you want to automate change request approvals, but start minimally. ![DevOps Change Request Minimal Automation Approval flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/change-minimal-automation-flow.png)

 You can clone this flow and customize it to make changes. Ensure that the other DevOps flows are deactivated.

 You can also add the DevOps - Update Minimal Automation Policy Decision Reason action to this flow to update the policy decisions to the step execution change comment and the change request worknotes to know the reasons for the decision. You can add this action inside every decision block and specify the required input. ![Update minimal automation policy decision action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/action-minimal-automation-policy.png)
...
This flow gathers DevOps data and runs the DevOps Change Request Advanced Automation Policy, which determines if the change should be auto-rejected, auto-approved, or sent for manual approval. This flow is triggered for DevOps change requests whose type or model is set to normal.
 ...
 If the DevOps change request is approved, the flow will update the change request to the scheduled state, and the planned start date will be used to set the change request start date. On the change request start date, the flow will update the change request state to implement. After that the pipeline will be resumed. Activate this flow if you want to automate change request approvals with a robust change policy. ![DevOps Change Request Advanced Automation Approval Flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/change-flow-advanced.png)
...
![DevOps Demo Change Automation flow](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/dev-ops-demo-chg-automation-flow.png) You can clone this flow and customize it to make changes. Ensure that the other DevOps flows are deactivated.
...
For more information on change approval policies, see [Change approval policies](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../../change-management/concept/change-approval-policy.md).
...
The DevOps Change Request Minimal Automation Policy has the following conditions and criteria by default: ![Change Request Minimal Automation Policy conditions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/change-policy-minimal.png)

The DevOps Change Request Advanced Automation Policy has the following conditions and criteria by default:![Change Request Advanced Automation Policy conditions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/change-policy-advanced.png)
...
If desired, you can write a custom subflow in place of this flow by modifying the **\[sn\_devops.change\_request\_handler\_subflow\]** [DevOps property](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/dev-ops-administration.md).
...
-   **Test Summaries \(replaces Test Results related list\)**
    ...
    See [Test Results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/dev-ops-change-acceleration.md#section_ccp_nbb_dlb) for more details.
...
![DevOps Change Related Lists](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/dev-ops-change-rel-lists.png)
...
These [DevOps change properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/dev-ops-administration.md) are available to customize your change request flow.
...
![DevOps pipeline execution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/dev-ops-pipeline-executions.png)

-   **[Customizing DevOps flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/using-dev-ops-model-change-flow.md)**  
...
-   **[Automate DevOps change request creation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/automate-devops-change-request.md)**  
Modify your pipeline to automatically create a DevOps change request.
-   **[Create a DevOps Change request and associate existing DevOps data — Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/devops-wkspc-chg-create-manual.md)**  
Create a DevOps change request and associate existing DevOps data through the Workspace UI.
-   **[Create a DevOps change request and associate existing DevOps data — Classic](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/create-devops-change-request-manual.md)**  
Create a DevOps change request and associate existing DevOps data through the Classic UI.
-   **[DevOps change request without mandating category as DevOps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/create-devops-change-any-category.md)**  
...
-   **[Change request creation with DevOps data retrieval errors](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/change-request-creation-with-devops-data-retrieval-errors.md)**  
Create change requests even with errors in DevOps data retrieval.
-   **[Artifacts and packages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/using-dev-ops-release-change.md)**  
...
-   **[DevOps Pipeline UI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/dev-ops-pipeline-ui.md)**  
...
-   **[Configuring DevOps change request details within the pipeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/dev-ops-config-change-details.md)**  
...
-   **[DevOps change models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/devops-change-multimodel.md)**  
...
-   **[Retrieve change request data using DevOpsChangeRelationshipHelper script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/retrieve-change-request-data-using-devopschangerelationshiphelper-script.md)**  
...
-   **[Manage Pull Requests \(PR\) or Merge Requests in DevOps Change Velocity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/manage-pull-request-pipelines.md)**  
...
-   **[DevOps change request attributes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/apis-for-change-actions-in-devops.md)**  
...
-   **[Import based evidence collection](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/import-based-evidence-collection-for-orchestration-capability.md)**  
