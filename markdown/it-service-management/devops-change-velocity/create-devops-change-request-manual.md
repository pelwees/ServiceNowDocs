...
1.  Navigate to **All** &gt; **Change** &gt; **Create New** &gt; **Create Normal Change**.
    ...
    **Note:** For more information on using the Change module, see [Create a Change](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../../change-management/task/t_CreateAChange.md).
...
10. Configure the change window for the change request from the Schedule tab.
    ...
    **Note:** For more information on configuring the schedule, see [Create a Change](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../../change-management/task/t_CreateAChange.md).
