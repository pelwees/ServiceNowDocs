...
Both [scripted pipelines](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/dev-ops-scripted-pipeline.md) \(Jenkinsfile\) and freestyle jobs are supported.
 ...
 **Note:** The step order determines the order of the cards in the [Pipeline UI](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/dev-ops-pipeline-ui.md).
...
4.  Enable change control automatically or manually based on the type of pipeline.
    ...
    -   For freestyle jobs, select the **Change control** check box in a step to enable [change acceleration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/dev-ops-change-acceleration.md) and the corresponding configuration fields.
...
Change model for the change request. For more information, see [DevOps change models](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/devops-change-multimodel.md).
...
![DevOps pipeline](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/dev-ops-pipeline.png "DevOps app")

![DevOps Pipeline Steps](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/dev-ops-pipeline-steps.png "DevOps pipeline")

![DevOps pipeline stages](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/dev-ops-pipeline-stages.png "DevOps pipeline step")
