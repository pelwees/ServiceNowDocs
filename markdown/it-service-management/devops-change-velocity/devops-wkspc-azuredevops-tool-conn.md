...
Complete the tasks specified in the [Getting started with DevOps Change Velocity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/setting-up-devops-change-velocity.md) topic.
...
2.  Select an existing application, or create one. To create an application, see [Create an application - Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/app-create-workspace.md).
...
2.  In the Connect to a tool modal, enter the connection details.
    ...
    4.  Select **Next**.
        ...
        ![Connect to organization.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-09.png)
...
Enter the password or access token to access this instance.For information on creating a PAT, see [Personal access token \(PAT\)](https://docs.microsoft.com/en-us/azure/devops/organizations/accounts/use-personal-access-tokens-to-authenticate?view=azure-devops&tabs=preview-page). ![Connect to a tool - ADO PAT](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/ado-pat-01.png)
...
Pre-requisites: -   [Create a tenant in Microsoft Entra](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
-   [Add a user to tenant in Microsoft Entra](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
-   [Create an organization in Azure portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
-   [Create an Azure DevOps app](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
-   [Register Azure DevOps as an OAuth provider](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
-   [Configure organization and project level settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
-   [Create credential record and get OAuth token](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
...
4.  Enter the client secret of your Azure application \(available in the Certificates &amp; secrets section of your Azure application registry in Azure\) in the **Client secret** field.![Connect to a tool - ADO OAuth 2.0](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/ado-oauth-01.png)
...
6.  Permission checks are run on the credentials that you entered.
    ...
    **Note:** When onboarding an Organization, the **Project Administrators** privilege requires the owner of the PAT to be a member of the organization's **Project Collection Administrators** group.
    ...
    ![Permissions required for Azure PAT.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-03.png)
...
7.  Specify the access for the tool.
    ...
    3.  Select **Assign**.
        ...
        ![Assign access groups.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-11.png)
...
8.  Install the ServiceNow DevOps extension in your Azure DevOps instance.
    ...
    For more information on the extension, see [Use the ServiceNow DevOps extension for Azure DevOps and Azure DevOps custom actions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/config-dev-ops-extensions-azure.md#).
    ...
    **Note:** If you skip this step, to send notifications from Azure DevOps, you must manually create service connections after configuring webhooks.
    ...
    ![Install the ServiceNow DevOps extension.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-01.png)
...
9.  Configure webhooks automatically in your Azure DevOps instance to send data to DevOps Change Velocity.
    ...
    1.  Enter the DevOps integration user name and password.
        ...
        For information about creating the DevOps integration user and password, see [Set up integration user account in DevOps Change Velocity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/devops-plybk-set-up-system-accts.md).
    ...
    3.  Select **Configure**.
        ...
        ![Configure Azure DevOps for organization.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-13.png)

    To configure webhooks manually, select **Configure manually**. See [Configure webhooks in Azure DevOps manually](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/configure-test-webhooks.md#) for more information.

    Webhook configuration and discovery happen in the background, and you’re taken to the Summary page.

    ![Organization connection summary.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-15.png)
...
2.  In the Connect to a tool modal, enter the connection details.
    ...
    ![Connect to project.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-10.png)
...
3.  Enter the instance details for your tool.
    ...
    1.  In the Enter Azure DevOps instance details section, select one of the following values in the **Credential type** field.
        ...
        -   **Personal Access Token**: Enter the password or access token to access this instance.
            ...
            For information on creating a PAT, see [Personal access token \(PAT\)](https://docs.microsoft.com/en-us/azure/devops/organizations/accounts/use-personal-access-tokens-to-authenticate?view=azure-devops&tabs=preview-page). ![Connect to a tool - ADO PAT](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/ado-pat-01.png)

        -   **OAuth 2.0**: Pre-requisites:

            -   [Create a tenant in Microsoft Entra](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
            -   [Add a user to tenant in Microsoft Entra](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
            -   [Create an organization in Azure portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
            -   [Create an Azure DevOps app](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
            -   [Register Azure DevOps as an OAuth provider](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/set-up-azure-devops-oauth-2-0-credential.md#)
            ...
            **Create a new credential record**
            ...
            ![Connect to a tool - ADO OAuth](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/ado-prj-oauth.png)
...
6.  Configure webhooks automatically in your Azure DevOps instance to send data to DevOps Change Velocity.
    ...
    2.  Select **Configure**.
        ...
        ![Configure Azure DevOps for a project.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-14.png)
...
7.  Select the plans to track.
    ...
    2.  Select **Next**.
        ...
        ![Select plans to track.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-02.png)

    3.  If you want to import plan data, select the date range and select **Submit**.

        You can import up to 90 days of data.

        ![Import plan data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-04.png)
...
8.  Select the repositories to track.
    ...
    2.  Select **Next**.
        ...
        ![Select repositories to track.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-05.png)

    3.  If you want to import repository data, select the date range and select **Submit**.

        You can import up to 90 days of data.

        ![Import repository data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-06.png)
...
9.  Select the pipelines to track.
    ...
    2.  Select **Next**.
        ...
        ![Select pipelines to track.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-07.png)
    ...
    4.  Select **Next**.
        ...
        ![Assign services to pipeline steps.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-08.png)

    5.  If you want to import pipeline data, select the date range and select **Submit**.

        You can import up to 90 days of data.

        ![Import historical pipeline data.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-17.png)
...
10. You're taken to the Summary page.
    ...
    ![Project connection summary.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../image/azure-plybk-16.png)
...
[Configure webhooks from the tool record](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../task/configure-webhooks-from-the-tool-record.md)
