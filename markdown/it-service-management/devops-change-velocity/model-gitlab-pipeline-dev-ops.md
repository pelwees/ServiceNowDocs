...
3.  Select the **Change control** check box in a step to enable [change acceleration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/dev-ops-change-acceleration.md) and the corresponding configuration fields.

    **Note:** The [Change Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../../change-management/concept/c_ITILChangeManagement.md) feature must be installed for change acceleration.
...
[Change acceleration in GitLab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/devops-change-velocity/../concept/dev-ops-change-gitlab.md)
