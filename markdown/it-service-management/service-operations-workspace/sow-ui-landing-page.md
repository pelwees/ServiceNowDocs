...
![Header section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/greeting-text.png "Header section")
...
![Option to navigate to the shift schedule of an agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/shift-schedule-agent.png "Shift schedule of an agent")
...
-   Request
 ...
 For information about customizing this section, see [Configure the donuts in the tier 1 landing page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/customize-first-level-cards.md).
...
This section notifies an agent of any announcements. The agent can view them in a list view or grid view.
 ...
 For information about how you can customize this section, see [Configure the Announcements section on the landing page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/modify-announcements-section.md).

 ![Announcements section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/announcements.png "Announcements section")
...
**Note:** An agent can also view tasks delegated to the agent by other users.
 ...
 ![Upcoming section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/upcoming-section.png)
...
-   The **Tomorrow** tab shows tasks coming up the day after the current day.
 ...
 When the [Workforce Optimization for ITSM plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../../configurable-workforce-optimization-itsm/task/activate-configurable-workforce-optimization-itsm.md) \(sn\_wfo\_cfg\_itsm\) is activated, you can also view your upcoming shift information and the following tasks are displayed in this section:
...
-   Shift sign-ups: Shifts that you can sign up for that are due on the current day and the day after the current day.
 ...
 For more information on Workforce Optimization for ITSM in Service Operations Workspace, see [Service Operations Workspace - Scheduling](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/itsm-sow-workspace-scheduling.md).

 For information about how you can customize this section, see [Configure the Upcoming section on the landing page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/modify-upcoming-section.md).
...
This section displays the configured quick links. For information about how you can customize this section, see [Add a user-specific quick link on the ITSM landing page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/add-quick-link.md).

 ![Quick links section](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/quick-links-section.png "Quick links section")
...
It provides an onboarding experience by specifying all key features to get started with Service Operations Workspace for ITSM.
 ...
 ![Onboarding experience for logged-in users](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/onboarding-sow-itsm.png "Onboarding section")
...
Analyze performance targets set by your manager.**Important:** This section is displayed only when the [Workforce Optimization for ITSM plugin](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../../configurable-workforce-optimization-itsm/task/activate-configurable-workforce-optimization-itsm.md) \(sn\_wfo\_cfg\_itsm\) is activated.
...
![My active learning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/my-active-learning.png)

For more information, see [Service Operations Workspace - Learning](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/itsm-sow-coaching.md).

</td></tr></tbody>
</table>**Parent Topic:**[Exploring Service Operations Workspace for ITSM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/explore-sow.md)
