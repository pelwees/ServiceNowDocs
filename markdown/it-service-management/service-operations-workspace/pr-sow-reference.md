...
To reset a password for a user, refer [Reset password using service-desk assistance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/reset-password-sd-pr-sow.md).
