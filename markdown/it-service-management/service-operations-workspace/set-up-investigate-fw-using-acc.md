...
-   Install the Agent Client Collector for Investigation Application. For more information, see [Install Agent Client Collector for Investigation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/install-acc-adapter.md).

    **Note:** Installing the Agent Client Collector for Investigation application requires the ITSM Pro package subscription.


-   **[Install Agent Client Collector for Investigation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/install-acc-adapter.md)**  
