...
-   **[Assign the Password Reset Service Desk role to the user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/assign-sd-role-pr-sow.md)**  
...
-   **[Create credential store for Password Reset in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/create-cred-store-pr-sow.md)**  
...
-   **[Create password reset process in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/create-password-reset-process-sow.md)**  
...
-   **[Configure the verification methods for service desk process in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/configuring-verification-methods-pr-sow.md)**  
...
-   **[Configure the password policies](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-password-policies-pr-sow.md)**  
Create a password policy to ensure that all passwords are strong and secure.
-   **[Configure the session properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-session-properties-pr-sow.md)**  
