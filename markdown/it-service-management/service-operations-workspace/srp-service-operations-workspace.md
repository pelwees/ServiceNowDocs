...
-   **[Adding Declarative Actions on the Standard Record Page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/customize-srp-sow.md)**  
...
-   **[Custom Modal Migration in Standard Record Page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/custom-modal-migration-srp.md)**  
Modify the modal containers inside a record page in the Service Operations Workspace.
-   **[Modify the Record Page in the Service Operations Workspace using the Standard Record Page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-record-page-order-sow.md)**  
...
-   **[Configure the Agent Assist tab in Service Operations Workspace using the Standard Record Page](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-agent-assist-tab-sow-srp.md)**  
...
**Parent Topic:**[Configuring record pages in Service Operations Workspace for ITSM](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/configuring-record-pages-sow-itsm.md)
