...
3.  To configure the support group recommendations, modify the **Script** field.
    ...
    For information about how these groups are available for an incident, see [Experts on-call in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../concept/on-call-sow.md#).
