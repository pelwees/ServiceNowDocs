...
7.  In the **Action input** field, add the script GUID.
    ...
    ![MECM restart service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/mecm-restart-service.png)
