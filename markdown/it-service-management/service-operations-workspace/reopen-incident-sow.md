...
An incident must be created and set to **Resolved** state. For more information, see [Create an incident in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/create-incident-sow.md).
