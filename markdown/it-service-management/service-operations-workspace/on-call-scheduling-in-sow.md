...
![On-call schedules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/Scheduling-in-SOW.png)
...
Use the Teams menu \(![Teams icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../../service-reliability/image/icon-sr-teams.png)\) in Service Operations Workspace to view all teams. Select a team card to view and manage a team's schedule, define escalation policies, and team preferences for the selected shift. This feature verifies that your team knows who is on call, is accountable, and is confident that critical alerts or incidents are acknowledged.
...
Select the Experts On-call icon \(![Experts on-call icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/experts-on-call.png)\) from the Contextual side panel to view and contact the recommended subject matter experts for help.

To view the escalation details and dynamic tracking of an on-call escalation, select the on-call escalations icon \(![On-call escalations icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/on-call-escalation.png)\) from the Contextual side panel.

-   **[Configuring On-Call Scheduling in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/configuring-oncall-scheduling-sow.md)**  
...
-   **[Scheduling in service operation workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/scheduling-in-service-operation-workspace.md)**  
View and manage schedules, shifts and time-off request.
-   **[On-call support for an incident in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/on-call-sow.md#)**  
