...
-   **[Configure a record page tab in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-record-page-tab.md)**  
Configure the display order of a record page tab in Service Operations Workspace.
-   **[Configure a task record form in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-form-layout-task.md)**  
...
-   **[Define and customize activity stream tags](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/define-customize-activity-stream-tags.md)**  
...
-   **[Configure the Assign or Resolve dialog box for an incident or change request in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/configure-assign-resolve-modals-incident.md)**  
...
-   **[Configure the experts On-call panel for an incident](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/customize-experts-on-call-tab.md)**  
Configure the **Experts on-call** panel for an incident.
-   **[Create a task type for problem or change in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/create-task-type-sow.md)**  
Configure a task type that can be used during problem or change creation.
-   **[Configuring Standard Record Page in Service Operations Workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/srp-service-operations-workspace.md)**  
