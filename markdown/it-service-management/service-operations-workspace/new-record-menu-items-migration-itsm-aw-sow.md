...
-   **[Perform post-migration tasks for new records](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../task/verify-migration-status-new-records.md)**  
