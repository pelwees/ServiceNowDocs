...
1.  On the incident record, select the **Collaborate** \(![Collaborate icon](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/mim-collaborate-icon.png)\) icon on the contextual side panel to open the collaborate tab on the side panel.
...
2.  Select the **Initiate collaboration** \(![Add call](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/../image/mim-add-call-chat-icon.png)\) icon.
...
-   **[Create adhoc communication and collaboration using the Related record tab](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/it-service-management/service-operations-workspace/create-adhoc-comm-collab-mim-sow.md)**  
