...
The frequency in number of days that the metric instance table should be purged of [work order task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/../../field-service-management/concept/close-wo-wot-mobile.md#) information to avoid an unnecessary amount of data in the table.-   Type: Integer
-   Default value: 365
-   Location: System Properties list \[sys\_properties\] table
