...
External manager of the contractor company can also assign additional manager role to a field service agent while on boarding them or later. For more information, see [Onboard agents on the Field Service Contractor Portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/workforce-optimization-for-field-service/../task/onboard-field-service-agent.md) and [Assign additional manager assignments to an agent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/workforce-optimization-for-field-service/../task/assign-additional-manager-assignments.md).
