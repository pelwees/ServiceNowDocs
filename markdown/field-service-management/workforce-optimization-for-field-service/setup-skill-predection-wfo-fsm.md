...
1.  Configure the properties for the Skill recommendation application.
    ...
    For more information, see [properties for the Skill Recommendation application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/workforce-optimization-for-field-service/../reference/components-wfo-fsm.md).
