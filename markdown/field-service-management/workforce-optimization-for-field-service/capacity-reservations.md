...
Select the demand channel for the reservation rule. For more information, see [Create a demand channel](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/workforce-optimization-for-field-service/../task/create-a-demand-channel.md). **Note:** Applies only if territory plugin is installed.
