...
-   Install
-   Planned Maintenance
 For more information, see [Create work types for a work order task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../../field-service-management/task/create-work-type-fsm.md).
