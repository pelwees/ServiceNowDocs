...
-   [Configuring work order templates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../../it-services/concept/c_WorkOrderTemplates.md)
...
-   [Configure the qualification state for work orders](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../task/configure-qualify-fsm.md)

    Allow for a quality check to make sure that the work order meets a certain standard before it moves to the next step.

-   [Customizing state flows](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/work-order-state-custom.md)
...
-   [Configuring Template Management for Field Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/enabling-advanced-configurations-for-wo-template.md)
...
-   [Signed PDF summaries for closed work orders](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/work-order-sign-and-confirm-pdf.md#)
