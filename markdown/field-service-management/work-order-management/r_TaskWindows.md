...
For more information on creating work order tasks, see [Create a work order task](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../task/t_CreateAWorkOrderTask.md).

For more information on Work order task start and end dates, see [Work order task start and end dates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../../field-service-management/reference/dynamic-sched-task-window-dates.md).
