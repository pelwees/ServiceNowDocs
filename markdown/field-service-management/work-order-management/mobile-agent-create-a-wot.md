...
1.  Navigate to the Create new work form.
    ...
    -   To create a work order task from the Work order overflow menu, navigate to the work order and select the **Overflow menu** ![Overflow icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../image/more-actions-mobile-icon.png). Select **Create new work**.
