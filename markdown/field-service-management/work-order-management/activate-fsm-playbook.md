...
-   Playbooks for Field Service Management requires the following plugins. Ensure that these plugins are activated before you install Playbooks for Field Service Management.
    -   **Required ServiceNow plugins**
        ...
        -   **Field Service Management**
            ...
            For information, see [Activate Field Service Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../../planning-and-policy/task/t_ActivateFieldServiceManagement.md).
