...
Optionally, you can click the search knowledge icon \(![Search knowledge icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/work-order-management/../image/SearchKnowledgeIcon.png)\) to view articles in the knowledge base relating to this product model, plan, or CI. Doing so could provide a solution related to the reason you are submitting a work order.
