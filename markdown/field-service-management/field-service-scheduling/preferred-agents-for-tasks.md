...
For more information on adding a preferred agent to a work order task see, [Set technician preferences for tasks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../task/assign-preferred-agents-tasks.md).
