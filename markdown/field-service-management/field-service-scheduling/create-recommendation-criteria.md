...
Some predefined recommendation criteria are provided for you. For more information, see [Predefined recommendation criteria](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../reference/fsm-task-recommendation-components.md#).
...
4.  In the **Script** field, enter the script that you want to run when recommending tasks to the agent.
    ...
    For information about custom script requirements, see [Providing a script for custom task recommendation criteria](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../reference/script-guidelines-recommendation-criteria.md).
