...
1.  Search for an agent in a specific location.
    ...
    ![lori and cupertino search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../image/lori-and-cupertino.png)
...
2.  Searching for more than one agent.
    ...
    ![lori or brian search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../image/lori-or-brian.png)
...
3.  Searching for agents, while excluding others.
    ...
    ![lori not ferguson search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../image/lori-not-ferguson.png)
...
4.  Searching for agents with just a few characters.
    ...
    ![l*i search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../image/l-star-i.png)
...
5.  Searching for more than one agent without using the full name.
    ...
    ![br or sha search](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../image/br-or-sha.png)
...
6.  Searching for a work order task by number only.
    ...
    ![task search number](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/../image/task-search-number.png)
