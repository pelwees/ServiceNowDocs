...
9.  Add matching rules to your configuration:
    ...
    -   To create your own matching rules, select **Save**, then see [Create matching rules for intraday events](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-scheduling/create-matching-rules-for-intraday-events.md).
