...
3.  Enable the work.management.enable.timezone.agnostic property. For more information see [Enable resource time indicators](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/../task/enable-equalized-time.md).
