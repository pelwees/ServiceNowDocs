...
![Calendar displaying an agent's schedule and daily assignments including work hours, tasks, personal meetings, and appointments.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/field-service-management/field-service-manager-workforce/../image/AgentCalendar.png "Agent Calendar")
