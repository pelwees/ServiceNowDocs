...
To learn more about the EMR Help data model, see [EMR Help data model](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/emr-help/emr-data-model.md).
