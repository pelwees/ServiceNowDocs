...
Document template to generate standard letters or documents associated with the policy.
 ...
 This field is used only when the [Policy type](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-policy-form.md#policy_type) field is set to **Document template**.
