...
As a user with the sn\_hcls.admin role, you can configure a privacy policy for obtaining consent from patients in a healthcare organization. For more information, see [Configure a privacy policy for managing patient consent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/../task/hcls-config-policy-consent.md).

You can determine the consent management process as one of the following types:

-   [Standard](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-consent-mgmt.md#section_ar1_sb2_ftb)
-   [Document](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-consent-mgmt.md#section_lgc_pb2_ftb)
