...
-   [Dosage specifications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md#section_xwz_z3x_htb)
-   [Dosage characteristics](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md#section_ur1_bjx_htb)
-   [Dosage characteristic groups](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md#section_cl5_qjx_htb)

To learn about how dosage components are linked to each other, see [Dosage characteristics mapping](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-dosage-concept.md#section_fwn_cjx_htb).

## Dosage specifications

A dosage specification consists of diagnosis details and dosage characteristics of a medication product associated with a program. For more information, see [Dosage specification table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/../reference/hcls-dosage-spec-table.md).

**Note:** When you add a dosage specification for a medication product, an equivalent dosage definition entry is added in the application. A dosage definition models a dosage specification for use as a request definition parameter. For more information, see [Dosage definition table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/../reference/hcls-dosage-defn-table.md).
...
![Infographic displaying default mapping of characteristics, characteristic groups, and the dosage details of a medication prescription.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/../image/hcls-characteristics.png "Default mapping of characteristics, characteristic groups, and the dosage details")
