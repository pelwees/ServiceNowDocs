...
-   As table rows where each index is displayed horizontally:
    ...
    ![Display types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-display-types-table-rows.png)

-   As table columns where each index is displayed vertically:

    ![Display types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-display-types-table-columns.png)

-   As list rows:

    ![Display types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-display-types-list-rows.png)

-   As a set repeater where each index is tied to a tier:

    ![Display types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-display-types-set-repeater.png)
...
![Display types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-display-types.png)
...
-   Show Index \(Table Display Type only\): Whether the index is displayed in the set.
    ...
    ![General settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-general-settings-show-index.png)
...
-   Index Label Template \(Table Display Type Only\): display a prefix or suffix string to the index numbers. Helps provide context of each index.
    ...
    ![layout](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-general-settings-index-level-template-1.png)

    ![General settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-general-settings-index-level-template-2.png)

-   Vertical Alignment \(List Display Type Only\): Control the alignment.
    -   Middle

        ![General settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-general-settings-vertical-alignment-middle.png)

    -   Top

        ![General settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-general-settings-vertical-alignment-top.png)
...
![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-message-settings.png)
...
-   Message summary position: display the message summary above or below the set. The following image shows Show Message Summary = true and Message Summary Position = Top.
    ...
    ![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-message-settings-1.png)
...
-   Show message when hovering indicator \(table display type only\): displays messages when users hover over the color-coded triangle.
    ...
    ![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-message-settings-2.png)
...
![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-size-settings.png)

-   Show size field: shows or hides the size field.

    ![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-size-settings-show-size-field.png)

-   Show Increment Size Button: control whether the green + icon is visible.

    ![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-size-settings-show-increment-size.png)

-   Size Field Display Type: Pick between a number field or a slider field for user input.

    ![Message settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-size-settings-size-field-display-type.png)
...
![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-inline-control-settings.png)
...
-   Show Dropdown Controls: show or hide the inline size control menu.
    ...
    ![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-inline-control-settings-menu.png)
...
![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-selection-settings.png)
...
-   Selection Type: choose between Single or Multiple. Single will appear as radio buttons and Multiple will appear as check boxes.
    ...
    ![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-selection-settings-single.png)

    Example of multiple selection where Show Selector = false:

    ![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-selection-settings-multiple.png)
...
-   Boolean field for selection: specify a field in the set that will be marked as true. This is required for the selection to work. If desired, the value can be displayed in the set itself:
    ...
    ![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-selection-settings-boolean.png)
...
![Inline control settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-layouts-search-settings.png)
...
[How sets interact with the rest of a blueprint](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/how_sets_interact_with_the_rest_of_the_blueprint.md)

[Creating set aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/creating_set_aggregates.md)
