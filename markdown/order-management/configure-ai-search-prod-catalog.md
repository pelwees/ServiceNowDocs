...
2.  [Configure Now Assist for Sales Force Automation \(SFA\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../../now-assist-som/task/configure-now-assist-som.md).
...
3.  [Run scheduled job to populate product offering categories](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/run-scheduled-job-prod-offer-categories.md) only if you upgraded to the Australia.
...
4.  [Run scheduled job to publish stop words dictionary, search profiles, and index tables](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/run-sched-job-index-stopwords-profile.md).
...
5.  [Enable AI Search in product catalog](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/enable-ai-search-catalog.md).
