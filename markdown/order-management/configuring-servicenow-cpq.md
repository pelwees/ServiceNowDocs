...
2.  [Set up a ServiceNow instance for CPQ Integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/cpq-integration-create-certificates.md).
3.  [Provision a Logik.ai instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/set-up-logik-instance.md)
4.  [Set up a ServiceNow instance connection with a Logik.ai instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/connect-sn-instance-logik.md).
5.  [Set up an external connection in CPQ](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/set-up-external-connection-logik.md).
6.  [Enable the CPQ Configurator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/enable-advanced-configurator.md).
