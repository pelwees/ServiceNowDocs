...
To learn more about setting up product offering catalogs, see [Configuring product offerings and catalogs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/som-managing-product-catalogs.md).
...
![Product catalog interface that shows the product catalog hierarchy, product tiles with images, and search option.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../image/som-catalog-ui.png "Product catalog user interface")
