...
Another worthwhile step when investigating any integration issue is to confirm that the steps in the [Installation and setup guide for environments linked to Salesforce orgs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/installation-and-setup-guide-for-environments-linked-to-salesforce-org.md) were correctly completed.

**Note:** If partner users are experiencing any of these issues, or you utilize RFQ APIs, first see the [Partner users/RFQ API sharing settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/common_salesforce_integration_issues.md#section_gml_qby_2hc) section at the end of this topic.

## Salesforce: “SBQQ: Too many SOQL queries: 101”

![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-error-SBQQ-too-many-SOQL-queries.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-additional-settings-enable-large-configurations.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-error-attempt-to-de-reference-a-null-object.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-pricebook-entry-missing.png)

![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-pricebook-entry-inactive.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-additional-settings-nested-bundles-for-external-configurator.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-logik-admin-settings-push-settings.png)
...
-   Check the permissions of the integration user against the list in [Required permissions for the integration user](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/integration_user_required_permissions.md).

## Saving does not create child quote lines

![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-shopping-cart-product-logik-environment.png)

CPQ BOM has the product CPQ environment.

![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-edit-quote-product-logik-environment-configurator.png)
...
-   Confirm that the BOM items have the correct BOM types as defined in CPQ Admin:
    ...
    ![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-logik-admin-settings-bom-types.png)
...
-   Check whether the parent configurable product has the related Dynamic feature defined:
    ...
    ![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-logik-environment-configurator-dynamic.png)

    If so, also confirm that the option selection method is also dynamic:

    ![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-edit-dynamic-option-selection-method.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-settings-editor-plugins-quote-calculator-plugin.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-error-JSON-string-exceeds-heap-size-limit.png)
...
-   Check whether the product has the related Feature Name, Configuration Attributes, and Price Books defined.
    ...
    ![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-product-related-tab.png)
...
![Salesforce issues](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-error-contact-blocked.png)

Solution:

-   If this is happening for only one user:
    -   Confirm that they have Admin access. See [User access](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/please_share_your_feedback_on_admin_assist_responses.md).
    -   Check whether they are running into browser issues. See [Common browser issues while using CPQ](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/common_browser_issues_while_using_logik_io.md).
-   If this is happening for a group of users:
    ...
    -   Confirm that CPQ has been added to Trusted URLs in the Setup section, with iFrame enabled. While this isn't necessary in all cases, we've seen this addition help organizations with CPQ users from multiple different countries, or if they are using Subscription Manager/RLM.
        ...
        ![Trusted URLs screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-setup-trusted-URLs.png)

    -   If this is happening for every user, check whether the URL is correctly entered in Custom Settings.

        ![Custom settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-salesforce-custom-settings.png)
...
![Information message](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-salesforce-insufficient-privileges.png)
...
-   If this is happening only for one Blueprint or when launching from one quote, check whether there are any errors in the Logs tab of the CPQ Admin.
    ...
    ![Logs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-logs-2.png)
...
-   If this is happening for only one user, check whether they are experiencing browser issues. See [Common browser issues while using CPQ](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/common_browser_issues_while_using_logik_io.md).
...
-   If this is happening for every user, confirm that the URL is correct in Salesforce CPQ. Navigate to Setup &gt; Installed packages &gt; Salesforce CPQ &gt; Configure &gt; Additional Settings &gt; External Configurator URL &amp; Third Party Configurator.
    ...
    ![External configurator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-salesforce-external-configuration-url.png)
...
![Sharing settings](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-salesforce-sharing-settings.png)
