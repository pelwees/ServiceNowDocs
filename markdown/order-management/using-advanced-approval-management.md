...
-   **[Tracking approval status and history](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/tracking-approval-status.md)**  
Monitor the progress of an approval request as it moves through the steps in an approval workflow.
-   **[Submitting approval requests](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/submitting-approval-requests.md)**  
...
-   **[Add approvers to an approval request](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/add-approver.md)**  
As a requester or an approver, add one or more ad-hoc approvers to an approval request in Advanced Approval Management.
-   **[Working with approval requests as an approver](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/approving-approval-requests.md)**  
