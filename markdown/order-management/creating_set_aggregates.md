...
![Set layout](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-1.png)

Below is the new sum aggregate during runtime:

![Create set screen](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-2.png)
...
![The Count aggregate](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-5.png)

**Note:** For multi-select picklists, it does not matter how many values are selected—it counts as one.

## Number field

![Number field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-3.png)

The count aggregate on this field would be 3 \(from index 1, 2, and 3\).

## Boolean field

![Boolean field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-4.png)
...
![The Average, Minimum, Maximum, and Sum aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-7.png)
...
![The Average, Minimum, Maximum, and Sum aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-8.png)
...
![Aggregates on picklist subfields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-9.png)
...
![Aggregates on picklist subfields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-10.png)

But if we select the numeric based options, the aggregates work.

![Aggregates on picklist subfields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-11.png)
...
![Aggregates on picklist subfields](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-12.png)
...
![Aggregates to the field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-18.png)
...
![Aggregates to the field](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-sets-aggregates-28.png)
