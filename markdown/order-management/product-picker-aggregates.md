...
**Note:** Before you read this article, we recommend that you understand the product picker field type and how to create a product picker. See [Product pickers](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/product_picker_overview.md).
...
![Product picker: Aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-product-picker-aggregates-new.png)
...
-   Base Field: A list of available subfields of the product picker is displayed here. Select the sub-field to create a new aggregate.
    ...
    ![Product picker: Aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-product-picker-aggregates-base-field.png)

-   Aggregate Type: Select the aggregate type whose behavior fits your use case: Sum, Average, Min, Max, or Count.

    ![Product picker: Aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-product-picker-aggregates-type.png)
...
For steps to create and configure an aggregate using API calls, see [Adding a product picker aggregate using APIs](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/cpq-adding-a-product-picker-aggregate-using-apis.md).
...
![Product picker: Aggregates](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-product-picker-aggregates-new-2.png)
