...
3.  Open a channel partner record from the list.
    ...
    To learn more about the components on the channel partner record, see [Channel Partner components on workspace](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../reference/channel-partner-components.md).
