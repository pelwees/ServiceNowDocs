...
6.  In the Catalog tab, add products to the new quote or order that is created.
    ...
    For more info, see [Add products to a quote](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../../tmt-order-mgt/task/quote-management-catalog-tab.md).
