...
![Sequence of steps in the default pricing plan, described in the following table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../image/default-pricing-plan-q42025.png "Default Pricing Plan steps")
...
Get costs from a [cost book](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/create-cost-books.md), if your organization is using cost books in Quote Management.
...
Get the list price for all requested products based on the [price list](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/som-create-price-list.md), unit of measurement, and data provided to the pricing API.
...
-   [Create a configurable pricing plan](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/create-custom-pricing-plan.md) \(copy the default plan\).
-   [Add or change a pricing plan step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/add-pricing-step.md). In your configurable pricing plan, you can add one or more pricing steps for pricing adjustments, including any conditions for running the step. If needed, you can also change the sequence of the adjustment step.
-   [Delete a pricing plan step](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/delete-pricing-plan-step.md), if needed.
