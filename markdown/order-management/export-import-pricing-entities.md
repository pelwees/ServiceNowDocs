...
|Step|Description|
|----|-----------|
|[Export pricing entities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/export-pricing-entities.md)|Export pricing entities from one instance to another. The entities are exported as JSON and are downloaded to your local download directory.|
|[View export job status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/view-export-job-status.md)|Check the state of the export job.|
|[Import pricing entities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/import-pricing-entities.md)|Import pricing entities exported as JSON files to another instance.|
|[View import job status](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/view-import-job-status.md)|Check the state of the import job.|
