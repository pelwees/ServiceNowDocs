...
6.  On the Configurator UI, modify the existing configurations for the customer contract line.
    ...
    To learn more about the Configurator UI, see [Exploring Sales Customer Relationship Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../../tmt-order-mgt/concept/som-exploring.md).
