...
2.  Within an integrated development environment \(IDE—in this example, VSCode\), or on the command line:
    1.  Connect to your Salesforce org using the Salesforce CLI or Salesforce Extensions for the IDE.
        ...
        ![Lightening code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-embed-logik-lightning-code.png)
    ...
    2.  Open the folder and publish to org using Salesforce CLI or the extensions in your IDE. In VSCode, this means right- clicking the folder in the VSCode explorer and clicking Deploy Source to Org.
        ...
        **Note:** To complete this step, you must be connected to the org.
        ...
        ![Menu](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-embed-logik-lightning-code-deploy.png)

3.  Go into the Salesforce page where you want to embed CPQ.
4.  On the Setup menu, click Edit Page.

    ![User interface](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-embed-logik-lightning-edit-page.png)

5.  Drag the Logik LWC from the menu at the bottom left into the page layout where you want to embed CPQ.

    ![Menu bar](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-embed-logik-lightning-drag.png)

6.  Add the configuration URL.

    ![Config url](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../images/cpq-embed-logik-lightning-config-url.png)
