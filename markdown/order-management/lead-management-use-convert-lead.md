...
Details to create an opportunity. To learn more, see [Create an opportunity](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../concept/create-new-opportunity.md).-   Create new: Select if you want to create a new opportunity.
