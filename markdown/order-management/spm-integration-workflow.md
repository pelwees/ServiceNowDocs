...
-   **SPM integration flow**
    ...
    -   Site project oversight determination: Qualifies the site location for site project oversight.
        ...
        To configure site project oversight for product offering, see [Configure project oversight for Product offering](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/configure-site-project-product-offering.md).
