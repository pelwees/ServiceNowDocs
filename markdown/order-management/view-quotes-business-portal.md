...
2.  Navigate to **Requests** &gt; **View submitted requests** &gt; **View quotes**.
    ...
    |State|Status of the quote. For more information, see [Request for quote \(RFQ\) states](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../reference/rfq-states.md).|
