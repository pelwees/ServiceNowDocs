...
9.  For disconnecting, suspending, or resuming products or services, perform the following steps.
    ...
    2.  Enter suspension start and end dates for suspend requests and select **Suspend**.
        ...
        If you do not specify a date, the suspension is effective immediately. For more information, see [Suspend and resume products and services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../concept/order-mgt-suspend-resume-action.md).
...
**Parent Topic:**[Managing post-fulfillment order changes](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../concept/managing-orders.md)

**Related topics**  


[Suspend and resume products and services](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../concept/order-mgt-suspend-resume-action.md)
