...
2.  [Enable the Business Portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/order-management-enable-business-portal.md)

    Enable the Business Portal \(sn\_b2b\_portal\) so customers can browse products and create orders.

3.  [Configuring product catalog visibility on the Business Portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/catalog-visibility-business-portal.md)
...
4.  [Install Sales Cart](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/install-sales-cart-plugin.md)

    Provide easy order creation and checkout processes to your customers through the Sales Cart application.

5.  \(Optional\) [Install Customer Request for Quote](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/install-rfq-plugin.md)
...
6.  \(Optional\) [Install apps for self-service order case management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/activating-self-service-order-case-management-business-portal.md)
...
-   [Add a logo to the sales cart PDF](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/add-logo-sales-cart-pdf.md)
...
-   [Modifying the data retention and table cleanup policy for the Sales Cart application](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/modify-data-retention-table-cleanup-sales-cart.md)
...
-   [Modify terms and conditions for the sales cart](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../task/modify-terms-conditions-sales-cart.md)
...
[Business Portal reference for Sales Customer Relationship Management](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../reference/som-business-portal-reference.md)

[Enable the manage order operations agent on the Business Portal](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/order-management/../../now-assist-order-mgmt/task/enable-manage-order-operations-ai-agent.md)
