...
To access this method from a client-side script, you must use [GlideAjax\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/../../GlideAjax/concept/c_GlideAjaxAPI.md#) to invoke it. To invoke this method from a server-side script, use something similar to the following to instantiate the object and access the method.
