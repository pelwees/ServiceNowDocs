...
When code generation is enabled on an instance, a Now Assist icon \(![Now Assist icon.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../../../common/image/icon-ai-sparkle.png)\) appears at the bottom of the script editor.
...
For more information, see [Generate code with autocomplete](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/generate-code-with-autocomplete.md).
...
For more information, see [edit-code-now-assist.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/edit-code-now-assist.md).
...
For more information, see [Explain and summarize code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/explain-and-summarize-code-with-quick-actions.md).

## Now Assist for Code benefits

|Benefit|Feature|Users|
|-------|-------|-----|
|Generate code based on your prompts to improve quality and reduce repetitive tasks.|[Generate code with AI-powered code generation](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../task/generate-scripts-from-text.md)|Developers|
|Quickly edit and refactor large code segments.|[edit-code-now-assist.md](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/edit-code-now-assist.md)|Developers|
|Add comments to code segments.|[Add comments to code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/add-comments-to-code-with-quick-actions.md)|Developers|
|Understand code.|[Explain and summarize code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/explain-and-summarize-code-with-quick-actions.md)|Developers|
|Identify code generated by AI.|[Tracking AI-generated code](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/tracking-ai-generated-code.md#)|Developers, administrators|
