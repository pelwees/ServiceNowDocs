...
Use the Script Debugger and session logs to debug server-side code. For more information, see [Script Debugger and Session Log](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/script-debugger.md).

You can also use session debug to display error messages related to a server-side script that runs as a result of a client-side change. For more information, see [Debugging sessions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/c_SessionDebug.md#).

GSLog is a script include that simplifies script logging and debugging by implementing levels of log output, selectable by per-caller identified sys\_properties values. For more information, see [GSLog API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../../../app-store/dev_portal/API_reference/GSLogBoth/concept/GSLogBoth.md#).
...
-   **[Script Debugger and Session Log](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/script-debugger.md)**  
...
-   **[Debugging sessions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/c_SessionDebug.md#)**  
Enable session debugging to display debugging messages in the user interface.
-   **[Debugging applications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/c_DebuggingApplications.md#)**  
...
-   **[Debugging business rules](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../../business-rules/reference/r_DebuggingBusinessRules.md)**  
Debugging business rules can be achieved with resources available in the ServiceNow product.
-   **[Debugging classifications](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../reference/r_DebuggingClassifications.md)**  
You must add a system property to enable classification debugging.
-   **[JS Code Coverage Debug](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/js-code-coverage-debug.md#)**  
...
-   **[JavaScript debug window](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/c_JavaScriptDebugWindow.md)**  
