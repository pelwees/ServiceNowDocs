...
-   **[Jelly escaping types](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../../server-scripting/reference/r_JellyEscapingTypes.md#)**  
...
-   **[Extensions to Jelly syntax](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../concept/c_ExtensionsToJellySyntax.md#)**  
Apache's Jelly syntax is used to render forms, lists, UI pages, and many other things rendered in ServiceNow.

**Parent Topic:**[Creating custom UI Pages and UI macros](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/scripts/../concept/create-custom-ui-pages.md)
