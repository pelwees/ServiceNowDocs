...
|Type|Description|
|----|-----------|
|AnyPublisher&lt;[Now​Push​Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowPushService/concept/NowPushServiceiOSAPI.md#), NowServiceError&gt;|If successful, returns an initialized [Now​Push​Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowPushService/concept/NowPushServiceiOSAPI.md#) object. If it fails, returns a NowServiceError object.|
