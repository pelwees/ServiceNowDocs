...
|Type|Description|
|----|-----------|
|AnyPublisher&lt;[NowChatService](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowChatService/concept/NowChatServiceiOSAPI.md#), NowServiceError&gt;|If successful, returns an initialized NowChatService object. If it fails, returns a NowServiceError object.|
