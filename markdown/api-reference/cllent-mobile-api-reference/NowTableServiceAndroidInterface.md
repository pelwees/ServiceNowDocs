...
[FieldWriteOptions](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../FieldWriteOptions/concept/FieldWriteOptionsAndroidAPI.md#)
...
|configuration|[FetchConfiguration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../FetchConfiguration/concept/FetchConfigAndroidAPI.md#)|Configuration that specified the filters to use, pagination page size limit, which fields to retrieve, and what to include in the fields.|
...
|tableName|String|Name of the table in which the specified record is located, such as incident or asset.|
|configuration|[FieldReadConfiguration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../FieldReadConfiguration/concept/FieldReadConfigAndroidAPI.md#)|Optional. Configuration that specifies which fields to retrieve and what to include in the fields.|
