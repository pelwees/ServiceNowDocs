...
For more information, see [Cabrillo JS constants - message styles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../namespace-topics/concept/cabrillo-constants.md#).
