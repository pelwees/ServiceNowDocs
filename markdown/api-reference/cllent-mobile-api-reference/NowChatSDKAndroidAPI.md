...
|nowChatSdkCallbacks|[NowChatSdkCallbacks](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowChatSdkCallbacks/concept/NowChatSdkCallbacksAndroidInt.md#)|Callbacks for the host application to use to configure the NowChatService.|
