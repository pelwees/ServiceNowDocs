...
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowWebViewController/concept/NWebViewControlleriOSAPI.md#)|Instance of NowWebViewController where the flow ended.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowWebViewController/concept/NWebViewControlleriOSAPI.md#)|Instance of NowWebViewController in which the navigation failed.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowWebViewController/concept/NWebViewControlleriOSAPI.md#)|Instance of NowWebViewController used when attempting to load the unsupported URL.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowWebViewController/concept/NWebViewControlleriOSAPI.md#)|Instance of NowWebViewController in which the back navigation was attempted.|
...
|Name|Type|Description|
|----|----|-----------|
|nowWebViewController|[NowWebViewController](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../NowWebViewController/concept/NWebViewControlleriOSAPI.md#)|Instance of NowWebViewController in which the web UI theme changed.|
