...
For more details on the ServiceNow GraphQL API, see [Query record data using the GraphQL API framework](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../../../../../integrate/graphql/concept/scripted-graph-ql.md).
...
|Type|Description|
|----|-----------|
|[Call](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/cllent-mobile-api-reference/../../Call/concept/CallAndroidInterface.md#)&lt;[Byte Array](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-byte-array/)&gt;|Query response.|
