...
The following shows how to obtain a [Call](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/developer-guides/../../../../../app-store/dev_portal/API_reference/MobileSDKAndroid/Call/concept/CallAndroidInterface.md#) object that fetches metadata for a particular attachments. It creates an executable object that is able to perform the specified request and return `Response<NowAttachmentMetadata>`.
...
The following shows how to obtain a [Call](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/developer-guides/../../../../../app-store/dev_portal/API_reference/MobileSDKAndroid/Call/concept/CallAndroidInterface.md#) object that fetches metadata for multiple attachments. It creates an executable object that is able to perform the specified request and return `Response< List<NowAttachmentMetadata>>`.
