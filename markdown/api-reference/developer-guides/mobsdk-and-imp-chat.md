...
You use the [NowChatSDK](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/developer-guides/../../../../../app-store/dev_portal/API_reference/MobileSDKAndroid/NowChatSDK/concept/NowChatSDKAndroidAPI.md#) API to create the chat service. Once the service is created, you must then start the chat user interface.
