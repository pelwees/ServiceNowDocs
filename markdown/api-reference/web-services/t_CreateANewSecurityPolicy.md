...
3.  Fill out the SOAP Security Policy form \(see table\).
    ...
    |Security Profiles|Select the [security profiles](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../reference/ws-security-reference.md) you want to apply to this SOAP security policy. You must select at least one security profile.|
