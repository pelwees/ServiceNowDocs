...
**Parent Topic:**[Getting started with ODBC](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../concept/c_GettingStartedWithODBC.md)

**Previous topic:**[Create an ODBC user account and assign the odbc role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/t_CreateAnODBCUser.md)

**Next topic:**[Installing the ODBC driver](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../concept/c_InstallingTheODBCDriver.md)
