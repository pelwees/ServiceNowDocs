...
**Note:** Before downloading and installing the ODBC driver, [review the requirements](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../reference/r_ODBCDriverInstallationReqs.md) to ensure that your configuration is compatible.

1.  [Create an ODBC user account and assign the odbc role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/t_CreateAnODBCUser.md)  
...
2.  [Define an ACL rule for the odbc role](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/t_DefineAnACLRuleForTheODBCRole.md)  
