...
**Important:** The AttachmentCreator SOAP web service is not recommended. Instead, use the REST [Attachment API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../inbound-rest/concept/c_AttachmentAPI.md#) to manage attachments with web services.
