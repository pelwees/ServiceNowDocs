...
-   **[Enable basic authentication for outbound SOAP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/t_BasicAuthentication.md)**  
If the endpoint requires a user name and password, you can provide credentials using basic authentication.
-   **[Enable WS-Security for outbound SOAP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/t_WebServiceSecurity.md)**  
