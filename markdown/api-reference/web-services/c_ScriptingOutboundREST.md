...
-   **[Generate a REST message script preview](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/t_ScriptingWithREST.md)**  
...
-   **[Direct RESTMessageV2 example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../../app-store/dev_portal/API_reference/RESTMessageV2/reference/r_DirectRESTMessageV2Example.md)**  
You can send an outbound REST message directly to the endpoint.
-   **[RESTMessageV2 MID server example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../../app-store/dev_portal/API_reference/RESTMessageV2/reference/r_RESTMessageV2MIDServerExample.md)**  
You can send an outbound REST message through a MID Server.
-   **[Recordless RESTMessageV2 example](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../../app-store/dev_portal/API_reference/RESTMessageV2/reference/r_RecordlessRESTMessageV2Example.md)**  
