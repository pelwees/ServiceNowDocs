...
To test queries to your GraphQL APIs, you can use the GraphQL Explorer, an integrated GraphQL testing tool. For more information, see [Test GraphQL APIs with GraphQL Explorer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/test-gql-schema.md).
...
-   **[Create a GraphQL schema](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/build-graphql-scripted-schema.md#)**  
Create a GraphQL schema to make data available to GraphQL queries.
-   **[Enable introspective queries for GraphQL schemas](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/enable-introspective-queries-graphql-schemas.md)**  
Discover the queries and mutations supported by schemas on your instance by enabling introspection.
-   **[Test GraphQL APIs with GraphQL Explorer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/test-gql-schema.md)**  
Test query your GraphQL APIs using an integrated GraphQL testing tool.
-   **[Query a GraphQL schema from a component](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/query-schema-from-component.md)**  
Access record data in a component by querying your scripted GraphQL schema.
-   **[GraphQL system properties](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../reference/graphql-properties.md)**  
