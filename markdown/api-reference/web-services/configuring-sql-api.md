...
1.  Instance Setup:
    ...
    -   [Configure SQL API plugin on your ServiceNow instance](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/configure-sql-api-overview.md)
2.  Driver Installation and Configuration:
    ...
    -   [Download the SQL API drivers on client machine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/download-sql-api-drivers.md)
    -   [Install ServiceNow SQL API ODBC driver on client machine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/install-odbc-driver.md)
    -   [Configure ServiceNow SQL API ODBC driver on client machine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/configure-odbc-driver.md)
    -   [Configure ServiceNow SQL API JDBC driver on client machine](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/configure-jdbc-driver.md)
...
-   **[Test SQL API ODBC driver connection using Interactive SQL](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/test-sql-api-odbc-driver-connection-using-interactive-sql.md)**  
...
-   **[Route SQL API calls to Read Replica](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/routing-sql-api-calls-to-read-replica.md)**  
