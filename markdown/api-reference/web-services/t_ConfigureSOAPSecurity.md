...
2.  [Create a WS-security profile](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/t_CreateANewWS-SecurityProfile.md).

3.  [Create a security policy](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/t_CreateANewSecurityPolicy.md).
