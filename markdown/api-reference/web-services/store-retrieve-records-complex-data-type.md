...
|JSON|JSONv2|Various. See [JSON data retrieval API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../inbound-other-web-services/concept/c_DataRetrievalAPI.md).|Y|
|PDF|PDF|sysparm\_query, sysparm\_view|N|
|RSS|RSS|sysparm\_query, sysparm\_view and more. See [Limiting results with a view](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../rss/concept/c_LimitingResultsWithAView.md).|N|
|XML|XML, XSD, SCHEMA|sysparm\_query, useUnloadFormat|N|

For more information about retrieving and converting table records into the JSON file format, see [JSONv2 Web Service](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../inbound-other-web-services/concept/c_JSONv2WebService.md).

For more information about retrieving and converting table records into the RSS file format, see [RSS feed generator](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../../rss/concept/c_RSSFeedGenerator.md).
