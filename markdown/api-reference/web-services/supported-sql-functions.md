...
**Parent Topic:**[Getting started with ServiceNow SQL API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../concept/getting-started-with-servicenow-sql-api.md)
