...
-   **[Configure C sharp with .NET](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../task/t_ConfigureCSharpWith.NET.md)**  
Configure web services within ServiceNow.
-   **[Call a web service in visual studio .NET](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/c_CallAWebServiceInVisualStudioNET.md)**  
Call a web service using Visual Studio 2008.
-   **[C Sharp integration results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/c_Results.md)**  
...
-   **[Troubleshoot a null response in a C Sharp integration](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/c_Troubleshoot.md)**  
