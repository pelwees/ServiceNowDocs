...
-   **[Use filters to limit the number of results](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../reference/r_UseFiltersLimitNumberOfResults.md)**  
...
-   **[Use a local data store to pull data from](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../reference/r_LclDtaStorePullDta.md)**  
...
-   **[Use Java/C\#/PHP code to fetch the XML data using basic authentication](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/../reference/r_FetchTheXMLData.md)**  
...
**Parent Topic:**[Retrieve a large number of records using SOAP](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/web-services/c_RtvLrgNmbrRcrdSOAP.md)
