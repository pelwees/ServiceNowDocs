...
Remote table rows are created using the [v\_table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_table/concept/v_tableAPI.md#) API.
...
See also [v\_table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_table/concept/v_tableAPI.md#) API.
...
-   [v\_table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_table/concept/v_tableAPI.md#) API
...
-   [Querying tables in script](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../script/server-scripting/concept/c_UsingGlideRecordToQueryTables.md#)
-   [v\_table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_table/concept/v_tableAPI.md#) API
...
-   [Scoped GlideRecord - getLastErrorMessage\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#)
-   [Retrieving specific records from a third-party source](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/remote-tables/remote-table-script-def-example2.md)
-   [v\_table](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_table/concept/v_tableAPI.md#) API
