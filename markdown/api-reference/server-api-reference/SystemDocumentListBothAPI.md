...
To create or manage a document list, use the [DocumentListService API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../DocumentListService/concept/DocumentListServiceBothAPI.md#).
...
The following example shows how to add a description to the document list. See also [DocumentListService API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../DocumentListService/concept/DocumentListServiceBothAPI.md#).
...
The following example shows how to rename an existing document list. See also [DocumentListService](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../DocumentListService/concept/DocumentListServiceBothAPI.md#).
