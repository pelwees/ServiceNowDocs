...
Use this API with the [PreferenceDestination](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PreferenceDestination/concept/PreferenceDestinationBothAPI.md#) API to update user notification preferences.
...
|Type|Description|
|----|-----------|
|Array|Array of [PreferenceDestination](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PreferenceDestination/concept/PreferenceDestinationBothAPI.md#) objects. If the user doesn't have any destinations, the array is empty.|
...
|Type|Description|
|----|-----------|
|Array|Array of [PreferenceDestination](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PreferenceDestination/concept/PreferenceDestinationBothAPI.md#) objects. If the user doesn't have any notification destinations that use the channel or if the channel doesn't exist, the array is empty.|
