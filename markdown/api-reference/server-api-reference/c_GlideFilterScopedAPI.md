 ...
 **Note:** The **filter** values are case-sensitive. In addition, you cannot use [setCaseSensitive\(false\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/c_GlideFilterScopedAPI.md#) to change the change the case-sensitive value.
