...
Error object. For more information about the types of error objects that can be used, see [Scripted REST API example - script samples](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../integrate/custom-web-services/reference/r_ScriptedRESTServiceScriptExamples.md).
