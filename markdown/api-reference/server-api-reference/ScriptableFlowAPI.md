...
|Type|Description|
|----|-----------|
|[ScriptableFlowRunner](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ScriptableFlowRunnerScoped/concept/ScriptableFlowRunnerScopedAPI.md#)|Builder object used to run a Workflow Studio action, flow, or subflow.|
