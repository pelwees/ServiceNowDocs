...
|Name|Type|Description|
|----|----|-----------|
|name|String|Name of the [ClassificationSolution\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClassificationSolution/concept/ClassificationSolutionAPI.md#) object to be deleted.|
...
|Type|Description|
|----|-----------|
|Object|[ClassificationSolutionVersion](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClassificationSolutionVersion/concept/ClassificationSolutionVersionAPI.md#) object. Returns an error if the object does not exist.|
