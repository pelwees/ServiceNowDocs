...
You can use search query details retrieved with this API to populate Genius Result answer objects created with the [GeniusResultAnswer](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GeniusResultAnswerScoped/concept/GeniusResultAnswerScopedAPI.md#) API.
