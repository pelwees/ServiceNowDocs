...
Use v\_record with the [v\_query – Scoped, Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_query/concept/v_queryAPI.md#) scriptable object to query remote tables, and the [v\_table – Scoped, Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../v_table/concept/v_tableAPI.md#) API to create remote tables.
