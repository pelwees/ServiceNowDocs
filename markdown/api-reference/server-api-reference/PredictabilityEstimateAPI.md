...
2.  Use the [constructor](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/PredictabilityEstimateAPI.md#) to create a predictability estimate object.
3.  Add the predictability estimate object to the predictability estimate store using the [PredictabilityEstimateStore - add\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PredictabilityEstimateStore/concept/PredictabilityEstimateStoreAPI.md#) method.
...
5.  Get estimated predictive values using the [PredictabilityEstimateVersion – getResults\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PredictabilityEstimateVersion/concept/PredictabilityEstimateVersionAPI.md#) method.
...
|Type|Description|
|----|-----------|
|Object|Active [PredictabilityEstimateVersion](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PredictabilityEstimateVersion/concept/PredictabilityEstimateVersionAPI.md#) object.|
...
|Type|Description|
|----|-----------|
|Array|Existing versions of a solution object. See also [PredictabilityEstimateVersion](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PredictabilityEstimateVersion/concept/PredictabilityEstimateVersionAPI.md#) API.|
...
Lists the properties of the [DatasetDefinition\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../DatasetDefinition/concept/DatasetDefinitionAPI.md#) object associated with the estimate.
...
Name of the [PredictabilityEstimate\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/PredictabilityEstimateAPI.md#) object version to activate.Activating this version deactivates any other version.
...
**Note:** Before running this method, you must first add a predictability estimate to the store using the [PredictabilityEstimateStore - add\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../PredictabilityEstimateStore/concept/PredictabilityEstimateStoreAPI.md#) method.
