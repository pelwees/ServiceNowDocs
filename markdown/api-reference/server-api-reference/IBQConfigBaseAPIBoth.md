...
Optional. JSON object needed to process the request using the PrimitiveUtil\(\) API. For usage information, see [LeadToCashCore](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../LeadtoCashCoreScoped/concept/LeadToCashCoreAPI.md#).```
"payload": {
...
[GlideRecord](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#) reference to the Inbound Request record that has triggered the flow.Table: Inbound Request \[sn\_tmt\_core\_inbound\_queue\] 
