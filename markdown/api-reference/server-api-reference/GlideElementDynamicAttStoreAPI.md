...
This API extends the [GlideElement - Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideElement_global/concept/c_GlideElementAPI.md#) API.
...
|Type|Description|
|----|-----------|
|Array|Array of [GlideDynamicAttribute](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideDynamicAttribute/concept/GlideDynamicAttributeAPI.md#) objects.|
...
|Name|Type|Description|
|----|----|-----------|
|values|[GlideDynamicAttributeStore](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideDynamicAttributeStore/concept/GlideDynamicAttStoreAPI.md#)|Object that contains the values to set in the current element's dynamic schema. Values not specified in this object are not updated.|
