...
|----|----|-----------|
|mlSolution|[ClusteringSolution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#)|[ClusteringSolution\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#) object to add to the store.|

|Type|Description|
|----|-----------|
|String|System-generated solution name.|

The following example shows how to add a solution to the store. Use [ClusteringSolution - submitTrainingJob\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#) to run the training job after adding it to the store.
...
|Name|Type|Description|
|----|----|-----------|
|name|String|Name of the [ClusteringSolution\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#) object to be deleted.|
...
|Type|Description|
|----|-----------|
|Object|[ClusteringSolution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#) object. Returns an error if the object does not exist.|

The following example shows how to get a solution object from the store using the get\(\) method and view its training status using the [ClusteringSolution - getActiveVersion\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#) and [ClusteringSolutionVersion - getStatus\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolutionVersion/concept/ClusteringSolutionVersionAPI.md#) methods.
...
|mlSolution|[ClusteringSolution](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#)|[ClusteringSolution\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ClusteringSolution/concept/ClusteringSolutionAPI.md#) object properties to update.|
