...
|----|----|-----------|
|grSchedule|[GlideRecord](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#)|GlideRecord object pointing to the record containing the job for which you want to get the schedule occurrences.|

|Type|Description|
|----|-----------|
|Array of [GlideDateTime](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideDateTime/concept/c_GlideDateTimeAPI.md#) objects|GlideDateTime object for each time that the schedule job should run.|
