...
You must have a REST message record defined before you can use this constructor. For instructions, see [Create a REST message](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../integrate/outbound-rest/task/t_ConfiguringARESTMessage.md).
...
You must set an HTTP method when using the [RESTMessageV2 - RESTMessageV2\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/c_RESTMessageV2API.md#) constructor with no parameters.
