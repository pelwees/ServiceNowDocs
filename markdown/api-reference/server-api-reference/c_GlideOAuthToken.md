...
This example code shows how to retrieve access and refresh tokens from the instance database. See also [GlideOAuthClient](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideOAuthClient/concept/c_GlideOAuthClient.md#).
...
</table>This example code shows how to retrieve access and refresh tokens from the instance database. See also [GlideOAuthClient](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideOAuthClient/concept/c_GlideOAuthClient.md#).
