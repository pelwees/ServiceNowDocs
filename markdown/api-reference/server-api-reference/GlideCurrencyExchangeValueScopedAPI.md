...
There is no constructor for this class. Use the convert\(\) method from the [GlideCurrencyConverter](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideCurrencyConverter/concept/GlideCurrencyConverterScopedAPI.md#) API to return a GlideCurrencyExchangeValue object.
