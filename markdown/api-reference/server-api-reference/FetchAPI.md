...
-   A [Fetch Request - Request\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/Fetch.RequestAPI.md#) object.
...
Optional. A [Fetch RequestInit - Scoped, Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/Fetch.RequestInitAPI.md#) object containing custom settings to apply to the request.Default: The request is passed without any customization settings.
...
-   response.json\(\): Parses the JSON response body into a JavaScript object. \(See [Fetch Response - json\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/Fetch.ResponseAPI.md#) for more information.\)
-   console.log\(\): Outputs the incidents \(data.result\) using the Console API \(See [Console - log\(Object val1...val2, String msg, String subst1...subst2\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../Console/concept/ConsoleAPI.md#)\).
