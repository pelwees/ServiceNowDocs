...
For handling lower-level instances of a segment, such as a header or item, refer to [SegmentHandle API - Scoped](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../SegmentHandleScoped/concept/SegmentHandleAPIScoped.md#).

See also [sn\_erp\_integration API - Scoped, Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../sn_erp_integrationBoth/concept/sn_erp_integrationBothAPI.md#).
...
|Type|Description|
|----|-----------|
|Object|[SegmentHandle](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../SegmentHandleScoped/concept/SegmentHandleAPIScoped.md#) for the new segment instance.|
