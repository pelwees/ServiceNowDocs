...
This API is the scoped equivalent of [CMDBQueryBuilderAPI - Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../CMDBQueryBuilderAPI/concept/CMDBQueryBuilderAPI.md#).
