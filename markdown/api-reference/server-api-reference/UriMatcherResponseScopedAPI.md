...
Use this API with the UriMatcher API. This API doesn't have a constructor. Instead, use the [UriMatcher - match\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../UriMatcherScoped/concept/UriMatcherScopedAPI.md#) method to instantiate a UriMatcherResponse object.
