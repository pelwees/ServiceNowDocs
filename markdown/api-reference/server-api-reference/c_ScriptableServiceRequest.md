...
|----|----|-----------|
|body|[RESTAPIRequestBody](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../ScriptableServiceRequestBody/concept/c_ScriptableServiceRequestBody.md#)|The body of the request. You can access data from the body object using the RESTAPIRequestBody API.|
