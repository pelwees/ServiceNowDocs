...
The following example shows how to add a document template as a document list entry. See also [DocumentListEntryService API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../DocumentListEntryService/concept/DocumentListEntryServiceBothAPI.md#).
...
The following example shows how to set the document list in which to add a document. See also [DocumentListEntryService API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../DocumentListEntryService/concept/DocumentListEntryServiceBothAPI.md#).
