...
[NotifyPhoneNumber](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../NotifyPhoneNumberScoped/concept/NPNScopedAPI.md#)
...
|Name|Type|Description|
|----|----|-----------|
|notifyPhoneNumber|[NotifyPhoneNumber](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../NotifyPhoneNumberScoped/concept/NPNScopedAPI.md#)|Notify phone number or short code to which to send this SMS message.|
|toPhoneNumber|String|E.164-compliant phone number to which to send the SMS message.|
|messageBody|String|SMS text message.|
|source|[GlideRecord](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#)|Source record that prompted this SMS message, such as an incident.|
