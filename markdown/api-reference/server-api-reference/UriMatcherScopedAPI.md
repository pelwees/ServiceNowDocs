...
|----|-----------|
|[UriMatcherResponse](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../UriMatcherResponseScoped/concept/UriMatcherResponseScopedAPI.md#)|UriMatcherResponse object with methods for returning detailed information about the match.|
