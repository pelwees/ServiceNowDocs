...
This API enables the processing of payloads that are used by the REST endpoint [DevOps - POST /devops/tool/\{capability\}](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../integrate/inbound-rest/concept/devops-api.md#). You must implement the methods of this API in a script include before calling the POST /devops/tool/\{capability\} endpoint.
...
You must implement this method in a script include before calling the REST endpoint [DevOps - POST /devops/tool/\{capability\}](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../integrate/inbound-rest/concept/devops-api.md#).
...
You must implement this method in a script include before calling [DevOps - POST /devops/tool/\{capability\}](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../integrate/inbound-rest/concept/devops-api.md#).
