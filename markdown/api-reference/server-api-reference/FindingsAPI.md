...
-   [LinterCheckAstNode API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../LinterCheckAstNode/concept/LinterCheckAstNodeAPIBoth.md#)
