...
GlideURI object representing the URI parameter of the user view.-   [GlideURI - Scoped](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideURIScoped/concept/c_GlideURIScopedAPI.md#)
-   [GlideURI - Global](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../GlideURIGlobal/concept/GlideURIGlobalAPI.md#)
...
|Name|Type|Description|
|----|----|-----------|
|gr|[GlideRecord](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#)|GlideRecord of the page to be opened in the user view.|
...
-   [Create a UI routing action](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../script/useful-scripts/concept/useful-client-side-scripts.md#)
...
|Name|Type|Description|
|----|----|-----------|
|URL|Object|URL to set as the redirect. You can provide the URL as a string or a [GlideRecord](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#). If you pass the URL as a GlideRecord, this value takes the focus to that record's form.|

|Type|Description|
|----|-----------|
|void| |

The following example shows how to redirect a user to a URL from a UI action using the [current](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../../../../script/server-scripting/concept/c_ScriptableServiceCatalogVariables.md) variable.
...
|Name|Type|Description|
|----|----|-----------|
|URL|Object|URI to set as the return location after a UI action is complete. You can provide the URL as a string or a [GlideRecord](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideRecordScoped/concept/c_GlideRecordScopedAPI.md#).|
