...
Use the [IEventSender](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../IEventSender/concept/IEventSenderAPI.md#) API to send the event to the ServiceNow instance. Use the [Event](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../Event/concept/EventAPI.md#) API to add/update fields within an event.
