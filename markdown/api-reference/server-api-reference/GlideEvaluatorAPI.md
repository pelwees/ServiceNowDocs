...
To use the GlideScopedEvaluator\(\) method in a scoped application, use the corresponding scoped method: [GlideScopedEvaluator\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideEvaluatorScoped/concept/c_GlideEvaluatorScopedAPI.md#).
...
To use the evaluateScript\(\) method in a scoped application, use the corresponding scoped method: [evaluateScript\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideEvaluatorScoped/concept/c_GlideEvaluatorScopedAPI.md#).
...
To use the getVariable\(\) method in a scoped application, use the corresponding scoped method: [getVariable\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideEvaluatorScoped/concept/c_GlideEvaluatorScopedAPI.md#).
...
To use the putVariable\(\) method in a scoped application, use the corresponding scoped method: [putVariable\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/server-api-reference/../../glideEvaluatorScoped/concept/c_GlideEvaluatorScopedAPI.md#).
