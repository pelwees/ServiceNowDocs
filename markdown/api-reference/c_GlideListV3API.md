...
This API is no longer supported. Consider using the [GlideList2\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/../../GlideList2/concept/c_GlideList2API.md#) API instead.
