...
Data type: Number, String, Boolean, or JSON object, depending on transform. \(For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/Clotho-Time-Series-API.md#Supported_transforms) below.\)
...
Required if a **transforms** object is specified. Name of the transform.For a list of available transforms, refer to the table [Supported transforms](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/Clotho-Time-Series-API.md#Supported_transforms) below.
