...
Use this API to create up to 50 monitors per request. To create more than 50 monitors per request, use the [SyntheticsAsyncBulkCreate](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/synth-async-api.md#) API.
...
Required. Correlation identifier for tracking and telemetry that links all monitors created in the same request. You can use [gs.generateGUID\(\)](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/../../../app-store/dev_portal/API_reference/glideSystemScoped/concept/c_GlideSystemScopedAPI.md#) to generate the id.
