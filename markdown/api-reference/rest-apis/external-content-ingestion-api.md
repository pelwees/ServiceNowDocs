...
1.  Store the binary content in AI Search using the [POST /ais/external\_content/storeContent](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/external-content-ingestion-api.md#) endpoint. Record the value of the **result** response body parameter.
