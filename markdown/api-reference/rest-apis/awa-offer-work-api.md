...
Use the [AWA Agent Consult API](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/awa-agent-consult-api.md#) to handle agent consult work items.
