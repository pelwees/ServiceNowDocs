...
Use the [AWA Agent - PUT /now/awa/agents/\{user\_id\}/capacities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/agent-api.md#) method to modify the channel and universal capacities of an agent.
...
Use the [AWA Agent - GET /now/awa/agents/\{user\_id\}/capacities](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/agent-api.md#) method to retrieve the current channel and universal capacities of an agent.
