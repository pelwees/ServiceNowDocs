...
Sys\_id of the interaction record to update. This value is returned by the [Create Voice Interaction/POST](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/openframe-api.md#) endpoint.Data type: String
...
See also the **callerPhoneNumber** property description for [Create Voice Interaction/POST](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/openframe-api.md#).
