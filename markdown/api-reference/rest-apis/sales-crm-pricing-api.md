...
-   **[Sales CRM Pricing - DELETE - /api/sn\_csm\_pricing/v1/pricingengine/pricing\_context/\{pricing\_context\_id\}](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/../reference/sales_crm_pricing-DELETE-pricing-context-id.md)**  
Terminate a session with a given ID that was established during a configurator session.
-   **[Sales CRM Pricing - POST /api/sn\_csm\_pricing/\{api\_version\}/pricingengine/computePrice](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/api-reference/rest-apis/../reference/sales_crm_pricing-POST-compute-price.md)**  
