...
3.  In the **Troubleshoot** tab, select **Test results**.
    ...
    ![Hi-tech test.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-media-technology/now-assist-for-telecom-media-and-technology/../image/test-result-hi-tech-cases.png)
...
5.  In the Test Run summary by Now Assist component, select **Summarize**.
    ...
    ![Summarize the hi-tech test.](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/telecom-media-technology/now-assist-for-telecom-media-and-technology/../image/test-result-summarize-hi-tech-cases.png)
