...
For the list of roles included with each plugin, see the roles section in each of the plugin links in [Components installed with plugins](https://raw.githubusercontent.com/pelwees/ServiceNowDocs/australia/markdown/retail-industry/../concept/rahi-retail-components-installed-with-plugins.md).
